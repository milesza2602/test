--------------------------------------------------------
--  DDL for Procedure WH_PRF_CORP_119U
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_CORP_119U" (p_forall_limit in integer,p_success out boolean) as
...
--
-- 28 December 2018 Shuaib Salie    Alloc_qty overstated – change needed to rectify measure going forward. ( Chg-20414)
-- 
--  Naming conventions
--  g_  -  Global variable
...
--                round(NVL(LI.reg_rsp,0) * 100 / (100 + LI.tax_perc),2)        -- REF03Mar2018
   ...
   from   fnd_rtl_allocation aloc
          ...
          join dim_item_hist dih on aloc.item_no               = dih.item_no  
            and aloc.release_date between dih.sk2_active_from_date and dih.sk2_active_to_date --SS
          join dim_location dl on aloc.to_loc_no      = dl.location_no 
          join dim_location_hist dlh on aloc.to_loc_no         = dlh.location_no 
            and aloc.release_date between dlh.sk2_active_from_date and dlh.sk2_active_to_date --SS
   ...
   --where aloc.release_date between dih.sk2_active_from_date and dih.sk2_active_to_date        and  --SS
   where      aloc.release_date between g_start_date  and g_date 
