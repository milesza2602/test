--------------------------------------------------------
--  DDL for Procedure WH_PRF_AST_044U_NEW
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_AST_044U_NEW" 
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_AST_044U_NEW';
...
--**************************************************************************************************
 ...
 --   dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);
  ...
  --                sum(nvl(CH_NUM_CATLG_DAYS,0))       as Avail_CH_NUM_CATLG_DAYS
     ...
     ----------------------------------------------------------     
     merge /*+ APPEND parallel (AST,4) */ into dwh_performance.RTL_LOC_ITEM_DY_AST_CATLG ast
