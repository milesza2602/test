--------------------------------------------------------
--  DDL for Procedure WH_PRF_CORP_714E_AZTEC_SLAB_SX
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_CORP_714E_AZTEC_SLAB_SX" (p_forall_limit in integer,p_success out boolean) 
as
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_CORP_714E_AZTEC_SLAB_SX';
...
--g_date_yyyymm          := '201902'; -- FEB 2019
--g_date_yyyymm          := '201901'; -- JAN 2019
--g_date_yyyymm          := '201812'; -- DEC 2018
--g_date_yyyymm          := '201811'; -- NOV 2018
g_date_yyyymm          := '201810'; -- OCT 2018
--g_date_yyyymm          := '201809'; -- SEP 2018
--g_date_yyyymm          := '201808'; -- AUG 2018
--g_date_yyyymm          := '201807'; -- JULY 2018
--g_date_yyyymm          := '201806'; -- JUNE 2018
--g_date_yyyymm          := '201805'; -- MAY 2018
--g_date_yyyymm          := '201804'; -- APR 2018
--g_date_yyyymm          := '201803'; -- MAR 2018
    ...
    ' WITH sub1 AS
      ...
      --        AND POST_DATE between ''07-AUG-2018'' and ''06-SEP-2018''    -- SEP 2018
              --AND POST_DATE between ''07-JUL-2018'' and ''06-AUG-2018''    -- AUG 2018
          --    AND POST_DATE between ''07-JUN-2018'' and ''06-JUL-2018''    -- JULY 2018
          --    AND POST_DATE between ''07-MAY-2018'' and ''06-JUN-2018''    -- JUNE 2018
           --   AND POST_DATE between ''07-APR-2018'' and ''06-MAY-2018''    --MAY 2018
            --  AND POST_DATE between ''07-MAR-2018'' and ''06-APR-2018''    -- APR 2018
            --  AND POST_DATE between ''07-FEB-2018'' and ''06-MAR-2018''    -- MARCH 2018
            AND LOC_TYPE = ''S''
...
--**************************************************************************************************
  ...
  exception
     ...
     when others then
       ...
       p_success := false;
       RAISE;
end WH_PRF_CORP_714E_AZTEC_SLAB_SX;
