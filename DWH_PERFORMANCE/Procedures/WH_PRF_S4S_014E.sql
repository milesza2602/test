--------------------------------------------------------
--  DDL for Procedure WH_PRF_S4S_014E
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_S4S_014E" (p_forall_limit in integer,p_success out boolean) as
...
l_description        sys_dwh_log_summary.log_description%type  := 'LOAD LABOUR_ROLE Dimension Data';
