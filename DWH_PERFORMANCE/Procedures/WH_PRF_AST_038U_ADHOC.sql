--------------------------------------------------------
--  DDL for Procedure WH_PRF_AST_038U_ADHOC
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_AST_038U_ADHOC" 
                                                                                (p_forall_limit in integer,p_success out boolean) as
--**************************************************************************************************
--  Date:        June 2014
--  Author:      A Joshua
--  Purpose:     Load Time On Offer (last 6 weeks) actuals - Adhoc load of data from 2014 week 1 until current
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_AST_038U';
