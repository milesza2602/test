--------------------------------------------------------
--  DDL for Procedure WH_PRF_CORP_500U_SHPD
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_CORP_500U_SHPD" 
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_CORP_500U_SHPD';
...
--2016	9
-- eg RTL_LCITMRD_M201111_48, RTL_LCITMRD_M20113_10,RTL_LCITMRD_M20162_9
------------
          g_partition_name :=   'RTL_LCITMRD_M'||g_fin_year_no||g_fin_month_no||'_'||g_fin_week_no;    
          g_sql_trunc_partition := 'alter table dwh_performance.RTL_LOC_ITEM_WK_RMS_DENSE truncate SUBPARTITION '||g_partition_name;
