--------------------------------------------------------
--  DDL for Procedure WH_PRF_DJ_669U_WL
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_DJ_669U_WL" 
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_DJ_669U_WL';
...
--qc4148            sum(lid.case_cost) case_cost
   ...
   from     rtl_po_supchain_loc_item_dy_dj lid   WHERE TRAN_DATE >= '1 AUG 2016'
