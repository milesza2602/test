--------------------------------------------------------
--  DDL for Procedure WH_PRF_CORP_234U
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_CORP_234U" (p_forall_limit in integer,p_success out boolean) as
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_CORP_234U';
...
begin
    ...
    l_text := 'Create Foods Loc Item Week Mart for LAST COMPLETED WEEK STARTED AT '||
...
--from rtl_loc_item_wk_rdf_fcst f, item_list il, store_list_area sl         --RDF L1/L2 remapping chg-2218
from RTL_LOC_ITEM_RDF_WKFCST_L1 f, item_list il, store_list_area sl
where f.sk1_item_no     = il.sk1_item_no
and f.sk1_location_no = sl.sk1_location_no
