--------------------------------------------------------
--  DDL for Procedure WH_PRF_CORP_152U
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_CORP_152U" 
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_CORP_152U';
...
begin
   ...
   from   dim_calendar
   where  fin_year_no = g_rec_in.fin_year_no and
          fin_week_no = g_rec_in.fin_week_no and
          fin_day_no  = 1 ;
   ...
   from   dim_calendar
   where  calendar_date = g_calendar_date - 7;
...
--**************************************************************************************************
    ...
    dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);
/*
    select fin_week_no, fin_year_no, this_week_start_date, fin_week_code
    into g_fin_week_no, g_fin_year_no, g_this_week_start_date, g_fin_week_code
    from dim_calendar
