--------------------------------------------------------
--  DDL for Procedure REP_PRF_CORP_001U
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."REP_PRF_CORP_001U" 
   (
...
from dwh_performance.dim_calendar_wk cal
