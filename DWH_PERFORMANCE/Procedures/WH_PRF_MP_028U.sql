--------------------------------------------------------
--  DDL for Procedure WH_PRF_MP_028U
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_MP_028U" 
...
-- 2. Added filters on fin_year_no and fin_week_no to help oracle to only process relevant partitions
-- 
-- **************************************************************************************************
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_MP_028U';
...
begin
  ...
  L_TEXT := 'Updating RMS Stock data ....';
   ...
   -- 2019-02-06 PaulW Upgrade performance tuning - force partition scans
   and stck.fin_year_no BETWEEN g_start_fin_year_no AND g_end_fin_year_no
   and stck.fin_week_no BETWEEN g_start_fin_week_no AND g_end_fin_week_no
...
begin
 ...
 merge /*+ parallel(mart,4) */   into  dwh_performance.mart_rtl_loc_subc_pln_wk_rms mart
   ...
   -- 2019-02-06 PaulW Upgrade performance tuning
    and dns.fin_year_no BETWEEN g_start_fin_year_no AND g_end_fin_year_no
    and dns.fin_week_no BETWEEN g_start_fin_week_no AND g_end_fin_week_no
--     and fin_year_no = g_fin_year_no
--     and fin_week_no = g_fin_week_no
...
begin
 ...
 merge /*+ parallel(mart,4) */   into  dwh_performance.mart_rtl_loc_subc_pln_wk_rms mart
   ...
   -- 2019-02-06 PaulW Upgrade performance tuning
      and sprs.fin_year_no BETWEEN g_start_fin_year_no AND g_end_fin_year_no
      and sprs.fin_week_no BETWEEN g_start_fin_week_no AND g_end_fin_week_no
--     and fin_year_no = g_fin_year_no
--     and fin_week_no = g_fin_week_no
