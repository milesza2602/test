--------------------------------------------------------
--  DDL for Procedure BV_FOODEXTR_PRICE
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."BV_FOODEXTR_PRICE" (p_forall_limit in integer,p_success out boolean) as
...
g_count              number        :=  0;
g_sub                integer       :=  0;
g_rec_out            temp_food_extr_pricing%rowtype;
g_found              boolean;
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'BV_FOODEXTR_PRICING';
...
--**************************************************************************************************
    ...
    g_start_date := '01 AUG 2011';
    g_end_date   := '07 AUG 2011';
...
insert  /*+ APPEND parallel (tmp,4)*/ into temp_food_extr_pricing tmp
