--------------------------------------------------------
--  DDL for Procedure WH_PRF_CORP_114U_BCK
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_CORP_114U_BCK" (p_forall_limit in integer,p_success out boolean) as
...
cursor c_fnd_rtl_shipment is
   ...
   select sum(nvl(shp.sdn_qty,0)) as trunked_qty,
