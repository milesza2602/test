--------------------------------------------------------
--  DDL for Procedure WH_PRF_RDF_212F_ADHOC
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_RDF_212F_ADHOC" 
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_RDF_212F_ADHOC';
...
begin
    ...
    l_text := 'LOAD RTL_LOC_ITEM_RDF_WKFCST_L2 EX TEMP TABLES STARTED '||
