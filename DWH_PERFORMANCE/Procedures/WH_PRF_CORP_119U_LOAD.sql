--------------------------------------------------------
--  DDL for Procedure WH_PRF_CORP_119U_LOAD
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_CORP_119U_LOAD" (p_forall_limit in integer,p_success out boolean) as
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_CORP_119U_LOAD';
...
--          max(round(nvl(li.reg_rsp,0) * 100 / (100 + nvl(di.vat_rate_perc,0)),2)) reg_rsp_excl_vat,
  ...
  --   and (aloc.CHAIN_CODE <> 'DJ' or aloc.chain_code is null)
     ...
     and aloc.last_updated_date = '01/JAN/2099'
...
--    dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);
   ...
   g_rec_out.last_updated_date               := '01/JAN/2099';    --g_date;
