--------------------------------------------------------
--  DDL for Procedure WH_PRF_CORP_185U_FIX
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_CORP_185U_FIX" 
...
--
--  Maintenance:
--  WW-857808  A Joshua (update returning more than one row)
--
--  Naming conventions:
--  g_  -  Global variable
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_CORP_185U_FIX';
                ...
                If g_inserted > 0 then 
                      ...
                      SET sk1_group_ITEM_NO = (SELECT distinct B.sk1_GROUP_ITEM_NO
                                               ...
                                               WHERE (A.SK1_CHAIN_CODE_IND = b.SK1_CHAIN_CODE_IND
                                                       ...
                                                       and    a.sk1_item_no = b.sk1_item_no --WW-857808
