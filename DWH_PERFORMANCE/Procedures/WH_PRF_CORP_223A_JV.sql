--------------------------------------------------------
--  DDL for Procedure WH_PRF_CORP_223A_JV
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_CORP_223A_JV" (p_forall_limit in integer,p_success out boolean) as
...
--               Output - tmp_mart_foods_wkly_snpsht_tt
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_CORP_223A_JV';
l_name               sys_dwh_log.log_name%type                 := dwh_constants.vc_log_name_rtl_facts;
l_system_name        sys_dwh_log.log_system_name%type          := dwh_constants.vc_log_system_name_rtl_prf;
l_script_name        sys_dwh_log.log_script_name%type          := dwh_constants.vc_log_script_rtl_prf_facts;
l_procedure_name     sys_dwh_log.log_procedure_name%type       := l_module_name;
l_text               sys_dwh_log.log_text%type ;
l_description        sys_dwh_log_summary.log_description%type  := 'Create Mart table for Foods weekly snapshot - with POS JV measures';
...
begin
    ...
    l_text := 'Create Mart table for Foods weekly snapshot  - with POS JV measures - STARTED AT '||
...
----------------------------------------------------------------------------------------------------
    ...
    dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);
    EXECUTE IMMEDIATE('truncate table w6005682.tmp_mart_foods_wkly_snpsht_tt');
...
INSERT /*+ APPEND */ INTO w6005682.tmp_mart_foods_wkly_snpsht_tt mart
with item_list as (
...
-- POS JV DATA
pos_jv as (
select /*+ PARALLEL(pos,4) */ pos.sk1_location_no, pos.sk1_item_no, pos.spec_dept_qty , pos.spec_dept_revenue 
...
pos_jv_ly as (
select /*+ PARALLEL(pos,4) */ pos.sk1_location_no, pos.sk1_item_no, pos.spec_dept_qty spec_dept_qty_ly, pos.spec_dept_revenue spec_dept_revenue_ly
  from dwh_performance.rtl_loc_item_wk_pos_jv pos,
       store_list dl,
       item_list di
...
pos_jv_ytd as (
select pos.sk1_location_no, pos.sk1_item_no, 
...
nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(f0.sk1_location_no,f2.sk1_location_no),
                                           f3.sk1_location_no),
                                           f4.sk1_location_no),
                                           f6.sk1_location_no),
                                           fy0.sk1_location_no),
...
sk1_location_no,
nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(f0.sk1_item_no,f2.sk1_item_no),
                                          f3.sk1_item_no),
                                          f4.sk1_item_no),
                                          f6.sk1_item_no),
                                          fy0.sk1_item_no),
...
f24.spec_dept_qty,              -- START POS JV
...
f27.spec_dept_revenue_ly_ytd    -- END POS JV
...
full outer join pos_jv f24 on nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(f0.sk1_location_no,f2.sk1_location_no),
                                                                                   f3.sk1_location_no),
                                                                                   f4.sk1_location_no),
                                                                                   f6.sk1_location_no),
                                                                                   fy0.sk1_location_no),
...
full outer join pos_jv_ly f25 on nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(f0.sk1_location_no,f2.sk1_location_no),
                                                                                   f3.sk1_location_no),
                                                                                   f4.sk1_location_no),
                                                                                   f6.sk1_location_no),
                                                                                   fy0.sk1_location_no),
                                 ...
                                 and nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(f0.sk1_item_no,f2.sk1_item_no),
                                                                                   f3.sk1_item_no),
                                                                                   f4.sk1_item_no),
                                                                                   f6.sk1_item_no),
                                                                                   fy0.sk1_item_no),
...
full outer join pos_jv_ytd f26 on nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(f0.sk1_location_no,f2.sk1_location_no),
                                                                                   f3.sk1_location_no),
                                                                                   f4.sk1_location_no),
                                                                                   f6.sk1_location_no),
                                                                                   fy0.sk1_location_no),
                                 ...
                                 and nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(f0.sk1_item_no,f2.sk1_item_no),
                                                                                   f3.sk1_item_no),
                                                                                   f4.sk1_item_no),
                                                                                   f6.sk1_item_no),
                                                                                   fy0.sk1_item_no),
...
full outer join pos_jv_ly_ytd f27 on nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(f0.sk1_location_no,f2.sk1_location_no),
                                                                                   f3.sk1_location_no),
                                                                                   f4.sk1_location_no),
                                                                                   f6.sk1_location_no),
                                                                                   fy0.sk1_location_no),
                                 ...
                                 and nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(f0.sk1_item_no,f2.sk1_item_no),
                                                                                   f3.sk1_item_no),
                                                                                   f4.sk1_item_no),
                                                                                   f6.sk1_item_no),
                                                                                   fy0.sk1_item_no),
