--------------------------------------------------------
--  DDL for Procedure WH_PRF_AST_034A_WLFX4
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_AST_034A_WLFX4" (
    ...
    --
     --**************************************************************************************************
      ...
      l_module_name sys_dwh_errlog.log_procedure_name%type := 'WH_PRF_AST_034A_WLFX4';
    ...
    execute immediate 'truncate table DWH_DATAFIX.MART_CH_AST_CHNGRDSCWK_WLFIX4';
    L_TEXT := 'truncate table MART_CH_AST_CHNGRDSCWK_WLFIX4';
    dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);
...
--
    ...
    WHERE calendar_date = G_LOOP_DATE + (g_sub * 7);
     ...
     l_text := 'BATCH DATE BEING PROCESSED - G_LOOP_DATE='||G_LOOP_DATE||' G_DATE='||G_DATE;
      ...
      execute immediate 'Truncate Table dwh_datafix.trtl_ast_sccontwk_034a_wlFIX4';
     l_text := 'Truncate Table dwh_datafix.trtl_ast_sccontwk_034a_wlFIX4';
      dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);
            
      insert 
      into dwh_datafix.trtl_ast_sccontwk_034a_wlFIX4 a
   with selext as
      (select 
               sk1_style_colour_no,
              continuity_ind,
 ...
 --     AND   sk1_style_colour_no in (5502589,16420002)
    ...
    l_text := 'Recs Inserted Into trtl_ast_sccontwk_034a_wlFIX4 = '||g_recs_inserted;
    dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);
...
--**************************************************************************************************     
    ...
    execute immediate 'truncate table dwh_datafix.trtl_ast_sc_dates_wlFIX4';
    L_TEXT := 'truncate table dwh_datafix.trtl_ast_sc_dates_wlFIX4';
    dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);


insert /*+ append */ into  dwh_datafix.trtl_ast_sc_dates_wlFIX4
                   select
                            sk1_style_colour_no 
                            ,continuity_ind 
                            ,season_first_trade_date 
                          ...
                          from dwh_datafix.trtl_ast_sccontwk_034a_wlFIX4 a,
                                dim_calendar dc1
...
--**************************************************************************************************
    ...
    execute immediate 'truncate table dwh_datafix.trtl_ast_sc_6wk_034b_wlFIX4';
    L_TEXT := 'truncate table dwh_datafix.trtl_ast_sc_6wk_034b_wlFIX4';
    dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);


    insert /*+ append */ into  dwh_datafix.trtl_ast_sc_6wk_034b_wlFIX4
              with selcal as
              ...
              from dwh_performance.rtl_chn_geo_grd_sc_wk_ast_act a
                                 ...
                                 join dwh_datafix.trtl_ast_sc_dates_wlFIX4 ic
...
--and a.sk1_grade_no = 6
    ...
    L_TEXT := 'Recs inserted into trtl_ast_sc_6wk_034b_wlFIX4 = '||g_recs_inserted;
    dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);
...
--**************************************************************************************************
    ...
    insert /*+append */ into  dwh_datafix.mart_ch_ast_chngrdscwk_wlFIX4 m
      with
    --------------------------------------------------------------------------------
    -- last completed week
    --------------------------------------------------------------------------------
   ...
   --                and sk1_chain_no = 243
    ...
    --------------------------------------------------------------------------------
     sixwk as (
              ...
              from dwh_datafix.trtl_ast_sc_6wk_034b_wlFIX4  w
...
--                and wkcat.fin_week_no = dcwkcat.fin_week_no
   ...
   --         and sk1_chain_no = 243 and   sk1_style_colour_no in (5502589,16420002)
    ...
    L_TEXT := 'Recs inserted into dwh_datafix.MART_CH_AST_CHNGRDSCWK_WLFIX4 = '||g_recs_inserted;
    dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);

     l_text := '************************************* C COMPLETED****************************************************';
    dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);

     DBMS_STATS.gather_table_stats ('DWH_DATAFIX','MART_CH_AST_CHNGRDSCWK_WLFIX4', DEGREE => 8);
   l_text := '**********Completed GATHER_TABLE_STATS ON MART_CH_AST_CHNGRDSCWK_WLFIX4********************************';
    dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);
