--------------------------------------------------------
--  DDL for Procedure WH_PRF_DJ_668B_VATFIX
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_DJ_668B_VATFIX" 
...
--  Tables:      Input  - rtl_contract_chain_item_wk_dj
--               Output - rtl_contract_chain_item_wk_dj
...
g_count              number        :=  0;
g_rec_out            DWH_PERFORMANCE.rtl_contract_chain_item_wk_dj%rowtype;
g_found              boolean;
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_DJ_668B_VATFIX';
...
type tbl_array_i is table of DWH_PERFORMANCE.rtl_contract_chain_item_wk_dj%rowtype index by binary_integer;
type tbl_array_u is table of DWH_PERFORMANCE.rtl_contract_chain_item_wk_dj%rowtype index by binary_integer;
...
boc.sk1_chain_code_ind
FROM DWH_PERFORMANCE.rtl_contrct_chn_item_wk_boc_dj BOC
...
begin
   ...
   forall i in a_tbl_insert.first .. a_tbl_insert.last
      save exceptions
      insert into DWH_PERFORMANCE.rtl_contract_chain_item_wk_dj values a_tbl_insert(i);
...
begin
    ...
    forall i in a_tbl_update.first .. a_tbl_update.last
       save exceptions
       update DWH_PERFORMANCE.rtl_contract_chain_item_wk_dj
...
-- Check to see if item is present on table and update/insert accordingly
 ---
  ...
  from DWH_PERFORMANCE.rtl_contract_chain_item_wk_dj
...
execute immediate 'alter session enable parallel dml';
     update /*+ parallel (RTL_CONTRACT_CHAIN_ITEM_WK_DJ ,4) */ DWH_PERFORMANCE.rtl_contract_chain_item_wk_dj
    ...
    l_text := 'RECORDS alltime values SET TO NULL - '||g_recs_updated;
    dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);
