--------------------------------------------------------
--  DDL for Procedure WH_PRF_CORP_160U_BCK
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_CORP_160U_BCK" (p_forall_limit in integer,p_success out boolean) as
--**************************************************************************************************
--  Date:        Novembe3r 2017
--  Author:      Q. Smit
    ...
    while g_from_date < g_to_date 
      loop
        ...
        left join fnd_rtl_inventory_adj b on b.post_date >= a.receive_date
                                         ...
                                         and to_number(b.ref_id_1) = to_number(a.sdn_no)
        ...
        left join fnd_rtl_inventory_adj d on d.post_date >= a.receive_date
                                         ...
                                         and to_number(d.ref_id_1) = to_number(a.sdn_no)
