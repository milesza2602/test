--------------------------------------------------------
--  DDL for Procedure WH_PRF_CORP_669U_FIXWL
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_CORP_669U_FIXWL" 
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_CORP_669U_FIXWL';
...
--qc4148            sum(lid.case_cost) case_cost
   ...
   from     chgrecs cr
   join     rtl_po_supchain_loc_item_dy lid     on  lid.tran_date           = cr.tran_date
...
begin
   ...
   forall i in a_tbl_insert.first .. a_tbl_insert.last
      save exceptions
      insert into rtl_supchain_loc_item_dy values a_tbl_insert(i);
...
begin
   ...
   forall i in a_tbl_update.first .. a_tbl_update.last
      save exceptions
      update rtl_supchain_loc_item_dy
...
begin
    ...
    delete from rtl_supchain_loc_item_dy r
