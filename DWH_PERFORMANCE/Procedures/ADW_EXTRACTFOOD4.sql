--------------------------------------------------------
--  DDL for Procedure ADW_EXTRACTFOOD4
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."ADW_EXTRACTFOOD4" (p_forall_limit in integer,p_success out boolean) as
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'ADW_EXTRACTFOOD4';
...
where lid.sk1_location_no = dl.sk1_location_no and
      ...
      lid.fin_year_no = 2012 and lid.fin_week_no between 1 and 53','|','DWH_FILES_OUT','extr_food_waste_2012');    
