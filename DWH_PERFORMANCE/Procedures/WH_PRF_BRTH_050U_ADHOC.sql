--------------------------------------------------------
--  DDL for Procedure WH_PRF_BRTH_050U_ADHOC
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_BRTH_050U_ADHOC" -- STORE PROC CHANGE
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_BRTH_050U_ADHOC';                              -- STORE PROC CHANGE
...
--**************************************************************************************************
  ...
  exception
      ...
      when others then
       ...
       p_success := false;
       raise;
END WH_PRF_BRTH_050U_ADHOC                                                                                             -- STORE PROC CHANGE 
;
