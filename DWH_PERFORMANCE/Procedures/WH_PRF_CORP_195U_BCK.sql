--------------------------------------------------------
--  DDL for Procedure WH_PRF_CORP_195U_BCK
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_CORP_195U_BCK" (p_forall_limit in integer,p_success out boolean) as
...
--          di.item_no = 6001009015174 and -- remove
--          dl.location_no = 457; -- remove
--          dl.loc_type                    = 'S'    and
...
begin
    ...
    forall i in a_tbl_update.first .. a_tbl_update.last
       ...
       set    fd_num_avail_days               = a_tbl_update(i).fd_num_avail_days,
              ...
              num_facings                     = a_tbl_update(i).num_facings --chg4256
