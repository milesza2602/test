--------------------------------------------------------
--  DDL for Procedure WH_PRF_CORP_687U_BK
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_CORP_687U_BK" (p_forall_limit in integer,p_success out boolean) as
--**************************************************************************************************
--  Date:         February 2013
--  Author:       A Joshua
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_CORP_687U_BK';
...
Cursor c_po_chain Is
   with chgrecs as (select   SK1_PO_NO,SK1_CHAIN_NO,SK1_STYLE_COLOUR_NO,FIN_YEAR_NO,FIN_WEEK_NO
                    from     w7104429.rtl_po_supchain_loc_item_dy   rtl, dim_location dl, dim_item di, dim_calendar dc --rtl_supchain_loc_item_dy
...
begin
    forall i in a_tbl_insert.first .. a_tbl_insert.last
       save exceptions
       insert into w7104429.rtl_po_chain_sc_wk values a_tbl_insert(i);
...
begin
    ...
    forall i in a_tbl_update.first .. a_tbl_update.last
       save exceptions
       update w7104429.rtl_po_chain_sc_wk
...
-- Check to see if item is present on table and update/insert accordingly
   select count(1)
   into   g_count
   from   w7104429.rtl_po_chain_sc_wk
...
begin
    ...
    delete from w7104429.rtl_po_chain_sc_wk r
