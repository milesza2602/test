--------------------------------------------------------
--  DDL for Procedure ADW_MC_HIST_LIF
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."ADW_MC_HIST_LIF" 
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'ADW_MC_HIST_LIF';
...
select   location_no  
from     dim_location
where    location_no > 3196   --restart point--
...
AND     LOCATION_NO = LOC_RECORD.LOCATION_NO;
 

      g_recs_read     := g_recs_read     + sql%rowcount;

      l_text := 'UPDATED LOCATION ' ||LOC_RECORD.LOCATION_NO||'  '||
