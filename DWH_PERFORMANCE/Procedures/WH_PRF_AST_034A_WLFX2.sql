--------------------------------------------------------
--  DDL for Procedure WH_PRF_AST_034A_WLFX2
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_AST_034A_WLFX2" (
    ...
    --
     --**************************************************************************************************
      ...
      l_module_name sys_dwh_errlog.log_procedure_name%type := 'WH_PRF_AST_034A_WLFX2';
...
--
      ...
      G_LOOP_DATE := '17 JULY 2016';
          G_LOOP_DATE := G_LOOP_DATE + 1;
    ...
    WHERE calendar_date = G_LOOP_DATE + (g_sub * 7);
     ...
     l_text := 'BATCH DATE BEING PROCESSED - G_LOOP_DATE='||G_LOOP_DATE||' G_DATE='||G_DATE;
      dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);
