--------------------------------------------------------
--  DDL for Procedure WH_PRF_CORP_510U_WLFIX
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_CORP_510U_WLFIX" 
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_CORP_510U_WLFIX';
...
begin
    ...
    g_recs_read := 0;
    g_recs_DELETED := 0;
      DELETE FROM dwh_performance.rtl_loc_sc_wk_rms_dense A
