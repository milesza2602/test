--------------------------------------------------------
--  DDL for Procedure WH_PRF_DJ_660U
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_DJ_660U" 
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_DJ_660U';
...
*/
    ...
    execute immediate 'truncate table dwh_performance.TEMP_PO_LIST_DJ1';
    l_text := 'TABLE TEMP_PO_LIST_DJ1 TRUNCATED.';
    dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);
...
--**************************************************************************************************
    g_param_ind := 1;
     insert /*+ append */ into dwh_performance.TEMP_PO_LIST_DJ1
...
---------------------------------------------------------------------------
 ...
 SELECT DISTINCT * FROM  dwh_performance.TEMP_PO_LIST_DJ1;
...
---------------------------------------------------------------------------
  ...
  if g_cnt > 0
  then 
  delete from  dwh_performance.TEMP_PO_LIST_DJ a
