--------------------------------------------------------
--  DDL for Procedure WH_PRF_MP_010U_TST
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_MP_010U_TST" (p_forall_limit in integer,p_success out boolean) as

--**************************************************************************************************
--  Date:        November 2008
--  Author:      Alfonso Joshua
--  Purpose:     Create the product area subclass plan type table in the performance layer
--               with input ex MP table from foundation layer.
--  Tables:      Input  - fnd_chain_subclass_wk_plan
--               Output - rtl_area_subclass_wk_mp_plan
--  Packages:    constants, dwh_log, dwh_valid
--
--  Maintenance:
--  08 Jan 2009 - defect 453  - Change to fnd_chain_subclass_wk_plan structure
--              - defect 455  - Change to rtl_area_subclass_wk_mp_plan structure
...
g_count              number        :=  0;
g_sk1_area_no        number(9)     :=  0;
g_rec_out            rtl_area_subclass_wk_mp_plan%rowtype;
g_found              boolean;
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_MP_010U_TST';
...
l_description        sys_dwh_log_summary.log_description%type  := 'LOAD THE MP PRODUCT AREA SUBCLASS PLAN TYPE FACTS EX FOUNDATION';
l_process_type       sys_dwh_log_summary.log_process_type%type := dwh_constants.vc_log_process_type_n;


-- For output arrays into bulk load forall statements --
type tbl_array_i is table of rtl_area_subclass_wk_mp_plan%rowtype index by binary_integer;
type tbl_array_u is table of rtl_area_subclass_wk_mp_plan%rowtype index by binary_integer;
...
cursor c_fnd_chain_subclass_wk_plan is
   select ds.sk1_subclass_no,
          dp.sk1_plan_type_no,
...
-- Rename measure for Total Planning --> 5043
    ...
    from  fnd_chain_subclass_wk_plan fnd_csw,
          dim_chain dc,
          dim_subclass ds,
          dim_plan_type dp,
          dim_calendar dcal
    where fnd_csw.last_updated_date = g_date and
          ...
          fnd_csw.subclass_no      = ds.subclass_no and
          fnd_csw.class_no         = ds.class_no and
          fnd_csw.department_no    = ds.department_no and
          ...
          fnd_csw.plan_type_no     = 54   and
          fnd_csw.fin_year_no      = 2016 and
          fnd_csw.fin_week_no      = 1    and
          ds.subclass_no = 1861;

g_rec_in                   c_fnd_chain_subclass_wk_plan%rowtype;
-- For input bulk collect --
type stg_array is table of c_fnd_chain_subclass_wk_plan%rowtype;
...
begin
   ...
   g_rec_out.sk1_area_no                     := g_sk1_area_no;
   ...
   dbms_output.put_line('SALES '||g_rec_out.pln_sales);
...
--   g_rec_out.pln_store_inter_fran_selling    := g_rec_in.pln_store_inter_fr_selling;
...
begin
    forall i in a_tbl_insert.first .. a_tbl_insert.last
       save exceptions
       insert into dwh_datafix.aj_area_subclass_wk_mp_plan values a_tbl_insert(i);
      ...
      when others then
       ...
       for i in 1 .. g_error_count loop
          ...
          l_message := dwh_constants.vc_err_lb_loop||i||
                       ...
                       ' '||a_tbl_insert(g_error_index).sk1_subclass_no||
...
begin
   ...
   forall i in a_tbl_update.first .. a_tbl_update.last
       save exceptions
       update dwh_datafix.aj_area_subclass_wk_mp_plan
...
-- Rename measure for Total Planning --> 5043
       ...
       where  sk1_area_no                    = a_tbl_update(i).sk1_area_no      and
              sk1_subclass_no                = a_tbl_update(i).sk1_subclass_no  and
      ...
      when others then
       ...
       for i in 1 .. g_error_count loop
          ...
          l_message := dwh_constants.vc_err_lb_loop||i||
                       ...
                       ' '||a_tbl_update(g_error_index).sk1_subclass_no||
...
-- Check to see if item is present on table and update/insert accordingly
   select count(1)
   into   g_count
   from   dwh_datafix.aj_area_subclass_wk_mp_plan
   where  sk1_area_no         = g_rec_out.sk1_area_no      and
          sk1_subclass_no     = g_rec_out.sk1_subclass_no  and
   ...
   dbms_output.put_line('StaTUS '||g_count);
   if a_count_i > 0 and not g_found then
      for i in a_tbl_insert.first .. a_tbl_insert.last
      loop
         if a_tbl_insert(i).sk1_area_no         = g_rec_out.sk1_area_no and
            a_tbl_insert(i).sk1_subclass_no     = g_rec_out.sk1_subclass_no and
...
begin
    ...
    l_text := 'LOAD OF RTL_AREA_SUBCLASS_WK_MP_PLAN EX FOUNDATION STARTED AT '||
...
--**************************************************************************************************
-- Look up area_no from dim_area  (area_no 9951 for SA Corporate)
--**************************************************************************************************
    select sk1_area_no
    into g_sk1_area_no
    from dim_area
...
--**************************************************************************************************
    open c_fnd_chain_subclass_wk_plan;
    fetch c_fnd_chain_subclass_wk_plan bulk collect into a_stg_input limit g_forall_limit;
    ...
    close c_fnd_chain_subclass_wk_plan;
--**************************************************************************************************
