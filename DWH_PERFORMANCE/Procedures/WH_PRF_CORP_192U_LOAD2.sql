--------------------------------------------------------
--  DDL for Procedure WH_PRF_CORP_192U_LOAD2
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_CORP_192U_LOAD2" (p_forall_limit in integer,p_success out boolean) as
...
--               with input ex RMS Food Stock table from foundation layer.
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_CORP_192U_LOAD2';
...
--          dl.loc_type                = 'S'    and
          ...
          lid.location_no            = dl.location_no and
          lid.item_no                = dih.item_no and
          dih.sk2_active_to_date     = dwh_constants.sk_to_date and
          lid.location_no            = dlh.location_no and
          di.sk1_item_no             = fnd_li.sk1_item_no and
          dl.sk1_location_no         = fnd_li.sk1_location_no and
...
begin
   ...
   g_rec_out.com_flag_adj_ind                := g_rec_in.com_flag_ind;
   g_rec_out.boh_adj_qty                     := g_rec_in.boh_qty;
   g_rec_out.boh_adj_selling                 := g_rec_in.boh_selling;
   g_rec_out.boh_adj_cost                    := g_rec_in.boh_cost;
   g_rec_out.soh_adj_qty                     := g_rec_in.soh_qty;
   g_rec_out.soh_adj_selling                 := g_rec_in.soh_selling;
   g_rec_out.soh_adj_cost                    := g_rec_in.soh_cost;
