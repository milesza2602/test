--------------------------------------------------------
--  DDL for Procedure WH_PRF_CORP_280U_WL102014
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_CORP_280U_WL102014" (
...
--**************************************************************************************************
     ...
     execute immediate('create index dwh_performance.i10_p_tmp_mrt_6wkavg_PRM_DTS on dwh_performance.temp_mart_6wkavg_prom_dates
                            (week_count, item_no) TABLESPACE PRF_MASTER NOLOGGING
NOPARALLEL ( DEGREE 8)

') ;
    l_text := 'create index  dwh_performance.i10_p_tmp_mrt_6wkavg_PRM_DTS NOLOGGING
NOPARALLEL ( DEGREE 8)
';
    dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);
     ...
     execute immediate('create index  dwh_performance.i20_p_tmp_mrt_6wkavg_PRM_DTS on dwh_performance.temp_mart_6wkavg_prom_dates
                            (week_count, sk1_prom_no) TABLESPACE PRF_MASTER NOLOGGING
NOPARALLEL ( DEGREE 8)
') ;
    l_text := 'create index  dwh_performance.i20_p_tmp_mrt_6wkavg_PRM_DTS NOLOGGING
NOPARALLEL ( DEGREE 8)
';
    dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);
     ...
     execute immediate('create index  dwh_performance.i30_p_tmp_mrt_6wkavg_PRM_DTS on dwh_performance.temp_mart_6wkavg_prom_dates
                            (item_no) TABLESPACE PRF_MASTER NOLOGGING
NOPARALLEL ( DEGREE 8)
') ;
      l_text := 'create index dwh_performance.i30_p_tmp_mrt_6wkavg_PRM_DTS NOLOGGING
NOPARALLEL ( DEGREE 8)
';
    dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);
