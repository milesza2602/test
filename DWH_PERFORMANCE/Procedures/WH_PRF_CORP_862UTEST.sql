--------------------------------------------------------
--  DDL for Procedure WH_PRF_CORP_862UTEST
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_CORP_862UTEST" 
...
--       where SK1_LOCATION_NO = 509         
    ...
    for i in 1..5  loop
        insert into  dwh_datafix.bk_temp_foods_tab_dense_sparse c
        select b.THIS_WEEK_START_DATE, 
               ...
               a.SK1_LOCATION_NO,
               0,0,0,0
        from   dwh_datafix.bk_temp_foods_tab_dense_sparse a
