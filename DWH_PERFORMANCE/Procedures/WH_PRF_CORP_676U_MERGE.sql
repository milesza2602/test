--------------------------------------------------------
--  DDL for Procedure WH_PRF_CORP_676U_MERGE
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_CORP_676U_MERGE" 
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_CORP_676U_MERGE';
...
FOR G_SUB IN 0..3
  LOOP
   ...
   merge /*+ parallel(prom,6) */ into RTL_PROM_LOC_SC_DY_MERGE prom using 
   (
