--------------------------------------------------------
--  DDL for Procedure WH_PRF_RDF_600U
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_RDF_600U" 
...
--**************************************************************************************************
  ...
  l_module_name sys_dwh_errlog.log_procedure_name%type := 'WH_PRF_RDF_600U';
...
*/
    ...
    EXECUTE IMMEDIATE('TRUNCATE TABLE DWH_PERFORMANCE.TEMP_LOC_ITEM_RDF_DYFCST_L2');
      l_text       := 'TRUNCATE TABLE DWH_PERFORMANCE.TEMP_LOC_ITEM_RDF_DYFCST_L2';
  dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);

  COMMIT;
    
  INSERT /*+ APPEND */ 
 INTO  DWH_PERFORMANCE.TEMP_LOC_ITEM_RDF_DYFCST_L2 rdf_mart 
    WITH SELRDF
                  AS(
...
;
  ...
  l_text := 'Insert TEMP_LOC_ITEM_RDF_DYFCST_L2 RECS =  '||g_recs_inserted;  
  dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);
  ...
  MERGE /*+ full(rdf_mart) parallel(rdf_mart,4) */ into DWH_PERFORMANCE.RTL_LOC_ITEM_RDF_DYFCST_L2 rdf_mart using (
    SELECT /*+ full(l2)  */  * FROM TEMP_LOC_ITEM_RDF_DYFCST_L2 l2
