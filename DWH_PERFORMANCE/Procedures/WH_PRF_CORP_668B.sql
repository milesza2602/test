--------------------------------------------------------
--  DDL for Procedure WH_PRF_CORP_668B
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_CORP_668B" (p_forall_limit in integer,p_success out boolean) as
--**************************************************************************************************
--  Date:        May 2010
--  Author:      W Lyttle
...
--**************************************************************************************************
    ...
    execute immediate 'alter session enable parallel dml';
     --update /*+ parallel(chn_wk,8) */ DWH_PERFORMANCE.rtl_contract_chain_item_wk chn_wk
    ...
    merge /*+ parallel (boc_mart,6) */ into DWH_PERFORMANCE.rtl_contract_chain_item_wk boc_mart 
    using (
  ...
  when not matched then
   ...
   values 
     ...
     g_recs_updated := g_recs_inserted + SQL%ROWCOUNT;
