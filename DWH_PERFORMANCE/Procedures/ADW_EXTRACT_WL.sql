--------------------------------------------------------
--  DDL for Procedure ADW_EXTRACT_WL
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."ADW_EXTRACT_WL" 
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'ADW_EXTRACT_WL';
...
--**************************************************************************************************
    ...
    ('select /*+ (parallel a,4) */ * from dim_item a  ','|','DWH_FILES_OUT','aj_item_xtr');
