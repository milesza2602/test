--------------------------------------------------------
--  DDL for Procedure WH_PRF_CORP_120U_BCK
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_CORP_120U_BCK" (p_forall_limit in integer,p_success out boolean) as
...
cursor c_fnd_rtl_shipment is
   ...
   where  shp.item_no                = lid_list.item_no        and
          ...
          lid_list.actl_rcpt_date         between dlh.sk2_active_from_date and dlh.sk2_active_to_date
