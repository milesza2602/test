--------------------------------------------------------
--  DDL for Procedure ADW_MC_HIST_LIF1
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."ADW_MC_HIST_LIF1" 
