--------------------------------------------------------
--  DDL for Procedure WH_PRF_CORP_759E_QS
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_CORP_759E_QS" 
...
--               Output - dwh_datafix.aj_rtl_sms_publish
...
g_rec_out            dwh_datafix.aj_rtl_sms_publish%rowtype;

l_message            sys_dwh_errlog.log_text%type;
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_CORP_759E_QS';
...
--   and       l.area_no            = 9951
   ...
   select    /*+ full(r) parallel(r,4) */ 
             2 rectype, u.commercial_manager_desc_562 merch_cat, r.calendar_date,u.product_class_desc_507 prod_class,
...
begin
   ...
   if g_store_cnt < 30 or g_hol_ind = 1 then
      if g_perc_too_low = 1 then
         ...
         insert into dwh_datafix.aj_rtl_sms_publish values g_rec_out;
...
--**************************************************************************************************
   ...
   update      dwh_datafix.aj_rtl_sms_publish
   set         processed_ind = 1
