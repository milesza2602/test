--------------------------------------------------------
--  DDL for Procedure WH_PRF_CORP_580U_020516
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_CORP_580U_020516" (p_forall_limit in integer,p_success out boolean) as
   ...
   loop
     ...
     where  prf.sk1_area_no         = upd_rec.sk1_area_no and
            ...
            prf.fin_week_no             = upd_rec.fin_week_no  and
              (
            upd_rec.forecast_sales <> prf.forecast_sales  );
