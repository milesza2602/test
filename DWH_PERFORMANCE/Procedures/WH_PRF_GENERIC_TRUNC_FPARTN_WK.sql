--------------------------------------------------------
--  DDL for Procedure WH_PRF_GENERIC_TRUNC_FPARTN_WK
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_GENERIC_TRUNC_FPARTN_WK" 
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_GENERIC_TRUNC_FPARTN_WK';
...
end wh_prf_generic_trunc_fpartn_wk;
