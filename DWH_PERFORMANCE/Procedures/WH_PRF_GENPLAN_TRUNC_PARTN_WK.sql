--------------------------------------------------------
--  DDL for Procedure WH_PRF_GENPLAN_TRUNC_PARTN_WK
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_GENPLAN_TRUNC_PARTN_WK" 
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_GENPLAN_TRUNC_PARTN_WK';
...
for g_sub in 1 .. g_no_of_weeks    -- g_sub changed to 1 to ensure last completed week
  loop
...
end wh_prf_genplan_trunc_partn_wk;
