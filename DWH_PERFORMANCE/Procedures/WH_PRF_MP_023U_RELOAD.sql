--------------------------------------------------------
--  DDL for Procedure WH_PRF_MP_023U_RELOAD
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_MP_023U_RELOAD" 
...
--  Maintenance:
-- fOUNDATION - TABLE
-- SELECT FIN_YEAR_NO, COUNT(DISTINCT FIN_MONTH_NO), LAST_UPDATED_DATE, COUNT(*) 
-- FROM  dwh_foundation.fnd_rtl_loc_DEPT_mth_plan_mp
-- GROUP BY FIN_YEAR_NO, LAST_UPDATED_DATE ORDER BY FIN_YEAR_NO, LAST_UPDATED_DATE
-- 2016	1	16/MAY/17	329332
-- 2017	2	14/MAY/17	816945
-- 2017	10	16/MAY/17	3457986
-- 2018	12	14/MAY/17	3921336
-- 2019	12	14/MAY/17	3921336
--
--  Naming conventions
--  g_  -  Global variable
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_MP_023U_RELOAD';
