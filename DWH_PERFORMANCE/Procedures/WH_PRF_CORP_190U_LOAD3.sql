--------------------------------------------------------
--  DDL for Procedure WH_PRF_CORP_190U_LOAD3
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_CORP_190U_LOAD3" (p_forall_limit in integer,p_success out boolean) as
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_CORP_190U';
...
begin
   ...
   dbms_output.put_line('fd_num_catlg_days '||g_rec_out.fd_num_catlg_days);
...
--    end if;
   ...
   dbms_output.put_line('this_wk_catalog_ind '||g_rec_out.this_wk_catalog_ind);
   ...
   dbms_output.put_line('fd_num_catlg_days for st_close_date '||g_rec_out.fd_num_catlg_days);
   ...
   dbms_output.put_line('fd_num_catlg_days for st_open_date '||g_rec_out.fd_num_catlg_days);
   exception
      when others then
