--------------------------------------------------------
--  DDL for Procedure WH_PRF_CORP_245U
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_CORP_245U" (p_forall_limit in integer, p_success out boolean) as
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_CORP_245U';
...
--**************************************************************************************************
   ...
   l_text := '1. l_end_6wks ='||l_end_6wks;
    dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);
   l_text := 'l_last_wk_fin_year_no ='||l_last_wk_fin_year_no;
    dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);

select unique ly_fin_year_no, ly_fin_week_no              --WK53
  into l_last_fin_year, l_last_fin_week                   --WK53
  from dim_calendar                                       --WK53
 where fin_year_no = l_last_wk_fin_year_no                --WK53
   and fin_week_no = l_end_6wks;                          --WK53
     l_text := '2. l_last_fin_year ='||l_last_fin_year;
    dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);
...
if l_end_6wks < 6 then
   ...
   l_text := '3. l_max_6wk_last_year = '||l_max_6wk_last_year;
   dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);
   ...
   l_text := '4. l_end_6wks_date = '||l_end_6wks_date;
   dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);
   --############################################################################################
  ...
  l_text := '5. l_last_wk_fin_year_no = '||l_last_wk_fin_year_no;
   dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);
   l_text := '6. l_6wks_wk6 = '||l_6wks_wk6;
   dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);
   l_text := '7. l_max_6wk_last_year = '||l_max_6wk_last_year;
   dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);


      --Calendar dates for last 6 weeks
    if l_max_6wk_last_year = 53 and l_end_6wks = 5 then  --done specifically for week 53
        ...
        select unique calendar_date start_date
          into l_start_6wks_date
          from dim_calendar
         where fin_year_no = l_last_wk_fin_year_no  --l_last_fin_year
           and fin_week_no = l_6wks_wk6
           and fin_day_no = 1;
     end if;
...
--       from dim_calendar
--where fin_year_no = l_last_fin_year
  ----    l_last_wk_fin_year_no  --l_last_fin_year
--        and fin_week_no = l_6wks_wk6
--        and fin_day_no = 1;
           l_text := '8. l_start_6wks_date = '||l_start_6wks_date;
   dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);
else
   select calendar_date end_date
     into l_end_6wks_date
    ...
    where fin_year_no = l_last_wk_fin_year_no  --l_fin_year_no
      and fin_week_no = l_end_6wks
      and fin_day_no = 7;
           l_text := '9. l_end_6wks_date = '||l_end_6wks_date;
   dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);
     l_6wks_wk1_yr := l_last_wk_fin_year_no;  --l_fin_year_no;
     l_6wks_wk2_yr := l_last_wk_fin_year_no;  --l_fin_year_no;
     l_6wks_wk3_yr := l_last_wk_fin_year_no;  --l_fin_year_no;
     ...
     select unique calendar_date start_date
      ...
      where fin_year_no = l_last_wk_fin_year_no  --l_fin_year_no
        ...
        and fin_day_no = 1;
                   l_text := '10. l_start_6wks_date = '||l_start_6wks_date;
   dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);
end if
;
...
/*
    ...
    l_last_wk_start_date := '25/FEB/13';
    l_last_wk_end_date   := '03/MAR/13';
*/
