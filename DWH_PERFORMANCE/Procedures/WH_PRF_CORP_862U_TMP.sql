--------------------------------------------------------
--  DDL for Procedure WH_PRF_CORP_862U_TMP
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_CORP_862U_TMP" 
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_CORP_862U_TMP';
      ...
      with 
        ...
        cleanse_xtr as 
          (select /*+ parallel (a,6) full (a) */
           ...
           where rownum = 0  -- not to return any rows of data
