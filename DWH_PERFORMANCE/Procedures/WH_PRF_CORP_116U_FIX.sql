--------------------------------------------------------
--  DDL for Procedure WH_PRF_CORP_116U_FIX
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_CORP_116U_FIX" (p_forall_limit in integer,p_success out boolean) as
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_CORP_116U';
...
cursor c_rtl_loc_item_dy_rms_sparse is
   ...
   from   rtl_loc_item_dy_rms_sparse prf_lid,
          dim_item di,
          dim_department dd,
          rtl_location_item  prf_li,
          dim_item_uda diu
   where  --prf_lid.last_updated_date  = g_date and
          prf_lid.post_date between '1 OCT 2016' and '9 Oct 2016' and
...
g_rec_in                   c_rtl_loc_item_dy_rms_sparse%rowtype;
-- For input bulk collect --
type stg_array is table of c_rtl_loc_item_dy_rms_sparse%rowtype;
...
begin
    ...
    l_text := 'LOAD OF RTL_LOC_ITEM_DY_RMS_SPARSE EX ITSELF STARTED AT '||
...
--**************************************************************************************************
    open c_rtl_loc_item_dy_rms_sparse;
    fetch c_rtl_loc_item_dy_rms_sparse bulk collect into a_stg_input limit g_forall_limit;
    ...
    close c_rtl_loc_item_dy_rms_sparse;
