--------------------------------------------------------
--  DDL for Procedure WH_PRF_CORP_715E_OLD
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_CORP_715E_OLD" (p_forall_limit in integer,p_success out boolean) as
...
--**************************************************************************************************
  ...
  --  g_count := dwh_generic_file_extract('select * from vw_extr_space_race','|','DWH_FILES_OUT','spacerace_20162425’');
    g_count := dwh_generic_file_extract('select * from vw_extr_space_race','|','DWH_FILES_OUT','spacerace_20162425');
    l_text :=  'Records extracted to spacerace_20162425 '||g_count;
    dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);
