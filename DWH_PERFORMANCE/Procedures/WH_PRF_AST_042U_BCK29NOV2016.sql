--------------------------------------------------------
--  DDL for Procedure WH_PRF_AST_042U_BCK29NOV2016
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_AST_042U_BCK29NOV2016" 
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_AST_042U_BCK29NOV2016';
                ...
                WITH sellnk
                     AS (  SELECT /*+ materialize full(b) parallel (b,8) */
                                 sk1_location_no,
                                  ...
                                  sk1_avail_uda_value_no,
                                  MAX (PROD_LINK_no) prod_link_no
                             FROM (SELECT /*+  full(b) materialize */
                                         sk1_location_no,
                                          sk1_item_no,
                                          post_date,
                                          sk1_avail_uda_value_no,
...
END WH_PRF_AST_042U_BCK29NOV2016;
