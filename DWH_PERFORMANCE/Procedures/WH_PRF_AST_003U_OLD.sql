--------------------------------------------------------
--  DDL for Procedure WH_PRF_AST_003U_OLD
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_AST_003U_OLD" (p_forall_limit in integer,p_success out boolean) as
...
cursor c_dim_sc_uda is
        select
              ...
              style_colour_no,
              character_desc_102,
              range_structure_ch_desc_104,
              cust_segmentation_desc_300,
              garment_length_desc_303,
              price_tier_desc_306,
              print_type_desc_307,
              top_vs_bottom_desc_309,
              plain_vs_design_desc_310,
              material_desc_313,
              lifestyle_desc_316,
              sleeve_length_desc_317,
              single_multiple_desc_319,
              sub_brands_desc_320,
              shoe_heel_height_desc_321,
              fit_desc_323,
              waist_drop_desc_324,
              neck_line_desc_325,
              silhouette_desc_327,
              ...
              gender_desc_330,
              event_buy_desc_331,
              product_category_desc_333,
              fabric_type_desc_334,
              fragrance_brand_desc_1002,
              fragrance_house_desc_1003,
              brand_type_desc_1103,
              brand_category_desc_1105,
              headqtr_assortment_desc_2301,
              shoe_heel_shape_desc_2402,
              handbag_sizing_desc_2601,
              great_value_desc_3202,
              product_defference_3104,
-- added for JDA Phase II
              curtain_hang_method_desc_314,
              curtain_lining_desc_315,
              gifting_desc_326,
              merch_class_desc_100,
              range_segmentation_desc_322,
              royalties_desc_106,
              sock_length_desc_318,
              cellular_item_desc_904,
              product_sample_status_desc_304,
              utilise_ref_item_desc_508,
              price_marked_ind_desc_903,
              digital_brands_desc_1503,
              digital_offer_desc_1504,
              digital_price_bands_desc_1505,
              digital_design_desc_1506,
              digital_data_desc_1507,
              merch_usage_desc_1907,
              kids_age_desc_335,
              availability_desc_540,
              planning_manager_desc_561,
              commercial_manager_desc_562,
              merchandise_category_desc_100,
              ...
              free_range_desc_554,
              vegetarian_desc_551,
              slimmers_choice_desc_553,
              kosher_desc_555,
              halaal_desc_556,
              branded_item_desc_911,
              import_item_desc_1601,
              new_line_launch_date_desc_543,
              foods_range_structure_desc_560,
              food_main_shop_desc_2803,
              hot_item_desc_2804,
              beauty_brnd_prd_dtl_desc_2501,
              beauty_gift_range_desc_2503,
              planning_item_ind_2901,
              stock_error_ind_desc_699,
              ...
              loose_item_desc_910,
              variable_weight_item_desc_905,
              shorts_longlife_desc_542,
              new_line_indicator_desc_3502
        from  dim_sc_uda;
--        where last_updated_date  = g_date;
--       where  sk1_style_colour_no not in (select ast_uda.sk1_style_colour_no
--                                          from   dim_ast_sc_uda ast_uda);
...
begin
     ...
     g_rec_out.knit_woven_desc_002             := 'No Value';
     g_rec_out.classic_highlight_desc_003      := 'No Value';
     g_rec_out.good_business_journey_desc_009  := 'No Value';
     g_rec_out.product_category_desc_010       := 'No Value';
     g_rec_out.product_category_desc_014       := 'No Value';
     g_rec_out.theme_desc_015                  := 'No Value';
     g_rec_out.range_desc_016                  := 'No Value';
     g_rec_out.variant_desc_017                := 'No Value';
     g_rec_out.product_feature_desc_018        := 'No Value';
     g_rec_out.diff_ranges_desc_019            := 'No Value';
     g_rec_out.lifestyle_desc_020              := 'No Value';
     g_rec_out.speed_to_market_desc_021        := 'No Value';
     g_rec_out.country_of_origin_desc_022      := 'No Value';
     g_rec_out.source_strat_desc_023           := 'No Value';
     g_rec_out.product_category_desc_025       := 'No Value';
