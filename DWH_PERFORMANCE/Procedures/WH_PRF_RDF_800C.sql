--------------------------------------------------------
--  DDL for Procedure WH_PRF_RDF_800C
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_RDF_800C" (p_forall_limit in integer,p_success out boolean) 
as
--**************************************************************************************************
--  Date:        October 2008
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_RDF_800C';
