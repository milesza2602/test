--------------------------------------------------------
--  DDL for Procedure WH_PRF_AST_034B_WLTST
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_AST_034B_WLTST" (P_FORALL_LIMIT in integer,P_SUCCESS OUT BOOLEAN) 
as
--**************************************************************************************************
--  Date:        April 2013
--  Author:      Wendy Lyttle
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_AST_034B_WLTST';
...
--**************************************************************************************************     
    ...
    execute immediate 'truncate table dwh_performance.Wtemp_rtl_ast_sc_dates';
    L_TEXT := 'truncate table dwh_performance.Wtemp_rtl_ast_sc_dates';
    dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);


insert /*+ append */ into  dwh_performance.Wtemp_rtl_ast_sc_dates
                   select
                            sk1_style_colour_no 
                            ,continuity_ind 
                          ...
                          from dwh_performance.Wtemp_rtl_ast_sc_cont_wk_034a a,
                                dim_calendar dc1
...
--**************************************************************************************************
    ...
    execute immediate 'truncate table dwh_performance.Wtemp_rtl_ast_sc_6wk_034b';
    L_TEXT := 'truncate table dwh_performance.Wtemp_rtl_ast_sc_6wk_034b';
    dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);


    insert /*+ append */ into  dwh_performance.Wtemp_rtl_ast_sc_6wk_034b 
              with selcal as
              ...
              from dwh_performance.rtl_chn_geo_grd_sc_wk_ast_act a
                                 ...
                                 join dwh_performance.Wtemp_rtl_ast_sc_dates ic
 ...
 union
              ...
              from dwh_performance.rtl_chn_geo_grd_sc_wk_ast_act a
                                 join dwh_performance.dim_calendar  dc2
                                            ...
                                            and dc2.fin_week_no = a.fin_week_no
                                            and dc2.fin_day_no = 1
                                 join Wtemp_rtl_ast_sc_dates ic
                                            on a.sk1_style_colour_no = ic.sk1_style_colour_no
                                            and dc2.this_week_start_date >= derive_start_date
                                            and  dc2.this_week_start_date <= ic.cont_end_week_date
                                 join selcal sc
...
--and a.sk1_grade_no = 6
    ...
    L_TEXT := 'Recs inserted into Wtemp_rtl_ast_sc_6wk_034b = '||g_recs_inserted;
    dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);
