--------------------------------------------------------
--  DDL for Procedure WH_PRF_AST_032U_WLFIX2
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_AST_032U_WLFIX2" 
...
l_module_name           sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_AST_032U_WLFIX2';
...
EXECUTE IMMEDIATE('TRUNCATE TABLE DWH_DATAFIX.MART_CH_AST_CHN_SC_WK_WLFIX');

      insert /*+ APPEND parallel (mart,4) */ into DWH_DATAFIX.MART_CH_AST_CHN_SC_WK_WLFIX
