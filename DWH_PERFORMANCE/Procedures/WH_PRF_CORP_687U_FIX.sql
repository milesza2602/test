--------------------------------------------------------
--  DDL for Procedure WH_PRF_CORP_687U_FIX
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_CORP_687U_FIX" (p_forall_limit in integer,p_success out boolean) as
--**************************************************************************************************
--  Date:         February 2013
--  Author:       A Joshua
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_CORP_687U_FIX';
...
--                    where    rtl.last_updated_date = g_date
                    where    rtl.last_updated_date between '29 jun 15' and '05 jul 15'
