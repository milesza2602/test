--------------------------------------------------------
--  DDL for Procedure WH_PRF_RDF_007X
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_RDF_007X" (p_forall_limit in integer, p_success out boolean)
...
--               Output - TEMP_26WK_RDF_BIG (unpivot temp table)
--                      - RDF_52WK_FCST_PART
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_RDF_007T';
...
--        g_from_loc_no := p_from_loc_no;
 ...
 --   end if;
   ...
   --truncate temp table 
--    execute immediate 'truncate table W6005682.TEMP_26WK_RDF_BIG';
--    --commit;
--    l_text := 'TEMP TABLE TEMP_26WK_RDF_BIG TRUNCATED.';
--    dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);
    
    execute immediate 'drop index DWH_PERFORMANCE.I01_P_RTL_LC_ITM_WK_FCST52';    --sk1_location / sk1_item
    l_text := 'INDEX I01_P_RTL_LC_ITM_WK_FCST52 DROPPED';
    dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);
    
--    execute immediate 'drop index DWH_PERFORMANCE.PK_U_NEW_LC_ITM_WK_FCST52';    --sk1_location / sk1_item / year / week
--    l_text := 'INDEX PK_U_NEW_LC_ITM_WK_FCST52 DROPPED';
--    dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);
    
    execute immediate 'drop index DWH_PERFORMANCE.I02_P_RTL_LC_ITM_WK_FCST52';    -- last updated date
    l_text := 'INDEX I02_P_RTL_LC_ITM_WK_FCST52 DROPPED';
    dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);
    
    execute immediate 'drop index DWH_PERFORMANCE.I03_P_RTL_LC_ITM_WK_FCST52';    -- this week start date
    l_text := 'INDEX I03_P_RTL_LC_ITM_WK_FCST52 DROPPED';
    dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);
...
--   insert /*+ APPEND parallel(sys,8) */ into W6005682.TEMP_26WK_RDF_BIG sys
...
--                                                            
-- --   order by SK1_LOCATION_NO, SK1_ITEM_NO, FIN_YEAR_NO, FIN_WEEK_NO
--;
--    
--    g_recs_inserted := + SQL%ROWCOUNT;
--    commit;
----
--    l_text := 'TEMP TABLE TEMP_26WK_RDF_BIG POPULATED';
--    dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);
--    l_text :=  dwh_constants.vc_log_records_inserted||g_recs_inserted;
--    dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);
--    
--    l_text := 'Running GATHER_TABLE_STATS ON TEMP_26WK_RDF_BIG';
--    dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);
--   
--   EXECUTE IMMEDIATE 'ALTER SESSION ENABLE PARALLEL DML';
--
--   DBMS_STATS.gather_table_stats ('W6005682', 'TEMP_26WK_RDF_BIG', DEGREE => 16);
--
--   l_text := 'GATHER_TABLE_STATS ON TEMP_26WK_RDF_BIG completed';
--   dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);
--
...
--    dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);
--
--   select /*+ parallel (a,6) full(a) */  min(fin_year_no) 
--     into l_temp_min_year
--     from W6005682.TEMP_26WK_RDF_BIG a;
--     
...
--      from W6005682.TEMP_26WK_RDF_BIG a, dim_item b, dim_location c
...
--    l_text := 'DROPPING PK CONSTRAINT - PK_P_NEW_LC_ITM_WK_FCST52';
--    dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);
...
--    
    if l_split_year = 1 then
       ...
       -- SPLIT YEAR MERGE
       --
        merge /*+ append parallel(tgt,8) */ into dwh_performance.RTL_LOC_ITEM_WK_RDF_FCST52 tgt 
        USING
          (select  /*+ parallel(sys_ilv,8) */
           ...
           from     W6005682.TEMP_26WK_RDF_BIG   sys_ilv 
 ...
 --         and tgt.fin_week_no between l_temp_min_wk_min_year and l_temp_max_wk_min_year  
    ...
    l_text := 'PRF TABLE RDF_52WK_FCST_PART Updated/Inserted';
    dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);
    l_text :=  dwh_constants.vc_log_records_processed||g_recs_updated;
    dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);
 
 
    l_text := 'Building Indexes';
    dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);
    
    execute immediate 'CREATE INDEX "DWH_PERFORMANCE"."I01_P_RTL_LC_ITM_WK_FCST52" ON "DWH_PERFORMANCE"."RTL_LOC_ITEM_WK_RDF_FCST52" ("SK1_LOCATION_NO", "SK1_ITEM_NO")
                      PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS NOCOMPRESS STORAGE 
                      (
                        INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645 PCTINCREASE 0 FREELISTS 1 
                        FREELIST GROUPS 1 BUFFER_POOL DEFAULT  
                       )
                        TABLESPACE "PRF_MASTER" NOLOGGING PARALLEL 32 LOCAL';
 
    execute immediate 'ALTER INDEX DWH_PERFORMANCE.I01_P_RTL_LC_ITM_WK_FCST52 NOPARALLEL LOGGING' ;  
    
    l_text := 'INDEX I01_P_RTL_LC_ITM_WK_FCST52 BUILT';
    dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);
    
    
--    execute immediate 'CREATE INDEX "DWH_PERFORMANCE"."PK_U_NEW_LC_ITM_WK_FCST52" ON "DWH_PERFORMANCE"."RTL_LOC_ITEM_WK_RDF_FCST52" ("SK1_LOCATION_NO", "SK1_ITEM_NO", "FIN_YEAR_NO", "FIN_WEEK_NO")
--                      PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS NOCOMPRESS STORAGE 
--                      (
--                        INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645 PCTINCREASE 0 FREELISTS 1 
--                        FREELIST GROUPS 1 BUFFER_POOL DEFAULT  
...
--                        TABLESPACE "PRF_MASTER" NOLOGGING PARALLEL 32 LOCAL';
-- 
--    execute immediate 'ALTER INDEX DWH_PERFORMANCE.PK_U_NEW_LC_ITM_WK_FCST52 NOPARALLEL LOGGING' ;  
    
    l_text := 'INDEX PK_U_NEW_LC_ITM_WK_FCST52 BUILT';
    dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);
      
 
    execute immediate 'CREATE INDEX "DWH_PERFORMANCE"."I03_P_RTL_LC_ITM_WK_FCST52" ON "DWH_PERFORMANCE"."RTL_LOC_ITEM_WK_RDF_FCST52" ("LAST_UPDATED_DATE")
                      PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS NOCOMPRESS STORAGE 
                      (
                        INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645 PCTINCREASE 0 FREELISTS 1 
                        FREELIST GROUPS 1 BUFFER_POOL DEFAULT  
    ...
    execute immediate 'ALTER INDEX DWH_PERFORMANCE.I03_P_RTL_LC_ITM_WK_FCST52 NOPARALLEL LOGGING' ;  
    
    l_text := 'INDEX I03_P_RTL_LC_ITM_WK_FCST52 BUILT';
    dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);
   
    
    execute immediate 'CREATE INDEX "DWH_PERFORMANCE"."I02_P_RTL_LC_ITM_WK_FCST52" ON "DWH_PERFORMANCE"."RTL_LOC_ITEM_WK_RDF_FCST52" ("THIS_WEEK_START_DATE")
                      PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS NOCOMPRESS STORAGE 
                      (
                        INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645 PCTINCREASE 0 FREELISTS 1 
                        FREELIST GROUPS 1 BUFFER_POOL DEFAULT  
    ...
    execute immediate 'ALTER INDEX DWH_PERFORMANCE.I02_P_RTL_LC_ITM_WK_FCST52 NOPARALLEL LOGGING' ;   
    
    l_text := 'INDEX I02_P_RTL_LC_ITM_WK_FCST52 BUILT';
    dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);
    
--    l_text := 'ADDING PK CONSTRAINT - PK_P_NEW_LC_ITM_WK_FCST52';
--    dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);
--    execute immediate 'ALTER TABLE dwh_performance.RTL_LOC_ITEM_WK_RDF_FCST52 ADD CONSTRAINT "PKP_RDF_52" PRIMARY KEY ("SK1_LOCATION_NO", "SK1_ITEM_NO", "FIN_YEAR_NO", "FIN_WEEK_NO")';
