--------------------------------------------------------
--  DDL for Procedure WH_PRF_MP_027U_RELOAD
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_MP_027U_RELOAD" 
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_MP_027U_RELOAD';
...
--**************************************************************************************************
   ...
   for l_fin_year_loop in 2015..2017 loop
     for l_fin_week_loop in 1..52 loop
     
       l_text := 'FIN YEAR ' ||l_fin_year_loop|| ' AND WEEK NO ' || l_fin_week_loop;
       dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);
       ...
       select /*+ full (aps) parallel (aps,4) */
         ...
         where dim.sk1_style_colour_no = aps.sk1_style_colour_no
           and fin_year_no = l_fin_year_loop
           and fin_week_no = l_fin_week_loop
   ...
   for l_fin_year_loop in 2018..2018 loop
     for l_fin_week_loop in 1..2 loop
