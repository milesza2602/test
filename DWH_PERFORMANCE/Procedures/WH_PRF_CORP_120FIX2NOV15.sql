--------------------------------------------------------
--  DDL for Procedure WH_PRF_CORP_120FIX2NOV15
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_CORP_120FIX2NOV15" (p_forall_limit in integer,p_success out boolean) as
--**************************************************************************************************
--  Date:        SEPT 2008
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_CORP_120FIX2NOV15';
...
cursor c_fnd_rtl_shipment is
   ...
   where  shp.last_updated_date  >= '4 MAY 2015' AND
