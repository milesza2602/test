--------------------------------------------------------
--  DDL for Procedure WH_PRF_CORP_534U_FIX201408
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_CORP_534U_FIX201408" 
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_CORP_534U_FIX201408';
...
END WH_PRF_CORP_534U_FIX201408;
