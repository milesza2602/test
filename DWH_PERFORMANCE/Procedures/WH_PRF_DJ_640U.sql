--------------------------------------------------------
--  DDL for Procedure WH_PRF_DJ_640U
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_DJ_640U" (
...
as
  ...
  --
  --  24 JUNE 2016 - Change derivation of source_data_status_code
  --                  AS was causing duplicates
  --
  --  NAMING CONVENTIONS:
  --  G_  -  GLOBAL VARIABLE
...
l_module_name sys_dwh_errlog.log_procedure_name%type := 'WH_PRF_DJ_640U';
