--------------------------------------------------------
--  DDL for Procedure WH_PRF_S4S_014C_OLD
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_S4S_014C_OLD" (p_forall_limit in integer,p_success out boolean) as
...
--
--  DIM Tables:  Input  - FND_S4S_JOBGROUP
--               Output - DIM_JOBGROUP
...
g_rec_out            DIM_JOBGROUP%rowtype;
--g_rec_out            RTL_S4S_JOBGROUP%rowtype;
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_S4S_014C_OLD';
...
type tbl_array_i is table of DIM_JOBGROUP%rowtype index by binary_integer;
type tbl_array_u is table of DIM_JOBGROUP%rowtype index by binary_integer;
...
begin
   ...
   forall i in a_tbl_insert.first .. a_tbl_insert.last
      save exceptions
      insert into DIM_JOBGROUP values a_tbl_insert(i);
--      insert into RTL_S4S_JOBGROUP values a_tbl_insert(i);
...
begin
    ...
    forall i in a_tbl_update.first .. a_tbl_update.last
       save exceptions
       UPDATE DIM_JOBGROUP
--       UPDATE RTL_S4S_JOBGROUP
          SET SK1_WORKGROUP_ID          = a_tbl_update(i).SK1_WORKGROUP_ID,
