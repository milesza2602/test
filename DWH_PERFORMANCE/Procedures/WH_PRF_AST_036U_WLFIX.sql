--------------------------------------------------------
--  DDL for Procedure WH_PRF_AST_036U_WLFIX
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_AST_036U_WLFIX" 
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_AST_036U_WLFIX';
...
--RTL_CSSWAP_M20129_36
          g_partition_name :=   'RTL_CSSWAP_M'||g_START_YEAR||g_START_month||'_'||g_START_week;    
          g_sql_trunc_partition := 'alter table dwh_performance.RTL_CHAIN_SC_SUPCHN_WK_AST_PLN truncate SUBPARTITION '||g_partition_name;
      ...
      insert /*+ APPEND parallel (spchn,2) */ into RTL_CHAIN_SC_SUPCHN_WK_AST_PLN spchn

      with chain_plan_data as (
      select /*+ parallel (pln,2) */
             pln.sk1_chain_no,
      ...
      where  pln.sk1_style_colour_no  = sc.sk1_style_colour_no
       ...
       and   pln.fin_year_no          = cal.fin_year_no
       and   pln.fin_week_no          = cal.fin_week_no
       and   cal.fin_day_no           = 3
       and   PLN.fin_year_no          = G_START_YEAR
       and   PLN.fin_week_no          = G_START_WEEK
--       and   pln.last_updated_date    = g_date
       and   pln.sk1_plan_type_no in (60,61,62)
      group by pln.sk1_chain_no, sc.sk1_style_colour_no, sct.sk1_supply_chain_no, pln.fin_year_no, pln.fin_week_no, pln.sk1_plan_type_no, cal.fin_week_code, g_date
      order by pln.fin_year_no, pln.fin_week_no) ,

      geo_grade_plan_data as (
      select /*+ parallel (cgg,2) */
             cgg.sk1_chain_no,
             sc.sk1_style_colour_no,
             sct.sk1_supply_chain_no,
             cgg.fin_year_no,
      ...
      where  cgg.sk1_style_colour_no  = sc.sk1_style_colour_no
       and   sct.supply_chain_code    = sc.supply_chain_code
       and   cgg.fin_year_no          = cal.fin_year_no
       and   cgg.fin_week_no          = cal.fin_week_no
       and   cal.fin_day_no           = 3
       and   cgg.fin_year_no          = G_START_YEAR
       and   cgg.fin_week_no          = G_START_WEEK
--       and   cgg.last_updated_date    = g_date
       and   cgg.sk1_plan_type_no in (60,61,62)
      group by cgg.sk1_chain_no, sc.sk1_style_colour_no, sct.sk1_supply_chain_no, cgg.fin_year_no, cgg.fin_week_no, cgg.sk1_plan_type_no, cal.fin_week_code, g_date
      order by cgg.fin_year_no, cgg.fin_week_no),

      contract_data as (
      select /*+ parallel (con,2) */
             con.sk1_chain_no,
             sc.sk1_style_colour_no,
             sct.sk1_supply_chain_no,
             con.fin_year_no,
      ...
      where  con.sk1_style_colour_no  = sc.sk1_style_colour_no
       and   sct.supply_chain_code    = sc.supply_chain_code
       and   con.fin_year_no          = cal.fin_year_no
       and   con.fin_week_no          = cal.fin_week_no
       and   cal.fin_day_no           = 3
       and   CON.fin_year_no          = G_START_YEAR
       and   CON.fin_week_no          = G_START_WEEK
      group by con.sk1_chain_no, sc.sk1_style_colour_no, sct.sk1_supply_chain_no, con.fin_year_no, con.fin_week_no, 1, cal.fin_week_code, g_date
      order by con.fin_year_no, con.fin_week_no),

      aps_data as (
      select /*+ parallel (aps,2) */
             loc.sk1_chain_no,
             sc.sk1_style_colour_no,
             sct.sk1_supply_chain_no,
             aps.fin_year_no,
      ...
      where  aps.sk1_style_colour_no  = sc.sk1_style_colour_no
       ...
       and   aps.fin_year_no          = cal.fin_year_no
       and   aps.fin_week_no          = cal.fin_week_no
       and   APS.fin_year_no          = G_START_YEAR
       and   APS.fin_week_no          = G_START_WEEK
--       and   aps.last_updated_date    = g_date
      group by loc.sk1_chain_no, sc.sk1_style_colour_no, sct.sk1_supply_chain_no, aps.fin_year_no, aps.fin_week_no, 1, cal.fin_week_code, g_date
      order by aps.fin_year_no, aps.fin_week_no)
