--------------------------------------------------------
--  DDL for Procedure WH_PRF_AST_027U
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_AST_027U" (p_forall_limit in integer,p_success out boolean) as

--**************************************************************************************************
--  Date:        May 2012
--  Author:      Alfonso Joshua
--  Purpose:     Load Pre-Actual Plan (current week APlan) from performance level.
--  Tables:      Input  - rtl_chain_sc_wk_ast_pln
--               Output - rtl_chain_sc_wk_ast_pln_preact
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_AST_027U';
...
cursor c_chn_geo_grd_sc_wk_ast_pln is
   select pln.sk1_chain_no,
          ...
          pln.fin_week_code,
          pln.chain_intake_qty,
          pln.chain_intake_cost,
          pln.chain_intake_selling,
          pln.dc_opening_stock_qty,
          pln.dc_opening_stock_cost,
          pln.dc_opening_stock_selling,
          pln.chain_closing_stock_qty,
          pln.chain_closing_stock_cost,
          pln.chain_closing_stock_selling,
          pln.chain_closing_stock_margin,
          g_date as last_updated_date
    from  rtl_chain_sc_wk_ast_pln pln,
          dim_control ctl
    where pln.sk1_plan_type_no = 60
    and   ctl.today_date       = g_date
...
begin
   ...
   g_rec_out.chain_closing_stock_margin      := g_rec_in.chain_closing_stock_margin;
...
begin
    forall i in a_tbl_insert.first .. a_tbl_insert.last
       save exceptions
       insert into rtl_chain_sc_wk_ast_pln_preact values a_tbl_insert(i);
...
begin
   ...
   forall i in a_tbl_update.first .. a_tbl_update.last
       save exceptions
       update rtl_chain_sc_wk_ast_pln_preact
...
begin
    ...
    l_text := 'LOAD OF RTL_CHAIN_SC_WK_AST_PLN EX PERFORMANCE STARTED AT '||
...
--    execute immediate 'truncate table dwh_performance.rtl_chain_sc_wk_ast_pln_preact';
