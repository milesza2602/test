--------------------------------------------------------
--  DDL for Procedure WH_PRF_AST_003A
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_AST_003A" (p_forall_limit in integer,p_success out boolean) as
--**************************************************************************************************
--  Date:        July 2012
...
--                  fnd_uda_value uda_val
           where  bam_uda.style_colour_no = lev.style_colour_no
            ...
            and   bam_uda.uda_no in (002,003,022,023,009,010,014,015,016,017,018,019,020,021,025,102,104,
                                     ...
                                     329,330,331,333,334,1002,1003,1103,1105,2301,2402,2601,3104,3202,7501)
