--------------------------------------------------------
--  DDL for Procedure WH_PRF_AST_034A
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_AST_034A" (
    ...
    --
     --**************************************************************************************************
      ...
      l_module_name sys_dwh_errlog.log_procedure_name%type := 'WH_PRF_AST_034A';
   ...
   --   EXECUTE immediate 'ALTER SESSION ENABLE PARALLEL DML';
    ...
    --  G_DATE := '26 JUNE 2016';
    --  G_DATE := '7 AUGUST 2016';
   --   G_DATE := '18 SEPTEMBER 2016';
