--------------------------------------------------------
--  DDL for Procedure WH_PRF_CORP_678U_FIX
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_CORP_678U_FIX" 
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_CORP_678U_FIX';
...
--   where    g_date                        between dp.approval_date and dp.prom_end_date
   where    po.last_updated_date between '26 jun 16' and '12 oct 16'
