--------------------------------------------------------
--  DDL for Procedure WH_PRF_CORP_665U_BK
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_CORP_665U_BK" 
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_CORP_665U_BK';
...
cursor c_rtl_loc_sc_wk_po_supchain is
   with chgrecs as (select   r.sk1_location_no, i.sk1_style_colour_no, c.fin_year_no, c.fin_week_no
                    from     w7104429.rtl_loc_item_dy_po_supchain r
...
--                    and i.sk1_style_colour_no <> 23936026 --> partition failure
   ...
   from     w7104429.rtl_loc_item_dy_po_supchain lid
...
begin
   ...
   forall i in a_tbl_insert.first .. a_tbl_insert.last
      save exceptions
      insert into w7104429.rtl_loc_sc_wk_po_supchain values a_tbl_insert(i);
...
begin
   ...
   forall i in a_tbl_update.first .. a_tbl_update.last
      save exceptions
      update w7104429.rtl_loc_sc_wk_po_supchain
...
-- Check to see if record is present on table and update/insert accordingly
   select count(1)
   into   g_count
   from   w7104429.rtl_loc_sc_wk_po_supchain
...
begin
    ...
    delete from w7104429.rtl_loc_sc_wk_po_supchain r
