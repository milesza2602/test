--------------------------------------------------------
--  DDL for Procedure WH_PRF_CORP_052U_01APR
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_CORP_052U_01APR" (p_forall_limit in integer,p_success out boolean) as
...
--  20 Sep 2016 - A Joshua Chg-xxx -- Cater for ETL for measures reg_rsp_excl_vat and cost_price                Ref: AJ-chgxxx
...
--   g_rec_out.cost_price                := g_rec_in.cost_price;          --AJ-chgxxx
...
--              cost_price                    = a_tbl_update(i).cost_price                                          -- AJ-chgxxx
