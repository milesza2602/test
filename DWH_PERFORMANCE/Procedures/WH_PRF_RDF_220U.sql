--------------------------------------------------------
--  DDL for Procedure WH_PRF_RDF_220U
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_RDF_220U" (p_forall_limit in integer,p_success out boolean) as
--**************************************************************************************************
--  Date:        Dec 2010
...
--  Tables:      Input  - rtl_loc_item_dy_rdf_fcst & dim_item/dim_department
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_RDF_220U';
...
begin
    ...
    l_text := 'LOAD RTL_LOC_ITEM_dy_rdf_FCST EX SELF TABLES STARTED '||
