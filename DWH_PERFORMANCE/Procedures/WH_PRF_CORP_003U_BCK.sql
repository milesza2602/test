--------------------------------------------------------
--  DDL for Procedure WH_PRF_CORP_003U_BCK
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_CORP_003U_BCK" (p_forall_limit in integer,p_success out boolean,P_end_date in date)
as
  --**************************************************************************************************
--  Date:        march 2009
--  Author:      Wendy Lyttle
...
--g_date := '15 aug 2011';
  ...
  --**************************************************************************************************
      ...
      where dc.calendar_date in (select dct.ly_calendar_date
                                 from dwh_performance.dim_calendar dct
...
--                                                      from dwh_performance.dim_calendar dct2
