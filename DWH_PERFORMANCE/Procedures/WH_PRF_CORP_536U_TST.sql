--------------------------------------------------------
--  DDL for Procedure WH_PRF_CORP_536U_TST
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_CORP_536U_TST" (
...
as
  ...
  g_rec_out dwh_datafix.AJ_RTL_LOC_ITEM_WK_CATALOG%rowtype;
  g_found boolean;
  ...
  l_module_name sys_dwh_errlog.log_procedure_name%type := 'WH_PRF_CORP_536U_TST';
...
--  commit;
  ...
  into dwh_datafix.AJ_RTL_LOC_ITEM_WK_CATALOG CAT
