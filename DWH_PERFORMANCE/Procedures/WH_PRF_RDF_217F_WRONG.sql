--------------------------------------------------------
--  DDL for Procedure WH_PRF_RDF_217F_WRONG
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_RDF_217F_WRONG" 
...
--  Tables:      Input  - RTL_LOC_ITEM_RDF_WKFCST_L1 & rtl_loc_item_wk_rdf_sale
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_RDF_217F';
