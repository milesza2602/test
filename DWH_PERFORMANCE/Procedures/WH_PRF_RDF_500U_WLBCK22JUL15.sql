--------------------------------------------------------
--  DDL for Procedure WH_PRF_RDF_500U_WLBCK22JUL15
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_RDF_500U_WLBCK22JUL15" 
...
--**************************************************************************************************
  ...
  l_module_name sys_dwh_errlog.log_procedure_name%type := 'WH_PRF_RDF_500U_WLBCK22JUL15';
...
END WH_PRF_RDF_500U_WLBCK22JUL15;
