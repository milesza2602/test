--------------------------------------------------------
--  DDL for Procedure WH_PRF_MP_028U_RELOAD1
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_MP_028U_RELOAD1" 
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_MP_028U_RELOAD1';
...
--**************************************************************************************************
  ...
  --   g_fin_year_no := l_fin_year_loop;
      ...
      l_text := 'g_fin_year_no='||g_fin_year_no;
       dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);
       
     for l_fin_week_loop in reverse 1..2 loop
       g_fin_week_no := l_fin_week_loop;
       
       l_text := 'g_fin_week_no='||g_fin_week_no;
       dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);
...
--   end loop;
   ...
   for l_fin_year_loop in reverse 2016..2016 loop
     ...
     for l_fin_week_loop in reverse 52..1 loop
       g_fin_week_no := l_fin_week_loop;
