--------------------------------------------------------
--  DDL for Procedure WH_PRF_DJ_669B_WL
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_DJ_669B_WL" 
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_DJ_669B_WL';
...
cursor c_spch_loc_item_dy_prsup is
   ...
   from     rtl_supchain_loc_item_dy_dj lid    
