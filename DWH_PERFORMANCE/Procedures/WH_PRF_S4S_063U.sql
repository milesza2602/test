--------------------------------------------------------
--  DDL for Procedure WH_PRF_S4S_063U
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_S4S_063U" (
...
--  g_NAME          VARCHAR2(40);
  ...
  l_procedure_name       sys_dwh_errlog.log_procedure_name%type := 'WH_PRF_S4S_063U';
  l_table_name           all_tables.table_name%type             := 'RTL_ACTL_XCPTN_EMP_DY';
...
BEGIN
   ...
   dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);
    ...
    INSERT /*+ append */ INTO DWH_PERFORMANCE.RTL_ACTL_XCPTN_EMP_DY
         SELECT  /*+ full(flr) parallel(flr,8) */              
            ...
            FROM      dwh_foundation.FND_S4S_ACTL_XCPTN_EMP_DY flr
                 ...
                 join dwh_performance.DIM_CALENDAR dc
                        on    trunc(flr.exception_date) = trunc(dc.calendar_date)
