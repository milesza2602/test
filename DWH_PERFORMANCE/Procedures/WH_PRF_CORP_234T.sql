--------------------------------------------------------
--  DDL for Procedure WH_PRF_CORP_234T
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_CORP_234T" (p_forall_limit in integer,p_success out boolean) as
...
--  Packages:    constants, dwh_log, dwh_vali--d
--
--  Maintenance:
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_CORP_234T';
...
begin
    ...
    l_text := 'Create Foods Loc Item Week TEST Mart for LAST COMPLETED WEEK STARTED AT '||
...
select /*+ PARALLEL(f,4) FULL(f) */
       ...
       nvl(sum(f.waste_cost),0) waste_cost_ly,
...
nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(f0.sk1_location_no,f1.sk1_location_no),
                                          f2.sk1_location_no),
                                          f3.sk1_location_no),
                                          f6.sk1_location_no),
                                          fy0.sk1_location_no),
...
sk1_location_no,
nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(nvl(f0.sk1_item_no,f1.sk1_item_no),
                                          f2.sk1_item_no),
                                          f3.sk1_item_no),
                                          f6.sk1_item_no),
                                          fy0.sk1_item_no),
...
atg.FD_NUM_DC_CATLG_DAYS_YTD,
atg.ON_ORDER_CASES,
atg.ON_ORDER_SELLING,
