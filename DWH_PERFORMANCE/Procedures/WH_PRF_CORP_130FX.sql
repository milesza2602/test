--------------------------------------------------------
--  DDL for Procedure WH_PRF_CORP_130FX
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_CORP_130FX" (p_forall_limit in integer,p_success out boolean) as
...
cursor c_fnd_rtl_loc_item_dy_pos_jv is
   ...
   ( select location_no,
      ...
      from  fnd_rtl_loc_item_dy_pos_jv pos
      where post_date between '17 Feb 2014' and '18 Feb 2014' ) lidlist
