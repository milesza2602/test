--------------------------------------------------------
--  DDL for Procedure WH_PRF_DJ_668U_VATFIX
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_DJ_668U_VATFIX" 
...
--  Tables:      Input  - rtl_contrct_chn_item_wk_po_dj,
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_DJ_668U_VATFIX';
...
begin
    ...
    l_text := 'COMBINE PO and BOC to rtl_contract_chain_item_wk_dj STARTED '||
...
--**************************************************************************************************
    ...
    execute immediate 'truncate table dwh_performance.rtl_contract_chain_item_wk_dj';
    l_text := 'TABLE rtl_contract_chain_item_wk_dj TRUNCATED - '||to_char(sysdate,('dd mon yyyy hh24:mi:ss'));
    dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);

    insert /* append */ into dwh_performance.rtl_contract_chain_item_wk_dj
    select   nvl(wpo.sk1_contract_no,wboc.sk1_contract_no) sk1_contract_no,
    ...
    --         nvl(wpo.sk2_item_no,wboc.sk2_item_no) sk2_item_no,
             ...
             nvl(wpo.sk1_chain_code_ind,wboc.sk1_chain_code_ind) sk1_chain_code_ind
    from     dwh_performance.rtl_contrct_chn_item_wk_po_dj wpo
    full     outer join dwh_performance.rtl_contrct_chn_item_wk_boc_dj wboc
             ...
             and   wpo.sk1_chain_code_ind  = wboc.sk1_chain_code_ind;
