--------------------------------------------------------
--  DDL for Procedure WH_PRF_CORP_714E_BCK
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_CORP_714E_BCK" (p_forall_limit in integer,
...
--**************************************************************************************************
    ...
    g_date := 'Moo';  -- done to force it to fail
...
DBMS_OUTPUT.PUT_LINE('Department extract');
    ...
    'SELECT /*+ PARALLEL(DNS,8) FULL(DNS) */
     ...
     '|','DWH_FILES_OUT','aztec_dept75.txt');
