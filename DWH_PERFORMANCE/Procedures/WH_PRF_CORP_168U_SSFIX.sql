--------------------------------------------------------
--  DDL for Procedure WH_PRF_CORP_168U_SSFIX
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_CORP_168U_SSFIX" (p_forall_limit in integer,p_success out boolean) as                                                                                                                                                                 
...
--    where last_updated_date = g_date;
      where post_date in to_date('30-JUL-2015','DD-MON-YYYY');
...
--   dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);
  ...
  INSERT  /*+ APPEND parallel (jdast,4) */
   ...
   where jdaff.item_no     = di.item_no
     ...
     and jdaff.post_date in to_date('30-JUL-2015','DD-MON-YYYY')
