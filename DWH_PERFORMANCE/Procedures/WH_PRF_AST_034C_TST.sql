--------------------------------------------------------
--  DDL for Procedure WH_PRF_AST_034C_TST
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_AST_034C_TST" 
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_AST_034C_TST';
...
--
    ...
    insert /*+append */ into  dwh_performance.mart_ch_ast_chn_grd_sc_wk_TST m
      with
    --------------------------------------------------------------------------------
    -- last completed week
    --------------------------------------------------------------------------------
