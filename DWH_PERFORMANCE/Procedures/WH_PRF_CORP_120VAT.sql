--------------------------------------------------------
--  DDL for Procedure WH_PRF_CORP_120VAT
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_CORP_120VAT" (p_forall_limit in integer,p_success out boolean) as
...
begin
   ...
   from   fnd_rtl_shipment shp,
          dim_location dl
   where  shp.last_updated_date  = '29 JUN 2015' and
