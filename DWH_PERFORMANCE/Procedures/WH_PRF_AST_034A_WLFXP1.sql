--------------------------------------------------------
--  DDL for Procedure WH_PRF_AST_034A_WLFXP1
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_AST_034A_WLFXP1" (
...
G_RUN_DATE DATE;
      ...
      l_module_name sys_dwh_errlog.log_procedure_name%type := 'WH_PRF_AST_034A_WLFXP1';
