--------------------------------------------------------
--  DDL for Procedure WH_PRF_S4S_014C_TAKEON
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_S4S_014C_TAKEON" (p_forall_limit in integer,p_success out boolean) as
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_S4S_014C_TAKEON';
...
JG.WORKGROUP_ID
,
WG.SK1_WORKGROUP_ID, WG.SK1_S4S_BUSINESS_UNIT_NO, WG.WORKGROUP_NAME, WG.S4S_BUSINESS_UNIT_NAME
from FND_S4S_JOBGROUP JG, DIM_WORKGROUP WG
