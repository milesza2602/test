--------------------------------------------------------
--  DDL for Procedure WH_PRF_AST_018U_ADHOC
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_AST_018U_ADHOC" 
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_AST_018U_ADHOC';
...
--**************************************************************************************************
   ...
   execute immediate 'alter session enable parallel dml';
      ...
      where  act.style_colour_no   = sc.style_colour_no
       ...
       and   act.fin_week_no       between 2 and 12
      ...
      where  mp.fin_year_no       = cal.fin_year_no
       ...
       and   cal.fin_day_no       = 3
       and   mp.fin_year_no       = 2014
       and   mp.fin_week_no       between 2 and 12
