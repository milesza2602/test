--------------------------------------------------------
--  DDL for Procedure WH_PRF_GENERIC_TRUNC_PARTN_AD
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_GENERIC_TRUNC_PARTN_AD" 
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_GENERIC_TRUNC_PARTN_WK';
...
end wh_prf_generic_trunc_partn_ad;
