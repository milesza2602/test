--------------------------------------------------------
--  DDL for Procedure WH_PRF_RDF_007T
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_RDF_007T" (p_forall_limit in integer, p_success out boolean)
...
--    execute immediate 'drop index W6005682.IP2_RDF_52';    --sk1_location / sk1_item
--    l_text := 'INDEX IP2_RDF_52 DROPPED';
--    dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);
--    
----    execute immediate 'drop index W6005682.PK_U_NEW_LC_ITM_WK_FCST52';    --sk1_location / sk1_item / year / week
----    l_text := 'INDEX PK_U_NEW_LC_ITM_WK_FCST52 DROPPED';
----    dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);
--    
--    execute immediate 'drop index W6005682.IP1_RDF_52';    -- last updated date
--    l_text := 'INDEX IP1_RDF_52 DROPPED';
--    dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);
--    
--    execute immediate 'drop index W6005682.IP3_RDF_52';    -- this week start date
--    l_text := 'INDEX IP3_RDF_52 DROPPED';
--    dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);
...
--      from W6005682.RDF_52WK_FCST_PART bb
...
--    dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);
--    execute immediate 'alter table W6005682.RDF_52WK_FCST_PART drop constraint PK_P_NEW_LC_ITM_WK_FCST52';
...
--       -- SPLIT YEAR MERGE
--       --
--        merge /*+ append parallel(tgt,8) */ into W6005682.RDF_52WK_FCST_PART tgt 
--        USING
...
--    dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);
--    
--    execute immediate 'CREATE INDEX "W6005682"."IP2_RDF_52" ON "W6005682"."RDF_52WK_FCST_PART" ("SK1_LOCATION_NO", "SK1_ITEM_NO")
...
--                       )
--                        TABLESPACE "STG_ARCHIVE2" NOLOGGING PARALLEL 32 LOCAL';
-- 
--    execute immediate 'ALTER INDEX W6005682.IP2_RDF_52 NOPARALLEL LOGGING' ;  
--    
--    l_text := 'INDEX IP2_RDF_52 BUILT';
--    dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);
--    
--    
----    execute immediate 'CREATE INDEX "W6005682"."PK_U_NEW_LC_ITM_WK_FCST52" ON "W6005682"."RDF_52WK_FCST_PART" ("SK1_LOCATION_NO", "SK1_ITEM_NO", "FIN_YEAR_NO", "FIN_WEEK_NO")
----                      PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS NOCOMPRESS STORAGE 
----                      (
----                        INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645 PCTINCREASE 0 FREELISTS 1 
----                        FREELIST GROUPS 1 BUFFER_POOL DEFAULT  
...
----                        TABLESPACE "STG_ARCHIVE2" NOLOGGING PARALLEL 32 LOCAL';
---- 
----    execute immediate 'ALTER INDEX W6005682.PK_U_NEW_LC_ITM_WK_FCST52 NOPARALLEL LOGGING' ;  
--    
----    l_text := 'INDEX PK_U_NEW_LC_ITM_WK_FCST52 BUILT';
----    dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);
--      
-- 
--    execute immediate 'CREATE INDEX "W6005682"."IP3_RDF_52" ON "W6005682"."RDF_52WK_FCST_PART" ("LAST_UPDATED_DATE")
--                      PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS NOCOMPRESS STORAGE 
--                      (
--                        INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645 PCTINCREASE 0 FREELISTS 1 
--                        FREELIST GROUPS 1 BUFFER_POOL DEFAULT  
...
--                        TABLESPACE "STG_ARCHIVE2" NOLOGGING PARALLEL 32 LOCAL';
-- 
--    execute immediate 'ALTER INDEX W6005682.IP3_RDF_52 NOPARALLEL LOGGING' ;  
--    
--    l_text := 'INDEX IP3_RDF_52 BUILT';
--    dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);
--   
--    
--    execute immediate 'CREATE INDEX "W6005682"."IP1_RDF_52" ON "W6005682"."RDF_52WK_FCST_PART" ("THIS_WEEK_START_DATE")
--                      PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS NOCOMPRESS STORAGE 
--                      (
--                        INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645 PCTINCREASE 0 FREELISTS 1 
--                        FREELIST GROUPS 1 BUFFER_POOL DEFAULT  
...
--                        TABLESPACE "STG_ARCHIVE2" NOLOGGING PARALLEL 32 LOCAL';
-- 
--    execute immediate 'ALTER INDEX W6005682.IP1_RDF_52 NOPARALLEL LOGGING' ;   
--    
--    l_text := 'INDEX IP1_RDF_52 BUILT';
--    dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);
--    
----    l_text := 'ADDING PK CONSTRAINT - PK_P_NEW_LC_ITM_WK_FCST52';
----    dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);
----    execute immediate 'ALTER TABLE W6005682.RDF_52WK_FCST_PART ADD CONSTRAINT "PKP_RDF_52" PRIMARY KEY ("SK1_LOCATION_NO", "SK1_ITEM_NO", "FIN_YEAR_NO", "FIN_WEEK_NO")';
