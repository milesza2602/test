--------------------------------------------------------
--  DDL for Procedure WH_PRF_S4S_014A_SS
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_S4S_014A_SS" (p_forall_limit in integer,p_success out boolean) as
...
--
--  DIM Tables:  Input  - FND_S4S_BUSINESS_UNIT_SS
--               Output - RTL_S4S_BUSINESS_UNIT_SS
...
g_count              number        :=  0;
g_rec_in             FND_S4S_BUSINESS_UNIT_SS%rowtype;
g_rec_out            RTL_S4S_BUSINESS_UNIT_SS%rowtype;
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_S4S_014A_SS';
...
type stg_array is table of FND_S4S_BUSINESS_UNIT_SS%rowtype;
a_stg_input      stg_array;

-- For output arrays into bulk load forall statements --
type tbl_array_i is table of RTL_S4S_BUSINESS_UNIT_SS%rowtype index by binary_integer;
type tbl_array_u is table of RTL_S4S_BUSINESS_UNIT_SS%rowtype index by binary_integer;
...
begin
   ...
   forall i in a_tbl_insert.first .. a_tbl_insert.last
      save exceptions
      insert into RTL_S4S_BUSINESS_UNIT_SS values a_tbl_insert(i);
...
begin
    ...
    forall i in a_tbl_update.first .. a_tbl_update.last
       save exceptions
        update RTL_S4S_BUSINESS_UNIT_SS
            set
...
-- dbms_output.put_line('g_count= '||g_count||', S4S_BUSINESS_UNIT_NO='||g_rec_out.S4S_BUSINESS_UNIT_NO);  
