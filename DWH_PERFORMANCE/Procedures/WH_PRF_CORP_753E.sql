--------------------------------------------------------
--  DDL for Procedure WH_PRF_CORP_753E
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_CORP_753E" 
...
Union all                                                                                     -- BK12May16
   ...
   select    1 seq_no, 'FBH' abbr, sum(sales) sales, sum(sales_cost) sales_cost,              -- AU26Mar18
