--------------------------------------------------------
--  DDL for Procedure WH_PRF_CORP_676U_DEL
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_CORP_676U_DEL" 
...
--               Output - rtl_prom_loc_sc_dy_merge
...
g_start_date         date;
g_end_date           date;
g_sk1_prom_period_1  rtl_prom_loc_sc_dy_merge.sk1_prom_period_no%type;
g_sk1_prom_period_2  rtl_prom_loc_sc_dy_merge.sk1_prom_period_no%type;
g_rec_out            rtl_prom_loc_sc_dy_merge%rowtype;

l_message            sys_dwh_errlog.log_text%type;
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_CORP_676U_DEL';
...
type tbl_array_i is table of rtl_prom_loc_sc_dy_merge%rowtype index by binary_integer;
type tbl_array_u is table of rtl_prom_loc_sc_dy_merge%rowtype index by binary_integer;
...
and  dp.SK1_PROM_NO = 28298062 AND dl.SK1_LOCATION_NO = 11802
...
begin
    forall i in a_tbl_insert.first .. a_tbl_insert.last
       save exceptions
       insert into rtl_prom_loc_sc_dy_merge values a_tbl_insert(i);
...
begin
    ...
    forall i in a_tbl_update.first .. a_tbl_update.last
       save exceptions
       update rtl_prom_loc_sc_dy_merge
...
begin
    ...
    l_text := 'LOAD rtl_prom_loc_sc_dy_merge from SALES SPARSE STARTED '||
