--------------------------------------------------------
--  DDL for Procedure WH_PRF_CORP_WL
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_CORP_WL" (p_forall_limit in integer,p_success out boolean) as
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_CORP_WL';
...
l_description        sys_dwh_log_summary.log_description%type  := 'prodlink fix DELETE FROM rtl_loc_item_dy_ast_catlg';
...
--**************************************************************************************************
    g_recs_DELETED  := 0;
 delete from DWH_PERFORMANCE.rtl_loc_item_dy_ast_catlg	WHERE post_date = '3 JULY 2017';
    ...
    dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);
          ...
          g_recs_DELETED  := 0;
 delete from  DWH_PERFORMANCE.rtl_loc_item_dy_ast_catlg	WHERE post_date = '10 JULY 2017';
