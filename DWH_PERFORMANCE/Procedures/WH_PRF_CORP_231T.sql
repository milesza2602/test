--------------------------------------------------------
--  DDL for Procedure WH_PRF_CORP_231T
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_CORP_231T" (p_forall_limit in integer,p_success out boolean) as 
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_CORP_231T';
l_name               sys_dwh_log.log_name%type                 := dwh_constants.vc_log_name_rtl_md;
l_system_name        sys_dwh_log.log_system_name%type          := dwh_constants.vc_log_system_name_rtl_prf;
l_script_name        sys_dwh_log.log_script_name%type          := dwh_constants.vc_log_script_rtl_prf_md;
l_procedure_name     sys_dwh_log.log_procedure_name%type       := l_module_name;
l_text               sys_dwh_log.log_text%type ;
l_description        sys_dwh_log_summary.log_description%type  := 'ROLL RATE OF SALE FROM DAY TO WEEK for 2 weeks';
...
--   group by dc.fin_year_no, dc.fin_week_no, sk1_location_no, sk1_item_no
-- order by dc.fin_year_no, dc.fin_week_no, sk1_location_no, sk1_item_no;
...
begin
   ...
   g_rec_out.fin_year_no                    := g_rec_in.fin_year_no;    --l_fin_year_no;
   g_rec_out.fin_week_no                    := g_rec_in.fin_week_no;    --l_fin_week_no;
   ...
   ------------------
   /*
   select sk1_item_no, avg(weekly_ros), avg(avg_units_per_day)
     into l_6wk_avg1, l_6wk_avg2 
     from rtl_loc_item_wk_rate_of_sale f
...
--**************************************************************************************************
   ...
   select today_fin_year_no,
    ...
    l_last_wk_start_date := '24/DEC/12';
    l_last_wk_end_date   := '20/JAN/13';
...
--    dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);
    ...
    l_text := 'Start date of period being processed :- '|| l_last_wk_start_date;
    dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);
    l_text := 'End date of period being processed :- '|| l_last_wk_end_date;
    dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);
/*    
