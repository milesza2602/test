--------------------------------------------------------
--  DDL for Procedure WH_PRF_CORP_678U_REUSE
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_CORP_678U_REUSE" 
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_CORP_678U';
...
cursor c_prom_chain_sc is
   select   /*+ parallel(4) */ ia.sk1_prom_no, dl.sk1_chain_no, di.sk1_style_colour_no,
...
--   where    po.last_updated_date                        between dp.approval_date and dp.prom_end_date
--   and      po.last_updated_date between '26 Jun 16' and '12 Oct 16'
