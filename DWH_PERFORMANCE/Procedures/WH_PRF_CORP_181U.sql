--------------------------------------------------------
--  DDL for Procedure WH_PRF_CORP_181U
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_CORP_181U" (
...
--**** setup rtl table with parttition on cycle_no.
 ...
 -- REMOVED WL 14 MAR 2014 - filter to limiting, must redo whole cycle if there is a change
       or (fnd.last_updated_date between G_DATE - 123 and  g_date) 
