--------------------------------------------------------
--  DDL for Procedure WH_PRF_CORP_263U_OLD
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_CORP_263U_OLD" (p_forall_limit in integer,p_success out boolean) as
...
MERGE /*+ parallel(rtl_mart,4) */ INTO DWH_PERFORMANCE.MART_SUPPLIER_MASTER_DATA_HIST rtl_mart USING
(
with cal as (
