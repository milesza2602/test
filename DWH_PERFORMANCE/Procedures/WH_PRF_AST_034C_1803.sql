--------------------------------------------------------
--  DDL for Procedure WH_PRF_AST_034C_1803
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_AST_034C_1803" (P_FORALL_LIMIT in integer,P_SUCCESS OUT BOOLEAN)
as
...
--  Author:      Wendy Lyttle
--
--  Purpose:     Create Style-colour datamart for CGM
--
--
