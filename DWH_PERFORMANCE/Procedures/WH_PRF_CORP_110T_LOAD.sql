--------------------------------------------------------
--  DDL for Procedure WH_PRF_CORP_110T_LOAD
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_CORP_110T_LOAD" (p_forall_limit in integer,p_success out boolean
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_CORP_110T_0';
