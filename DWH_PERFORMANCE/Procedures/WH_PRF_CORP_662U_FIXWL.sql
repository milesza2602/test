--------------------------------------------------------
--  DDL for Procedure WH_PRF_CORP_662U_FIXWL
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_CORP_662U_FIXWL"                                                                                                                 (p_forall_limit in integer,p_success out boolean) as
--**************************************************************************************************
--  Date:         February 2009
--  Author:       M Munnik
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_CORP_662U_FIXWL';
...
WITH SELTST
AS (SELECT /*+ materialize full(a) */ * FROM DWH_DATAFIX.TEMP_PO_LIST_260815 a
/*WHERE  (SK1_PO_NO = 23972736 AND SK1_ITEM_NO = 22382720 )
OR (SK1_PO_NO = 23972736 AND SK1_ITEM_NO = 22382721 )
OR (SK1_PO_NO = 23972736 AND SK1_ITEM_NO = 22382722 )
OR (SK1_PO_NO = 23972736 AND SK1_ITEM_NO = 22382723 )
OR (SK1_PO_NO = 23972736 AND SK1_ITEM_NO = 22382724 )
OR (SK1_PO_NO = 23966165 AND SK1_ITEM_NO = 22062915 )
OR (SK1_PO_NO = 23966165 AND SK1_ITEM_NO = 22062916 )
OR (SK1_PO_NO = 23967033 AND SK1_ITEM_NO = 22210112 )
OR (SK1_PO_NO = 23967033 AND SK1_ITEM_NO = 22210113 )
OR (SK1_PO_NO = 23967033 AND SK1_ITEM_NO = 22210114 )
OR (SK1_PO_NO = 23967033 AND SK1_ITEM_NO = 22210115 )
OR (SK1_PO_NO = 23967033 AND SK1_ITEM_NO = 22210116 )
OR (SK1_PO_NO = 23967568 AND SK1_ITEM_NO = 22311713 )
OR (SK1_PO_NO = 23967568 AND SK1_ITEM_NO = 22311714 )
OR (SK1_PO_NO = 23967568 AND SK1_ITEM_NO = 22311715 )
OR (SK1_PO_NO = 23967568 AND SK1_ITEM_NO = 22311716 )
OR (SK1_PO_NO = 23967568 AND SK1_ITEM_NO = 22311717 )
OR (SK1_PO_NO = 23968402 AND SK1_ITEM_NO = 22316982 )
OR (SK1_PO_NO = 23968402 AND SK1_ITEM_NO = 22316983 )
OR (SK1_PO_NO = 23968402 AND SK1_ITEM_NO = 22316984 )
OR (SK1_PO_NO = 23968402 AND SK1_ITEM_NO = 22316989 )
OR (SK1_PO_NO = 23981287 AND SK1_ITEM_NO = 22271759 )
OR (SK1_PO_NO = 23981287 AND SK1_ITEM_NO = 22271762 )
OR (SK1_PO_NO = 23981287 AND SK1_ITEM_NO = 22271763 )
OR (SK1_PO_NO = 23979916 AND SK1_ITEM_NO = 22210104 )
OR (SK1_PO_NO = 23979916 AND SK1_ITEM_NO = 22210106 )
OR (SK1_PO_NO = 23981287 AND SK1_ITEM_NO = 22271759 )
OR (SK1_PO_NO = 23981287 AND SK1_ITEM_NO = 22271760 )
OR (SK1_PO_NO = 23981287 AND SK1_ITEM_NO = 22271762 )
OR (SK1_PO_NO = 23981287 AND SK1_ITEM_NO = 22271763 ) */
),
   shipment as
   (select  /*+ materialize parallel(s,4) */     s.po_no, s.item_no, s.to_loc_no, s.shipment_status_code,
   ...
   receipts as
   (select    /*+ materialize parallel(s,4)  parallel(ldd,4) full(ldd) */  
             s.po_no, s.item_no, s.to_loc_no, dl.sk1_location_no, dl.loc_type, dl.chain_no, s.actl_rcpt_date,
   ...
   purchord as
   (select    /*+ materialize parallel(p,4)  parallel(li,4) full(di)  full(dc)  */  
             p.po_no, pl.supply_chain_type, p.item_no, pl.sk1_po_no, nvl(dsc.sk1_supply_chain_no,0) sk1_supply_chain_no,
    ...
    join      SELTST pl           on  p.po_no              = pl.po_no
...
-- Case quantities can not contain fractions, the case quantity has to be an integer value (ie. 976.0).
   ...
   g_rec_out.last_updated_date                   := g_date + 100;
