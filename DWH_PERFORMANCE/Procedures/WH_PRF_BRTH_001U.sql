--------------------------------------------------------
--  DDL for Procedure WH_PRF_BRTH_001U
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_BRTH_001U" 
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_BRTH_001U';
...
--    dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);
    ...
    DBMS_STATS.gather_table_stats ('DWH_PERFORMANCE',
                                   'temp_product_status_1_code', DEGREE => 8);
    commit;
    l_text := 'GATHER STATS on dwh_performance.temp_product_status_1_code';
    dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);
...
----
    ...
    dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);
    DBMS_STATS.gather_table_stats ('DWH_PERFORMANCE',
                                   'temp_rtl_area_item_wk_catalog', DEGREE => 8);
    commit;
    l_text := 'GATHER STATS on dwh_performance.temp_rtl_area_item_wk_catalog';
    dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);
