--------------------------------------------------------
--  DDL for Procedure WH_PRF_CORP_158U
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_CORP_158U" (p_forall_limit in integer,p_success out boolean) as
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_CORP_158U';
...
cursor c_fnd_rtl_till_hist is
   ...
   from   fnd_rtl_till_hist th,
          ...
          dim_business_unit dbu
   where  th.business_unit_no         = dbu.business_unit_no and
          th.location_no              = dl.location_no      and
          ...
          th.business_unit_no        not in (999,998)
   group by dl.sk1_location_no,dbu.sk1_business_unit_no,th.tran_date ;
...
begin
    ...
    forall i in a_tbl_update.first .. a_tbl_update.last
       ...
       where  sk1_location_no                 = a_tbl_update(i).sk1_location_no      and
              sk1_business_unit_no            = a_tbl_update(i).sk1_business_unit_no    and
...
-- Check to see if item is present on table and update/insert accordingly
   ...
   where  sk1_location_no     = g_rec_out.sk1_location_no      and
          sk1_business_unit_no      = g_rec_out.sk1_business_unit_no    and
...
begin
    ...
    l_text := 'LOAD OF rtl_loc_bus_unit_dy EX FOUNDATION STARTED AT '||
