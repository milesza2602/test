--------------------------------------------------------
--  DDL for Procedure WH_PRF_CORP_128U
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_CORP_128U" (p_forall_limit in integer,p_success out boolean) as
...
--  Tables:      Input  - fnd_rtl_loc_item_dy_rms_stock
--               Output - rtl_loc_item_dy_catalog
--  Packages:    constants, dwh_log, dwh_valid
--
--  Maintenance: 24/2/09 Table reduced to catalog only for all stock movements. fd_avail table replaces all other
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_CORP_128U';
l_name               sys_dwh_log.log_name%type                 := dwh_constants.vc_log_name_rtl_facts;
l_system_name        sys_dwh_log.log_system_name%type          := dwh_constants.vc_log_system_name_rtl_prf;
l_script_name        sys_dwh_log.log_script_name%type          := dwh_constants.vc_log_script_rtl_prf_facts;
l_procedure_name     sys_dwh_log.log_procedure_name%type       := l_module_name;
l_text               sys_dwh_log.log_text%type ;
l_description        sys_dwh_log_summary.log_description%type  := 'LOAD THE CATALOG FACTS EX FOUNDATION';
...
cursor c_fnd_rtl_loc_item_dy_rms_stk is
   select fnd_lid.fd_num_avail_days,
          fnd_lid.post_date,
          di.sk1_item_no,
          dl.sk1_location_no,
...
--   where  lid.last_updated_date >= g_yesterday;
...
--   g_rec_out.fd_num_catlg_days               := g_rec_in.this_wk_catalog_ind;
--   g_rec_out.fd_num_catlg_days_avail         := g_rec_in.this_wk_catalog_ind ;
