--------------------------------------------------------
--  DDL for Procedure WH_PRF_CORP_760U_LOAD
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_CORP_760U_LOAD" (p_forall_limit in integer,p_success out boolean) as
--**************************************************************************************************
--  Date:        January 2013
--  Author:      Q Smit
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_CORP_760U_LOAD';
...
cursor c_zone_item_supp_po_plan is
   select   unique dz.sk1_zone_group_zone_no, di.sk1_item_no, ds.sk1_supplier_no, dc.calendar_date, dih.sk2_item_no,
            ...
            sop.sysdata dc_supp_inbound_cases, g_q_date last_updated_date,
   ...
   --and di.item_no = 20008307 and ds.supplier_no = 70739 
