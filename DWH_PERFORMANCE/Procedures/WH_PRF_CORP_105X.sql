--------------------------------------------------------
--  DDL for Procedure WH_PRF_CORP_105X
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_CORP_105X" 
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_CORP_105U';
...
cursor c_fnd_rtl_loc_item_dy_rms_stk is
   ...
   where  fnd_lid.post_date  =       '03 May 2011' and
