--------------------------------------------------------
--  DDL for Procedure WH_PRF_RDF_210U
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_RDF_210U" 
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_RDF_210U';
...
/*   else
      ...
      g_rec_out.abs_rltv_app_fcst_err_qty_ll   := g_rec_in.fcst_err_sls_dly_app_fcst_qty -
                                                  g_rec_in.fcst_err_corr_sales_qty;
      g_rec_out.abs_sys_fcst_err_qty_ll        := abs(g_rec_in.fcst_err_sls_dly_sys_fcst_qty -
                                                      g_rec_in.fcst_err_corr_sales_qty);
      g_rec_out.abs_rltv_sys_fcst_err_qty_ll   := g_rec_in.fcst_err_sls_dly_sys_fcst_qty -
                                                  g_rec_in.fcst_err_corr_sales_qty;
