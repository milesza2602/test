--------------------------------------------------------
--  DDL for Procedure WH_PRF_CORP_668B_TEST
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_CORP_668B_TEST" (p_forall_limit in integer,p_success out boolean) as
--**************************************************************************************************
--  Date:        May 2010
--  Author:      W Lyttle
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_CORP_668B_TEST';
...
begin
   ...
   forall i in a_tbl_insert.first .. a_tbl_insert.last
      save exceptions
      insert into DWH_PERFORMANCE.rtl_contract_chain_item_wkQ values a_tbl_insert(i);
...
begin
    ...
    forall i in a_tbl_update.first .. a_tbl_update.last 
       save exceptions
       update DWH_PERFORMANCE.rtl_contract_chain_item_wkq
...
-- Check to see if item is present on table and update/insert accordingly   
 ---
  ...
  from DWH_PERFORMANCE.rtl_contract_chain_item_wkq
...
--**************************************************************************************************
     ...
     update /*+ parallel (RTL_CONTRACT_CHAIN_ITEM_WKQ ,8) */ DWH_PERFORMANCE.rtl_contract_chain_item_wkQ
