--------------------------------------------------------
--  DDL for Procedure WH_PRF_CORP_731U_FIX
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_CORP_731U_FIX" (p_forall_limit in integer,p_success out boolean) as
--**************************************************************************************************
--  Date:        April 2013
--  Author:      Q. Smit
...
(select     /*+ PARALLEL(jdaff,4) full(jdaff) full(dl) full(di) */
            dl.sk1_location_no, 
            di.sk1_item_no,
            week_1_day_1_cases,
            week_1_day_2_cases,
   ...
   from     W6005682.FND_LOC_ITEM_OM_WH_PLANQ jdaff,
            dim_location dl,
            dim_item di,
