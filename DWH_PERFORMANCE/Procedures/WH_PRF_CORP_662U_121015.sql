--------------------------------------------------------
--  DDL for Procedure WH_PRF_CORP_662U_121015
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_CORP_662U_121015" 
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_CORP_662U_121015';
...
MERGE INTO  DWH_PERFORMANCE.RTL_PO_SUPCHAIN_LOC_ITEM_DY RTL
 using ( SELECT A.* FROM     DWH_PERFORMANCE.TEMP_POSHIP_CALC A ) MER_MART
