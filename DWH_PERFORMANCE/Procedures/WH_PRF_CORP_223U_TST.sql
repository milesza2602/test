--------------------------------------------------------
--  DDL for Procedure WH_PRF_CORP_223U_TST
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_CORP_223U_TST" (p_forall_limit in integer,p_success out boolean) as
...
----------------------------------------------------------------------------------------------------
    ...
    dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);
    EXECUTE IMMEDIATE('truncate table dwh_datafix.aj_tmp_mart_foods_wkly_snpsht');
...
INSERT /*+ APPEND */ INTO dwh_datafix.aj_tmp_mart_foods_wkly_snpsht mart
with item_list as (
