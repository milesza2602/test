--------------------------------------------------------
--  DDL for Procedure WH_PRF_AST_032U_TEST
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_AST_032U_TEST" 
...
--               Output - mart_ch_ast_chn_sc_wk_test
...
begin
   ...
   l_text := 'LOAD OF mart_ch_ast_chn_sc_wk_test STARTED AT '||
...
--   execute immediate 'truncate table dwh_performance.mart_ch_ast_chn_sc_wk_test';
   execute immediate 'alter session enable parallel dml';

      insert /*+ APPEND parallel (mart,4) */ into dwh_performance.mart_ch_ast_chn_sc_wk_test mart
