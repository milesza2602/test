--------------------------------------------------------
--  DDL for Procedure WH_PRF_CORP_562U
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_CORP_562U"                                                 (p_forall_limit in integer,p_success out boolean) as
--**************************************************************************************************
--  Date:        Oct 2008
--  Author:      Christie Koorts
--  Purpose:     Create location dept day fact table in the performance layer with
--               added value ex foundation layer fin location recon 1 day table.
--  Tables:      Input  -   fnd_fin_loc_recon_1_dy
--               Output -   rtl_loc_dept_dy
--  Packages:    constants, dwh_log, dwh_valid
--  Comments:    Single DML could be considered for this program.
--
--  Maintenance:
--  01 April 2009 - defect 1227 - no filter on driving cursor
--  29 April 2009 - defect 1499 - change to max sk2_location_no retrieval to prevent duplication of data
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_CORP_562U';
l_name               sys_dwh_log.log_name%type                 := dwh_constants.vc_log_name_rtl_roll;
l_system_name        sys_dwh_log.log_system_name%type          := dwh_constants.vc_log_system_name_rtl_prf;
l_script_name        sys_dwh_log.log_script_name%type          := dwh_constants.vc_log_script_rtl_prf_roll;
l_procedure_name     sys_dwh_log.log_procedure_name%type       := l_module_name;
l_text               sys_dwh_log.log_text%type ;
l_description        sys_dwh_log_summary.log_description%type  := 'CREATE RTL_LOC_DEPT_DY EX FND_FIN_LOC_RECON_1_DY';
...
cursor c_fnd_fin_loc_recon_1_dy is
   with chgrecs as
  (select   location_no, department_no, tran_date
   ...
   select   dl.sk1_location_no,
            ...
            sum(decode(flr.record_id,'A',(flr.tran_value - flr.vat_amt),0)) cra_recon_1_sales,
            sum(decode(flr.record_id,'A',flr.tran_value,0)) cra_recon_1_sales_incl_vat
   from     chgrecs cr
   join     fnd_fin_loc_recon_1_dy flr   on  cr.location_no    = flr.location_no 
...
g_rec_in             c_fnd_fin_loc_recon_1_dy%rowtype;

-- Input bulk collect table declared
type stg_array is table of c_fnd_fin_loc_recon_1_dy%rowtype;
...
begin
   ...
   g_rec_out.cra_recon_1_sales              := g_rec_in.cra_recon_1_sales;
   g_rec_out.cra_recon_1_sales_incl_vat     := g_rec_in.cra_recon_1_sales_incl_vat;
...
begin
   ...
   forall i in a_tbl_update.first .. a_tbl_update.last
      ...
      set sk1_location_no                = a_tbl_update(i).sk1_location_no,
          ...
          cra_recon_1_sales              = a_tbl_update(i).cra_recon_1_sales,
          cra_recon_1_sales_incl_vat     = a_tbl_update(i).cra_recon_1_sales_incl_vat,
...
begin
    ...
    l_text := 'LOAD OF RTL_LOC_DEPT_DY EX FND_FIN_LOC_RECON_1_DY STARTED '||
...
--**************************************************************************************************
    open c_fnd_fin_loc_recon_1_dy;
    fetch c_fnd_fin_loc_recon_1_dy bulk collect into a_stg_input limit g_forall_limit;
    ...
    close c_fnd_fin_loc_recon_1_dy;
--**************************************************************************************************
