--------------------------------------------------------
--  DDL for Procedure WH_PRF_CORP_026U
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_CORP_026U" (p_forall_limit in integer,p_success out boolean) as
--**************************************************************************************************
--  Date:        Sept 2008
...
-- Multi Currency ----------------------------------------------------
   g_rec_out.dc_region_no              := g_rec_in.dc_region_no; 
   g_rec_out.fd_zone_group_no          := 1; 
   if g_rec_out.dc_region_no in (10,30,60,90) then
      select sk1_dc_region_no,
             dc_region_description
      into   g_rec_out.sk1_dc_region_no,
             g_rec_out.dc_region_description
      from   dim_dc_region
      where  dc_region_no = g_rec_out.dc_region_no;
   end if;   
------------------------------------------------------------------------   
...
-- Multi currency ------------------------------
      ...
      G_REC_OUT.CH_COST_ZONE_NO := NULL;
      G_REC_OUT.FD_COST_ZONE_NO := NULL;
      G_REC_OUT.CH_SELL_ZONE_NO := NULL;
      G_REC_OUT.FD_SELL_ZONE_NO := NULL;
      G_REC_OUT.SK1_FD_COST_ZONE_GROUP_ZONE_NO := NULL;
      G_REC_OUT.SK1_CH_COST_ZONE_GROUP_ZONE_NO := NULL;
      G_REC_OUT.SK1_FD_SELL_ZONE_GROUP_ZONE_NO := NULL;
      G_REC_OUT.SK1_CH_SELL_ZONE_GROUP_ZONE_NO := NULL;
--------------------------------------------------
...
-- Multi currency ------------------------------
      ...
      G_REC_OUT.CH_COST_ZONE_NO := G_CH_ZONE_NO;
      G_REC_OUT.FD_COST_ZONE_NO := G_FD_ZONE_NO;
      G_REC_OUT.CH_SELL_ZONE_NO := G_CH_ZONE_NO;
      G_REC_OUT.FD_SELL_ZONE_NO := G_FD_ZONE_NO;
      G_REC_OUT.SK1_FD_COST_ZONE_GROUP_ZONE_NO := G_REC_OUT.SK1_FD_ZONE_GROUP_ZONE_NO;
      G_REC_OUT.SK1_CH_COST_ZONE_GROUP_ZONE_NO := G_REC_OUT.SK1_CH_ZONE_GROUP_ZONE_NO;
      G_REC_OUT.SK1_FD_SELL_ZONE_GROUP_ZONE_NO := G_REC_OUT.SK1_FD_ZONE_GROUP_ZONE_NO;
      G_REC_OUT.SK1_CH_SELL_ZONE_GROUP_ZONE_NO := G_REC_OUT.SK1_CH_ZONE_GROUP_ZONE_NO;
--------------------------------------------------
   ...
   if g_rec_out.vat_region_no = 1000 then
      g_rec_out.default_tax_region_no_perc := '15';
   else
...
--Multi currency
              ...
              SK1_CURRENCY_CODE               = A_TBL_UPDATE(I).SK1_CURRENCY_CODE,
              FD_ZONE_GROUP_NO                = A_TBL_UPDATE(I).FD_ZONE_GROUP_NO,
              CH_COST_ZONE_NO                 = A_TBL_UPDATE(I).CH_COST_ZONE_NO,
              FD_COST_ZONE_NO                 = A_TBL_UPDATE(I).FD_COST_ZONE_NO,
              CH_SELL_ZONE_NO                 = A_TBL_UPDATE(I).CH_SELL_ZONE_NO,
              FD_SELL_ZONE_NO                 = A_TBL_UPDATE(I).FD_SELL_ZONE_NO,
              SK1_DC_REGION_NO                = A_TBL_UPDATE(I).SK1_DC_REGION_NO,
              SK1_FD_COST_ZONE_GROUP_ZONE_NO  = A_TBL_UPDATE(I).SK1_FD_COST_ZONE_GROUP_ZONE_NO,
              SK1_CH_COST_ZONE_GROUP_ZONE_NO  = A_TBL_UPDATE(I).SK1_CH_COST_ZONE_GROUP_ZONE_NO,
              SK1_FD_SELL_ZONE_GROUP_ZONE_NO  = A_TBL_UPDATE(I).SK1_FD_SELL_ZONE_GROUP_ZONE_NO,
              SK1_CH_SELL_ZONE_GROUP_ZONE_NO  = A_TBL_UPDATE(I).SK1_CH_SELL_ZONE_GROUP_ZONE_NO,
              DC_REGION_DESCRIPTION           = A_TBL_UPDATE(I).DC_REGION_DESCRIPTION
