--------------------------------------------------------
--  DDL for Procedure WH_PRF_CORP_669B_WL
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_CORP_669B_WL" 
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_CORP_669B_WL';
...
--)
   ...
   from     rtl_supchain_loc_item_dy lid
   join     dim_item i                          on  lid.sk1_item_no         = i.sk1_item_no
   WHERE LID.LAST_UPDATED_DATE = '29 AUG 2016'
 --   where    tran_date >= '1 aug 2016'
