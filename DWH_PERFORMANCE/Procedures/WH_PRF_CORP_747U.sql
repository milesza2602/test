--------------------------------------------------------
--  DDL for Procedure WH_PRF_CORP_747U
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_CORP_747U" (p_forall_limit in integer,p_success out boolean) as
--**************************************************************************************************
--  Date:        Apr 2011
--  Author:      Alastair de Wet
--  Purpose:     Roll down averages from weekly to daily level
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_CORP_747U';
...
l_description        sys_dwh_log_summary.log_description%type  := 'LOAD OF RDF 13 WKLY AVRG EX  WKLY TO DY ';
...
--            di.handling_method_code = 'S'    and
            est_ll_dc_cover_cases_av is not null ;
...
begin
    ...
    forall i in a_tbl_update.first .. a_tbl_update.last
       ...
       set    est_ll_dc_cover_cases_av      = a_tbl_update(i).est_ll_dc_cover_cases_av,
...
begin
    ...
    l_text := 'LOAD rtl_depot_item_dy EX WK  STARTED '||
