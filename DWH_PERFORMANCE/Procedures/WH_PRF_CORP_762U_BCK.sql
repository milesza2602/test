--------------------------------------------------------
--  DDL for Procedure WH_PRF_CORP_762U_BCK
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_CORP_762U_BCK" (p_forall_limit in integer,p_success out boolean) as
--**************************************************************************************************
--  Date:        May 2009
--  Author:      M Munnik
...
--**************************************************************************************************
  ...
  (
   ...
   (select  /*+ full(jdaff) parallel(jdaff,4)*/
            ...
            syscol,
            sysdata
   from     dwh_foundation.fnd_loc_item_jdaff_wh_plan jdaff a, (select /*+ full(x) */ x.item_no from dim_item x where x.group_no in (1,2)) b
