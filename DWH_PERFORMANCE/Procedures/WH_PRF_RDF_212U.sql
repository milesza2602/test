--------------------------------------------------------
--  DDL for Procedure WH_PRF_RDF_212U
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_RDF_212U" 
...
--
--  Maintenance:
--  04 Nov 2009 - W Lyttle - td2443 - Rename fields on RTL_LOC_ITEM_DY_RDF_FCST
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_RDF_212U';
...
--          sum(nvl(fcst.abs_rltv_sys_fcst_err_qty_ll,0))  abs_rltv_sys_fcst_err_qty_ll,
  ...
  from    rtl_loc_item_dy_rdf_fcst fcst
...
begin
    ...
    l_text := 'LOAD RTL_LOC_ITEM_WK_RDF_FCST EX TEMP TABLES STARTED '||
