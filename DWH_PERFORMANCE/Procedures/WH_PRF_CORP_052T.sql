--------------------------------------------------------
--  DDL for Procedure WH_PRF_CORP_052T
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_CORP_052T" (p_forall_limit in integer,p_success out boolean) as
...
--               Output - w6005682.rtl_zone_item_om_qs
...
g_count              number        :=  0;
g_rec_out            w6005682.rtl_zone_item_om_qs%rowtype;
g_found              boolean;
g_date               date          := trunc(sysdate);
g_yesterday          date          := trunc(sysdate) - 1;
l_message            sys_dwh_errlog.log_text%type;
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_CORP_052T';
...
type tbl_array_i is table of w6005682.rtl_zone_item_om_qs%rowtype index by binary_integer;
type tbl_array_u is table of w6005682.rtl_zone_item_om_qs%rowtype index by binary_integer;
...
cursor c_fnd_zone_item is
   ...
   where  fiz.item_no             = di.item_no  and
          ...
          --and fiz.item_no = 2030580000006;
          --and   fiz.last_updated_date = '23/JUN/13';
...
begin
  ...
  Case
   ...
   begin
         ...
         exception
         when no_data_found then g_vat_rate_perc   := 14;
   end;
...
begin
    forall i in a_tbl_insert.first .. a_tbl_insert.last
       save exceptions
       insert into w6005682.rtl_zone_item_om_qs values a_tbl_insert(i);
...
begin
    ...
    forall i in a_tbl_update.first .. a_tbl_update.last
       save exceptions
       update w6005682.rtl_zone_item_om_qs
...
-- Check to see if item is present on table and update/insert accordingly
   select count(1)
   into   g_count
   from   w6005682.rtl_zone_item_om_qs
...
begin
    ...
    l_text := 'LOAD OF w6005682.rtl_zone_item_om_qs EX FOUNDATION STARTED AT '||
