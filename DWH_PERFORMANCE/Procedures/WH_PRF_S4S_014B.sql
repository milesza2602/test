--------------------------------------------------------
--  DDL for Procedure WH_PRF_S4S_014B
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_S4S_014B" (p_forall_limit in integer,p_success out boolean) as
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_S4S_014B';
...
l_description        sys_dwh_log_summary.log_description%type  := 'LOAD Workgroup dimension Data';
...
from FND_S4S_WORKGROUP WG
     , DIM_S4S_BUSINESS_UNIT BU
