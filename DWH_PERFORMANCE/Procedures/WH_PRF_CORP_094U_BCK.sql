--------------------------------------------------------
--  DDL for Procedure WH_PRF_CORP_094U_BCK
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_CORP_094U_BCK" (p_forall_limit in integer,p_success out boolean) as
...
type tbl_array_i is table of c_dim_item%rowtype index by binary_integer;
type tbl_array_u is table of c_dim_item%rowtype index by binary_integer;
...
begin
   ...
   forall i in a_tbl_update.first .. a_tbl_update.last
      save exceptions
      update dim_item
      set    sk1_style_no           = a_tbl_update(i).sk1_style_no,
             sk1_style_colour_no    = a_tbl_update(i).sk1_style_colour_no,
...
-- Bulk 'write from array' loop controlling bulk updates  to output table
--**************************************************************************************************
procedure local_bulk_update_h as
begin
   ...
   forall i in a_tbl_update.first .. a_tbl_update.last
      ...
      g_recs_updated_h := g_recs_updated_h + a_tbl_update.count;
