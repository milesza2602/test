--------------------------------------------------------
--  DDL for Procedure WH_PRF_AST_030U
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_AST_030U" 
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_AST_030U';
...
-- Approved Plan
      ...
      where  apln.sk1_plan_type_no = 60
       ...
       and   cal.this_week_start_date between g_6wk_bck_start_date and g_season_end_date
