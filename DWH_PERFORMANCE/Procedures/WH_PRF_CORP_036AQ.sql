--------------------------------------------------------
--  DDL for Procedure WH_PRF_CORP_036AQ
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_CORP_036AQ" 
...
-- 30 April 2009 - defect 636 - Measures with a data type of text are causing
--                               issues in SSAS
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_CORP_036Q';
...
--**************************************************************************************************
  ...
  --  dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);
  --  update dim_item
  --  set    NEXT_COST_PRICE                = null,
  --         NEXT_COST_PRICE_EFFECTIVE_DATE = null
  --  where  NEXT_COST_PRICE_EFFECTIVE_DATE <= g_date and
  --         business_unit_no               <> 50;
  --  commit;
