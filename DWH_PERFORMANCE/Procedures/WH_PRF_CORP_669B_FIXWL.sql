--------------------------------------------------------
--  DDL for Procedure WH_PRF_CORP_669B_FIXWL
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_CORP_669B_FIXWL" 
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_CORP_669B_FIXWL';
...
cursor c_spch_loc_item_dy_prsup is
   ...
   from     chgrecs cr
   join     rtl_supchain_loc_item_dy lid        on  lid.tran_date           = cr.tran_date
...
begin
   ...
   forall i in a_tbl_insert.first .. a_tbl_insert.last
      save exceptions
      insert into rtl_supchain_loc_item_dy_prsup values a_tbl_insert(i);
...
begin
   ...
   forall i in a_tbl_update.first .. a_tbl_update.last
      save exceptions
      update rtl_supchain_loc_item_dy_prsup
...
-- Check to see if record is present on table and update/insert accordingly
   select count(1)
   into   g_count
   from   rtl_supchain_loc_item_dy_prsup
...
begin
    ...
    delete from rtl_supchain_loc_item_dy_prsup r
