--------------------------------------------------------
--  DDL for Procedure WH_PRF_CORP_746U_1803
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_CORP_746U_1803" (p_forall_limit in integer,p_success out boolean) as
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_CORP_746U';
...
l_description        sys_dwh_log_summary.log_description%type  := 'ROLL UP ZONE ITEM DATA EX FOUNDATION';
...
cursor c_fnd_zone_item_supp_om_po_pl is
   select sum(nvl(week_1_day_1_cases,0)) week_1_day_1_cases,
          sum(nvl(week_1_day_2_cases,0)) week_1_day_2_cases,
          sum(nvl(week_1_day_3_cases,0)) week_1_day_3_cases,
          sum(nvl(week_1_day_4_cases,0)) week_1_day_4_cases,
          sum(nvl(week_1_day_5_cases,0)) week_1_day_5_cases,
          sum(nvl(week_1_day_6_cases,0)) week_1_day_6_cases,
          sum(nvl(week_1_day_7_cases,0)) week_1_day_7_cases,
          sum(nvl(week_2_day_1_cases,0)) week_2_day_1_cases,
          sum(nvl(week_2_day_2_cases,0)) week_2_day_2_cases,
          sum(nvl(week_2_day_3_cases,0)) week_2_day_3_cases,
          sum(nvl(week_2_day_4_cases,0)) week_2_day_4_cases,
          sum(nvl(week_2_day_5_cases,0)) week_2_day_5_cases,
          sum(nvl(week_2_day_6_cases,0)) week_2_day_6_cases,
          di.sk1_item_no,
          ...
          max(nvl(zi.reg_rsp_excl_vat,0)) reg_rsp_excl_vat
   from   fnd_zone_item_supp_om_po_plan zis,
          fnd_zone_item_om zi,
          dim_item di,
          dim_item_hist dih,
          dim_zone dz
   where  zis.item_no                    = di.item_no      and
          zis.item_no                    = dih.item_no         and
          g_date         between dih.sk2_active_from_date and dih.sk2_active_to_date and
          zis.zone_no                    = dz.zone_no and
          zis.zone_group_no              = dz.zone_group_no and
          zis.zone_no                    = zi.zone_no(+) and
          zis.zone_group_no              = zi.zone_group_no(+) and
          zis.item_no                    = zi.item_no(+)
...
begin
   ...
   if g_day = 1 then
      g_rec_out.st_order_cases_1  := g_rec_in.week_1_day_1_cases;
      g_rec_out.st_order_cases_2  := g_rec_in.week_1_day_2_cases;
      g_rec_out.st_order_cases_3  := g_rec_in.week_1_day_3_cases;
      g_rec_out.st_order_cases_4  := g_rec_in.week_1_day_4_cases;
      g_rec_out.st_order_cases_5  := g_rec_in.week_1_day_5_cases;
      g_rec_out.st_order_cases_6  := g_rec_in.week_1_day_6_cases;
      g_rec_out.st_order_cases_7  := g_rec_in.week_1_day_7_cases;
   end if;
   if g_day = 2 then
      g_rec_out.st_order_cases_1  := g_rec_in.week_1_day_2_cases;
      g_rec_out.st_order_cases_2  := g_rec_in.week_1_day_3_cases;
      g_rec_out.st_order_cases_3  := g_rec_in.week_1_day_4_cases;
      g_rec_out.st_order_cases_4  := g_rec_in.week_1_day_5_cases;
      g_rec_out.st_order_cases_5  := g_rec_in.week_1_day_6_cases;
      g_rec_out.st_order_cases_6  := g_rec_in.week_1_day_7_cases;
      g_rec_out.st_order_cases_7  := g_rec_in.week_2_day_1_cases;
   end if;
      if g_day = 3 then
      g_rec_out.st_order_cases_1  := g_rec_in.week_1_day_3_cases;
      g_rec_out.st_order_cases_2  := g_rec_in.week_1_day_4_cases;
      g_rec_out.st_order_cases_3  := g_rec_in.week_1_day_5_cases;
      g_rec_out.st_order_cases_4  := g_rec_in.week_1_day_6_cases;
      g_rec_out.st_order_cases_5  := g_rec_in.week_1_day_7_cases;
      g_rec_out.st_order_cases_6  := g_rec_in.week_2_day_1_cases;
      g_rec_out.st_order_cases_7  := g_rec_in.week_2_day_2_cases;
   end if;
      if g_day = 4 then
      g_rec_out.st_order_cases_1  := g_rec_in.week_1_day_4_cases;
      g_rec_out.st_order_cases_2  := g_rec_in.week_1_day_5_cases;
      g_rec_out.st_order_cases_3  := g_rec_in.week_1_day_6_cases;
      g_rec_out.st_order_cases_4  := g_rec_in.week_1_day_7_cases;
      g_rec_out.st_order_cases_5  := g_rec_in.week_2_day_1_cases;
      g_rec_out.st_order_cases_6  := g_rec_in.week_2_day_2_cases;
      g_rec_out.st_order_cases_7  := g_rec_in.week_2_day_3_cases;
   end if;
      if g_day = 5 then
      g_rec_out.st_order_cases_1  := g_rec_in.week_1_day_5_cases;
      g_rec_out.st_order_cases_2  := g_rec_in.week_1_day_6_cases;
      g_rec_out.st_order_cases_3  := g_rec_in.week_1_day_7_cases;
      g_rec_out.st_order_cases_4  := g_rec_in.week_2_day_1_cases;
      g_rec_out.st_order_cases_5  := g_rec_in.week_2_day_2_cases;
      g_rec_out.st_order_cases_6  := g_rec_in.week_2_day_3_cases;
      g_rec_out.st_order_cases_7  := g_rec_in.week_2_day_4_cases;
   end if;
      if g_day = 6 then
      g_rec_out.st_order_cases_1  := g_rec_in.week_1_day_6_cases;
      g_rec_out.st_order_cases_2  := g_rec_in.week_1_day_7_cases;
      g_rec_out.st_order_cases_3  := g_rec_in.week_2_day_1_cases;
      g_rec_out.st_order_cases_4  := g_rec_in.week_2_day_2_cases;
      g_rec_out.st_order_cases_5  := g_rec_in.week_2_day_3_cases;
      g_rec_out.st_order_cases_6  := g_rec_in.week_2_day_4_cases;
      g_rec_out.st_order_cases_7  := g_rec_in.week_2_day_5_cases;
   end if;
      if g_day = 7 then
      g_rec_out.st_order_cases_1  := g_rec_in.week_1_day_7_cases;
      g_rec_out.st_order_cases_2  := g_rec_in.week_2_day_1_cases;
      g_rec_out.st_order_cases_3  := g_rec_in.week_2_day_2_cases;
      g_rec_out.st_order_cases_4  := g_rec_in.week_2_day_3_cases;
      g_rec_out.st_order_cases_5  := g_rec_in.week_2_day_4_cases;
      g_rec_out.st_order_cases_6  := g_rec_in.week_2_day_5_cases;
      g_rec_out.st_order_cases_7  := g_rec_in.week_2_day_6_cases;
   end if;
