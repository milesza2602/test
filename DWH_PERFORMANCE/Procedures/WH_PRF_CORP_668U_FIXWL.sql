--------------------------------------------------------
--  DDL for Procedure WH_PRF_CORP_668U_FIXWL
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_CORP_668U_FIXWL" 
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_CORP_668U_FIXWL';
...
--**************************************************************************************************
    ...
    insert /* append */ into dwh_performance.rtl_contract_chain_item_wk
