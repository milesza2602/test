--------------------------------------------------------
--  DDL for Procedure WH_PRF_DJ_641U_T23
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_DJ_641U_T23" 
  (
...
as
  ...
  --                           dim_item
  --                           Dim_calendar
  --                           temp_fnd_boc_contract_list_T22
  --               Output -    temp_fnd_boc_contractwkdj_T23
  --  Packages:    Constants, Dwh_Log, Dwh_Valid
  --  Comments:    Single Dml Could Be Considered For This Program.
  --
  --  Maintenance:
  --  20 Jan 2008   - defect 351  - Change to temp_fnd_boc_contractwkdj_T23 structure
  ...
  --
  --  PROCESSING FLOW
  --   1. Clear temp_fnd_boc_contractwkdj_T23
  --   2. Select contracts from temp_fnd_boc_contractwkdj_T23
  --  With
  ...
  -- Insert into temp_fnd_boc_contract_list_T22
  ...
  l_module_name sys_dwh_errlog.log_procedure_name%type := 'WH_PRF_DJ_641U_T23';
  ----
...
--------------
 ...
 --                 sum(contract_qty * di.base_rsp_excl_vat) contract_selling,
                  ...
                  (case when frc.chain_code is null
                  then 0
                 else 1 end) sk1_chain_code_ind
             from dwh_foundation.fnd_rtl_contract frc,
                  dwh_performance.temp_fnd_boc_contract_list_T22 tf,
...
--                  posp.sk1_chain_code_ind
             from  dwh_performance.rtl_po_supchain_loc_item_dy_dj posp,
                   dwh_performance.temp_fnd_boc_contract_list_T22 tf
...
--    tf.sk2_item_no                     ,
    ...
    tf.fin_week_code                   ,
    tf.contract_status_code
     from  dwh_performance.temp_fnd_boc_contract_list_T22 tf
 group by tf.sk1_contract_no               ,
    tf.contract_no               ,
    tf.item_no                         ,
    tf.sk1_item_no                     ,
 ...
 select bocl.sk1_contract_no sk1_contract_no          ,
  ...
  --      bocl.sk2_item_no sk2_item_no                  ,
        ...
        NVL(extc.sk1_chain_code_ind,1) sk1_chain_code_ind,
        --
...
g_rec_out    dwh_performance.temp_fnd_boc_contractwkdj_T23%rowtype;

-- For output arrays into bulk load forall statements --
type tbl_array_i is table of temp_fnd_boc_contractwkdj_T23%rowtype index by binary_integer;
...
begin
   ...
   forall i in a_tbl_insert.first .. a_tbl_insert.last
      save exceptions
      insert into  dwh_performance.temp_fnd_boc_contractwkdj_T23 values a_tbl_insert(i);
...
begin
  ...
  l_text := 'LOAD OF temp_fnd_boc_contractwkdj_T23 EX fnd_rtl_contract AND RTL_PO_SUPCHAIN_LOC_ITEM_DY_DJ STARTED '|| to_char ( sysdate,('dd mon yyyy hh24:mi:ss') ) ;
  dwh_log.write_log ( l_name,l_system_name,l_script_name,l_procedure_name,l_text ) ;
  ...
  dwh_log.write_log ( l_name,l_system_name,l_script_name,l_procedure_name,l_text ) ;
  --**************************************************************************************************
  -- TRUNCATE temp_fnd_boc_contract_list_T22
  -- DWH_LOG.WRITE_LOG   : temp_fnd_boc_contract_list_T22 truncated
  --**************************************************************************************************
  execute immediate('truncate table  temp_fnd_boc_contractwkdj_T23');
  commit;
  l_text :='TRUNCATED temp_fnd_boc_contractwkdj_T23 AT '||to_char ( sysdate,('dd mon yyyy hh24:mi:ss') ) ;
  dwh_log.write_log ( l_name,l_system_name,l_script_name,l_procedure_name,l_text ) ;
