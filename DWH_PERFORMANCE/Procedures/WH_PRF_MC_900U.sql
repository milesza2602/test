--------------------------------------------------------
--  DDL for Procedure WH_PRF_MC_900U
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_MC_900U" (p_forall_limit in integer,p_success out boolean) as
--**************************************************************************************************
--  Date:        July 2018
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_MC_900U';
...
--              sales_cost_opr  sales_cost,
       ...
       from   RTL_MC_LOC_ITEM_DY_RMS_DENSE dns
