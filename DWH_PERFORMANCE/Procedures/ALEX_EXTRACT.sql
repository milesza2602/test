--------------------------------------------------------
--  DDL for Procedure ALEX_EXTRACT
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."ALEX_EXTRACT" (p_forall_limit in integer,p_success out boolean) as
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'ALEX_EXTRACT';
...
--                 Where  A.this_week_start_date Between ''9 May 11'' And ''20 Jun 11''
    g_count := dwh_generic_file_extract('',',','DWH_FILES_OUT','aj_size_scalar1_17');
