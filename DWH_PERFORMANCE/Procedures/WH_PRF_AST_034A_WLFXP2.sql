--------------------------------------------------------
--  DDL for Procedure WH_PRF_AST_034A_WLFXP2
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_AST_034A_WLFXP2" (
...
G_RUN_DATE DATE;
      ...
      l_module_name sys_dwh_errlog.log_procedure_name%type := 'WH_PRF_AST_034A_WLFXP2';
...
with SELCAL AS  (SELECT DISTINCT FIN_YEAR_NO, FIN_WEEK_NO, THIS_WEEK_START_DATE + 42 LAST_UPDATED_DATE 
            FROM DIM_CALENDAR WHERE FIN_YEAR_NO = 2017 AND FIN_WEEK_NO BETWEEN 1 AND 16)
