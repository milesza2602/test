--------------------------------------------------------
--  DDL for Procedure WH_PRF_CORP_003U_T
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_CORP_003U_T" (p_forall_limit in integer,p_success out boolean,P_end_date in date)
as
  --**************************************************************************************************
--  Date:        march 2009
--  Author:      Wendy Lyttle
...
--  l_module_name sys_dwh_errlog.log_procedure_name%type     := 'WH_PRF_DIM_CALENDAR_LOAD';
  l_module_name sys_dwh_errlog.log_procedure_name%type     := 'WH_PRF_CORP_003U_T';
...
--g_date := '15 aug 2011';
  ...
  --**************************************************************************************************
      ...
      L_TEXT  := ' about to set 2wk ind for 2 years back (' ||l_prev_fin_year_no|| ') = 0';
      dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);
