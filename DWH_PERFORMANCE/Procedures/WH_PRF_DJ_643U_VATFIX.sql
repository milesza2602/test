--------------------------------------------------------
--  DDL for Procedure WH_PRF_DJ_643U_VATFIX
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_DJ_643U_VATFIX" 
  (
...
as
  ...
  --  Tables:      Input  -    Temp_FND_BOC_CONTRACT_WK_DJ
  --               Output -    RTL_CONTRCT_CHN_ITEM_WK_BOC_DJ
  --  Packages:    Constants, Dwh_Log, Dwh_Valid
  --  Comments:    Single Dml Could Be Considered For This Program.
  --
  --  Maintenance:
  --  20 Jan 2008 - defect 351 - Change to temp_fnd_boc_contract_wk_dj structure
  --                           - Rename RTL_CONTRCT_CHN_ITEM_WK_BOC_DJ
  --                              to RTL_CONTRCT_CHN_ITEM_WK_BOC_DJ
  --                           -  Change to RTL_CONTRCT_CHN_ITEM_WK_BOC_DJ
  --                               structure
  --                           - CHAIN_NO added with hardcoded value = 10
  --  12 Feb 2009 - defect 528 - Add dim_calendar.this_week_start_date
  --  2 March 2009 - DEFECT 387 - RTL_CONTRCT_CHN_ITEM_WK_BOC_DJ has new fields
  --                              Table-Field Numbers: CONTRACT_MARGIN (25822),
  --                                                   BOC_MARGIN (25823)
  --  7 August 2009 - defect 2203 - PRC - Generation of the
  --                                RTL_CONTRCT_CHN_ITEM_WK_BOC_DJ table
  --                                (and the associated TEMP Table)
  --  24 Feb 2010 - defect2592 - Incorrect BOC_QTY_ALL_TIME value on
  --                              RTL_CONTRCT_CHN_ITEM_WK_BOC_DJ
  --
  --
    --
  ...
  --
  -- PROCESSING FLOW
  --   1. RTL_CONTRCT_CHN_ITEM_WK_BOC_DJ is truncated
  --   2. All records in TEMP_FND_BOC_CONTRACT_WK_DJ
  --          are accumulated
  --              and written to RTL_CONTRCT_CHN_ITEM_WK_BOC_DJ
  --  **
  ...
  g_rec_out dwh_performance.RTL_CONTRCT_CHN_ITEM_WK_BOC_DJ%rowtype;
  g_found boolean;
  ...
  l_module_name sys_dwh_errlog.log_procedure_name%type := 'WH_PRF_DJ_643U_VATFIX';
...
type tbl_array_i
is
  table of RTL_CONTRCT_CHN_ITEM_WK_BOC_DJ%rowtype index by binary_integer;
type tbl_array_u
is
  table of RTL_CONTRCT_CHN_ITEM_WK_BOC_DJ%rowtype index by binary_integer;
 ...
 a_count_i integer := 0;
  a_count_u integer := 0;
 -----------------------------------------------------
 ---- Cursor : Select all temp_fnd_boc_contract_wk_dj
 ...
 --------------------------------
  ...
  --    max(a.fin_week_code) fin_week_code,
    ...
    --    max(d.this_week_start_date) this_week_start_date,
      ...
      0 boc_cost_all_time
       from dwh_performance.temp_fnd_boc_contract_wk_dj a,
   ...
   a.fin_year_no, a.fin_week_no, d.fin_week_code, d.this_week_start_date,sk1_chain_code_ind;
...
begin
  ...
  save exceptions
   insert into dwh_performance.RTL_CONTRCT_CHN_ITEM_WK_BOC_DJ values a_tbl_insert
    (i
    );
...
from dwh_performance.temp_fnd_boc_contract_wk_dj a, dwh_performance.dim_calendar b
where a.fin_year_no = b.fin_year_no
and a.fin_week_no = b.fin_week_no
and b.fin_day_no = 3
group by sk1_contract_no, sk1_item_no))
loop
update dwh_performance.rtl_contrct_chn_item_wk_boc_dj d
...
--
--
-- DWH_LOG.WRITE_LOG          : BOC - LOAD OF RTL_CONTRCT_CHN_ITEM_WK_BOC_DJ STARTED AT
-- DWH_LOG.INSERT_LOG_SUMMARY : BOC - LOAD OF RTL_CONTRCT_CHN_ITEM_WK_BOC_DJ STARTED AT
--**************************************************************************************************
begin
  p_success      := false;
 ...
 --**************************************************************************************************
  ...
  dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);
   execute immediate
   ('truncate table dwh_performance.RTL_CONTRCT_CHN_ITEM_WK_BOC_DJ');
   commit;
  l_text :='TRUNCATED RTL_CONTRCT_CHN_ITEM_WK_BOC_DJ AT '||sysdate;
  dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);
