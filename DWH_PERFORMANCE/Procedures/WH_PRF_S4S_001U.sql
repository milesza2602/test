--------------------------------------------------------
--  DDL for Procedure WH_PRF_S4S_001U
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_S4S_001U" (p_forall_limit in integer,p_success out boolean) AS
...
--  Purpose:     Create dwh_HR_performance.dim_employee dimention table in the performance layer
--               with added value ex foundation layer dwh_foundation.fnd_s4s_EMPLOYEE.
--  Tables:      Input  - dwh_foundation.fnd_s4s_EMPLOYEE
--               Output - dwh_HR_performance.dim_employee
...
g_rec_out            dwh_HR_performance.dim_employee%rowtype;
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_S4S_001U';
l_name               sys_dwh_log.log_name%type                 := dwh_constants.vc_log_name_rtl_md;
l_system_name        sys_dwh_log.log_system_name%type          := dwh_constants.vc_log_system_name_rtl_prf;
l_script_name        sys_dwh_log.log_script_name%type          := dwh_constants.vc_log_script_rtl_prf_md;
l_procedure_name     sys_dwh_log.log_procedure_name%type       := l_module_name;
l_text               sys_dwh_log.log_text%type ;
l_description        sys_dwh_log_summary.log_description%type  := 'LOAD THE S4S employee data  EX FOUNDATION';
...
type tbl_array_i is table of dwh_HR_performance.dim_employee%rowtype index by binary_integer;
type tbl_array_u is table of dwh_HR_performance.dim_employee%rowtype index by binary_integer;
...
begin
   ...
   forall i in a_tbl_insert.first .. a_tbl_insert.last
      save exceptions
      insert into dwh_HR_performance.dim_employee values a_tbl_insert(i);
...
begin
   ...
   forall i in a_tbl_update.first .. a_tbl_update.last
      save exceptions
      update  dwh_HR_performance.dim_employee
       set   
...
begin
    ...
    l_text := 'LOAD OF dwh_HR_performance.dim_employee EX dwh_foundation.fnd_s4s_EMPLOYEE STARTED AT '||
