--------------------------------------------------------
--  DDL for Procedure WH_PRF_AST_003A_OLD
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_AST_003A_OLD" (p_forall_limit in integer,p_success out boolean) as
--**************************************************************************************************
--  Date:        July 2012
...
--                  fnd_uda_value uda_val
           where  bam_uda.style_colour_no = lev.style_colour_no
            ...
            and   bam_uda.uda_no in (002,003,022,023,009,010,014,015,016,017,018,019,020,021,102,104,
            ...
            and   bam_uda.last_updated_date                       = g_date)
...
begin
     ...
     g_rec_out.design_type_desc_307            := nvl(g_rec_in.uda_307,'No Value');
     ...
     g_rec_out.heel_height_desc_321            := nvl(g_rec_in.uda_321,'No Value');
     ...
     g_rec_out.handbag_size_desc_2601          := nvl(g_rec_in.uda_2601,'No Value');
     g_rec_out.shoe_heel_shape_desc_2402       := nvl(g_rec_in.uda_2402,'No Value');
     g_rec_out.product_difference_desc_3104    := nvl(g_rec_in.uda_3104,'No Value');
   ...
   forall i IN a_tbl_update.FIRST .. a_tbl_update.LAST
      ...
      UPDATE dim_ast_sc_uda
         set style_colour_no                    = a_tbl_update(i).style_colour_no,
             ...
             design_type_desc_307               = a_tbl_update(i).design_type_desc_307,
             ...
             heel_height_desc_321               = a_tbl_update(i).heel_height_desc_321,
             ...
             product_category_desc_333          = a_tbl_update(i).product_category_desc_333,        --Added
             fabric_type_desc_334               = a_tbl_update(i).fabric_type_desc_334,
             fragrance_brand_desc_1002          = a_tbl_update(i).fragrance_brand_desc_1002,        --Added
             fragrance_house_desc_1003          = a_tbl_update(i).fragrance_house_desc_1003,        --Added
             brand_type_desc_1103               = a_tbl_update(i).brand_type_desc_1103,             --Added
             brand_category_desc_1105           = a_tbl_update(i).brand_category_desc_1105,         --Added
             ...
             handbag_size_desc_2601             = a_tbl_update(i).handbag_size_desc_2601,
             product_difference_desc_3104       = a_tbl_update(i).product_difference_desc_3104,
