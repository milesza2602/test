--------------------------------------------------------
--  DDL for Procedure WH_PRF_CORP_664U_FIX
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_CORP_664U_FIX" 
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_CORP_664U_FIX';
...
--                    where    last_updated_date = g_date
                    where    last_updated_date between '29 jun 15' and '09 aug 15'
