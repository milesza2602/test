--------------------------------------------------------
--  DDL for Procedure WH_PRF_CORP_046U_MRG
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_CORP_046U_MRG" (p_forall_limit in integer,p_success out boolean, p_from_loc_no in integer,p_to_loc_no in integer) as
--**************************************************************************************************
--  Date:        Sept 2008
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_CORP_046M'|| p_from_loc_no;
...
begin
   ...
   merge /*+ parallel(mer_lid,6) */ into w6005682.rtl_location_item_qs   mer_lid
    using  (
...
merge /*+ parallel(rlid,6) */ into w6005682.rtl_location_item_qs rlid 
  using (
