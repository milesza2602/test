--------------------------------------------------------
--  DDL for Procedure WH_PRF_RDF_207U
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_RDF_207U" 
...
--               with input ex RMS price table from performance layer.
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_RDF_207U';
...
cursor c_rtl_loc_item_dy_rdf_sale is
   ...
   select rdf.sk1_item_no,
          ...
          di.random_mass_ind,
          di.static_mass,
          lip.ruling_rsp_excl_vat
   from   rtl_loc_item_dy_rdf_sale rdf,
          dim_item di,
          dim_location dl,
          rtl_loc_item_dy_rms_price lip
   where  rdf.last_updated_date      = g_date and
          rdf.sk1_item_no            = di.sk1_item_no  and
          rdf.sk1_location_no        = dl.sk1_location_no and
          rdf.sk1_item_no            = lip.sk1_item_no and
          rdf.sk1_location_no        = lip.sk1_location_no and
          rdf.post_date              = lip.calendar_date ;
...
begin
   ...
   if g_rec_in.standard_uom_code = 'EA' and
      ...
      g_rec_out.corr_sales                   := g_rec_in.corr_sales_qty * g_rec_in.ruling_rsp_excl_vat * g_rec_in.static_mass;
      g_rec_out.lost_sales                   := g_rec_in.lost_sales_qty * g_rec_in.ruling_rsp_excl_vat * g_rec_in.static_mass;
   else
      g_rec_out.corr_sales                   := g_rec_in.corr_sales_qty * g_rec_in.ruling_rsp_excl_vat;
      g_rec_out.lost_sales                   := g_rec_in.lost_sales_qty * g_rec_in.ruling_rsp_excl_vat;
   end if;
...
begin
    ...
    forall i in a_tbl_update.first .. a_tbl_update.last
       ...
       set    corr_sales                      = a_tbl_update(i).corr_sales,
