--------------------------------------------------------
--  DDL for Procedure WH_PRF_CORP_663U_FIX
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_CORP_663U_FIX"                                                                                                                                 (p_forall_limit in integer,p_success out boolean) as
--**************************************************************************************************
--  Date:        March 2009
--  Author:      M Munnik
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_CORP_663U_FIX';
...
begin
   ...
   from
      (select    /*+ full(r) parallel (r,4)  */ tl.sk1_po_no,
       ...
       group by  tl.sk1_po_no, r.sk1_item_no) clc
