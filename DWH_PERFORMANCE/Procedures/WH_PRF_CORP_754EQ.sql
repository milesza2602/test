--------------------------------------------------------
--  DDL for Procedure WH_PRF_CORP_754EQ
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_CORP_754EQ" 
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_CORP_754EQ';
...
--   g_date := g_date-1;
   ...
   l_text := 'year PROCESSED - '||g_year || ' week - ' || g_week;
   dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);
   l_text := 'THIS WEEK START DATE - '||g_this_wk_strt_dte;
    dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);
