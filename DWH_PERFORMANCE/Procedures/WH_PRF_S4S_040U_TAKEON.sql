--------------------------------------------------------
--  DDL for Procedure WH_PRF_S4S_040U_TAKEON
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_S4S_040U_TAKEON" (
...
AS
  ...
  l_module_name sys_dwh_errlog.log_procedure_name%type := 'WH_PRF_S4S_040_TAKEON';
