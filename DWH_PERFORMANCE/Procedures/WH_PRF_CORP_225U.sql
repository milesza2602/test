--------------------------------------------------------
--  DDL for Procedure WH_PRF_CORP_225U
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_CORP_225U" (p_forall_limit in integer,p_success out boolean) as
...
--  Tables:      Input  - tmp_mart_foods_mngmnt_guide
--               Output - mart_foods_management_guide
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_CORP_225U';
l_name               sys_dwh_log.log_name%type                 := dwh_constants.vc_log_name_rtl_facts;
l_system_name        sys_dwh_log.log_system_name%type          := dwh_constants.vc_log_system_name_rtl_prf;
l_script_name        sys_dwh_log.log_script_name%type          := dwh_constants.vc_log_script_rtl_prf_facts;
l_procedure_name     sys_dwh_log.log_procedure_name%type       := l_module_name;
l_text               sys_dwh_log.log_text%type ;
l_description        sys_dwh_log_summary.log_description%type  := 'MAINTAIN THE FOODS MANAGEMENT GUIDE MART';
...
begin
    ...
    l_text := 'Maintain mart_foods_management_guide STARTED AT '||
...
----------------------------------------------------------------------------------------------------
    ...
    dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);
    EXECUTE IMMEDIATE('truncate table dwh_performance.mart_foods_management_guide');
...
----------------------------------------------------------------------------------------------------
    ...
    insert /*+ APPEND */ into mart_foods_management_guide
    select /*+ PARALLEL(f,4) */ * from tmp_mart_foods_mngmnt_guide;
