--------------------------------------------------------
--  DDL for Procedure WH_PRF_DJ_662U_BCK11092015
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_DJ_662U_BCK11092015" (p_forall_limit in integer,p_success out boolean) as
--**************************************************************************************************
--  Date:         April 2015
--  Author:       A Joshua
...
--                The table temp_po_list_dj contains the POs updated during the selected period(today or last 5 weeks)
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_DJ_662U';
...
end wh_prf_dj_662U_BCK11092015;
