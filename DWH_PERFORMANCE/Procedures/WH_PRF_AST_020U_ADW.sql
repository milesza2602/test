--------------------------------------------------------
--  DDL for Procedure WH_PRF_AST_020U_ADW
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_AST_020U_ADW" 
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_AST_020U';
