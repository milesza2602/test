--------------------------------------------------------
--  DDL for Procedure WH_PRF_CORP_223A_BCK210214
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_CORP_223A_BCK210214" (p_forall_limit in integer,p_success out boolean) as
...
END WH_PRF_CORP_223A_BCK210214;
