--------------------------------------------------------
--  DDL for Procedure WH_PRF_CORP_CGMR_DELX
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_CORP_CGMR_DELX" (p_forall_limit in integer,p_success out boolean) as
--**************************************************************************************************
--  Date:        May 2017
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_CORP_CGMR_DELX';
...
--**************************************************************************************************
    ...
    execute immediate 'create table DWH_PERFORMANCE.RTL_LOC_SUBC_WK_MP_BCK20170508
