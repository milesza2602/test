--------------------------------------------------------
--  DDL for Procedure WH_PRF_CORP_750E_WLTST
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_CORP_750E_WLTST" (p_forall_limit in integer,p_success out boolean) as
--**************************************************************************************************
--  Date:        April 2009
--  Author:      M Munnik
...
--               Output - DWH_DATAFIX.RTL_SMS_PUBLISH_WLTST
...
g_rec_out            DWH_DATAFIX.RTL_SMS_PUBLISH_WLTST%rowtype;

l_message            sys_dwh_errlog.log_text%type;
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_CORP_750E_WLTST';
...
cursor c_sales is
   ...
   join      w6005682.dim_department_qs d     on r.sk1_department_no = d.sk1_department_no
...
begin
   ...
   insert into DWH_DATAFIX.RTL_SMS_PUBLISH_WLTST values g_rec_out;
...
--**************************************************************************************************
   ...
   update      DWH_DATAFIX.RTL_SMS_PUBLISH_WLTST
   set         processed_ind = 1
