--------------------------------------------------------
--  DDL for Procedure WH_PRF_CORP_715C
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_CORP_715C" (p_forall_limit in integer,p_success out boolean) as
...
--**************************************************************************************************
    ...
    g_count := dwh_generic_file_extract('select * from vw_extr_space_race_ch','|','DWH_FILES_OUT','spacerace_ch_0611_2015');
    l_text :=  'Records extracted to spacerace_ch_2015 '||g_count;
    dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);
