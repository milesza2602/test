--------------------------------------------------------
--  DDL for Procedure WH_PRF_S4S_004U_SS
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_S4S_004U_SS" (
...
--
   ...
   --**************************************************************************************************
   --
   --  Tables:      Input    - DWH_PERFORMANCE.TEMP_S4S_LOC_EMP_DY_PART3_SS
       --               Output   - RTL_EMP_AVAIL_LOC_JOB_DY_SS 
   ...
   g_rec_out          RTL_EMP_AVAIL_LOC_JOB_DY_SS%ROWTYPE;
   g_found            BOOLEAN;
   g_date             DATE;    
   g_end_date         DATE;
   g_name             varchar2(40);
   ...
   l_module_name sys_dwh_errlog.log_procedure_name%TYPE := 'WH_PRF_S4S_004U_SS';
   ...
   TYPE tbl_array_i IS TABLE OF RTL_EMP_AVAIL_LOC_JOB_DY_SS%ROWTYPE INDEX BY BINARY_INTEGER;
   TYPE tbl_array_u IS TABLE OF RTL_EMP_AVAIL_LOC_JOB_DY_SS%ROWTYPE INDEX BY BINARY_INTEGER;
...
--  I30_RTL_EMP_AVL_LC_JB_DY_SS	NONUNIQUE	VALID	NORMAL	N	NO		NO	LAST_UPDATED_DATE
--  I40_RTL_EMP_AVL_LC_JB_DY_SS	NONUNIQUE	VALID	NORMAL	N	NO		NO	SK1_EMPLOYEE_ID, SK1_JOB_ID, TRAN_DATE
--  I50_RTL_EMP_AVL_LC_JB_DY_SS	NONUNIQUE	VALID	NORMAL	N	NO		NO	SK1_EMPLOYEE_ID, TRAN_DATE
--  PK_RTL_EMP_AVL_LC_JB_DY_SS	UNIQUE	VALID	NORMAL	N	NO		NO	SK1_LOCATION_NO, SK1_EMPLOYEE_ID, SK1_JOB_ID, TRAN_DATE
  --**************************************************************************************************
...
BEGIN
  ...
  BEGIN
    ...
    WHERE CONSTRAINT_NAME = 'PK_RTL_EMP_AVL_LC_JB_DY_SS'
    AND TABLE_NAME        = 'RTL_EMP_AVAIL_LOC_JOB_DY_SS';
    
    l_text               := 'alter table dwh_performance.RTL_EMP_AVAIL_LOC_JOB_DY_SS drop constraint PK_RTL_EMP_AVL_LC_JB_DY_SS';
    dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);
    EXECUTE immediate('alter table dwh_performance.RTL_EMP_AVAIL_LOC_JOB_DY_SS drop constraint PK_RTL_EMP_AVL_LC_JB_DY_SS');
    COMMIT;
    
  EXCEPTION
  WHEN no_data_found THEN
    l_text := 'constraint PK_RTL_EMP_AVL_LC_JB_DY_SS does not exist';
    dwh_log.write_log (l_name, l_system_name, l_script_name,l_procedure_name, l_text);
  END;
     l_text               := 'done';
    dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text); 
  ...
  BEGIN
    SELECT index_NAME
     INTO G_name
    FROM DBA_indexes
    WHERE index_NAME = 'I30_RTL_EMP_AVL_LC_JB_DY_SS'
    AND TABLE_NAME   = 'RTL_EMP_AVAIL_LOC_JOB_DY_SS';
    
    l_text              := 'drop INDEX DWH_PERFORMANCE.I30_RTL_EMP_AVL_LC_JB_DY_SS';
    dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);
    EXECUTE immediate('drop INDEX DWH_PERFORMANCE.I30_RTL_EMP_AVL_LC_JB_DY_SS');
    COMMIT;
    
  EXCEPTION
  WHEN no_data_found THEN
    l_text := 'index PI30_RTL_EMP_AVL_LC_JB_DY_SS does not exist';
    dwh_log.write_log (l_name, l_system_name, l_script_name,l_procedure_name, l_text);
  END;
  ...
  BEGIN
    SELECT index_NAME
     INTO G_name
    FROM DBA_indexes
    WHERE index_NAME = 'I40_RTL_EMP_AVL_LC_JB_DY_SS'
    AND TABLE_NAME        = 'RTL_EMP_AVAIL_LOC_JOB_DY_SS';
    
    l_text               := 'drop INDEX DWH_PERFORMANCE.I40_RTL_EMP_AVL_LC_JB_DY_SS';
    dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);
    EXECUTE immediate('drop INDEX DWH_PERFORMANCE.I40_RTL_EMP_AVL_LC_JB_DY_SS');
    COMMIT;
    
  EXCEPTION
  WHEN no_data_found THEN
        l_text := 'index I40_RTL_EMP_AVL_LC_JB_DY_SS does not exist';
        dwh_log.write_log (l_name, l_system_name, l_script_name,l_procedure_name, l_text);
  END;
  ...
  BEGIN
    ...
    INTO G_name
    FROM DBA_indexes
    WHERE index_NAME = 'I50_RTL_EMP_AVL_LC_JB_DY_SS'
    AND TABLE_NAME        = 'RTL_EMP_AVAIL_LOC_JOB_DY_SS';
    
    l_text               := 'drop INDEX DWH_PERFORMANCE.I50_RTL_EMP_AVL_LC_JB_DY_SS';
    DWH_LOG.WRITE_LOG(L_NAME,L_SYSTEM_NAME,L_SCRIPT_NAME,L_PROCEDURE_NAME,L_TEXT);
    EXECUTE immediate('drop INDEX DWH_PERFORMANCE.I50_RTL_EMP_AVL_LC_JB_DY_SS');
    COMMIT;
    
  EXCEPTION
  WHEN no_data_found THEN
        l_text := 'index I50_RTL_EMP_AVL_LC_JB_DY_SS does not exist';
        dwh_log.write_log (l_name, l_system_name, l_script_name,l_procedure_name, l_text);
  END;
...
BEGIN
  ...
  l_text := 'Insert into TEMP_S4S_AVAIL_004U_SS ';
  dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);
  
  insert /*+ append */  into DWH_PERFORMANCE.TEMP_S4S_AVAIL_004U_SS
    ...
    with selexta
     ...
     (SELECT
      ...
      JOIN DWH_PERFORMANCE.TEMP_S4S_LOC_EMP_DY_PART3_SS fc
      ...
      selext1
      as   ( select  
               /*+ FULL(sea) FULL(dc) FULL(ej) FULL(el) parallel(sea,8) parallel(dc,8) parallel(ej,8) parallel(el,8) */
                 sea.EMPLOYEE_ID ,
    ...
    ORDER BY se2.SK1_LOCATION_NO
        ...
        L_TEXT := 'TEMP_S4S_AVAIL_004U_SS : recs = '||g_recs;
        dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);
        ...
        from DWH_PERFORMANCE.TEMP_S4S_AVAIL_004U_SS dup
        ...
        group by SK1_LOCATION_NO, SK1_EMPLOYEE_ID, SK1_JOB_ID, TRAN_DATE
        having count(*) > 1)
        select tmp.* from DWH_PERFORMANCE.TEMP_S4S_AVAIL_004U_SS tmp, seldup sd
        ...
        L_TEXT := 'RTL_EMP_AVAIL_LOC_JOB_DY_SS : recs = '||g_recs;
        dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);
----
...
BEGIN
      l_text          := 'Running GATHER_TABLE_STATS ON RTL_EMP_AVAIL_LOC_JOB_DY_SS';
      dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);
      DBMS_STATS.gather_table_stats ('DWH_PERFORMANCE', 'RTL_EMP_AVAIL_LOC_JOB_DY_SS', DEGREE => 8);

      l_text := 'create INDEX DWH_PERFORMANCE.I30_RTL_EMP_AVL_LC_JB_DY_SS';
      dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);
      EXECUTE immediate('CREATE INDEX DWH_PERFORMANCE.I30_RTL_EMP_AVL_LC_JB_DY_SS ON DWH_PERFORMANCE.RTL_EMP_AVAIL_LOC_JOB_DY_SS (LAST_UPDATED_DATE)     
      TABLESPACE PRF_MASTER NOLOGGING  PARALLEL');
      Execute Immediate('ALTER INDEX DWH_PERFORMANCE.I30_RTL_EMP_AVL_LC_JB_DY_SS LOGGING NOPARALLEL') ;
      
      l_text := 'create INDEX DWH_PERFORMANCE.I40_RTL_EMP_AVL_LC_JB_DY_SS';
      dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);
      EXECUTE immediate('CREATE INDEX DWH_PERFORMANCE.I40_RTL_EMP_AVL_LC_JB_DY_SS ON DWH_PERFORMANCE.RTL_EMP_AVAIL_LOC_JOB_DY_SS (SK1_EMPLOYEE_ID, SK1_JOB_ID, TRAN_DATE)     
      TABLESPACE PRF_MASTER NOLOGGING  PARALLEL');
      Execute Immediate('ALTER INDEX DWH_PERFORMANCE.I40_RTL_EMP_AVL_LC_JB_DY_SS LOGGING NOPARALLEL') ;

      l_text := 'create INDEX DWH_PERFORMANCE.I50_RTL_EMP_AVL_LC_JB_DY_SS';
      dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);
      EXECUTE immediate('CREATE INDEX DWH_PERFORMANCE.I50_RTL_EMP_AVL_LC_JB_DY_SS ON DWH_PERFORMANCE.RTL_EMP_AVAIL_LOC_JOB_DY_SS (SK1_EMPLOYEE_ID, TRAN_DATE)     
      TABLESPACE PRF_MASTER NOLOGGING  PARALLEL');
      Execute Immediate('ALTER INDEX DWH_PERFORMANCE.I50_RTL_EMP_AVL_LC_JB_DY_SS LOGGING NOPARALLEL') ;   
...
BEGIN
    ...
    DBMS_STATS.gather_table_stats ('DWH_PERFORMANCE', 'RTL_EMP_AVAIL_LOC_JOB_DY_SS', DEGREE => 8);
      ...
      l_text := 'alter table dwh_performance.RTL_EMP_AVAIL_LOC_JOB_DY_SS add constraint PK_RTL_EMP_AVL_LC_JB_DY_SS';
      dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);
      EXECUTE immediate('alter table dwh_performance.RTL_EMP_AVAIL_LOC_JOB_DY_SS add CONSTRAINT PK_RTL_EMP_AVL_LC_JB_DY_SS PRIMARY KEY (SK1_LOCATION_NO, SK1_EMPLOYEE_ID, SK1_JOB_ID, TRAN_DATE)                    
...
BEGIN
  ...
  l_text := 'Truncating RTL_EMP_AVAIL_LOC_JOB_DY_SS';
  DWH_LOG.WRITE_LOG(L_NAME,L_SYSTEM_NAME,L_SCRIPT_NAME,L_PROCEDURE_NAME,L_TEXT);
  ...
  l_text := 'Truncating TEMP_S4S_AVAIL_004U_SS';
  DWH_LOG.WRITE_LOG(L_NAME,L_SYSTEM_NAME,L_SCRIPT_NAME,L_PROCEDURE_NAME,L_TEXT);
  execute immediate ('truncate table DWH_PERFORMANCE.TEMP_S4S_AVAIL_004U_SS');
