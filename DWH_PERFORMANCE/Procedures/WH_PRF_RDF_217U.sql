--------------------------------------------------------
--  DDL for Procedure WH_PRF_RDF_217U
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_RDF_217U" 
...
--  Tables:      Input  - rtl_loc_item_wk_rdf_fcst & rtl_loc_item_wk_rdf_sale
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_RDF_217U';
...
cursor c_rtl_loc_item_dy_rdf_fcst is
  ...
  join    rtl_loc_item_wk_rdf_fcst fcst on
