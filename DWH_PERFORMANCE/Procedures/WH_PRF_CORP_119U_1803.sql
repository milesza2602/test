--------------------------------------------------------
--  DDL for Procedure WH_PRF_CORP_119U_1803
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_CORP_119U_1803" (p_forall_limit in integer,p_success out boolean) as

--**************************************************************************************************
--  Date:        FEB 2009
--  Author:      Alastair de Wet
--  Purpose:     Load Allocation fact table in performance layer
--               with input ex RMS Allocation table from foundation layer (CGH Only).
