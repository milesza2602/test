--------------------------------------------------------
--  DDL for Procedure WH_PRF_CORP_643U_FIX
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_CORP_643U_FIX" 
  (
...
as
  ...
  l_module_name sys_dwh_errlog.log_procedure_name%type := 'WH_PRF_CORP_643U_FIX';
