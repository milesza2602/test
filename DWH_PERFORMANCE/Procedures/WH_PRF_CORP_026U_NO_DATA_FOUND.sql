--------------------------------------------------------
--  DDL for Procedure WH_PRF_CORP_026U_NO_DATA_FOUND
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_CORP_026U_NO_DATA_FOUND" (p_forall_limit in integer,p_success out boolean) as
--**************************************************************************************************
--  Date:        Sept 2008
...
--Else OLAP will crash)
   ...
   if g_rec_out.loc_type = 'W' then
    ...
    exception
        when no_data_found then
          dbms_output.put_line('1 g_rec_out.wh_store_no = '||g_rec_out.wh_store_no );
          g_date := 'moo';
       end ;
 ...
 begin
     ...
     exception
        when no_data_found then
          dbms_output.put_line('2 g_fd_zone_no = '||g_fd_zone_no );
          g_date := 'moo';
        end;
...
begin
     ...
     exception
        when no_data_found then
          dbms_output.put_line('3 g_rec_out.wh_physical_wh_no = '||g_rec_out.wh_physical_wh_no );
          g_date := 'moo';
        end;
...
--      dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,'1');
      ...
      exception
        when no_data_found then
          dbms_output.put_line('4 g_rec_out.location_no = '||g_rec_out.location_no );
          g_date := 'moo';
        end;
...
--      dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,'2');
     exception
        when no_data_found then
          dbms_output.put_line('5 g_rec_out.location_no = '||g_rec_out.location_no );
          g_date := 'moo';
   end;
...
--      dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,'3');
     exception
        when no_data_found then
          dbms_output.put_line('6 g_fd_zone_no = '||g_fd_zone_no );
          g_date := 'moo';
   end;
...
--      dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,'4');
     exception
        when no_data_found then
          dbms_output.put_line('7 g_ch_zone_no = '||g_ch_zone_no );
          g_date := 'moo';
    end;
...
end wh_prf_corp_026u_no_data_found;
