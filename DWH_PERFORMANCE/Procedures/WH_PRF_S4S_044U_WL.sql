--------------------------------------------------------
--  DDL for Procedure WH_PRF_S4S_044U_WL
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_S4S_044U_WL" (p_forall_limit in integer,p_success out boolean) as
--**************************************************************************************************
--- COPY OF CURRENT LIVE - USED TO MANUALLY RUN ON 17 FEB 2017
-- CHANGED CONSTRAINT OF LAST_UPDATED_DATE
--**************************************************************************************************
--  Date:        July 2014
--  Author:      Wendy lyttle
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_S4S_044U_WL';
...
--**************************************************************************************************
  g_rec_cnt := 0;
  --  ********* CHANGE MADE FOR MANUAL RUN  17 FEB 2017
  Select count(*) into g_rec_cnt from dwh_foundation.FND_S4S_LOC_EMP_job_PAYCAT_DY where last_updated_date = g_date - 1;
