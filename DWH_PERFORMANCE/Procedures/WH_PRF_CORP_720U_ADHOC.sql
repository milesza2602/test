--------------------------------------------------------
--  DDL for Procedure WH_PRF_CORP_720U_ADHOC
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_CORP_720U_ADHOC" (p_forall_limit in integer,p_success out boolean) as
...
--            so.create_date             between g_last_wk_start and g_this_wk_end ;
            so.create_date             between '20 apr 2015' and '31 may 2015';
