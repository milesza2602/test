--------------------------------------------------------
--  DDL for Procedure WH_PRF_CORP_110X
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_CORP_110X" (p_forall_limit in integer,p_success out boolean , p_from_loc_no in integer, p_to_loc_no in integer) 
as
--**************************************************************************************************
--  Date:        Sept 2008
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_CORP_110X';
...
g_process_no := 7;
  ...
  g_process_no := 8;
      ...
      l_text := ' SALES_FR_COST = '|| g_rec_out.sales_fr_cost ;
      dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);
      l_text := ' SALES_COST = '|| nvl(g_rec_out.sales_cost,0) ;
      dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);
      l_text := ' g_debtors_commission_perc = '|| g_debtors_commission_perc ;
      dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);
