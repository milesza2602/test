--------------------------------------------------------
--  DDL for Procedure ADW_MC_HIST_LIP1
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."ADW_MC_HIST_LIP1" 
...
AND     SK1_LOCATION_NO between g_start and g_end;
