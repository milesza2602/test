--------------------------------------------------------
--  DDL for Procedure WH_PRF_S4S_004U_BACKUP
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_S4S_004U_BACKUP" (
...
BEGIN
         ...
         where (SK1_employee_id, availability_start_date) in (select distinct SK1_employee_id, availability_start_date from dwh_foundation.FND_S4S_EMP_AVAIL_DY_DEL_LIST A, dim_employee DE
...
BEGIN
         delete from DWH_PERFORMANCE.RTL_EMP_AVAIL_LOC_JOB_DY
         where (SK1_employee_id, availability_start_date) in (select distinct SK1_employee_id, availability_start_date from dwh_foundation.FND_S4S_EMP_AVAIL_DY_DEL A, dim_employee DE
