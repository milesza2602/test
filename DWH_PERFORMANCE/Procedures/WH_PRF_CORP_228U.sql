--------------------------------------------------------
--  DDL for Procedure WH_PRF_CORP_228U
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_CORP_228U" (p_forall_limit in integer,p_success out boolean) as

--**************************************************************************************************
--  Date:        June 2012
--  Author:      Quentin Smit
--  Purpose:     Extract first sale date per item
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_CORP_228U';
...
begin
   ...
   forall i in a_tbl_update.first .. a_tbl_update.last
      ...
      set    sk1_business_unit_no             = a_tbl_update(i).sk1_business_unit_no,
             ...
             no_of_weeks                      = a_tbl_update(i).no_of_weeks + 2,
...
begin
    ...
    l_text := 'LOAD OF RTL_ITEM_TRADING STARTED AT '||
