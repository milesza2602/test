--------------------------------------------------------
--  DDL for Procedure WH_PRF_CORP_641U_BK
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_CORP_641U_BK" 
  (
...
as
  ...
  l_module_name sys_dwh_errlog.log_procedure_name%type := 'WH_PRF_CORP_641U_BK';
  ----
...
--------------
        ...
        --          tf.sk2_item_no          ,
             ...
             from  w7104429.rtl_po_supchain_loc_item_dy posp,
                   dwh_performance.temp_fnd_boc_contract_list tf
...
begin
   ...
   forall i in a_tbl_insert.first .. a_tbl_insert.last
      save exceptions
      insert into  w7104429.temp_fnd_boc_contract_wk values a_tbl_insert(i);
...
begin
  ...
  --**************************************************************************************************
  execute immediate('truncate table  w7104429.temp_fnd_boc_contract_wk');
  commit;
