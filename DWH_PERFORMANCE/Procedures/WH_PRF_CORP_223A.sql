--------------------------------------------------------
--  DDL for Procedure WH_PRF_CORP_223A
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_CORP_223A" (p_forall_limit in integer,p_success out boolean) as
...
--               Output - dwh_datafix.aj_tmp_mart_foods_wkly_snpsht
--  Packages:    constants, dwh_log, dwh_valid
--
--  Maintenance:
--  21 Feb 2014 - add pack_item_ind
--  04 Apr 2017 - Chg-5359  - Add 3 new measures for Customer Availability
--  05 Feb 2018 - Chg-12260 - Add 3 new measures for Customer Availability
--
--  Naming conventions
--  g_  -  Global variable
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_CORP_223A';
...
catalog_measures as (
select /*+ PARALLEL(f,6) FULL(f) full(iu) */
       f.sk1_location_no,
       f.sk1_item_no,
