--------------------------------------------------------
--  DDL for Procedure WH_PRF_RDF_600U_WL10112015
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_RDF_600U_WL10112015" 
...
--**************************************************************************************************
  ...
  l_module_name sys_dwh_errlog.log_procedure_name%type := 'WH_PRF_RDF_600U_WL10112015';
...
*/
  ...
  INSERT /*+ APPEND */ INTO  DWH_PERFORMANCE.TEMP_LOC_ITEM_RDF_DYFCST_L2 rdf_mart 
    WITH SELRDF
                  AS(
...
;
  ...
  MERGE /*+ parallel (rdf_mart,4) */ into DWH_PERFORMANCE.RTL_LOC_ITEM_RDF_DYFCST_L2 rdf_mart using (
    SELECT * FROM TEMP_LOC_ITEM_RDF_DYFCST_L2
...
END WH_PRF_RDF_600U_WL10112015 ;
