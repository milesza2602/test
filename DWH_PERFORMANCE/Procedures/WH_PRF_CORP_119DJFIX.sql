--------------------------------------------------------
--  DDL for Procedure WH_PRF_CORP_119DJFIX
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_CORP_119DJFIX" (p_forall_limit in integer,p_success out boolean) as
...
g_start_date         date          := trunc(sysdate) - 124;
