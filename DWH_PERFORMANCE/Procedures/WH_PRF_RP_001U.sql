--------------------------------------------------------
--  DDL for Procedure WH_PRF_RP_001U
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_RP_001U" 
...
l_module_name            sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_RP_001U_'||p_from_loc_no;
...
l_description            sys_dwh_log_summary.log_description%type  := 'LOAD THE RP DAILY CHBD ITEM CATALOG FACTS EX FOUNDATION';
