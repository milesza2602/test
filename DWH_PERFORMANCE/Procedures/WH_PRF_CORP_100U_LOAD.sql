--------------------------------------------------------
--  DDL for Procedure WH_PRF_CORP_100U_LOAD
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_CORP_100U_LOAD" (p_forall_limit in integer,p_success out boolean) as
--**************************************************************************************************
--  Date:        Sept 2008
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_CORP_100U_LOAD';
l_name               sys_dwh_log.log_name%type                 := dwh_constants.vc_log_name_rtl_facts;
l_system_name        sys_dwh_log.log_system_name%type          := dwh_constants.vc_log_system_name_rtl_prf;
l_script_name        sys_dwh_log.log_script_name%type          := dwh_constants.vc_log_script_rtl_prf_facts;
l_procedure_name     sys_dwh_log.log_procedure_name%type       := l_module_name;
l_text               sys_dwh_log.log_text%type ;
l_description        sys_dwh_log_summary.log_description%type  := 'LOAD RMS FOOD STOCK FACTS EX FOUNDATION';
...
cursor c_fnd_rtl_loc_item_dy_rms_stk is
   select fnd_lid.*,
          ...
          dih.sk2_item_no,
          dlh.sk2_location_no
   from   fnd_rtl_loc_item_dy_rms_stk_fd fnd_lid,
          dim_item di,
          dim_location dl,
   ...
   where  fnd_lid.last_updated_date  = g_date and
          fnd_lid.post_date          = '09/AUG/14' and
...
begin
    ...
    l_text := 'LOAD rtl_loc_item_dy_rms_stock FOODS EX FOUNDATION STARTED AT '||
