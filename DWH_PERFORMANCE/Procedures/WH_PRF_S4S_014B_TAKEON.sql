--------------------------------------------------------
--  DDL for Procedure WH_PRF_S4S_014B_TAKEON
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_S4S_014B_TAKEON" (p_forall_limit in integer,p_success out boolean) as
...
--
--  DIM Tables:  Input  - FND_S4S_WORKGROUP
--               Output - DIM_WORKGROUP
...
g_rec_out            DIM_WORKGROUP%rowtype;
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_S4S_014B_TAKEON';
...
type tbl_array_i is table of DIM_WORKGROUP%rowtype index by binary_integer;
type tbl_array_u is table of DIM_WORKGROUP%rowtype index by binary_integer;
...
begin
   ...
   forall i in a_tbl_insert.first .. a_tbl_insert.last
      save exceptions
      insert into DIM_WORKGROUP values a_tbl_insert(i);
...
begin
    ...
    forall i in a_tbl_update.first .. a_tbl_update.last
       save exceptions
        update DIM_WORKGROUP
            set WORKGROUP_ID = a_tbl_update(i).WORKGROUP_ID,
