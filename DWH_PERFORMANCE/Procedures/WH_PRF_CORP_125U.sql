--------------------------------------------------------
--  DDL for Procedure WH_PRF_CORP_125U
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_CORP_125U" (p_forall_limit in integer,p_success out boolean, p_from_loc_no in integer, p_to_loc_no in integer) as
...
--                                         ord.post_date              = prc.calendar_date
   ...
   and dl.location_no between g_from_loc_no and g_to_loc_no;
