--------------------------------------------------------
--  DDL for Procedure WH_PRF_CORP_195U
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_CORP_195U" (p_forall_limit in integer,p_success out boolean) as
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_CORP_195U';
...
begin
   ...
   g_rec_out.sk1_location_no                 := g_rec_in.sk1_location_no;
          ...
          g_rec_out.fd_num_cust_avail_adj     := 0; --Chg12260
          g_rec_out.fd_num_cust_catlg_adj     := 0; --Chg12260
          g_rec_out.fd_cust_avail             := 0; --Chg12260
