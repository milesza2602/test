--------------------------------------------------------
--  DDL for Procedure ADW_EXTRACTFOOD2
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."ADW_EXTRACTFOOD2" (p_forall_limit in integer,p_success out boolean) as
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'ADW_EXTRACTFOOD2';
...
where lid.sk1_location_no = dl.sk1_location_no and
      ...
      lid.fin_year_no = 2010 and lid.fin_week_no between 27 and 53','|','DWH_FILES_OUT','extr_food_boh_2010_2');    
