--------------------------------------------------------
--  DDL for Procedure WH_PRF_RDF_600C
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_RDF_600C" 
(p_forall_limit in integer,p_success out boolean) 
as
--**************************************************************************************************
--  Date:        October 2008
--  Author:      Alfonso Joshua
--  Purpose:     Load CATALOGUE data into performance layer daily forecast LEVEL 2(DEPARTMENT LEVEL)
...
--  qc4340 - W LYTTLE: RDF Rollup of LEVEL 2(DEPARTMENT LEVEL) data
      ...
      --                        - was from rtl_loc_item_dy_catalog	rtl_loc_item_dy_rdf_fcst
      --                          now from rtl_loc_item_dy_catalog	RTL_LOC_ITEM_RDF_DYFCST_L2
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_RDF_600C';
...
begin
    ...
    l_text := 'LOAD RTL_LOC_ITEM_RDF_DYFCST_L2 EX TEMP TABLES STARTED '||
