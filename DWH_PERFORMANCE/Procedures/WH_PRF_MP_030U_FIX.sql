--------------------------------------------------------
--  DDL for Procedure WH_PRF_MP_030U_FIX
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_MP_030U_FIX" 
                                                                                                                                (p_forall_limit in integer,p_success out boolean) as
--**************************************************************************************************
--  Date:        April 2011
--  Author:      A Joshua
--  Purpose:     Load MP APS/Stock counts from rtl_loc_sc_wk_mp_bck to rtl_loc_sc_wk_mp.
--  Tables:      Input  - rtl_loc_sc_wk_mp_bck
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_MP_030U_FIX';
...
*/
      ...
      from   rtl_loc_sc_wk_mp_bck  fnd
--             dim_ast_lev1_diff1    sc,
--             dim_location          dl,
--             dim_calendar_wk       cal
      where  --fnd.style_colour_no   = sc.style_colour_no and
             --fnd.location_no       = dl.location_no     and
             fnd.fin_year_no       = 2012    and
             fnd.fin_week_no       between 27 and 52 and 
            (fnd.adjusted_store_count > 0 or
             fnd.aps_sales_qty > 0);
