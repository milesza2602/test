--------------------------------------------------------
--  DDL for Procedure WH_PRF_CORP_195U_CFIX
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_CORP_195U_CFIX" (p_forall_limit in integer,p_success out boolean) as
...
g_count              number        :=  0;
g_rec_out            DWH_PERFORMANCE.RTL_LOC_ITEM_DY_DATALOG_N%rowtype;
g_found              boolean;
...
g_start_date         date          := '07 feb 18';
g_end_date           date          := '07 feb 18';

l_message            sys_dwh_errlog.log_text%type;
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_CORP_195U_CFIX';
...
type tbl_array_i is table of DWH_PERFORMANCE.RTL_LOC_ITEM_DY_DATALOG_N%rowtype index by binary_integer;
type tbl_array_u is table of DWH_PERFORMANCE.RTL_LOC_ITEM_DY_DATALOG_N%rowtype index by binary_integer;
...
--          lid.sk1_location_no            = li.sk1_location_no and
...
begin
    forall i in a_tbl_insert.first .. a_tbl_insert.last
       save exceptions
       insert into DWH_PERFORMANCE.RTL_LOC_ITEM_DY_DATALOG_N values a_tbl_insert(i);
...
begin
    ...
    forall i in a_tbl_update.first .. a_tbl_update.last
       save exceptions
       update DWH_PERFORMANCE.RTL_LOC_ITEM_DY_DATALOG_N
       set /*   fd_num_avail_days               = a_tbl_update(i).fd_num_avail_days,
              ...
              fd_cust_avail                   = a_tbl_update(i).fd_cust_avail,          --chg4256
              fd_num_cust_catlg_adj           = a_tbl_update(i).fd_num_cust_catlg_adj   --chg_12260
