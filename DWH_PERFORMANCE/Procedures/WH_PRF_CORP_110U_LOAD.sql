--------------------------------------------------------
--  DDL for Procedure WH_PRF_CORP_110U_LOAD
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_CORP_110U_LOAD" 
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_CORP_110U_LOAD_'|| p_from_loc_no;
