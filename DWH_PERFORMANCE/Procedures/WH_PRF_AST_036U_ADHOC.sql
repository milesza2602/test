--------------------------------------------------------
--  DDL for Procedure WH_PRF_AST_036U_ADHOC
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_AST_036U_ADHOC" 
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_AST_036U';
...
/*
   ...
   group by ly_fin_year_no, ly_fin_week_no, fin_week_no, fin_year_no;   
*/
   g_6wk_bck_start_date := '08 jul 13';
   g_74wk_fwd_end_date  := '22 sep 13'; 
...
--       and   cgg.last_updated_date    = g_date
      ...
      where  con.sk1_style_colour_no  = sc.sk1_style_colour_no
       ...
       and   cal.fin_day_no           = 3
       and   cal.this_week_start_date between g_6wk_bck_start_date and g_74wk_fwd_end_date
--       and   con.last_updated_date    = g_date
