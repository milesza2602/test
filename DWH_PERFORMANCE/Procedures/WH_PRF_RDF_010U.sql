--------------------------------------------------------
--  DDL for Procedure WH_PRF_RDF_010U
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_RDF_010U" (p_forall_limit in integer,p_success out boolean) as

--**************************************************************************************************
--  Date:        October 2008
--  Author:      M Munnik
--  Purpose:     Load/Update forecast alert indicator ex RDF.
--  Tables:      Input  - fnd_rtl_loc_item_wk_rdf_alert
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_RDF_010U';
...
l_description        sys_dwh_log_summary.log_description%type  := 'LOAD RDF FORECAST_ALERT_IND EX FOUNDATION';
...
cursor c_fnd_rtl_loc_item_wk_alert is
...
begin
    forall i in a_tbl_update.first .. a_tbl_update.last
       ...
       set    forecast_alert_ind         = a_tbl_update(i).forecast_alert_ind,
...
begin
    ...
    l_text := 'LOAD OF rtl_loc_item_wk EX FOUNDATION STARTED '||
...
--**************************************************************************************************
    open c_fnd_rtl_loc_item_wk_alert;
    fetch c_fnd_rtl_loc_item_wk_alert bulk collect into a_stg_input limit g_forall_limit;
    ...
    close c_fnd_rtl_loc_item_wk_alert;
--**************************************************************************************************
