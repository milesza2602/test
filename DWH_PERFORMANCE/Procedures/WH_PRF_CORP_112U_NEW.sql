--------------------------------------------------------
--  DDL for Procedure WH_PRF_CORP_112U_NEW
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_CORP_112U_NEW" (p_forall_limit in integer,p_success out boolean) as
--**************************************************************************************************
--  Date:        Sept 2008
--  Author:      Sean Le Roux
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_CORP_112U_NEW';
...
begin
    ...
    save exceptions
MERGE /*+ USE_NL(rtl_lidrs)*/ INTO rtl_loc_item_dy_rms_sparse rtl_lidrs
USING
