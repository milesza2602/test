--------------------------------------------------------
--  DDL for Procedure WH_PRF_DJ_661U_VATFIX
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_DJ_661U_VATFIX" 
...
--                The distinct supply_chain_type is then used for all the records of the PO, regardless of the item and location (in wh_prf_corp_661U_VATFIXD and _662u).
--  2 nov 2011 - qc 4419 - wendy lyttle
--               Procedure Change:WH_PRF_CORP_661U_VATFIX - Use DIM_ITEM.PACK_ITEM_IND to update
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_DJ_661U_VATFIX';
