--------------------------------------------------------
--  DDL for Procedure WH_PRF_AST_032U_WLFIX3
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_AST_032U_WLFIX3" 
...
l_module_name           sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_AST_032U_WLFIX3';
...
--  LOOP
   ...
   select ly_fin_week_no, ly_fin_year_no, ly_calendar_date, ly_calendar_date
   into   g_fin_week_no_ly, g_fin_year_no_ly, g_calendar_end_date_ly, g_6wk_bck_start_date_ly
   from   dim_calendar
   where  calendar_date = g_prev_week_end_date;
    ...
    dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);
      l_text := ' SUB='||G_SUB
               ...
               ||' g_calendar_end_date_ly='||g_calendar_end_date_ly
               ||' g_6wk_bck_start_date_ly='||g_6wk_bck_start_date_ly;
    dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);
...
-- LY Original Plan - extract9
      selcal as (
                  ...
                  where CALENDAR_DATE = g_6wk_bck_start_date_ly --and g_calendar_end_date_ly
                  ),
