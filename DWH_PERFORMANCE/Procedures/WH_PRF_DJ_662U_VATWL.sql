--------------------------------------------------------
--  DDL for Procedure WH_PRF_DJ_662U_VATWL
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_DJ_662U_VATWL" 
...
--                Output - rtl_posupchnlocitemdy_DJ_vatwl
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_DJ_662U_VATWL';
...
(
   ...
   from      fnd_rtl_purchase_order p
    join      dwh_performance.temp_po_list_DJ_vatwl tp           on  p.po_no              = tp.po_no
...
MERGE INTO  DWH_PERFORMANCE.rtl_posupchnlocitemdy_DJ_vatwl RTL
 using ( SELECT a.*, g_date+200 gdate200 FROM     DWH_PERFORMANCE.TEMP_POSHIP_CALC_DJ a ) MER_MART
