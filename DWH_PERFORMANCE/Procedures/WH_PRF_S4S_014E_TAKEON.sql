--------------------------------------------------------
--  DDL for Procedure WH_PRF_S4S_014E_TAKEON
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_S4S_014E_TAKEON" (p_forall_limit in integer,p_success out boolean) as
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_S4S_014E_TAKEON';
...
JG.JOB_ID,
JG.JOB_NAME,
WG.SK1_JOB_ID,WG.SK1_JOBGROUP_ID, WG.SK1_WORKGROUP_ID, WG.SK1_S4S_BUSINESS_UNIT_NO
from FND_S4S_LABOUR_ROLE JG, DIM_JOB WG
...
begin
   ...
   select count(1)
    ...
    where 
    LABOUR_ROLE_ID = g_rec_out.LABOUR_ROLE_ID
	   and
