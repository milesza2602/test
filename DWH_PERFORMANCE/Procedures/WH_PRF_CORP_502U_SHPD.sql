--------------------------------------------------------
--  DDL for Procedure WH_PRF_CORP_502U_SHPD
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_CORP_502U_SHPD" 
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_CORP_502U_SHPD';
...
--    G_DATE := g_date - 41;
 ...
 --Period=25-JAN-16 - 31-JAN-16 Recs inserted = 1567448 STOPPED AT 
     G_DATE := '18 JAN 2016';
...
--2016	9
-- EG RTL_LCITMWRSPRS_M201312_49 RTL_LCITMWRSPRS_M20113_10  RTL_LCITMWRSPRS_M20162_9
------------
          g_partition_name :=   'RTL_LCITMWRSPRS_M'||g_fin_year_no||g_fin_month_no||'_'||g_fin_week_no;    
          g_sql_trunc_partition := 'alter table dwh_performance.RTL_LOC_ITEM_WK_RMS_SPARSE truncate SUBPARTITION '||g_partition_name;
