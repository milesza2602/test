--------------------------------------------------------
--  DDL for Procedure WH_PRF_CORP_002U_HR
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_CORP_002U_HR" (p_success out boolean) AS
--**************************************************************************************************
--  Date:        July 2008
...
g_cnt               integer       := 0;
g_rec_out           dwh_hr_performance.dim_control_hr%rowtype;
...
l_module_name       sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_CORP_002U_HR';
...
begin
   ...
   insert into dwh_hr_performance.dim_control_hr values g_rec_out;
...
begin
    ...
    l_text := 'GENERATE DIM_CONTROL_HR TABLE STARTED AT '||
...
--**************************************************************************************************
       ...
       Delete From dwh_hr_performance.Dim_Control_hr;
       ...
       from dwh_hr_performance.dim_control_hr;
