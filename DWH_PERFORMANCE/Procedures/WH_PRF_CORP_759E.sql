--------------------------------------------------------
--  DDL for Procedure WH_PRF_CORP_759E
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_CORP_759E" 
...
--   and       l.area_no            = 9951
   ...
   union all
   select    /*+ full (r) parallel (r,4) full (l) full (i) full (u) */
