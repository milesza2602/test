--------------------------------------------------------
--  DDL for Procedure WH_PRF_DJ_640U_T22
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_DJ_640U_T22" 
(
...
as
  ...
  --               OUTPUT -    DWH_PERFORMANCE.temp_fnd_boc_contractlistdjT22
  ...
  --                             populating DWH_PERFORMANCE.temp_fnd_boc_contractlistdjT22
  --
  ...
  --
  --  PROCESSING FLOW
  --   1. Clear DWH_PERFORMANCE.temp_fnd_boc_contractlistdjT22
  ...
  --                which have in DWH_PERFORMANCE.temp_fnd_boc_contractlistdjT22
  --**************************************************************************************************
...
g_rec_out            DWH_PERFORMANCE.temp_fnd_boc_contractlistdjT22%rowtype;
g_found              boolean;
g_count              number       := 0;
...
l_module_name sys_dwh_errlog.log_procedure_name%type := 'WH_PRF_DJ_640U_T22';
...
type tbl_array_i is table of DWH_PERFORMANCE.temp_fnd_boc_contractlistdjT22%rowtype index by binary_integer;
type tbl_array_u is table of DWH_PERFORMANCE.temp_fnd_boc_contractlistdjT22%rowtype index by binary_integer;
...
--**************************************************************************************************
 ...
 --**************************************************************************************************
    ...
    dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);
  --**************************************************************************************************
  -- TRUNCATE DWH_PERFORMANCE.temp_fnd_boc_contractlistdjT22
  -- DWH_LOG.WRITE_LOG   : DWH_PERFORMANCE.temp_fnd_boc_contractlistdjT22 is truncated before running
  --**************************************************************************************************
    l_text :='TRUNCATED DWH_PERFORMANCE.temp_fnd_boc_contractlistdjT22 AT '||sysdate;
    dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);
    execute immediate ('truncate table DWH_PERFORMANCE.temp_fnd_boc_contractlistdjT22');
    commit;
...
--**************************************************************************************************
INSERT /*+ APPEND */ INTO DWH_PERFORMANCE.temp_fnd_boc_contractlistdjT22
WITH 
     SELCON AS 
...
GROUP BY CONTRACT_NO
 ...
 ;
    ...
    commit; 
    l_text := 'Recs inserted into temp_fnd_boc_contractlistdjT22='||g_recs_inserted;
    dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);                 
