--------------------------------------------------------
--  DDL for Procedure WH_PRF_CORP_679U_FIX
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_CORP_679U_FIX" 
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_CORP_679U_FIX';
...
--   where    g_date                        between dp.approval_date and dp.prom_end_date
   where    boc.last_updated_date between '29 jun 15' and '09 aug 15'
...
begin
    ...
    forall i in a_tbl_update.first .. a_tbl_update.last
       ...
       set    
--              sk1_prom_period_no      = a_tbl_update(i).sk1_prom_period_no,
