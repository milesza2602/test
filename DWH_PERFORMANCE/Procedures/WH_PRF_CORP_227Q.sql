--------------------------------------------------------
--  DDL for Procedure WH_PRF_CORP_227Q
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_CORP_227Q" (p_forall_limit in integer,p_success out boolean) as
...
l_fin_week_no := 24;
l_last_week_no := 23;
l_next_wk_fin_week_no:= 25;
l_day_no := 7;
l_this_wk_end_date := '14/DEC/14';
l_this_wk_start_date := '08/DEC/14';
