--------------------------------------------------------
--  DDL for Procedure WH_PRF_S4S_004A_EXCPT_TAKEON
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_S4S_004A_EXCPT_TAKEON" (
...
g_end_sub number;
      ...
      l_module_name sys_dwh_errlog.log_procedure_name%TYPE := 'WH_PRF_S4S_004A_EXCPT_TAKEON';
...
---------------------------------------------------------------
      ...
      FOR v_cur IN (  SELECT employee_id,
                             CYCLE_start_date,
                             AVAILABILITY_START_DATE,
                             this_week_start_date,
...
END WH_PRF_S4S_004A_EXCPT_TAKEON;
