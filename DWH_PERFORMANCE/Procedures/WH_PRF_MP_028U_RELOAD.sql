--------------------------------------------------------
--  DDL for Procedure WH_PRF_MP_028U_RELOAD
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_MP_028U_RELOAD" 
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_MP_028U_RELOAD';
...
--**************************************************************************************************
   ...
   */
   ...
   /*
   for l_fin_year_loop in reverse 2018..2018 loop
     g_fin_year_no := l_fin_year_loop;

     for l_fin_week_loop in reverse 1..2 loop
   ...
   for l_fin_year_loop in reverse 2017..2017 loop
     g_fin_year_no := l_fin_year_loop;
   ...
   */
   ...
   dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);  
    begin
      DBMS_STATS.gather_table_stats ('DWH_PERFORMANCE','MART_RTL_LOC_SUBC_PLN_WK_RMS',estimate_percent=>1, DEGREE => 32);
      commit;
    end;
