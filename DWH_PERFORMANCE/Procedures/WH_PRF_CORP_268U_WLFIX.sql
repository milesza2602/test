--------------------------------------------------------
--  DDL for Procedure WH_PRF_CORP_268U_WLFIX
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_CORP_268U_WLFIX" 
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_CORP_268U_WLFIX';
...
begin
   ...
   l_text := 'LOAD OF RTL_CHN_SC_WK_TOO_ACT STARTED AT '||
...
--RTL_RCSWTA_M200712_51
          g_partition_name :=   'RTL_RCSWTA_M'||g_START_YEAR||g_START_month||'_'||g_START_week;    
          g_sql_trunc_partition := 'alter table dwh_performance.RTL_CHN_SC_WK_TOO_ACT truncate SUBPARTITION '||g_partition_name;
      ...
      insert /*+ APPEND parallel (too,2) */ into RTL_CHN_SC_WK_TOO_ACT too
      select /*+ parallel (a,4) */
             a.sk1_chain_no,
   ...
   --   where  a.last_updated_date = '6 july 14'
       and   a.sk1_plan_type_no  = 63
      group by a.sk1_chain_no, a.sk1_style_colour_no, a.fin_year_no, a.fin_week_no, a.sk1_plan_type_no, a.fin_week_code, g_date;
