--------------------------------------------------------
--  DDL for Procedure WH_PRF_CORP_640U_FIXWL
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_CORP_640U_FIXWL" 
  (
...
l_module_name sys_dwh_errlog.log_procedure_name%type := 'WH_PRF_CORP_640U_FIXWL';
...
--    where rc.last_updated_date >= g_start_date
    where rc.last_updated_date BETWEEN '29 jun 15'  AND G_DATE2
...
begin
 ...
 l_text := 'Batch period selected is :- '||g_date;
   dwh_log.write_log  (l_name,l_system_name,l_script_name,l_procedure_name,l_text);
