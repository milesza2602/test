--------------------------------------------------------
--  DDL for Procedure WH_PRF_CORP_668B_FIXWL
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_CORP_668B_FIXWL" 
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_CORP_668B_FIXWL';
...
--**************************************************************************************************
  ...
  --   update /*+ parallel (RTL_CONTRACT_CHAIN_ITEM_WK ,4) */ DWH_PERFORMANCE.rtl_contract_chain_item_wk
