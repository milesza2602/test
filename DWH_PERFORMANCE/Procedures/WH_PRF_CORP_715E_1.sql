--------------------------------------------------------
--  DDL for Procedure WH_PRF_CORP_715E_1
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_CORP_715E_1" (p_forall_limit in integer,p_success out boolean) as
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_CORP_715E_1';
...
--**************************************************************************************************
    ...
    g_count := dwh_generic_file_extract('select * from vw_extr_space_race1','|','DWH_FILES_OUT','spacerace_2016Q2’');
    l_text :=  'Records extracted to spacerace_2016Q2 '||g_count;
    dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);
