--------------------------------------------------------
--  DDL for Procedure WH_PRF_CORP_660U_SHPD
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_PERFORMANCE"."WH_PRF_CORP_660U_SHPD" 
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_CORP_660U_SHPD';
...
g_start := g_date - 8;
g_end := g_date - 6;
    l_text := 'date range'||g_start||'-'||g_end;
    dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);
   ...
   select /*+ parallel(po,4) full(ps) parallel(ps,4) full(di) */
                             ...
                             where  po.last_updated_date between g_start and g_end  -- CHANGE 10 SEP 2016 WL TO PICKUP MORE DATA DUE TO DATAFIX
                     ...
                     union
                             ...
                             where  s.last_updated_date between g_start and g_end  -- CHANGE 10 SEP 2016 WL TO PICKUP MORE DATA DUE TO DATAFIX
