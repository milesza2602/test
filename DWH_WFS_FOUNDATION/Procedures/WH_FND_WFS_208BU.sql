--------------------------------------------------------
--  DDL for Procedure WH_FND_WFS_208BU
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_WFS_FOUNDATION"."WH_FND_WFS_208BU" (p_forall_limit in integer,p_success out boolean) as
...
--            nvl(fnd.tot_due_enter_coll	,0) <>	cpy.	tot_due_enter_coll	or
...
FOR upd_rec IN c_stg_vsn_cust_collect
   loop
     update fnd_wfs_cust_collect fnd 
     set    fnd.	wfs_account_no	    =	upd_rec.	wfs_account_no	,
----            fnd.	tot_due_enter_coll	=	upd_rec.	tot_due_enter_coll	,
            fnd.	total_due         	=	upd_rec.	total_due	,
            fnd.	wfs_rep_id	        =	upd_rec.	wfs_rep_id	,
            fnd.	rep_assign_date	    =	upd_rec.	rep_assign_date	,
            fnd.	temp_rep	          =	upd_rec.	temp_rep	,
            fnd.	tmprep_assgn_date 	=	upd_rec.	tmprep_assgn_date	,
            fnd.	delinq_reason       =	upd_rec.	delinq_reason	,
            fnd.	purge_date	        =	upd_rec.	purge_date	,
            fnd.	cta_class	          =	upd_rec.	cta_class	,
            fnd.	cta_class_date    	=	upd_rec.	cta_class_date	,
            fnd.	ctaclas_dys_remain	=	upd_rec.	ctaclas_dys_remain	,
            fnd.	no_days_delinquent	=	upd_rec.	no_days_delinquent	,
            fnd.	last_ptp_repid	    =	upd_rec.	last_ptp_repid	,
            fnd.	last_ptp_value	    =	upd_rec.	last_ptp_value	,
            fnd.	last_ptp_date	      =	upd_rec.	last_ptp_date	,
            fnd.	ptp_balance       	=	upd_rec.	ptp_balance	,
            fnd.	no_of_brkn_ptp	    =	upd_rec.	no_of_brkn_ptp	,
            fnd.	satsfd_ptp_flag   	=	upd_rec.	satsfd_ptp_flag	,
            fnd.	no_of_prod_actions	=	upd_rec.	no_of_prod_actions	,
            fnd.	no_of_nonprd_actns	=	upd_rec.	no_of_nonprd_actns	,
            fnd.	no_of_letters_sent	=	upd_rec.	no_of_letters_sent	,
            fnd.	next_letter_code	  =	upd_rec.	next_letter_code	,
            fnd.	last_letter_date	  =	upd_rec.	last_letter_date	,
            fnd.	last_action	        =	upd_rec.	last_action	,
            fnd.	last_action_date	  =	upd_rec.	last_action_date	,
            fnd.	last_pymt_date	    =	upd_rec.	last_pymt_date	,
            fnd.	permanent_msg	      =	upd_rec.	permanent_msg	,
            fnd.	perm_msg_date	      =	upd_rec.	perm_msg_date	,
            fnd.	perm_msg_rep_id	    =	upd_rec.	perm_msg_rep_id	,
            fnd.	worked_flag       	=	upd_rec.	worked_flag	,
     ...
     where  fnd.	wfs_customer_no	      =	upd_rec.	wfs_customer_no and
            ...
            fnd.	entered_coll_date	    =	upd_rec.	entered_coll_date
