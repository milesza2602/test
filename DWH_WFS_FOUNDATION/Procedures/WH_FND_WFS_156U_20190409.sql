--------------------------------------------------------
--  DDL for Procedure WH_FND_WFS_156U_20190409
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_WFS_FOUNDATION"."WH_FND_WFS_156U_20190409" (
...
BEGIN
 ...
 --       NVL(fnd.monthly_insurance_amount	,0) <>	upd_rec.	monthly_insurance_amount	OR
        ...
        nvl(fnd. poi_required_no_of_months, 0) <> upd_rec. poi_required_no_of_months
