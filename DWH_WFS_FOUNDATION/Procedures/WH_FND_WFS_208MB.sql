--------------------------------------------------------
--  DDL for Procedure WH_FND_WFS_208MB
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_WFS_FOUNDATION"."WH_FND_WFS_208MB" (p_forall_limit in integer,p_success out boolean) as
...
----            fnd.	tot_due_enter_coll	=	mer_rec.	tot_due_enter_coll	,
