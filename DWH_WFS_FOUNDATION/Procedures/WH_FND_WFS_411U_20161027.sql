--------------------------------------------------------
--  DDL for Procedure WH_FND_WFS_411U_20161027
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_WFS_FOUNDATION"."WH_FND_WFS_411U_20161027" (p_forall_limit in integer,p_success out boolean) as
   ...
   loop
     ...
     where  fnd.cli_offer_no = upd_rec.cli_offer_no and
        ( 
         ...
         nvl(fnd. source_of_proof_of_income, 0) <> upd_rec. source_of_proof_of_income
