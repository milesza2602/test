--------------------------------------------------------
--  DDL for Procedure WH_FND_WFS_302U
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_WFS_FOUNDATION"."WH_FND_WFS_302U" (p_forall_limit in integer,p_success out boolean) as

--**************************************************************************************************
--  Date:        March 2013
--  Author:      Alastair de Wet
--  Purpose:     Create wfs_crd_acc_mly fact table in the foundation layer
--               with input ex staging table from ABSA.
--  Tables:      Input  - stg_absa_crd_acc_mly_cpy
--               Output - fnd_wfs_crd_acc_mly
...
g_information_date                 stg_absa_crd_acc_mly_cpy.information_date%type;  
g_account_number                   stg_absa_crd_acc_mly_cpy.account_number%type; 
   
g_date               date          := trunc(sysdate);

L_MESSAGE            SYS_DWH_ERRLOG.LOG_TEXT%TYPE;
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_FND_WFS_302U';
l_name               sys_dwh_log.log_name%type                 := dwh_constants.vc_log_name_rtl_facts;
l_system_name        sys_dwh_log.log_system_name%type          := dwh_constants.vc_log_system_name_rtl_fnd;
l_script_name        sys_dwh_log.log_script_name%type          := dwh_constants.vc_log_script_rtl_fnd_facts;
l_procedure_name     sys_dwh_log.log_procedure_name%type       := l_module_name;
L_TEXT               SYS_DWH_LOG.LOG_TEXT%TYPE ;
l_description        sys_dwh_log_summary.log_description%type  := 'LOAD WFS CARD ACC MLY EX ABSA';
l_process_type       sys_dwh_log_summary.log_process_type%type := dwh_constants.vc_log_process_type_n;

cursor stg_dup is
select * from stg_absa_crd_acc_mly_cpy
where (information_date,
account_number)
in
(select information_date,
account_number
from stg_absa_crd_acc_mly_cpy 
...
cursor c_stg_absa_crd_acc_mly is
select /*+ FULL(stg) parallel (stg,4)  full(fnd) parallel (fnd,4)  */  
              stg.*
      from    stg_absa_crd_acc_mly_cpy stg,
              fnd_wfs_crd_acc_mly fnd
...
for dupp_record in stg_dup
   loop
    ...
    if  dupp_record.information_date        = g_information_date and
        ...
        update stg_absa_crd_acc_mly_cpy stg
...
begin
 --     g_rec_out.last_updated_date         := g_date;
      ...
      insert /*+ APPEND parallel (fnd,4) */ into fnd_wfs_crd_acc_mly fnd
      SELECT /*+ FULL(cpy)  parallel (cpy,4) */
            	...
            	cpy.	debit_interest_income_amt	,
            	cpy.	debit_interest_rate	,
            	...
            	cpy.	interest_rate_cash_withdrawal	,
            	cpy.	interest_rate_on_petrol	,
            	cpy.	interest_rate_on_purchases	,
            	...
            	cpy.	total_indebtedness_amt	,
            	cpy.	transfer_account_number	,
            	cpy.	transfer_to_legal_orig_date	,
            	cpy.	triad_sub_product_code	,
              g_date as last_updated_date
      from   stg_absa_crd_acc_mly_cpy cpy
      where  not exists 
      (select /*+ nl_aj */ * from fnd_wfs_crd_acc_mly 
...
for upd_rec in c_stg_absa_crd_acc_mly
   loop
     update fnd_wfs_crd_acc_mly fnd 
     set    fnd.	information_date	              =	upd_rec.	information_date	,
            ...
            fnd.	credit_interest_rate	          =	upd_rec.	credit_interest_rate	,
            ...
            fnd.	debit_interest_income_amt	      =	upd_rec.	debit_interest_income_amt	,
            fnd.	debit_interest_rate	            =	upd_rec.	debit_interest_rate	,
            ...
            fnd.	interest_rate_cash_withdrawal 	=	upd_rec.	interest_rate_cash_withdrawal	,
            fnd.	interest_rate_on_petrol       	=	upd_rec.	interest_rate_on_petrol	,
            fnd.	interest_rate_on_purchases	    =	upd_rec.	interest_rate_on_purchases	,
            ...
            fnd.	site_code_sourced	              =	upd_rec.	site_code_sourced	,
            ...
            fnd.	total_indebtedness_amt	        =	upd_rec.	total_indebtedness_amt	,
     ...
     where  fnd.	information_date                =	upd_rec.	information_date and
            ...
            nvl(fnd.credit_interest_rate	          ,0) <>	upd_rec.	credit_interest_rate	or
            ...
            nvl(fnd.debit_interest_income_amt     	,0) <>	upd_rec.	debit_interest_income_amt	or
            nvl(fnd.debit_interest_rate	            ,0) <>	upd_rec.	debit_interest_rate	or
            ...
            nvl(fnd.interest_rate_cash_withdrawal	  ,0) <>	upd_rec.	interest_rate_cash_withdrawal	or
            nvl(fnd.interest_rate_on_petrol       	,0) <>	upd_rec.	interest_rate_on_petrol	or
            nvl(fnd.interest_rate_on_purchases	    ,0) <>	upd_rec.	interest_rate_on_purchases	or
            ...
            nvl(fnd.site_code_sourced	              ,0) <>	upd_rec.	site_code_sourced	or
            ...
            nvl(fnd.total_indebtedness_amt	        ,0) <>	upd_rec.	total_indebtedness_amt	or
            ...
            nvl(fnd.triad_sub_product_code	        ,0) <>	upd_rec.	triad_sub_product_code
            );         
...
begin
      ...
      insert /*+ APPEND parallel (hsp,2) */ into stg_absa_crd_acc_mly_hsp hsp
...
--    update stg_absa_crd_acc_mly_cpy
