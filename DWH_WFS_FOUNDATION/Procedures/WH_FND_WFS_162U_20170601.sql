--------------------------------------------------------
--  DDL for Procedure WH_FND_WFS_162U_20170601
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_WFS_FOUNDATION"."WH_FND_WFS_162U_20170601" (
...
BEGIN
  ...
  LOOP    
    ...
    AND ( 
      ...
      nvl(fnd. dea_statement_received_ind, 0) <> upd_rec. dea_statement_received_ind
