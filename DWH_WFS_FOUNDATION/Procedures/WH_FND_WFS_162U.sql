--------------------------------------------------------
--  DDL for Procedure WH_FND_WFS_162U
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_WFS_FOUNDATION"."WH_FND_WFS_162U" (
...
--  2016-09-29 N Chauhan - added 6 more fields for NCA Queue.
--  2017-03-30 N Chauhan - Additional fields for Data Revitalisation project.
--  2017-06-23 S Ismail - Additional fields added and CONSENT_CONSENT_ID amended to CONSENT_CONSENT_ID_1
--                        & consent_opt_out_all_channels amended to consent_opt_out_all_channels_1
--
--
...
BEGIN
  ...
  SELECT
    /*+ FULL(cpy)  parallel (cpy,2) */
      ...
      cpy. store_type ,
      cpy. document_received_ind ,
      cpy. poi_channel_source ,
      cpy. sub_status ,
      cpy. poi_decline_reason ,
      cpy. discrepancy_period_ind ,
      cpy. dea_statement_received_ind ,
      cpy. residential_address_line2 ,
      cpy. postal_address_line_2 ,
      cpy. poi_bank_det_bank_name_oth ,
      cpy. consent_consent_id_1 ,
      cpy. consent_opt_out_all_channels_1 ,
      cpy. sec_card_use_for_credit_card ,
      cpy. sec_card_use_for_store_card ,
      cpy. sec_card_use_for_personal_loan ,
      cpy. sec_card_relationship ,
      cpy. uti_product_code ,
      cpy. uti_reference ,
      cpy. uti_status ,
      cpy. uti_messages,
      cpy. consent_consent_id_2 ,
      cpy. consent_opt_out_all_channels_2
...
BEGIN
  ...
  LOOP    
    ...
    SET 
      ...
      fnd. store_type = upd_rec. store_type ,
      fnd. document_received_ind = upd_rec. document_received_ind ,
      fnd. poi_channel_source = upd_rec. poi_channel_source ,
      fnd. sub_status = upd_rec. sub_status ,
      fnd. poi_decline_reason = upd_rec. poi_decline_reason ,
      fnd. discrepancy_period_ind = upd_rec. discrepancy_period_ind ,
      fnd. dea_statement_received_ind = upd_rec. dea_statement_received_ind ,
      fnd. residential_address_line2 = upd_rec. residential_address_line2 ,
      fnd. postal_address_line_2 = upd_rec. postal_address_line_2 ,
      fnd. poi_bank_det_bank_name_oth = upd_rec. poi_bank_det_bank_name_oth ,
      fnd. consent_consent_id_1 = upd_rec. consent_consent_id_1 ,
      fnd. consent_opt_out_all_channels_1 = upd_rec. consent_opt_out_all_channels_1 ,
      fnd. sec_card_use_for_credit_card = upd_rec. sec_card_use_for_credit_card ,
      fnd. sec_card_use_for_store_card = upd_rec. sec_card_use_for_store_card ,
      fnd. sec_card_use_for_personal_loan = upd_rec. sec_card_use_for_personal_loan ,
      fnd. sec_card_relationship = upd_rec. sec_card_relationship ,
      fnd. uti_product_code = upd_rec. uti_product_code ,
      fnd. uti_reference = upd_rec. uti_reference ,
      fnd. uti_status = upd_rec. uti_status ,
      fnd. uti_messages = upd_rec. uti_messages,
      fnd. consent_consent_id_2 = upd_rec. consent_consent_id_2 ,
      fnd. consent_opt_out_all_channels_2 = upd_rec. consent_opt_out_all_channels_2
    ...
    AND ( 
      ...
      NVL(fnd. partner_identity_no,0) <> upd_rec. partner_identity_no OR
      nvl(fnd. store_type, 0) <> upd_rec. store_type OR
      nvl(fnd. document_received_ind, 0) <> upd_rec. document_received_ind OR
      nvl(fnd. poi_channel_source, 0) <> upd_rec. poi_channel_source OR
      nvl(fnd. sub_status, 0) <> upd_rec. sub_status OR
      nvl(fnd. poi_decline_reason, 0) <> upd_rec. poi_decline_reason OR
      nvl(fnd. discrepancy_period_ind, 0) <> upd_rec. discrepancy_period_ind OR
      nvl(fnd. dea_statement_received_ind, 0) <> upd_rec. dea_statement_received_ind or
      nvl(fnd. residential_address_line2, 0) <> upd_rec. residential_address_line2 OR
      nvl(fnd. postal_address_line_2, 0) <> upd_rec. postal_address_line_2 OR
      nvl(fnd. poi_bank_det_bank_name_oth, 0) <> upd_rec. poi_bank_det_bank_name_oth OR
      nvl(fnd. consent_consent_id_1, 0) <> upd_rec. consent_consent_id_1 OR
      nvl(fnd. consent_opt_out_all_channels_1, 0) <> upd_rec. consent_opt_out_all_channels_1 OR
      nvl(fnd. sec_card_use_for_credit_card, 0) <> upd_rec. sec_card_use_for_credit_card OR
      nvl(fnd. sec_card_use_for_store_card, 0) <> upd_rec. sec_card_use_for_store_card OR
      nvl(fnd. sec_card_use_for_personal_loan, 0) <> upd_rec. sec_card_use_for_personal_loan OR
      nvl(fnd. sec_card_relationship, 0) <> upd_rec. sec_card_relationship OR
      nvl(fnd. uti_product_code, 0) <> upd_rec. uti_product_code OR
      nvl(fnd. uti_reference, 0) <> upd_rec. uti_reference OR
      nvl(fnd. uti_status, 0) <> upd_rec. uti_status OR
      nvl(fnd. uti_messages, 0) <> upd_rec. uti_messages OR
      nvl(fnd. consent_consent_id_2, 0) <> upd_rec. consent_consent_id_2 OR
      nvl(fnd. consent_opt_out_all_channels_2, 0) <> upd_rec. consent_opt_out_all_channels_2
