--------------------------------------------------------
--  DDL for Procedure WH_FND_WFS_316U_FIXNC
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_WFS_FOUNDATION"."WH_FND_WFS_316U_FIXNC" (p_forall_limit in integer,p_success out boolean) as
...
--  2018-10-22 - N Chauhan - block out index handling for reprocessing lost 4mths chunk of data.
--
--
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_FND_WFS_316U_FIXNC';
