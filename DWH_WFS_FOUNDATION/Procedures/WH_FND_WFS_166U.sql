--------------------------------------------------------
--  DDL for Procedure WH_FND_WFS_166U
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_WFS_FOUNDATION"."WH_FND_WFS_166U" (
...
AS
  ...
  -- Tables:      Input  - stg_om4_pa_expense_cpy
  ...
  g_pa_c_id stg_om4_pa_expense_cpy.credit_applications_id%type;
  g_pa_p_id stg_om4_pa_expense_cpy.personal_applicant_id%type;
  g_pa_exp_id stg_om4_pa_expense_cpy.expense_id%type;
...
IS
  ...
  IS
    SELECT
      ...
      stg.*
    FROM stg_om4_pa_expense_cpy stg,
...
BEGIN
  ...
  LOOP
    IF dupp_record.credit_applications_id = g_pa_c_id and
      ...
      UPDATE stg_om4_pa_expense_cpy stg
...
BEGIN
  ...
  FROM stg_om4_pa_expense_cpy cpy
  WHERE NOT EXISTS
    (SELECT
      /*+ nl_aj */
      *
