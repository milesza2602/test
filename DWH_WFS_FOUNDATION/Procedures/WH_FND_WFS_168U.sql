--------------------------------------------------------
--  DDL for Procedure WH_FND_WFS_168U
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_WFS_FOUNDATION"."WH_FND_WFS_168U" (p_forall_limit in integer,p_success out boolean) as
...
--  2018-10-26 S Ismail - added T101_PREDICTED_INCOME and T102_PREDICTED_INCOME fields for POI project
...
begin
 --     g_rec_out.last_updated_date         := g_date;
      ...
      SELECT /*+ FULL(cpy)  parallel (cpy,2) */
         ...
         cpy. t101_predicted_income ,
         cpy. t102_predicted_income
...
for upd_rec in c_stg
   loop
     ...
     set    
         ...
         fnd. t101_predicted_income = upd_rec. t101_predicted_income ,
         fnd. t102_predicted_income = upd_rec. t102_predicted_income
     ...
     where  fnd.consumer_no = upd_rec.consumer_no and
        ( 
         ...
         nvl(fnd. my01_curr_mthly_install, 0) <> upd_rec. my01_curr_mthly_install OR
         nvl(fnd. t101_predicted_income, 0) <> upd_rec. t101_predicted_income OR
         nvl(fnd. t102_predicted_income, 0) <> upd_rec. t102_predicted_income
...
--**************************************************************************************************
    ...
    l_text := 'LOAD TABLE: '||'FND_WFS_OM4_CR_SCORES' ;
    dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);
