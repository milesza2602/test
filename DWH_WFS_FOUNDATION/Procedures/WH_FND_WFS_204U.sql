--------------------------------------------------------
--  DDL for Procedure WH_FND_WFS_204U
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_WFS_FOUNDATION"."WH_FND_WFS_204U" (p_forall_limit in integer,p_success out boolean) as
...
--  Tables:      Input  - stg_vsn_cust_perf_60dy_cpy
...
g_wfs_customer_no    stg_vsn_cust_perf_60dy_cpy.wfs_customer_no%type; 
g_product_code_no    stg_vsn_cust_perf_60dy_cpy.product_code_no%type; 
g_run_date           stg_vsn_cust_perf_60dy_cpy.run_date%type; 
g_wfs_account_no     stg_vsn_cust_perf_60dy_cpy.wfs_account_no%type;
...
cursor stg_dup is
select * from stg_vsn_cust_perf_60dy_cpy
...
product_code_no,
run_date
from stg_vsn_cust_perf_60dy_cpy 
...
select /*+ FULL(cpy)  parallel (4) */  
              cpy.*
      from    stg_vsn_cust_perf_60dy_cpy cpy,
...
for dupp_record in stg_dup
   loop
    ...
    if  dupp_record.wfs_customer_no   = g_wfs_customer_no and
        ...
        update stg_vsn_cust_perf_60dy_cpy stg
