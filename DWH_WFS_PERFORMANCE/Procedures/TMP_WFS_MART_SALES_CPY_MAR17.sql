--------------------------------------------------------
--  DDL for Procedure TMP_WFS_MART_SALES_CPY_MAR17
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_WFS_PERFORMANCE"."TMP_WFS_MART_SALES_CPY_MAR17" (p_forall_limit in integer,p_success out boolean) as

--**************************************************************************************************
--  Description  WFS Sales/Rewards take-on data copy -  for MARCH 2017 data
--  Date:        2017-03-22
...
--
--  Maintenance:
--  2017-04-04 N Chauhan - created - based on TMP_WFS_MART_SALES_CPY
--  2017-04-04 N Chauhan - fully re-load RWDS tables after TRUNCATE
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'TMP_WFS_MART_SALES_CPY_MAR17';
l_name               sys_dwh_log.log_name%type                 := dwh_constants.vc_log_name_rtl_facts;
l_system_name        sys_dwh_log.log_system_name%type          := dwh_constants.vc_log_system_name_rtl_prf;
l_script_name        sys_dwh_log.log_script_name%type          := dwh_constants.vc_log_script_rtl_prf_facts;
l_procedure_name     sys_dwh_log.log_procedure_name%type       := l_module_name;
L_TEXT               SYS_DWH_LOG.LOG_TEXT%TYPE ;
l_description        sys_dwh_log_summary.log_description%type  := 'WFS Sales/Rewards Marts takeon data copy - Mar2017';
...
--WFS_MART_SALES_BASKET_ITEM
    ...
    l_text :=  'Dropping Index I10_WFS_MT_SALES_BSK_ITM, I20_WFS_MT_SALES_BSK_ITM';
    dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);


    EXECUTE immediate('DROP INDEX DWH_WFS_PERFORMANCE.I10_WFS_MT_SALES_BSK_ITM');
    EXECUTE immediate('DROP INDEX DWH_WFS_PERFORMANCE.I20_WFS_MT_SALES_BSK_ITM');

    l_text :=  'Copying data to WFS_MART_SALES_BASKET_ITEM ex TMP_MART_SALES_BASKET_ITEM';
    dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);


insert /*+ APPEND parallel(i,8) */
into DWH_WFS_PERFORMANCE.WFS_MART_SALES_BASKET_ITEM i
(TRAN_DATE
,LOCATION_NO
,TILL_NO
,TRAN_NO
...
,DIFF_REWARDS_PERCENTAGE
,LAST_UPDATED_DATE
from w7071603.TMP_MART_SALES_BASKET_ITEM t;
    ...
    EXECUTE immediate('CREATE INDEX DWH_WFS_PERFORMANCE.I10_WFS_MT_SALES_BSK_ITM ON '||
           'DWH_WFS_PERFORMANCE.WFS_MART_SALES_BASKET_ITEM (CUSTOMER_NO)NOlogging '||
           'TABLESPACE '||l_tablespace||' PARALLEL (degree 16)');
    ...
    EXECUTE immediate('CREATE INDEX DWH_WFS_PERFORMANCE.I20_WFS_MT_SALES_BSK_ITM ON '||
           'DWH_WFS_PERFORMANCE.WFS_MART_SALES_BASKET_ITEM (TRAN_NO)NOlogging '||
           'TABLESPACE '||l_tablespace||' PARALLEL (degree 16)');
    ...
    l_text :=  'Dropping Index I10_WFS_MART_SALES_MLY, I20_WFS_MART_SALES_MLY';
    dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);
    ...
    l_text :=  'Truncating WFS_MART_SALES_RWDS_BU_MLY';
    dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);

    EXECUTE immediate('TRUNCATE TABLE DWH_WFS_PERFORMANCE.WFS_MART_SALES_RWDS_BU_MLY');
...
/***--truncate table  *###########***/
    ...
    l_text :=  'truncating WFS_MART_SALES_RWDS_CUST_MLY';
    dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);

    EXECUTE immediate('TRUNCATE TABLE DWH_WFS_PERFORMANCE.WFS_MART_SALES_RWDS_CUST_MLY');
...
end tmp_wfs_mart_sales_cpy_mar17;
