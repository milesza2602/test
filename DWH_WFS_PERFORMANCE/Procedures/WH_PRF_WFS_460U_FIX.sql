--------------------------------------------------------
--  DDL for Procedure WH_PRF_WFS_460U_FIX
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_WFS_PERFORMANCE"."WH_PRF_WFS_460U_FIX" 
...
--  2018-11-26 N Chauhan - "FIX" version of proc created to run for specific days passed as parameters.
--
--
...
l_module_name        sys_dwh_errlog.log_procedure_name%TYPE    := 'WH_PRF_WFS_460U_FIX';
