--------------------------------------------------------
--  DDL for Procedure WH_PRF_WFS_658U_FIX
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_WFS_PERFORMANCE"."WH_PRF_WFS_658U_FIX" 
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_WFS_658U_FIX';
