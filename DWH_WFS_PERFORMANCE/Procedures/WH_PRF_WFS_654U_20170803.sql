--------------------------------------------------------
--  DDL for Procedure WH_PRF_WFS_654U_20170803
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_WFS_PERFORMANCE"."WH_PRF_WFS_654U_20170803" (p_forall_limit in integer,p_success out boolean) as
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_WFS_654U';
...
--/***TEMP override to resume from some other day: */   g_date_start:= to_date(to_char(add_months(sysdate,-1),'YYYYMM')||'06', 'YYYYMMDD' );
