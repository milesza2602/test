--------------------------------------------------------
--  DDL for Procedure WH_FND_RP_001U_TEST
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_FOUNDATION"."WH_FND_RP_001U_TEST" 
...
--  Tables:      Input  - stg_rp_loc_item_dy_catlg_cpy
...
g_rec_in             stg_rp_loc_item_dy_catlg_cpy%rowtype;
g_found              boolean;
g_valid              boolean;
g_count              integer       :=  0;
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_FND_RP_001U';
...
type stg_array is table of stg_rp_loc_item_dy_catlg_cpy%rowtype;
...
type staging_array1 is table of stg_rp_loc_item_dy_catlg_cpy.sys_source_batch_id%type
                                                       index by binary_integer;
type staging_array2 is table of stg_rp_loc_item_dy_catlg_cpy.sys_source_sequence_no%type
                                                       index by binary_integer;
...
cursor c_stg_rp_loc_item_dy_catlg is
   select *
   from stg_rp_loc_item_dy_catlg_cpy
...
begin
    forall i in a_staging1.first .. a_staging1.last
       save exceptions
       update stg_rp_loc_item_dy_catlg_cpy
