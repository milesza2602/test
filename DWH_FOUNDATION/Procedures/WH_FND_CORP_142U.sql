--------------------------------------------------------
--  DDL for Procedure WH_FND_CORP_142U
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_FOUNDATION"."WH_FND_CORP_142U" (p_forall_limit in integer,p_success out boolean) as
...
--
--  Maintenance:
--  04 Aug 2016  Add 2 new columns (SUPPLIER_SHELF_LIFE and FROM_LOC_NO) to both STG and FND tables.  Ref: BK04Aug2016
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_FND_CORP_142U';
...
begin
   ...
   g_rec_out.SUPPLIER_SHELF_LIFE             := g_rec_in.SUPPLIER_SHELF_LIFE;       -- BK04Aug2016
   g_rec_out.FROM_LOC_NO                     := g_rec_in.FROM_LOC_NO;               -- BK04Aug2016
...
begin
    ...
    forall i in a_tbl_update.first .. a_tbl_update.last
       ...
       set    to_loc_no                       = a_tbl_update(i).to_loc_no,
              ...
              SUPPLIER_SHELF_LIFE             = a_tbl_update(i).SUPPLIER_SHELF_LIFE,        -- BK04Aug2016
              FROM_LOC_NO                     = a_tbl_update(i).FROM_LOC_NO,                -- BK04Aug2016
