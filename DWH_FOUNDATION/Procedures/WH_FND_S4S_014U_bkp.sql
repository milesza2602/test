--------------------------------------------------------
--  DDL for Procedure WH_FND_S4S_014U_bkp
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_FOUNDATION"."WH_FND_S4S_014U_bkp" (p_forall_limit in integer,p_success out boolean) as
...
FROM (SELECT DISTINCT 
 ...
 --  and stg.workgroup_id in (9000190,9000198)
