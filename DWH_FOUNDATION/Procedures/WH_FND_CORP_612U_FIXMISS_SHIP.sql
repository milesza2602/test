--------------------------------------------------------
--  DDL for Procedure WH_FND_CORP_612U_FIXMISS_SHIP
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_FOUNDATION"."WH_FND_CORP_612U_FIXMISS_SHIP" 
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_FND_CORP_612U_FIXMISS_SHIP';
...
END WH_FND_CORP_612U_FIXMISS_SHIP;
