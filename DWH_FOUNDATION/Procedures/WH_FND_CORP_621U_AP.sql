--------------------------------------------------------
--  DDL for Procedure WH_FND_CORP_621U_AP
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_FOUNDATION"."WH_FND_CORP_621U_AP" (p_forall_limit in integer,p_success out boolean) as
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_FND_CORP_621U_AP';
...
cursor c_fnd_rtl_loc_item_dy_rms_wac is
 ...
 SELECT  DL.LOCATION_NO,
         ...
         ALLOC.RELEASE_DATE,
         MAX(LI.WAC) WAC
 FROM    FND_RTL_ALLOCATION_AP  ALLOC,
         DIM_ITEM DI,
         DIM_LOCATION DL,
...
begin
    ...
    l_text := 'LOAD OF FND_RTL_ALLOCATION_AP EX FND_RTL_LOC_ITEM_DY_RMS_WAC STARTED AT '||
