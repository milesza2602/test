--------------------------------------------------------
--  DDL for Procedure WH_FND_CORP_654U
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_FOUNDATION"."WH_FND_CORP_654U" (p_forall_limit in integer,p_success out boolean) as
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_FND_CORP_654U';
...
type tbl_array_i is table of fnd_deal_actual_detail%rowtype index by binary_integer;
type tbl_array_u is table of fnd_deal_actual_detail%rowtype index by binary_integer;
...
begin
    forall i in a_tbl_insert.first .. a_tbl_insert.last
       save exceptions
       insert into fnd_deal_actual_detail values a_tbl_insert(i);
