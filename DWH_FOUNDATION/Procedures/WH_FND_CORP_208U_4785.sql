--------------------------------------------------------
--  DDL for Procedure WH_FND_CORP_208U_4785
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_FOUNDATION"."WH_FND_CORP_208U_4785" 
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_FND_CORP_208U';
...
cursor c_stg_rms_sale is
   select *
   from stg_rms_sale_arc
  where sys_load_date > '1 oct 2012'
   and post_date = '15 oct 2012'
   and location_no <> 512
   and item_no = 2080540000003
