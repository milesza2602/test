--------------------------------------------------------
--  DDL for Procedure WH_FND_CORP_613U_HIST
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_FOUNDATION"."WH_FND_CORP_613U_HIST" (
...
AS
  ...
  l_module_name sys_dwh_errlog.log_procedure_name%type := 'WH_FND_CORP_613U_HIST';
...
--------------------------------------------------------------------------------------
    ...
    INSERT /*+ append */ 
/*    INTO DWH_FOUNDATION.TEMP_ALLOC_SHIP4
          WITH selalloc AS
                    (SELECT
                      /*+ materialize */
/*                      alloc_no
