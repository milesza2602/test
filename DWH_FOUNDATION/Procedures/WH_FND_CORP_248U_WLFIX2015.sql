--------------------------------------------------------
--  DDL for Procedure WH_FND_CORP_248U_WLFIX2015
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_FOUNDATION"."WH_FND_CORP_248U_WLFIX2015" (
...
AS
  ...
  --  Tables:      Input  - dwh_foundation.wl_stg_l4l
  ...
  l_description sys_dwh_log_summary.log_description%type   := 'fix LIKE FOR LIKE TRANSACTION EX FINANCE SPREADSHEET';
  l_process_type sys_dwh_log_summary.log_process_type%type := dwh_constants.vc_log_process_type_n;
  -- For input bulk collect --
type stg_array
IS
  TABLE OF dwh_foundation.wl_stg_l4l%rowtype;
...
type staging_array1
IS
  TABLE OF dwh_foundation.wl_stg_l4l.sys_source_batch_id%type INDEX BY binary_integer;
type staging_array2
IS
  TABLE OF dwh_foundation.wl_stg_l4l.sys_source_sequence_no%type INDEX BY binary_integer;
  ...
  WITH selext AS
    ...
    from dwh_foundation.wl_stg_l4l a,
...
WHEN OTHERS THEN
  ...
  ************************************************************************************************************
  ...
  update dwh_foundation.wl_stg_l4l
...
END WH_FND_CORP_248U_WLFIX2015;
