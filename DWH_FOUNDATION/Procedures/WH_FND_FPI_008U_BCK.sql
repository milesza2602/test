--------------------------------------------------------
--  DDL for Procedure WH_FND_FPI_008U_BCK
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_FOUNDATION"."WH_FND_FPI_008U_BCK" -- STORE PROC CHANGE
   ...
   select /*+ PARALLEL(CPY1,8) */ cpy1.*
    ...
    where  cpy1.supplier_no   = sup.supplier_no and
          ...
          (sys_source_batch_id, sys_source_sequence_no,
           ...
           section_type, attribute_code,attribute_value
	  ) in
...
--**************************************************************************************************
  ...
  exception
      ...
      when others then
       ...
       p_success := false;
       RAISE;
end wh_fnd_fpi_008u_bck                                                                                             -- STORE PROC CHANGE 
;
