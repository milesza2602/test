--------------------------------------------------------
--  DDL for Procedure WH_FND_FPI_002U_BCK
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_FOUNDATION"."WH_FND_FPI_002U_BCK" -- STORE PROC CHANGE
...
begin
    ...
    where  cpy1.supplier_no   = sup.supplier_no and
          ...
          (sys_source_batch_id, sys_source_sequence_no,
           ...
           ingredient_id,ingredient_supplier)
       in
...
--**************************************************************************************************
  ...
  exception
      ...
      when others then
       ...
       p_success := false;
       RAISE;
end wh_fnd_fpi_002u_bck                                                                                             -- STORE PROC CHANGE 
;
