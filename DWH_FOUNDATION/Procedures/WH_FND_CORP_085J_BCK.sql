--------------------------------------------------------
--  DDL for Procedure WH_FND_CORP_085J_BCK
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_FOUNDATION"."WH_FND_CORP_085J_BCK" (p_forall_limit in integer,p_success out boolean) as
-- ******************************************************************************************
--  Date:        March 2014
--  Author:      Quentin Smit
...
cursor c_fnd_zone_item is
   ...
   where  li.item_no              = di.item_no  
          ...
          --and zi.zone_no          = fs.zone_no
          --and li.item_no          = fs.item_no
          --and fs.to_loc_no        = dl.location_no
          --and fs.supplier_no      = zi.supplier_no
...
--   g_rec_out.this_wk_deliv_pattern_code      := g_rec_in.reg_delivery_pattern_code;
--   g_rec_out.next_wk_deliv_pattern_code      := g_rec_in.reg_delivery_pattern_code;
