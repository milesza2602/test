--------------------------------------------------------
--  DDL for Procedure WH_FND_CORP_151U
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_FOUNDATION"."WH_FND_CORP_151U" 
...
--  Tables:      Input  - stg_jdaff_wh_plan_analysis
--               Output - fnd_jdaff_wh_plan_dy_analysis
...
--  c_  -  Prefix to cursor
--**************************************************************************************************
g_forall_limit       integer       :=  1000000;
...
g_hospital           char(1)       := 'N';
g_hospital_text      stg_jdaff_wh_plan_analysis_hsp.sys_process_msg%type;
g_rec_out            fnd_jdaff_wh_plan_dy_analysis%rowtype;
g_rec_in             stg_jdaff_wh_plan_analysis%rowtype;
g_found              boolean;
g_valid              boolean;
g_count              integer       :=  0;
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_FND_CORP_151U';
...
type stg_array is table of stg_jdaff_wh_plan_analysis%rowtype;
a_stg_input      stg_array;

-- For output arrays into bulk load forall statements --
type tbl_array_i is table of fnd_jdaff_wh_plan_dy_analysis%rowtype index by binary_integer;
type tbl_array_u is table of fnd_jdaff_wh_plan_dy_analysis%rowtype index by binary_integer;
...
type staging_array1 is table of stg_jdaff_wh_plan_analysis.sys_source_batch_id%type
                                                       index by binary_integer;
type staging_array2 is table of stg_jdaff_wh_plan_analysis.sys_source_sequence_no%type
                                                       index by binary_integer;
...
cursor c_stg_jdaff_wh_plan_analysis is
  select *
     from stg_jdaff_wh_plan_analysis_cpy
    where sys_process_code = 'N'
      order by sys_source_batch_id,sys_source_sequence_no;

 --  select a.*
 --    from stg_jdaff_wh_plan_analysis_cpy a, fnd_jdaff_dept_rollout b, dim_item c
 --   where sys_process_code = 'N'
...
begin
   ...
   insert into stg_jdaff_wh_plan_analysis_hsp values g_rec_in;
...
begin
    forall i in a_tbl_insert.first .. a_tbl_insert.last
       save exceptions
       insert into fnd_jdaff_wh_plan_dy_analysis values a_tbl_insert(i);
...
begin
    ...
    forall i in a_tbl_update.first .. a_tbl_update.last
       save exceptions
       update fnd_jdaff_wh_plan_dy_analysis
...
begin
    forall i in a_staging1.first .. a_staging1.last
       save exceptions
       update stg_jdaff_wh_plan_analysis_cpy
...
begin
   ...
   select count(1)
   into   g_count
   from   fnd_jdaff_wh_plan_dy_analysis
...
begin
    ...
    l_text := 'LOAD OF fnd_jdaff_wh_plan_dy_analysis EX JDA STARTED AT '||
...
--**************************************************************************************************
    open c_stg_jdaff_wh_plan_analysis;
    fetch c_stg_jdaff_wh_plan_analysis bulk collect into a_stg_input limit g_forall_limit;
    ...
    close c_stg_jdaff_wh_plan_analysis;
--**************************************************************************************************
