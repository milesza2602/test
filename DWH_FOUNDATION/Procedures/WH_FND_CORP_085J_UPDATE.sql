--------------------------------------------------------
--  DDL for Procedure WH_FND_CORP_085J_UPDATE
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_FOUNDATION"."WH_FND_CORP_085J_UPDATE" (p_forall_limit in integer,p_success out boolean) as
-- ******************************************************************************************
--  Date:        March 2014
--  Author:      Quentin Smit
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_FND_CORP_085J_UPD';
...
--**************************************************************************************************
procedure merge_bulk_update as
begin

 merge /*+ parallel(fli,5) */ into W6005682.FND_LOCATION_ITEM_QS fli 
    using (
       select /*+ parallel(li,5) full(li) full(dl) full(di) full(zi) */
              li.item_no,
              li.location_no,
