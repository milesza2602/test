--------------------------------------------------------
--  DDL for Procedure WH_FND_CORP_085U_BCK
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_FOUNDATION"."WH_FND_CORP_085U_BCK" (p_forall_limit in integer,p_success out boolean) as
-- ******************************************************************************************
--  Date:        Sept 2008
...
--           li.this_wk_deliv_pattern_code  is null or
           li.num_shelf_life_days        <> zi.num_shelf_life_days or
           li.num_units_per_tray         <> zi.num_units_per_tray
--           li.this_wk_deliv_pattern_code <> zi.reg_delivery_pattern_code
           );
