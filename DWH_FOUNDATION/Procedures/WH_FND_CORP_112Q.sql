--------------------------------------------------------
--  DDL for Procedure WH_FND_CORP_112Q
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_FOUNDATION"."WH_FND_CORP_112Q" 
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_FND_CORP_112Q';
...
cursor c_stg_rms_prom_location is
   select *
   from stg_rms_prom_location_cpy
