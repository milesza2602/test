--------------------------------------------------------
--  DDL for Procedure WH_FND_CORP_060U
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_FOUNDATION"."WH_FND_CORP_060U" (p_forall_limit in integer,p_success out boolean) as
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_FND_CORP_060U';
...
cursor c_stg_om_item is
   select a.* 
   from stg_om_item_cpy a, fnd_jdaff_dept_rollout b, dim_item c
