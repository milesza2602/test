--------------------------------------------------------
--  DDL for Procedure WH_FND_CORP_156U_BCK
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_FOUNDATION"."WH_FND_CORP_156U_BCK" (p_forall_limit in integer,p_success out boolean) as
...
--  Tables:      Input  - stg_jdaff_location_item
...
g_hospital           char(1)       := 'N';
g_hospital_text      stg_jdaff_location_item_hsp.sys_process_msg%type;
g_rec_out            fnd_location_item%rowtype;
g_rec_in             stg_jdaff_location_item%rowtype;
g_found              boolean;
g_valid              boolean;
g_count              integer       :=  0;
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_FND_CORP_156U';
...
type stg_array is table of stg_jdaff_location_item%rowtype;
...
type staging_array1 is table of stg_jdaff_location_item.sys_source_batch_id%type
                                                       index by binary_integer;
type staging_array2 is table of stg_jdaff_location_item.sys_source_sequence_no%type
                                                       index by binary_integer;
...
cursor c_stg_jdaff_location_item is
   select a.*
   from stg_jdaff_location_item_cpy a, fnd_jdaff_dept_rollout b, dim_item c
   where sys_process_code = 'N'
     and a.item_no = c.item_no
     and b.department_no = c.department_no
     and b.department_live_ind = 'Y'
     --and a.item_no = 6009000033630
...
begin
   ...
   insert into stg_jdaff_location_item_hsp values g_rec_in;
...
begin
    forall i in a_staging1.first .. a_staging1.last
       save exceptions
       update stg_jdaff_location_item_cpy
...
--**************************************************************************************************
    open c_stg_jdaff_location_item;
    fetch c_stg_jdaff_location_item bulk collect into a_stg_input limit g_forall_limit;
    ...
    close c_stg_jdaff_location_item;
--**************************************************************************************************
