--------------------------------------------------------
--  DDL for Procedure WH_FND_CORP_211U_BCK
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_FOUNDATION"."WH_FND_CORP_211U_BCK" (p_forall_limit in integer,p_success out boolean) as
...
MERGE /*+ PARALLEL(fnd_lidfford,4) */ INTO fnd_rtl_loc_item_dy_ff_ord fnd_lidfford USING
     (
       select /*+ PARALLEL(a,4) FULL(a) */ b.location_no, c.item_no, a.post_date, sum(a.store_order1) roq_qty, 
