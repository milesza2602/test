--------------------------------------------------------
--  DDL for Procedure WH_FND_S4S_021U_TAKEON
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_FOUNDATION"."WH_FND_S4S_021U_TAKEON" (p_forall_limit in integer,p_success out boolean) as


--**************************************************************************************************
--  Date:        July 2014
--  Author:      Wendy lyttle
--  Purpose:     Update Hyperion S4S business_unit week information for Scheduling for Staff(S4S)
--
--  Tables:      AIT load - STG_S4S_HYP_BU_WK
--               Input    - STG_S4S_HYP_BU_WK_CPY
--               Output   - FND_S4S_HYP_LOC_BU_WK
...
g_hospital           char(1)       := 'N';
g_hospital_text      DWH_FOUNDATION.STG_S4S_HYP_BU_WK_hsp.sys_process_msg%type;
g_rec_out            DWH_FOUNDATION.FND_S4S_HYP_LOC_BU_WK%rowtype;
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_FND_S4S_021U_TAKEON';
l_name               sys_dwh_log.log_name%type                 := dwh_constants.vc_log_name_rtl_md;
l_system_name        sys_dwh_log.log_system_name%type          := dwh_constants.vc_log_system_name_rtl_fnd;
l_script_name        sys_dwh_log.log_script_name%type          := dwh_constants.vc_log_script_rtl_fnd_md;
l_procedure_name     sys_dwh_log.log_procedure_name%type       := l_module_name;
l_text               sys_dwh_log.log_text%type ;
l_description        sys_dwh_log_summary.log_description%type  := 'LOAD THE Hyperion S4S business_unit week data ex S4S';
l_process_type       sys_dwh_log_summary.log_process_type%type := dwh_constants.vc_log_process_type_n;

  -- For output arrays into bulk load forall statements --
type tbl_array_i is table of DWH_FOUNDATION.FND_S4S_HYP_LOC_BU_WK%rowtype index by binary_integer;
type tbl_array_u is table of DWH_FOUNDATION.FND_S4S_HYP_LOC_BU_WK%rowtype index by binary_integer;
...
type staging_array1 is table of DWH_FOUNDATION.STG_S4S_HYP_BU_WK_cpy.sys_source_batch_id%type
                                                       index by binary_integer;
type staging_array2 is table of DWH_FOUNDATION.STG_S4S_HYP_BU_WK_cpy.sys_source_sequence_no%type
                                                       index by binary_integer;
...
SELECT SYS_SOURCE_BATCH_ID,
          ...
          STG.s4s_business_unit_no stg_s4s_business_unit_no,
...
g_rec_in                   c_STG_S4S_HYP_BU_WK%rowtype;
-- For input bulk collect --
type stg_array is table of c_STG_S4S_HYP_BU_WK%rowtype;
...
begin
   ...
   g_rec_out.s4s_business_unit_no :=  g_rec_in.STG_s4s_business_unit_no;
  ...
  g_rec_out.last_updated_date               := g_date;
   ...
   if G_REC_IN.fe_s4s_business_unit_no IS NULL then
     g_hospital      := 'Y';
     g_hospital_text := 's4s_business_unit_no NOT FOUND';
     return;
   end if;
...
begin
   ...
   g_rec_in.sys_process_msg       := g_hospital_text;
      ...
      insert into dwh_foundation.STG_S4S_HYP_BU_WK_hsp values
   ( g_rec_in.SYS_SOURCE_BATCH_ID
     ...
     ,g_rec_in.STG_s4s_business_unit_no
...
begin
    forall i in a_tbl_insert.first .. a_tbl_insert.last
       save exceptions
       insert into DWH_FOUNDATION.FND_S4S_HYP_LOC_BU_WK  values a_tbl_insert(i);
...
' '||a_tbl_insert(g_error_index).fin_year_no||' '||a_tbl_insert(g_error_index).fin_year_no||
' '||' INS';
...
begin
    ...
    forall i in a_tbl_update.first .. a_tbl_update.last
       save exceptions
       update DWH_FOUNDATION.FND_S4S_HYP_LOC_BU_WK
       set
...
begin
   ...
   select count(1)
      into   v_count
   from   DWH_FOUNDATION.FND_S4S_HYP_LOC_BU_WK
...
begin
    ...
    l_text := 'LOAD THE HYP_BU_WK data ex S4S STARTED AT '||
...
--**************************************************************************************************
    open c_STG_S4S_HYP_BU_WK;
    fetch c_STG_S4S_HYP_BU_WK bulk collect into a_stg_input limit g_forall_limit;
...
--**************************************************************************************************
    ...
    l_text := 'Running GATHER_TABLE_STATS ON FND_S4S_HYP_LOC_BU_WK';
    dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);
     DBMS_STATS.gather_table_stats ('DWH_FOUNDATION',
                                   'FND_S4S_HYP_LOC_BU_WK', DEGREE => 8);
