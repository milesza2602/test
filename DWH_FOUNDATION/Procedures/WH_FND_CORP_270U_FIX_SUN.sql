--------------------------------------------------------
--  DDL for Procedure WH_FND_CORP_270U_FIX_SUN
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_FOUNDATION"."WH_FND_CORP_270U_FIX_SUN" (p_forall_limit in integer,p_success out boolean) as


--**************************************************************************************************
-- datafix  - copy from wh_fnd_corp_270
-- fix SUNDAY data, batch=SUN
--
--**************************************************************************************************
--  Date:        AUGUST 2014
--  Author:      Wendy Lyttle
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_FND_CORP_270U_FIX_SUN';
