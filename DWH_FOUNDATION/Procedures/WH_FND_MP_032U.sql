--------------------------------------------------------
--  DDL for Procedure WH_FND_MP_032U
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_FOUNDATION"."WH_FND_MP_032U" (p_forall_limit in integer,p_success out boolean) as
...
--
--  Tables:      Input  - stg_mp_location_cpy
--               Output - fnd_location
--
...
-- Change:    Rename Store_size_format to Store_size_cluster and Store_cluster to Customer_classification
--
--  Naming conventions
--  g_  -  Global variable
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_FND_MP_032U';
...
type stg_array is table of stg_mp_location%rowtype;
...
type staging_array1 is table of stg_mp_location.sys_source_batch_id%type
                                                       index by binary_integer;
type staging_array2 is table of stg_mp_location.sys_source_sequence_no%type
                                                       index by binary_integer;
...
cursor c_mp_location is
   select *
   from stg_mp_location_cpy
...
begin
    ...
    g_rec_out.customer_classification       := nvl(g_rec_in.customer_classification,'0');
    g_rec_out.store_size_cluster            := nvl(g_rec_in.store_size_cluster,'0');
...
begin
   ...
   insert into stg_mp_location_hsp values g_rec_in;
...
begin
    ...
    forall i in a_tbl_update.first .. a_tbl_update.last
       save exceptions
       update fnd_location
       set    customer_classification     = a_tbl_update(i).customer_classification,
...
--**************************************************************************************************
    open c_mp_location;
    fetch c_mp_location bulk collect into a_stg_input limit g_forall_limit;
