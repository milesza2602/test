--------------------------------------------------------
--  DDL for Procedure WH_FND_CORP_841U_95
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_FOUNDATION"."WH_FND_CORP_841U_95" (p_forall_limit in integer,p_success out boolean)
as
--**************************************************************************************************
--  Date:        April 2010
--  Author:      W Lyttle
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_FND_CORP_841U_95';
