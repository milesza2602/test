--------------------------------------------------------
--  DDL for Procedure WH_FND_CORP_144U_16052016
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_FOUNDATION"."WH_FND_CORP_144U_16052016" (p_forall_limit in integer,p_success out boolean) as
      ...
      when others then
       ...
       for i in 1 .. g_error_count loop
          ...
          l_message := dwh_constants.vc_err_lb_loop||i||
                       ...
                       ' '||a_tbl_insert(g_error_index).dc_loc_no;
          dwh_log.record_error(l_module_name,sqlcode,l_message);
       end loop;
       raise;
...
begin
    ...
    forall i in a_tbl_update.first .. a_tbl_update.last
       ...
       where  location_no                 = a_tbl_update(i).location_no and
              ...
              dc_loc_no                   = a_tbl_update(i).dc_loc_no ;
      ...
      when others then
       ...
       for i in 1 .. g_error_count loop
          ...
          l_message := dwh_constants.vc_err_lb_loop||i||
                       ...
                       ' '||a_tbl_update(g_error_index).dc_loc_no;
          dwh_log.record_error(l_module_name,sqlcode,l_message);
       end loop;
       raise;
   ...
   if a_count_i > 0 and not g_found then
      ...
      loop
         if a_tbl_insert(i).location_no   = g_rec_out.location_no and
            ...
            a_tbl_insert(i).dc_loc_no     = g_rec_out.dc_loc_no then
            g_found := TRUE;
         end if;
      end loop;
   end if;
...
begin
    ...
    l_text := 'LOAD OF fnd_loc_item_jdaff_wh_plan EX OM STARTED AT '||
