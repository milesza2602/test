--------------------------------------------------------
--  DDL for Procedure WH_FND_CORP_270U_FIX_SAT
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_FOUNDATION"."WH_FND_CORP_270U_FIX_SAT" (p_forall_limit in integer,p_success out boolean) as


--**************************************************************************************************
-- datafix  - copy from wh_fnd_corp_270
-- fix SATURDAY data, batch=sat
--
--**************************************************************************************************
--  Date:        AUGUST 2014
--  Author:      Wendy Lyttle
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_FND_CORP_270U_FIX_SAT';
...
type tbl_array_i is table of fnd_rtl_loc_item_dy_stk_ch_FIX%rowtype index by binary_integer;
type tbl_array_u is table of fnd_rtl_loc_item_dy_stk_ch_FIX%rowtype index by binary_integer;
...
begin
    forall i in a_tbl_insert.first .. a_tbl_insert.last
       save exceptions
       insert into fnd_rtl_loc_item_dy_stk_ch_FIX values a_tbl_insert(i);
...
begin
    ...
    forall i in a_tbl_update.first .. a_tbl_update.last
       save exceptions
       update fnd_rtl_loc_item_dy_stk_ch_FIX
...
begin
    ...
    l_text := 'Roll OF fnd_rtl_loc_item_dy_stk_ch_FIX to tomorrow STARTED AT '||
