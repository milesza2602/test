--------------------------------------------------------
--  DDL for Procedure WH_FND_CORP_210U
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_FOUNDATION"."WH_FND_CORP_210U" (p_forall_limit in integer,p_success out boolean,p_from_loc_no in integer,p_to_loc_no in integer) as
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_FND_CORP_210U'|| p_from_loc_no;
...
cursor c_stg_om_loc_item_dy_ord is
  ...
  select a.*
   from stg_om_loc_item_dy_ord_cpy a, dim_item b, fnd_jdaff_dept_rollout c
