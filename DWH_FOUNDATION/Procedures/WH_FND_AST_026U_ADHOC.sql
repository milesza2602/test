--------------------------------------------------------
--  DDL for Procedure WH_FND_AST_026U_ADHOC
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_FOUNDATION"."WH_FND_AST_026U_ADHOC" 
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_FND_AST_026U_ADHOC';
...
--**************************************************************************************************
   ...
   where calendar_date = (select to_date(sysdate, 'dd mon yy') from dual);
      ...
      where  ast.style_colour_no                         = sc.style_colour_no (+)
       ...
       and   ast.fin_year_no = 2014
       and   ast.fin_week_no = 29;
