--------------------------------------------------------
--  DDL for Procedure WH_FND_S4S_014D
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_FOUNDATION"."WH_FND_S4S_014D" (p_forall_limit in integer,p_success out boolean) as
...
g_rec_out            FND_S4S_job%rowtype;
g_found              boolean;
g_date               date          := trunc(sysdate);
g_yesterday          date          := trunc(sysdate) - 1;

l_message            sys_dwh_errlog.log_text%type;
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_FND_S4S_014D';
...
type tbl_array_i is table of FND_S4S_job%rowtype index by binary_integer;
type tbl_array_u is table of FND_S4S_job%rowtype index by binary_integer;
...
begin
   ...
   forall i in a_tbl_insert.first .. a_tbl_insert.last
      save exceptions
      insert into dwh_foundation.FND_S4S_JOB values a_tbl_insert(i);
...
begin
    ...
    forall i in a_tbl_update.first .. a_tbl_update.last
       save exceptions
        update dwh_foundation.FND_S4S_JOB
...
begin
   ...
   select count(1)
     into g_count
     from dwh_foundation.FND_S4S_JOB
