--------------------------------------------------------
--  DDL for Procedure WH_FND_CORP_RECLASS_TAB_STATX
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_FOUNDATION"."WH_FND_CORP_RECLASS_TAB_STATX" 
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_FND_CORP_RECLASS_TAB_STATX';
...
begin
  DBMS_STATS.gather_table_stats ('DWH_FOUNDATION','FND_RTL_LOC_DEPT_MTH_PLAN_MP',estimate_percent=>1, DEGREE => 32);
  commit;
end;
   l_text := 'FND_RTL_LOC_DEPT_MTH_PLAN_MP completed';
   dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);
...
end WH_FND_CORP_RECLASS_TAB_STATX;
