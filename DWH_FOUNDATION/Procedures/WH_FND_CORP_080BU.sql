--------------------------------------------------------
--  DDL for Procedure WH_FND_CORP_080BU
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_FOUNDATION"."WH_FND_CORP_080BU" (p_forall_limit in integer,p_success out boolean) as
