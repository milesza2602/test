--------------------------------------------------------
--  DDL for Procedure WH_FND_CORP_211Q
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_FOUNDATION"."WH_FND_CORP_211Q" (p_forall_limit in integer,p_success out boolean) as
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_FND_CORP_211Q';
...
--MERGE /*+ parallel(fnd_lidfford,6) */ INTO W6005682.FND_RTL_LOC_ITEM_DY_FF_ORQ fnd_lidfford USING
MERGE  /*+ parallel(fnd_lidfford,2) */ INTO W6005682.FND_RTL_LOC_ITEM_DY_FF_ORQ fnd_lidfford USING
       (
      select /*+ PARALLEL(a,2) full(a)  */b.location_no, c.item_no, a.post_date, sum(a.store_order1) roq_qty, 
