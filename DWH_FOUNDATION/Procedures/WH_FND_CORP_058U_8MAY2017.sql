--------------------------------------------------------
--  DDL for Procedure WH_FND_CORP_058U_8MAY2017
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_FOUNDATION"."WH_FND_CORP_058U_8MAY2017" (p_forall_limit in integer,p_success out boolean) as
