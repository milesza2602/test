--------------------------------------------------------
--  DDL for Procedure WH_FND_CORP_084U_BCK
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_FOUNDATION"."WH_FND_CORP_084U_BCK" (p_forall_limit in integer,p_success out boolean) as
-- ******************************************************************************************
--  Date:        Sept 2008
...
cursor c_fnd_zone_item_om is
   ...
   where  fiz.zone_no             = dl.wh_fd_zone_no and
          fiz.zone_group_no       = dl.wh_fd_zone_group_no and
          dl.loc_type = 'W';       
...
--   g_rec_out.source_data_status_code         := g_rec_in.source_data_status_code;
  ...
  g_rec_in.reg_delivery_pattern_code||' '||
  g_rec_in.reg_delivery_pattern_code||' '||
