--------------------------------------------------------
--  DDL for Procedure WH_FND_MC_660U
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_FOUNDATION"."WH_FND_MC_660U" (p_forall_limit in integer,p_success out boolean) as
...
--  Tables:      Input  - STG_RMS_MC_DEAL_ACTDTL_RTV_CPY
--               Output - FND_MC_DEAL_ACTUAL_DETAIL_RTV
--  Packages:    dwh_constants, dwh_log, dwh_valid
--
--  Maintenance
--  28 jan 2011 qc4141 Key for FND_DEAL_ACTUAL_DETAIL
--                       and FND_MC_DEAL_ACTUAL_DETAIL_RTV is not unique enough
...
g_hospital           char(1)       := 'N';
g_hospital_text      STG_RMS_MC_DEAL_ACTDTL_RTV_HSP.sys_process_msg%type;
g_rec_out            FND_MC_DEAL_ACTUAL_DETAIL_RTV%rowtype;
g_rec_in             STG_RMS_MC_DEAL_ACTDTL_RTV_CPY%rowtype;
g_found              boolean;
g_valid              boolean;
g_date               date          := trunc(sysdate);

l_message            sys_dwh_errlog.log_text%type;
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_FND_MC_660U';
...
l_description        sys_dwh_log_summary.log_description%type  := 'LOAD THE FND_MC_DEAL_ACTUAL_DETAIL_RTV DATA EX RMS';
l_process_type       sys_dwh_log_summary.log_process_type%type := dwh_constants.vc_log_process_type_n;

-- For input bulk collect --
type stg_array is table of STG_RMS_MC_DEAL_ACTDTL_RTV_CPY%rowtype;
a_stg_input      stg_array;

-- For output arrays into bulk load forall statements --
type tbl_array_i is table of FND_MC_DEAL_ACTUAL_DETAIL_RTV%rowtype index by binary_integer;
type tbl_array_u is table of FND_MC_DEAL_ACTUAL_DETAIL_RTV%rowtype index by binary_integer;
...
type staging_array1 is table of STG_RMS_MC_DEAL_ACTDTL_RTV_CPY.sys_source_batch_id%type
                                                       index by binary_integer;
type staging_array2 is table of STG_RMS_MC_DEAL_ACTDTL_RTV_CPY.sys_source_sequence_no%type
                                                       index by binary_integer;
...
cursor c_STG_RMS_MC_DEAL_ACTDTL_RTV is
   select *
   from DWH_FOUNDATION.STG_RMS_MC_DEAL_ACTDTL_RTV_CPY
...
begin
   ...
   insert into STG_RMS_MC_DEAL_ACTDTL_RTV_HSP values g_rec_in;
...
begin
    forall i in a_tbl_insert.first .. a_tbl_insert.last
       save exceptions
       insert into FND_MC_DEAL_ACTUAL_DETAIL_RTV values a_tbl_insert(i);
...
begin
    ...
    forall i in a_tbl_update.first .. a_tbl_update.last
       save exceptions
       update FND_MC_DEAL_ACTUAL_DETAIL_RTV
...
begin
    forall i in a_staging1.first .. a_staging1.last
       save exceptions
       update STG_RMS_MC_DEAL_ACTDTL_RTV_CPY
...
begin
  ...
  g_found := false;
   ...
   select count(1)
   into   v_count
   from   FND_MC_DEAL_ACTUAL_DETAIL_RTV
...
begin
    ...
    l_text := 'LOAD OF FND_MC_DEAL_ACTUAL_DETAIL_RTV EX RMS STARTED AT '||
...
--**************************************************************************************************
    open c_STG_RMS_MC_DEAL_ACTDTL_RTV;
    fetch c_STG_RMS_MC_DEAL_ACTDTL_RTV bulk collect into a_stg_input limit g_forall_limit;
    ...
    close c_STG_RMS_MC_DEAL_ACTDTL_RTV;
--**************************************************************************************************
