--------------------------------------------------------
--  DDL for Procedure WH_FND_CORP_732M
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_FOUNDATION"."WH_FND_CORP_732M" (p_forall_limit in integer,p_success out boolean) as
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_FND_CORP_732M';
...
begin
 ...
 -- merge into fnd_rtl_purchase_order fnd_po using 
  MERGE /*+ parallel(fnd_po, 4) */ INTO W6005682.FND_RTL_LOC_ITEM_DY_TRCPS_BOHQ FND_PO USING 
  (
