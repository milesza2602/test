--------------------------------------------------------
--  DDL for Procedure WH_FND_CORP_144M
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_FOUNDATION"."WH_FND_CORP_144M" (p_forall_limit in integer,p_success out boolean) as
...
--               Output - FND_LOC_ITEM_JDAFF_WH_PLANQ
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_FND_CORP_144M';
...
begin
    ...
    l_text := 'LOAD OF FND_LOC_ITEM_JDAFF_WH_PLANQ EX RMS STARTED AT '||
...
--**************************************************************************************************
  ...
  merge /*+ parallel (fnd_mart,6) */ 
    into W6005682.FND_LOC_ITEM_JDAFF_WH_PLANQ fnd_mart 
    using (
    select /*+ FULL(TMP) */ 
        tmp.LOCATION_NO,
        tmp.ITEM_NO,
...
--                            'INVALID INDICATOR OR REFERENCIAL ERROR ON ITEM pr LOC',
--                            TMP.ITEM_NO,
--                            TMP.LOCATION_NO,
--                            TMP.dc_loc_no,
--                            TMP.week_1_day_1_cases,
