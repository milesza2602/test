--------------------------------------------------------
--  DDL for Procedure WH_FND_GENERIC_TRUNC_PARTN_WK
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_FOUNDATION"."WH_FND_GENERIC_TRUNC_PARTN_WK" 
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_FND_GENERIC_TRUNC_PARTN_WK';
...
end wh_fnd_generic_trunc_partn_wk;
