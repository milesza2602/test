--------------------------------------------------------
--  DDL for Procedure WH_FND_RDF_006U
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_FOUNDATION"."WH_FND_RDF_006U" (p_forall_limit in integer,p_success out boolean) as

--**************************************************************************************************
--  Date:        August 2010
--  Author:      Alfonso Joshua
--  Purpose:     Create RDF Weekly Foods Forecast level 1 table in the foundation layer
--               with input ex staging table from RDF.
--  Tables:      Input  - stg_rdf_rtl_wkfcst_l1_cpy
--               Output - fnd_rtl_li_wk_rdf_wkfcst_l2
...
g_hospital           char(1)       := 'N';
g_hospital_text      stg_rdf_rtl_wkfcst_l1_hsp.sys_process_msg%type;
g_rec_out            fnd_rtl_li_wk_rdf_wkfcst_l2%rowtype;
g_rec_in             stg_rdf_rtl_wkfcst_l1_cpy%rowtype;
g_found              boolean;
g_valid              boolean;
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_FND_RDF_006U';
...
l_description        sys_dwh_log_summary.log_description%type  := 'LOAD THE WEEKLY FOODS FORECAST EX RDF LEVEL 1';
l_process_type       sys_dwh_log_summary.log_process_type%type := dwh_constants.vc_log_process_type_n;


-- For input bulk collect --
type stg_array is table of stg_rdf_rtl_wkfcst_l1_cpy%rowtype;
a_stg_input      stg_array;

-- For output arrays into bulk load forall statements --
type tbl_array_i is table of fnd_rtl_li_wk_rdf_wkfcst_l2%rowtype index by binary_integer;
type tbl_array_u is table of fnd_rtl_li_wk_rdf_wkfcst_l2%rowtype index by binary_integer;
...
type staging_array1 is table of stg_rdf_rtl_wkfcst_l1_cpy.sys_source_batch_id%type
                                                       index by binary_integer;
type staging_array2 is table of stg_rdf_rtl_wkfcst_l1_cpy.sys_source_sequence_no%type
                                                       index by binary_integer;
...
cursor c_stg_rdf_rtl_wkfcst is
   select *
   from stg_rdf_rtl_wkfcst_l1_cpy
...
begin
   ...
   insert into stg_rdf_rtl_wkfcst_l1_hsp values g_rec_in;
...
begin
    forall i in a_tbl_insert.first .. a_tbl_insert.last
       save exceptions
       insert into fnd_rtl_li_wk_rdf_wkfcst_l2 values a_tbl_insert(i);
...
begin
    ...
    forall i in a_tbl_update.first .. a_tbl_update.last
       save exceptions
       update fnd_rtl_li_wk_rdf_wkfcst_l2
...
begin
    forall i in a_staging1.first .. a_staging1.last
       save exceptions
       update stg_rdf_rtl_wkfcst_l1_cpy
...
begin
    ...
    l_text := 'LOAD OF FND_RTL_LI_WK_RDF_WKFCST_L2 EX RDF STARTED AT '||
