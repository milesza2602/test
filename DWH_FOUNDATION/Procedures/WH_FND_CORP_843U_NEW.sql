--------------------------------------------------------
--  DDL for Procedure WH_FND_CORP_843U_NEW
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_FOUNDATION"."WH_FND_CORP_843U_NEW" 
...
--  NB !! NB !!  both wh_fnd_corp_842u and WH_FND_CORP_843U_NEW must be re-run.
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_FND_CORP_843U_NEW_'|| p_from_loc_no;
