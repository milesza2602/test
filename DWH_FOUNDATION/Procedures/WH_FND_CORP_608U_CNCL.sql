--------------------------------------------------------
--  DDL for Procedure WH_FND_CORP_608U_CNCL
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_FOUNDATION"."WH_FND_CORP_608U_CNCL" (p_forall_limit in integer,p_success out boolean) as
...
--  Tables:      Input  - stg_rms_rtl_purchase_order_cp1
...
type staging_array1 is table of stg_rms_rtl_purchase_order_cp1.sys_source_batch_id%type
                                                       index by binary_integer;
type staging_array2 is table of stg_rms_rtl_purchase_order_cp1.sys_source_sequence_no%type
                                                       index by binary_integer;
...
cursor c_stg_rms_rtl_purchase_order is
   ...
   from dwh_foundation.stg_rms_rtl_purchase_order_cp1 a, dwh_foundation.TEMP_DEL_PURCHASE_ORDER b
   WHERE 
   SYS_PROCESS_CODE = 'N'
   and
   a.po_no = b.po_no(+)
...
begin
    forall i in a_staging1.first .. a_staging1.last
       save exceptions
       update stg_rms_rtl_purchase_order_cp1
...
--    from dwh_foundation.stg_rms_rtl_purchase_order_cp1
--    ;
