--------------------------------------------------------
--  DDL for Procedure WH_FND_CORP_730U_BCK
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_FOUNDATION"."WH_FND_CORP_730U_BCK" (p_forall_limit in integer,p_success out boolean) as
