--------------------------------------------------------
--  DDL for Procedure WH_FND_CORP_620U_LOAD
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_FOUNDATION"."WH_FND_CORP_620U_LOAD" (p_forall_limit in integer,p_success out boolean) as
...
type staging_array1 is table of W6005682.STG_ALLOCATIONS.sys_source_batch_id%type
                                                       index by binary_integer;
type staging_array2 is table of W6005682.STG_ALLOCATIONS.sys_source_sequence_no%type
                                                       index by binary_integer;
...
cursor c_stg_rms_rtl_allocation is  
   ...
   from W6005682.STG_ALLOC_2016_4_1 stg
 ...
 --       where stg.sys_source_batch_id in (5726,5727,5728,5730,5731,5732,5733,5734,5735,5736,5737,5738,5739,5740,5741,5742,5743,5744,5745,5746,5747,5748,5749,5750,5752,5753)
 --         and stg.alloc_status_code = 'C'
...
begin
   ...
   g_rec_out.last_updated_date               := '01/JAN/2099';
...
begin
    forall i in a_staging1.first .. a_staging1.last
       save exceptions
       update W6005682.STG_ALLOCATIONS
