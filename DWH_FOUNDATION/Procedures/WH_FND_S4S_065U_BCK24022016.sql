--------------------------------------------------------
--  DDL for Procedure WH_FND_S4S_065U_BCK24022016
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_FOUNDATION"."WH_FND_S4S_065U_BCK24022016" (p_forall_limit in integer,p_success out boolean) as
...
--445 22 april
  ...
  where  exception_date >= g_date
 --AND sys_source_batch_id = 1213
...
END WH_FND_S4S_065U_bck24022016;
