--------------------------------------------------------
--  DDL for Procedure WH_FND_CORP_168U
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_FOUNDATION"."WH_FND_CORP_168U" (p_forall_limit in integer,p_success out boolean) as
-- *************************************************************************************************
...
--**************************************************************************************************
  ...
  -- SS Added 7 new columns 07/may/2015
   ...
   dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);
   -- Table is partitioned on trading date, new data is in the future.
   DWH_PERFORMANCE.WH_PRF_GENERIC_STATS(l_success, 'DWH_FOUNDATION','FND_JDAFF_ST_PLAN_ANALYSIS_DY', 21, 'future'); -- Stats for trading dates up to 21 days in the future
