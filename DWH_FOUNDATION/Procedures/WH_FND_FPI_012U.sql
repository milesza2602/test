--------------------------------------------------------
--  DDL for Procedure WH_FND_FPI_012U
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_FOUNDATION"."WH_FND_FPI_012U" -- STORE PROC CHANGE
...
--/*+ first_rows parallel(fnd) parallel(upd_rec) */
   ...
   update set                                                                                                      -- COLUNM NAME CHANGE 
            ...
            fnd.category_selection              =   mer_rec.category_selection,
            fnd.category_comment                =   mer_rec.category_comment,
  ...
  values                                                                                                           -- COLUNM NAME CHANGE 
          (         
           ...
           mer_rec.category_selection,
           mer_rec.category_comment,
           mer_rec.foot_note,
...
--**************************************************************************************************
  ...
  exception
      ...
      when others then
       ...
       p_success := false;
       RAISE;
end wh_fnd_fpi_012u                                                                                             -- STORE PROC CHANGE 
;
