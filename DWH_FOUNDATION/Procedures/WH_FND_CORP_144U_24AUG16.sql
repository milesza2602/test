--------------------------------------------------------
--  DDL for Procedure WH_FND_CORP_144U_24AUG16
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_FOUNDATION"."WH_FND_CORP_144U_24AUG16" (p_forall_limit in integer,p_success out boolean) as
...
begin
   ...
   -- BK05Jul2016 (start) Remove all zero checks for each week day & replace with 1 to 1 assignment ...
