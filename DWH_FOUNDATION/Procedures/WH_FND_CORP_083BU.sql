--------------------------------------------------------
--  DDL for Procedure WH_FND_CORP_083BU
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_FOUNDATION"."WH_FND_CORP_083BU" (p_forall_limit in integer,p_success out boolean) as
