--------------------------------------------------------
--  DDL for Procedure WH_FND_S4S_014E_OLD
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_FOUNDATION"."WH_FND_S4S_014E_OLD" 
...
l_description        sys_dwh_log_summary.log_description%type  := 'LOAD S4S labour role';
...
--     WHERE FND.labour_role_id in (1000192,1000217,1000243,1000271,1000316,1000390,1000410,1000413,1000414)
  GROUP BY FND.labour_role_id,
           FND.labour_role_name,
           FND.s4s_business_unit_no,
           FND.s4s_business_unit_name,
           FND.workgroup_id,
           ...
           FND.effective_from_date,
           FND.effective_to_date
  ORDER BY FND.labour_role_id,fnd.job_id,fnd.jobgroup_id,fnd.workgroup_id,fnd.s4s_business_unit_no;
