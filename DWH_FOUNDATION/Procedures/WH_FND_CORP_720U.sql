--------------------------------------------------------
--  DDL for Procedure WH_FND_CORP_720U
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_FOUNDATION"."WH_FND_CORP_720U" 
...
cursor c_stg_allpoints_stockown is
   ...
   WHERE SYS_PROCESS_CODE = 'N'
         --         AND (ORDER_NO >= 3000000 OR ORDER_NO IS NULL) -- INTERIM MEASURE TO PREVENT OLD PO'S BEING OVERWRITTEN WITH RE-CYLCLED PO'S
