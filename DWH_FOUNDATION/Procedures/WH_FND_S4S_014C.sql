--------------------------------------------------------
--  DDL for Procedure WH_FND_S4S_014C
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_FOUNDATION"."WH_FND_S4S_014C" (p_forall_limit in integer,p_success out boolean) as
...
g_rec_out            FND_S4S_jobgroup%rowtype;
g_found              boolean;
g_date               date          := trunc(sysdate);
g_yesterday          date          := trunc(sysdate) - 1;

l_message            sys_dwh_errlog.log_text%type;
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_FND_S4S_014C';
...
type tbl_array_i is table of FND_S4S_jobgroup%rowtype index by binary_integer;
type tbl_array_u is table of FND_S4S_jobgroup%rowtype index by binary_integer;
...
begin
 ...
 --  dbms_output.put_line('local_bulk_insert'||l_message);


   forall i in a_tbl_insert.first .. a_tbl_insert.last
      save exceptions
      insert into FND_S4S_jobgroup values a_tbl_insert(i);
...
begin
 ...
 --dbms_output.put_line('local_bulk_update'||l_message);

    forall i in a_tbl_update.first .. a_tbl_update.last
       save exceptions
        update FND_S4S_jobgroup
...
--**************************************************************************************************
  ...
  exception
      ...
      when others then
       ...
       --dbms_output.put_line('Message XY'||l_message||SQLERRM);
       raise;
