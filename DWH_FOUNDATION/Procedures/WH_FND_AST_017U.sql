--------------------------------------------------------
--  DDL for Procedure WH_FND_AST_017U
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_FOUNDATION"."WH_FND_AST_017U" 
                                                                                (p_forall_limit in integer,p_success out boolean) as
--**************************************************************************************************
--  Date:        November 2012
--  Author:      A Joshua
--  Purpose:     Load Assort Approved Plan from foundation level.
--  Tables:      Input  - stg_ast_loc_sc_act_wk_cpy
--               Output - stg_ast_loc_sc_act_wk_hsp
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_FND_AST_017U';
...
begin
   ...
   l_text := 'LOAD OF STG_AST_LOC_SC_ACT_WK_HSP STARTED AT '||
...
--**************************************************************************************************
   ...
   dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);
      ...
      insert /*+ APPEND  */ into stg_ast_loc_sc_act_wk_hsp ast
      select /*+ full (apln) parallel (apln,2) */
             ...
             apln.store_count
      from   stg_ast_loc_sc_act_wk_cpy apln,
