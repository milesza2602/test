--------------------------------------------------------
--  DDL for Procedure WH_FND_S4S_014U_SS_ARC
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_FOUNDATION"."WH_FND_S4S_014U_SS_ARC" 
...
--  DIM Tables:  Input  - STG_S4S_LABOUR_HIERARCHY_ARC
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_FND_S4S_014U_SS_ARC';
...
type staging_array1 is table of STG_S4S_LABOUR_HIERARCHY_ARC.sys_source_batch_id%type index by binary_integer;
type staging_array2 is table of STG_S4S_LABOUR_HIERARCHY_ARC.sys_source_sequence_no%type index by binary_integer;
...
(SELECT S4S_BUSINESS_UNIT_NO,EFFECTIVE_FROM_DATE,COUNT(*)
    FROM (SELECT DISTINCT 
              ...
              EFFECTIVE_FROM_DATE                       
          FROM STG_S4S_LABOUR_HIERARCHY_ARC
          )
...
FROM STG_S4S_LABOUR_HIERARCHY_ARC STG,
     SELBU SB,
     SELWG SWG, 
     SELJG SJG, 
     SELJ SJ, 
