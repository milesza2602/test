--------------------------------------------------------
--  DDL for Procedure WH_FND_CORP_145U_ORIG
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_FOUNDATION"."WH_FND_CORP_145U_ORIG" (p_forall_limit in integer,
...
g_rec_out            fnd_loc_item_dy_ff_ord%rowtype;
...
type tbl_array_i is table of fnd_loc_item_dy_ff_ord%rowtype index by binary_integer;
type tbl_array_u is table of fnd_loc_item_dy_ff_ord%rowtype index by binary_integer;
...
cursor c_stg_cam_location_item is
   select a.*
     from stg_cam_location_item_cpy a, fnd_jdaff_dept_rollout b, dim_item c
...
begin
    ...
    l_text := 'LOAD OF fnd_loc_item_dy_ff_ord EX OM STARTED AT '||
...
--**************************************************************************************************
    ...
    l_text := 'BATCH DATE BEING PROCESSED IS:- '||g_date||' '||p_from_loc_no||' '||p_to_loc_no;
    dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);
