--------------------------------------------------------
--  DDL for Procedure WH_FND_CORP_270X
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_FOUNDATION"."WH_FND_CORP_270X" (p_forall_limit in integer,p_success out boolean) as
...
--
--  Maintenance: NB!! THIS PROGRAM COULD BE TURNED INTO ONE EASY 'INSERT INTO SELECT FROM' TO IMPROVE PERFORMANCE
