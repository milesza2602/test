--------------------------------------------------------
--  DDL for Procedure WH_FND_S4S_014E_SS
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_FOUNDATION"."WH_FND_S4S_014E_SS" 
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_FND_S4S_014E_SS';
...
begin
   ...
   forall i in a_tbl_insert.first .. a_tbl_insert.last
      save exceptions
      insert into fnd_s4s_labour_role_ss values a_tbl_insert(i);
