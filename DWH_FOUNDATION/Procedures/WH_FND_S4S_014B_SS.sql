--------------------------------------------------------
--  DDL for Procedure WH_FND_S4S_014B_SS
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_FOUNDATION"."WH_FND_S4S_014B_SS" (p_forall_limit in integer,p_success out boolean) as
...
g_rec_out            FND_S4S_workgroup_ss%rowtype;
g_found              boolean;
g_date               date          := trunc(sysdate);
g_yesterday          date          := trunc(sysdate) - 1;

l_message            sys_dwh_errlog.log_text%type;
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_FND_S4S_014B_SS';
...
type tbl_array_i is table of FND_S4S_workgroup_ss%rowtype index by binary_integer;
type tbl_array_u is table of FND_S4S_workgroup_ss%rowtype index by binary_integer;
...
begin
   ...
   forall i in a_tbl_insert.first .. a_tbl_insert.last
      save exceptions
      insert into FND_S4S_workgroup_ss values a_tbl_insert(i);
