--------------------------------------------------------
--  DDL for Procedure WH_FND_MC_656U
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_FOUNDATION"."WH_FND_MC_656U" (p_forall_limit in integer,p_success out boolean) as


--**************************************************************************************************
--  Date:        February 2009
--  Author:      Alfonso Joshua
--  Purpose:     Load deal_accrual detail information in the foundation layer
--               with input ex staging table from RMS.
--  Tables:      Input  - STG_RMS_MC_DEAL_ACCRUAL_DY_cpy
--               Output - FND_MC_DEAL_LOC_ITEM_DY
--  Packages:    dwh_constants, dwh_log, dwh_valid
--
--  Maintenance:
--  feb 2018 multicurrency
--
...
g_hospital           char(1)       := 'N';
g_hospital_text      STG_RMS_MC_DEAL_ACCRUAL_DY_hsp.sys_process_msg%type;
g_rec_out            FND_MC_DEAL_LOC_ITEM_DY%rowtype;
g_rec_in             STG_RMS_MC_DEAL_ACCRUAL_DY_cpy%rowtype;
g_found              boolean;
g_valid              boolean;
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_FND_MC_656U';
...
l_description        sys_dwh_log_summary.log_description%type  := 'LOAD THE FND_MC_DEAL_LOC_ITEM_DY DATA EX RMS';
l_process_type       sys_dwh_log_summary.log_process_type%type := dwh_constants.vc_log_process_type_n;


-- For input bulk collect --
type stg_array is table of STG_RMS_MC_DEAL_ACCRUAL_DY_cpy%rowtype;
a_stg_input      stg_array;

-- For output arrays into bulk load forall statements --
type tbl_array_i is table of FND_MC_DEAL_LOC_ITEM_DY%rowtype index by binary_integer;
type tbl_array_u is table of FND_MC_DEAL_LOC_ITEM_DY%rowtype index by binary_integer;
...
type staging_array1 is table of STG_RMS_MC_DEAL_ACCRUAL_DY_cpy.sys_source_batch_id%type
                                                       index by binary_integer;
type staging_array2 is table of STG_RMS_MC_DEAL_ACCRUAL_DY_cpy.sys_source_sequence_no%type
                                                       index by binary_integer;
...
cursor c_STG_RMS_MC_DEAL_ACCRUAL_DY is
   select *
   from STG_RMS_MC_DEAL_ACCRUAL_DY_cpy
...
begin
   ...
   g_rec_out.accrual_qty                     := g_rec_in.accrual_qty;
   g_rec_out.accrual_cost_LOCAL              := g_rec_in.accrual_cost_LOCAL;
  g_rec_out.accrual_cost_OPR                 := g_rec_in.accrual_cost_OPR;
--   g_rec_out.billing_cost                    := null;
...
begin
   ...
   insert into STG_RMS_MC_DEAL_ACCRUAL_DY_hsp values g_rec_in;
...
begin
    forall i in a_tbl_insert.first .. a_tbl_insert.last
       save exceptions
       insert into FND_MC_DEAL_LOC_ITEM_DY values a_tbl_insert(i);
...
begin
    ...
    forall i in a_tbl_update.first .. a_tbl_update.last
       save exceptions
       update FND_MC_DEAL_LOC_ITEM_DY
       set    accrual_qty                     = a_tbl_update(i).accrual_qty,
              accrual_cost_LOCAL              = a_tbl_update(i).accrual_cost_LOCAL,
              accrual_cost_OPR                = a_tbl_update(i).accrual_cost_OPR,
...
begin
    forall i in a_staging1.first .. a_staging1.last
       save exceptions
       update STG_RMS_MC_DEAL_ACCRUAL_DY_cpy
...
begin
    ...
    l_text := 'LOAD OF FND_MC_DEAL_LOC_ITEM_DY EX RMS STARTED AT '||
...
--**************************************************************************************************
    open c_STG_RMS_MC_DEAL_ACCRUAL_DY;
    fetch c_STG_RMS_MC_DEAL_ACCRUAL_DY bulk collect into a_stg_input limit g_forall_limit;
    ...
    close c_STG_RMS_MC_DEAL_ACCRUAL_DY;
--**************************************************************************************************
