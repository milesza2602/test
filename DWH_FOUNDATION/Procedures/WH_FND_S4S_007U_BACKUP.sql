--------------------------------------------------------
--  DDL for Procedure WH_FND_S4S_007U_BACKUP
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_FOUNDATION"."WH_FND_S4S_007U_BACKUP" (p_forall_limit in integer,p_success out boolean) as
...
--                        based upon employee_id and absence_start_date
--
--                The delete lists are used in the rollups as well.
--                ie. FND_S4S_ABSNCE_EMP_DY_del_list
--
...
-- Delete Process
--**************************************************************************************************
 -- delete_fnd; -- NEED THIS FOR UPDATING SCHEDULE DATA
