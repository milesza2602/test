--------------------------------------------------------
--  DDL for Procedure WH_FND_AST_020U
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_FOUNDATION"."WH_FND_AST_020U" 
...
--               Output - fnd_ast_geo_grd_sc_wk_apln
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_FND_AST_020U';
...
begin
   ...
   l_text := 'LOAD OF FND_AST_GEO_GRD_SC_WK_APLN STARTED AT '||
...
--**************************************************************************************************
   ...
   where calendar_date = (select to_date(sysdate, 'dd mon yy') from dual);
      ...
      insert /*+ APPEND parallel (ast,2) */ into fnd_ast_geo_grd_sc_wk_apln ast
