--------------------------------------------------------
--  DDL for Procedure WH_FND_MP_030U
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_FOUNDATION"."WH_FND_MP_030U" 
...
l_description        sys_dwh_log_summary.log_description%type  := 'LOAD THE MP CLEANSED APS';
...
begin
   ...
   l_text := 'LOAD OF FND_MP_LOC_SC_WK STARTED AT '||
