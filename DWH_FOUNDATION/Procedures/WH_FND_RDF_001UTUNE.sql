--------------------------------------------------------
--  DDL for Procedure WH_FND_RDF_001UTUNE
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_FOUNDATION"."WH_FND_RDF_001UTUNE" 
...
g_rec_in             stg_rdf_rtl_dyfcst_cpy%rowtype;
g_found              boolean;
g_valid              boolean;
...
type stg_array is table of stg_rdf_rtl_dyfcst_cpy%rowtype;
...
begin
   ...
   insert into stg_rdf_rtl_dyfcst_hsp values g_rec_in;
