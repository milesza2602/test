--------------------------------------------------------
--  DDL for Procedure WH_FND_CORP_085U_MERGE
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_FOUNDATION"."WH_FND_CORP_085U_MERGE" (p_forall_limit in integer,p_success out boolean) as
-- ******************************************************************************************
--  Date:        Sept 2008
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_FND_CORP_085U_M';
l_name               sys_dwh_log.log_name%type                 := dwh_constants.vc_log_name_rtl_md;
l_system_name        sys_dwh_log.log_system_name%type          := dwh_constants.vc_log_system_name_rtl_fnd;
l_script_name        sys_dwh_log.log_script_name%type          := dwh_constants.vc_log_script_rtl_fnd_md;
l_procedure_name     sys_dwh_log.log_procedure_name%type       := l_module_name;
l_text               sys_dwh_log.log_text%type ;
l_description        sys_dwh_log_summary.log_description%type  := 'UPDATE location_item ex zone_item_om EX FOUNDATION';
...
begin
  ...
  select  /*+ parallel(li,4) parallel(zi,4) */
          ...
          zi.reg_delivery_pattern_code
   from   fnd_location_item li,
          dim_location dl,
          dim_item di,
          fnd_zone_item_om zi
   where  li.item_no          = di.item_no  and
          li.location_no      = dl.location_no and
          li.item_no          = zi.item_no and
          zi.zone_no          = dl.wh_fd_zone_no and
          zi.zone_group_no    = dl.wh_fd_zone_group_no and
