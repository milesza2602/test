--------------------------------------------------------
--  DDL for Procedure WH_FND_AST_024U_ADHOC
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_FOUNDATION"."WH_FND_AST_024U_ADHOC" 
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_FND_AST_024U_ADHOC';
...
--**************************************************************************************************
   ...
   dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);
      ...
      where apln.style_colour_no              = sc.style_colour_no
       ...
       and  apln.fin_week_no                  = 29
       and  apln.plan_type_no                 = 63;
