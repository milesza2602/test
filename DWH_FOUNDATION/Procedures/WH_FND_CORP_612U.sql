--------------------------------------------------------
--  DDL for Procedure WH_FND_CORP_612U
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_FOUNDATION"."WH_FND_CORP_612U" 
...
WITH selext1 AS
            ...
            WHERE (to_loc_no      between p_from_loc_no and p_to_loc_no
            OR (P_FROM_LOC_NO = 0 AND TO_LOC_NO IS NULL))
