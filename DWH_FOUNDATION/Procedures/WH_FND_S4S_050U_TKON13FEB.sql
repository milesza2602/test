--------------------------------------------------------
--  DDL for Procedure WH_FND_S4S_050U_TKON13FEB
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_FOUNDATION"."WH_FND_S4S_050U_TKON13FEB" (
...
g_recs_deleted      integer       :=  0;
  ...
  l_module_name sys_dwh_errlog.log_procedure_name%type := 'WH_FND_S4S_050U_TKON13FEB';
...
begin
     ...
     with selstg
            as (select /*+ full(a) parallel(a,6) */ distinct employee_id, trunc(SHIFT_CLOCK_IN) SHIFT_CLOCK_IN from STG_S4S_EMP_LOC_JOB_SHED_cpy a where sys_source_batch_id = g_sys_source_batch_id)
