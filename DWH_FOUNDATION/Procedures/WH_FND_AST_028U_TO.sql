--------------------------------------------------------
--  DDL for Procedure WH_FND_AST_028U_TO
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_FOUNDATION"."WH_FND_AST_028U_TO" (p_forall_limit in integer,p_success out boolean) as
--**************************************************************************************************
--  Date:        May 2012
--  Author:      A Joshua
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_FND_AST_028U_TO';
...
--**************************************************************************************************
   ...
   dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);
      ...
      insert /*+ APPEND parallel (ast,8) */ into FND_AST_LOC_SC_WK AST
      select /*+ full (X) parallel (X,8) */
           X.STORE,
             ...
             X.GRADE,
             X.last_updated
       from W7012356.TAKEON_AST_STORE_SC_WK X, 
            FND_AST_LEV1_DIFF1_REAL B
       where X.STYLE_COLOUR = B.STYLE_COLOUR_NO
         and B.RANGE_IND = 1;
