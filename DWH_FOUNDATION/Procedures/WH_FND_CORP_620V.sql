--------------------------------------------------------
--  DDL for Procedure WH_FND_CORP_620V
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_FOUNDATION"."WH_FND_CORP_620V" 
...
--               Output - W6005682.fnd_rtl_allocationQ
...
g_rec_out            W6005682.fnd_rtl_allocationQ%rowtype;
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_FND_CORP_620V_'|| p_from_loc_no;
...
type tbl_array_i is table of W6005682.fnd_rtl_allocationQ%rowtype index by binary_integer;
type tbl_array_u is table of W6005682.fnd_rtl_allocationQ%rowtype index by binary_integer;
...
--  fnd_vr as (
--select vr.item_no, vr.vat_region_no, vr.vat_rate_perc 
...
--   )
   ...
   from stg_rms_rtl_allocation_cpy stg
        ...
        left outer join dim_location_VATWL dl      on stg.wh_no      = dl.location_no
        left outer join dim_location_VATWL dl2     on stg.to_loc_no  = dl2.location_no
...
begin
    forall i in a_tbl_insert.first .. a_tbl_insert.last
       save exceptions
       insert into W6005682.fnd_rtl_allocationQ values a_tbl_insert(i);
...
begin
    ...
    forall i in a_tbl_update.first .. a_tbl_update.last
       save exceptions
       update W6005682.fnd_rtl_allocationQ
...
-- Check to see if item is present on table and update/insert accordingly
   select count(1)
   into   g_count
   from   W6005682.fnd_rtl_allocationQ
...
--**************************************************************************************************
   ...
   if a_count > g_forall_limit then
      local_bulk_insert;
      local_bulk_update;
      --local_bulk_staging_update;      REMEMBER TO UNCOMMENT !!
