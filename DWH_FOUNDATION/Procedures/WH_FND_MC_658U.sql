--------------------------------------------------------
--  DDL for Procedure WH_FND_MC_658U
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_FOUNDATION"."WH_FND_MC_658U" (p_forall_limit in integer,p_success out boolean) as
...
--  Tables:      Input  - STG_RMS_MC_DEAL_bill_DY_cpy
...
g_hospital           char(1)       := 'N';
g_hospital_text      STG_RMS_MC_DEAL_bill_DY_hsp.sys_process_msg%type;
g_rec_out            FND_MC_DEAL_LOC_ITEM_DY%rowtype;
g_rec_in             STG_RMS_MC_DEAL_bill_DY_cpy%rowtype;
g_found              boolean;
g_valid              boolean;
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_FND_MC_658U';
...
type stg_array is table of STG_RMS_MC_DEAL_bill_DY_cpy%rowtype;
...
type staging_array1 is table of STG_RMS_MC_DEAL_bill_DY_cpy.sys_source_batch_id%type
                                                       index by binary_integer;
type staging_array2 is table of STG_RMS_MC_DEAL_bill_DY_cpy.sys_source_sequence_no%type
                                                       index by binary_integer;
...
cursor c_STG_RMS_MC_DEAL_bill_DY is
   select *
   from STG_RMS_MC_DEAL_bill_DY_cpy
...
begin
   ...
   g_rec_out.billing_cost_LOCAL              := g_rec_in.billing_cost_LOCAL;
   g_rec_out.billing_cost_OPR                := g_rec_in.billing_cost_OPR;
...
begin
   ...
   insert into STG_RMS_MC_DEAL_bill_DY_hsp values g_rec_in;
...
begin
    ...
    forall i in a_tbl_update.first .. a_tbl_update.last
       ...
       set   
              billing_cost_LOCAL              = a_tbl_update(i).billing_cost_LOCAL,
              billing_cost_OPR                = a_tbl_update(i).billing_cost_OPR,
...
begin
    forall i in a_staging1.first .. a_staging1.last
       save exceptions
       update STG_RMS_MC_DEAL_bill_DY_cpy
...
--**************************************************************************************************
    open c_STG_RMS_MC_DEAL_bill_DY;
    fetch c_STG_RMS_MC_DEAL_bill_DY bulk collect into a_stg_input limit g_forall_limit;
    ...
    close c_STG_RMS_MC_DEAL_bill_DY;
--**************************************************************************************************
