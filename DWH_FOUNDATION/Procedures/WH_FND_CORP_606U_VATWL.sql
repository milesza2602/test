--------------------------------------------------------
--  DDL for Procedure WH_FND_CORP_606U_VATWL
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_FOUNDATION"."WH_FND_CORP_606U_VATWL" 
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_FND_CORP_606U_VATWL';
