--------------------------------------------------------
--  DDL for Procedure WH_FND_AST_011U
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_FOUNDATION"."WH_FND_AST_011U" (p_forall_limit in integer,p_success out boolean) as

-- **************************************************************************************************
--  Date:        26 April 2012
--  Author:      Alfonso Joshua
--  Purpose:     Create a dim_lev1_diff1 realised ASSORT interface
--               on the foundation layer
--
--  Tables:      Input  - stg_ast_lev1_diff1_real_cpy
--               Output - fnd_ast_lev1_diff1_real
...
g_count              number        :=  0;
g_hospital           char(1)       := 'N';
g_hospital_text      stg_ast_lev1_diff1_real_hsp.sys_process_msg%type;
g_rec_out            fnd_ast_lev1_diff1_real%rowtype;
g_rec_in             stg_ast_lev1_diff1_real_cpy%rowtype;
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_FND_AST_011U';
...
l_description        sys_dwh_log_summary.log_description%type  := 'LOAD ASSORT LEV1 DEFF1 (SC) REALISED MASTER DATA';
l_process_type       sys_dwh_log_summary.log_process_type%type := dwh_constants.vc_log_process_type_n;

-- For input bulk collect --
type stg_array is table of stg_ast_lev1_diff1_real_cpy%rowtype;
a_stg_input      stg_array;

-- For output arrays into bulk load forall statements --
type tbl_array_i is table of fnd_ast_lev1_diff1_real%rowtype index by binary_integer;
type tbl_array_u is table of fnd_ast_lev1_diff1_real%rowtype index by binary_integer;
...
type staging_array1 is table of stg_ast_lev1_diff1_real_cpy.sys_source_batch_id%type
                                                       index by binary_integer;
type staging_array2 is table of stg_ast_lev1_diff1_real_cpy.sys_source_sequence_no%type
                                                       index by binary_integer;
...
cursor c_bam_lev1_diff1 is
   select *
   from   stg_ast_lev1_diff1_real_cpy
...
begin
   ...
   g_rec_out.range_ind                     := g_rec_in.range_ind;
...
begin
   ...
   insert into stg_ast_lev1_diff1_real_hsp values g_rec_in;
...
begin
    ...
    forall i in a_tbl_insert.first .. a_tbl_insert.last
       save exceptions
       insert into fnd_ast_lev1_diff1_real values a_tbl_insert(i);
...
begin
    ...
    forall i in a_tbl_update.first .. a_tbl_update.last
       save exceptions
       update fnd_ast_lev1_diff1_real
          set into_store_fin_week_code  =  a_tbl_update(i).into_store_fin_week_code,
              ...
              range_ind                 =  a_tbl_update(i).range_ind,
...
begin
    ...
    forall i in a_staging1.first .. a_staging1.last
       save exceptions
       update stg_ast_lev1_diff1_real_cpy
...
begin
    ...
    l_text := 'LOADING BAM REALISED LEV1_DIFF1 DATA STARTED AT '|| to_char(sysdate,('dd mon yyyy hh24:mi:ss'));
    dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);
