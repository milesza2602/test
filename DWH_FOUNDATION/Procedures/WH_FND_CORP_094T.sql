--------------------------------------------------------
--  DDL for Procedure WH_FND_CORP_094T
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_FOUNDATION"."WH_FND_CORP_094T" (p_forall_limit in integer,p_success out boolean) as
...
--    UPDATE /*+ PARALLEL(A,8) */ DWH_FOUNDATION.FND_LOCATION_ITEM A 
    UPDATE /*+ PARALLEL(A,8) */ W6005682.FND_LOCATION_ITEM_TST A   --
       SET THIS_WK_CATALOG_IND = 2, 
           NEXT_WK_CATALOG_IND = 2,
           LAST_UPDATED_DATE = G_DATE
