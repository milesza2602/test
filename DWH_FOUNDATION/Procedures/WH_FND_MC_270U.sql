--------------------------------------------------------
--  DDL for Procedure WH_FND_MC_270U
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_FOUNDATION"."WH_FND_MC_270U" (p_forall_limit in integer,p_success out boolean) as
...
--               Output - fnd_mc_loc_item_dy_rms_stk_ch
...
g_count              number        :=  0;
g_rec_out            fnd_mc_loc_item_dy_rms_stk_ch%rowtype;
g_found              boolean;
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_FND_MC_270U';
...
type tbl_array_i is table of fnd_mc_loc_item_dy_rms_stk_ch%rowtype index by binary_integer;
type tbl_array_u is table of fnd_mc_loc_item_dy_rms_stk_ch%rowtype index by binary_integer;
...
cursor c_fnd_rtl_loc_item_dy_rms_stk is
   select *
   from   fnd_mc_loc_item_dy_rms_stk_ch
...
begin
    forall i in a_tbl_insert.first .. a_tbl_insert.last
       save exceptions
       insert into fnd_mc_loc_item_dy_rms_stk_ch values a_tbl_insert(i);
...
begin
    ...
    forall i in a_tbl_update.first .. a_tbl_update.last
       save exceptions
       update fnd_mc_loc_item_dy_rms_stk_ch
       set    soh_qty                         = a_tbl_update(i).soh_qty,
              ...
              soh_selling_OPR                     = a_tbl_update(i).soh_selling_OPR,
              soh_cost_OPR                        = a_tbl_update(i).soh_cost_OPR,
              sit_selling_OPR                     = a_tbl_update(i).sit_selling_OPR,
              sit_cost_OPR                        = a_tbl_update(i).sit_cost_OPR,
              inbnd_excl_cust_ord_sell_OPR        = a_tbl_update(i).inbnd_excl_cust_ord_sell_OPR,
              inbnd_excl_cust_ord_cost_OPR        = a_tbl_update(i).inbnd_excl_cust_ord_cost_OPR,
              inbnd_incl_cust_ord_sell_OPR        = a_tbl_update(i).inbnd_incl_cust_ord_sell_OPR,
              inbnd_incl_cust_ord_cost_OPR        = a_tbl_update(i).inbnd_incl_cust_ord_cost_OPR,
              clear_soh_selling_OPR               = a_tbl_update(i).clear_soh_selling_OPR,
              clear_soh_cost_OPR                  = a_tbl_update(i).clear_soh_cost_OPR                   
...
begin
    ...
    l_text := 'Roll OF fnd_mc_loc_item_dy_rms_stk_ch to tomorrow STARTED AT '||
