--------------------------------------------------------
--  DDL for Procedure WH_FND_CUST_620U
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_CUST_FOUNDATION"."WH_FND_CUST_620U" (p_forall_limit in integer,p_success out boolean) as
