-- ****** Object: Procedure W7104429.LOAD_CPY_TABLES Script Date: 04/12/2018 11:29:27 AM ******
CREATE OR REPLACE PROCEDURE "LOAD_CPY_TABLES"  (l_owner in varchar2, l_table_name in varchar2, l_pfx in varchar2) authid  current_user    --definer as  --
as
...
--   IF l_gn <> 'DWHPRD.DWHDBPRD.WOOLWORTHS.CO.ZA'
   ...
   BEGIN
      ...
      if  c > 0 then   
          l_sql_i := 'truncate table ' || l_owner || '.'|| l_table_name || ' ';      
