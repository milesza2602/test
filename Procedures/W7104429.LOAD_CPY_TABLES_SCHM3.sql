-- ****** Object: Procedure W7104429.LOAD_CPY_TABLES_SCHM3 Script Date: 04/12/2018 11:29:27 AM ******
CREATE OR REPLACE PROCEDURE "LOAD_CPY_TABLES_SCHM3"  (l_owner in varchar2, l_table_name in varchar2, l_pfx in varchar2) authid  current_user    --definer as  --
as
...
--insert into w7104429.sys_dwh_log values (localtimestamp,l_name,l_system_name,l_script_name,l_procedure_name,l_text, c, '002');
         ...
         l_sql_i := 'update W7104429.MO_'|| l_table_name || ' set SYS_PROCESS_CODE = ''N'' ';      
