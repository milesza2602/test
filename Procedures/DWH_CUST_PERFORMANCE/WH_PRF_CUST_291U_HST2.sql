--------------------------------------------------------
--  DDL for Procedure WH_PRF_CUST_291U_HST2
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_CUST_PERFORMANCE"."WH_PRF_CUST_291U_HST2" (p_forall_limit in integer,p_success out boolean) AS
...
insert /*+ APPEND Parallel(a,12) */ into dwh_cust_performance.cust_db_subgroup_month_involve a
select  /*+ Parallel(cma,8) Parallel(cmb,8) Parallel(cmc,8) Parallel(cmd,8) Full(cma) Full(cmb) Full(cmc) Full(cmd) */
          ...
          from dwh_cust_performance.cust_db_subgroup_month cma 
               left join
               dwh_cust_performance.temp_cust_sgrp_item_ranking cmb on (num_item_yr2_mn01 + num_item_yr2_mn02 + num_item_yr2_mn03 + num_item_yr2_mn04 + num_item_yr2_mn05 + num_item_yr2_mn06 + 
               ...
               left join
               dwh_cust_performance.temp_cust_sgrp_sale_ranking cmc on ROUND(sales_yr2_mn01 + sales_yr2_mn02 + sales_yr2_mn03 + sales_yr2_mn04 + sales_yr2_mn05 + sales_yr2_mn06 + 
...
select  /*+ Parallel(cma,8) Parallel(cmb,8) Parallel(cmc,8) Parallel(cmd,8) Full(cma) Full(cmb) Full(cmc) Full(cmd) */
          ...
          from dwh_cust_performance.cust_db_subgroup_month cma 
               left join
               dwh_cust_performance.temp_cust_sgrp_item_ranking cmb on (num_item_yr1_mn12 + 
                                                                        num_item_yr2_mn01 + num_item_yr2_mn02 + num_item_yr2_mn03 + num_item_yr2_mn04 + num_item_yr2_mn05 + num_item_yr2_mn06 + 
                                                                        ...
                                                                        cma.subgroup_no = cmb.subgroup_no
               left join
               dwh_cust_performance.temp_cust_sgrp_sale_ranking cmc on ROUND(sales_yr1_mn12 + 
                                                                             sales_yr2_mn01 + sales_yr2_mn02 + sales_yr2_mn03 + sales_yr2_mn04 + sales_yr2_mn05 + sales_yr2_mn06 + 
...
select  /*+ Parallel(cma,8) Parallel(cmb,8) Parallel(cmc,8) Parallel(cmd,8) Full(cma) Full(cmb) Full(cmc) Full(cmd) */
          ...
          from dwh_cust_performance.cust_db_subgroup_month cma 
               left join
               dwh_cust_performance.temp_cust_sgrp_item_ranking cmb on (num_item_yr1_mn11 + num_item_yr1_mn12 + 
                                                                        num_item_yr2_mn01 + num_item_yr2_mn02 + num_item_yr2_mn03 + num_item_yr2_mn04 + num_item_yr2_mn05 + num_item_yr2_mn06 + 
                                                                        ...
                                                                        cma.subgroup_no = cmb.subgroup_no
               left join
               dwh_cust_performance.temp_cust_sgrp_sale_ranking cmc on ROUND(sales_yr1_mn11 + sales_yr1_mn12 + 
                                                                             sales_yr2_mn01 + sales_yr2_mn02 + sales_yr2_mn03 + sales_yr2_mn04 + sales_yr2_mn05 + sales_yr2_mn06 + 
...
select  /*+ Parallel(cma,8) Parallel(cmb,8) Parallel(cmc,8) Parallel(cmd,8) Full(cma) Full(cmb) Full(cmc) Full(cmd) */
          ...
          from dwh_cust_performance.cust_db_subgroup_month cma 
               left join
               dwh_cust_performance.temp_cust_sgrp_item_ranking cmb on (num_item_yr1_mn10 + num_item_yr1_mn11 + num_item_yr1_mn12 + 
                                                                        num_item_yr2_mn01 + num_item_yr2_mn02 + num_item_yr2_mn03 + num_item_yr2_mn04 + num_item_yr2_mn05 + num_item_yr2_mn06 + 
                                                                        ...
                                                                        cma.subgroup_no = cmb.subgroup_no
               left join
               dwh_cust_performance.temp_cust_sgrp_sale_ranking cmc on ROUND(sales_yr1_mn10 + sales_yr1_mn11 + sales_yr1_mn12 + 
                                                                             sales_yr2_mn01 + sales_yr2_mn02 + sales_yr2_mn03 + sales_yr2_mn04 + sales_yr2_mn05 + sales_yr2_mn06 + 
...
select  /*+ Parallel(cma,8) Parallel(cmb,8) Parallel(cmc,8) Parallel(cmd,8) Full(cma) Full(cmb) Full(cmc) Full(cmd) */
          ...
          from dwh_cust_performance.cust_db_subgroup_month cma 
               left join
               dwh_cust_performance.temp_cust_sgrp_item_ranking cmb on (num_item_yr1_mn09 + num_item_yr1_mn10 + num_item_yr1_mn11 + num_item_yr1_mn12 + 
                                                                        num_item_yr2_mn01 + num_item_yr2_mn02 + num_item_yr2_mn03 + num_item_yr2_mn04 + num_item_yr2_mn05 + num_item_yr2_mn06 + 
                                                                        ...
                                                                        cma.subgroup_no = cmb.subgroup_no
               left join
               dwh_cust_performance.temp_cust_sgrp_sale_ranking cmc on ROUND(sales_yr1_mn09 + sales_yr1_mn10 + sales_yr1_mn11 + sales_yr1_mn12 + 
                                                                             sales_yr2_mn01 + sales_yr2_mn02 + sales_yr2_mn03 + sales_yr2_mn04 + sales_yr2_mn05 + sales_yr2_mn06 + 
...
select  /*+ Parallel(cma,8) Parallel(cmb,8) Parallel(cmc,8) Parallel(cmd,8) Full(cma) Full(cmb) Full(cmc) Full(cmd) */
          ...
          from dwh_cust_performance.cust_db_subgroup_month cma 
               left join
               dwh_cust_performance.temp_cust_sgrp_item_ranking cmb on (num_item_yr1_mn08 + num_item_yr1_mn09 + num_item_yr1_mn10 + num_item_yr1_mn11 + num_item_yr1_mn12 + 
                                                                        num_item_yr2_mn01 + num_item_yr2_mn02 + num_item_yr2_mn03 + num_item_yr2_mn04 + num_item_yr2_mn05 + num_item_yr2_mn06 + 
                                                                        ...
                                                                        cma.subgroup_no = cmb.subgroup_no
               left join
               dwh_cust_performance.temp_cust_sgrp_sale_ranking cmc on ROUND(sales_yr1_mn08 + sales_yr1_mn09 + sales_yr1_mn10 + sales_yr1_mn11 + sales_yr1_mn12 + 
                                                                             sales_yr2_mn01 + sales_yr2_mn02 + sales_yr2_mn03 + sales_yr2_mn04 + sales_yr2_mn05 + sales_yr2_mn06 + 
...
select  /*+ Parallel(cma,8) Parallel(cmb,8) Parallel(cmc,8) Parallel(cmd,8) Full(cma) Full(cmb) Full(cmc) Full(cmd) */
          ...
          from dwh_cust_performance.cust_db_subgroup_month cma 
               left join
               dwh_cust_performance.temp_cust_sgrp_item_ranking cmb on (num_item_yr1_mn07 + num_item_yr1_mn08 + num_item_yr1_mn09 + num_item_yr1_mn10 + num_item_yr1_mn11 + num_item_yr1_mn12 + 
                                                                        ...
                                                                        cma.subgroup_no = cmb.subgroup_no
               left join
               dwh_cust_performance.temp_cust_sgrp_sale_ranking cmc on ROUND(sales_yr1_mn07 + sales_yr1_mn08 + sales_yr1_mn09 + sales_yr1_mn10 + sales_yr1_mn11 + sales_yr1_mn12 + 
...
select  /*+ Parallel(cma,8) Parallel(cmb,8) Parallel(cmc,8) Parallel(cmd,8) Full(cma) Full(cmb) Full(cmc) Full(cmd) */
          ...
          from dwh_cust_performance.cust_db_subgroup_month cma 
               left join
               dwh_cust_performance.temp_cust_sgrp_item_ranking cmb on (num_item_yr1_mn06 + 
                                                                        num_item_yr1_mn07 + num_item_yr1_mn08 + num_item_yr1_mn09 + num_item_yr1_mn10 + num_item_yr1_mn11 + num_item_yr1_mn12 + 
                                                                        ...
                                                                        cma.subgroup_no = cmb.subgroup_no
               left join
               dwh_cust_performance.temp_cust_sgrp_sale_ranking cmc on ROUND(sales_yr1_mn06 + 
                                                                             sales_yr1_mn07 + sales_yr1_mn08 + sales_yr1_mn09 + sales_yr1_mn10 + sales_yr1_mn11 + sales_yr1_mn12 + 
...
select  /*+ Parallel(cma,8) Parallel(cmb,8) Parallel(cmc,8) Parallel(cmd,8) Full(cma) Full(cmb) Full(cmc) Full(cmd) */
          ...
          from dwh_cust_performance.cust_db_subgroup_month cma 
               left join
               dwh_cust_performance.temp_cust_sgrp_item_ranking cmb on (num_item_yr1_mn05 + num_item_yr1_mn06 + 
                                                                        num_item_yr1_mn07 + num_item_yr1_mn08 + num_item_yr1_mn09 + num_item_yr1_mn10 + num_item_yr1_mn11 + num_item_yr1_mn12 + 
                                                                        ...
                                                                        cma.subgroup_no = cmb.subgroup_no
               left join
               dwh_cust_performance.temp_cust_sgrp_sale_ranking cmc on ROUND(sales_yr1_mn05 + sales_yr1_mn06 + 
                                                                             sales_yr1_mn07 + sales_yr1_mn08 + sales_yr1_mn09 + sales_yr1_mn10 + sales_yr1_mn11 + sales_yr1_mn12 + 
...
select  /*+ Parallel(cma,8) Parallel(cmb,8) Parallel(cmc,8) Parallel(cmd,8) Full(cma) Full(cmb) Full(cmc) Full(cmd) */
          ...
          from dwh_cust_performance.cust_db_subgroup_month cma 
               left join
               dwh_cust_performance.temp_cust_sgrp_item_ranking cmb on (num_item_yr1_mn04 + num_item_yr1_mn05 + num_item_yr1_mn06 + 
                                                                        num_item_yr1_mn07 + num_item_yr1_mn08 + num_item_yr1_mn09 + num_item_yr1_mn10 + num_item_yr1_mn11 + num_item_yr1_mn12 + 
                                                                        ...
                                                                        cma.subgroup_no = cmb.subgroup_no
               left join
               dwh_cust_performance.temp_cust_sgrp_sale_ranking cmc on ROUND(sales_yr1_mn04 + sales_yr1_mn05 + sales_yr1_mn06 + 
                                                                             sales_yr1_mn07 + sales_yr1_mn08 + sales_yr1_mn09 + sales_yr1_mn10 + sales_yr1_mn11 + sales_yr1_mn12 + 
...
select  /*+ Parallel(cma,8) Parallel(cmb,8) Parallel(cmc,8) Parallel(cmd,8) Full(cma) Full(cmb) Full(cmc) Full(cmd) */
          ...
          from dwh_cust_performance.cust_db_subgroup_month cma 
               left join
               dwh_cust_performance.temp_cust_sgrp_item_ranking cmb on (num_item_yr1_mn03 + num_item_yr1_mn04 + num_item_yr1_mn05 + num_item_yr1_mn06 + 
                                                                        num_item_yr1_mn07 + num_item_yr1_mn08 + num_item_yr1_mn09 + num_item_yr1_mn10 + num_item_yr1_mn11 + num_item_yr1_mn12 + 
                                                                        ...
                                                                        cma.subgroup_no = cmb.subgroup_no
               left join
               dwh_cust_performance.temp_cust_sgrp_sale_ranking cmc on ROUND(sales_yr1_mn03 + sales_yr1_mn04 + sales_yr1_mn05 + sales_yr1_mn06 + 
                                                                             sales_yr1_mn07 + sales_yr1_mn08 + sales_yr1_mn09 + sales_yr1_mn10 + sales_yr1_mn11 + sales_yr1_mn12 + 
