--------------------------------------------------------
--  DDL for Procedure WH_PRF_CUST_280U
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_CUST_PERFORMANCE"."WH_PRF_CUST_280U" (p_forall_limit in integer,p_success out boolean) AS 
...
SET      DI.PRODUCT_FAMILY_CODE = 
         (SELECT  DPC.PRODUCT_FAMILY_CODE
          FROM    DWH_CUST_PERFORMANCE.DIM_LSS_PFC_CONVERT DPC
