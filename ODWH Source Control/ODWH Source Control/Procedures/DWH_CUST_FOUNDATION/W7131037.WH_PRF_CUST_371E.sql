-- ****** Object: Procedure W7131037.WH_PRF_CUST_371E Script Date: 13/03/2019 04:41:17 PM ******
CREATE OR REPLACE PROCEDURE "W7131037"."WH_PRF_CUST_371E" 
...
--**************************************************************************************************
    ...
    g_count := dwh_performance.dwh_generic_file_extract(
         q'[select sk1_item_no,
                   ...
                   item_long_desc
              from dim_item@dwhprd
             where business_unit_no in (50,51,52,54,55)]','|','DWH_FILES_OUT','e20_cust_item.txt');
