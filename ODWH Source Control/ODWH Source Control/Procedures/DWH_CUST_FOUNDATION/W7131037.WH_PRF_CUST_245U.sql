-- ****** Object: Procedure W7131037.WH_PRF_CUST_245U Script Date: 13/03/2019 04:41:17 PM ******
CREATE OR REPLACE PROCEDURE "W7131037"."WH_PRF_CUST_245U" (p_forall_limit in integer,p_success out boolean) AS
...
--   execute immediate 'truncate table W7131037.cust_db_group_mn'; ---For testing only---
--   l_text := 'Delete from table  W7131037.cust_db_group_mn' ;
--   dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);
--*********************************************************************************************
