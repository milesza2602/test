-- ****** Object: Procedure W7131037.WH_PRF_CUST_324U Script Date: 13/03/2019 04:41:17 PM ******
CREATE OR REPLACE PROCEDURE "W7131037"."WH_PRF_CUST_324U" (p_forall_limit in integer,p_success out boolean) as
...
--================================================================================================================================
    ...
    g_stmt      := 'TRUNCATE table  W7131037.DIM_CUSTOMER_STORE_OF_PREF';
    execute immediate g_stmt;
    DBMS_STATS.gather_table_stats ('W7131037','DIM_CUSTOMER_STORE_OF_PREF',estimate_percent=>1, DEGREE => 32);
    COMMIT;
     ...
     COMMIT;
--=============================================================================================================================
-- create store of preference over time for C48 and Foods
--=============================================================================================================================
...
commit;
--------------------------------------------------------------------------------
--    DBMS_STATS.gather_table_stats ('W7131037','CUSTOMER_STORE_OF_PREF',estimate_percent=>1, DEGREE => 32);
--    COMMIT;
...
order by home.location_no,
   ...
   DBMS_STATS.gather_table_stats ('W7131037','CUST_MART_HOME_AND_AWAY_BU',estimate_percent=>1, DEGREE => 32);
