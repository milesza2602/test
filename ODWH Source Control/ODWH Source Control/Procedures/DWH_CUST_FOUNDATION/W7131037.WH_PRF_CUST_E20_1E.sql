-- ****** Object: Procedure W7131037.WH_PRF_CUST_E20_1E Script Date: 13/03/2019 04:41:17 PM ******
CREATE OR REPLACE PROCEDURE "W7131037"."WH_PRF_CUST_E20_1E" 
...
--               Create Customer Extract to flat file by reading data and calling generic function
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_CUST_E20_1E';
...
--**************************************************************************************************
    ...
    g_count := dwh_performance.dwh_generic_file_extract(
         q'[select * from W7131037.temp_e20_customer
       ]','|','DWH_FILES_OUT','e20_customer.txt');
        l_text :=  'Records extracted to E20_CUSTOMER '||g_count;
    dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);
