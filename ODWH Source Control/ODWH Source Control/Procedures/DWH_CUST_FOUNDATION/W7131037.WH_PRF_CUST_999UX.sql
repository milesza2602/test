-- ****** Object: Procedure W7131037.WH_PRF_CUST_999UX Script Date: 13/03/2019 04:41:17 PM ******
CREATE OR REPLACE PROCEDURE "W7131037"."WH_PRF_CUST_999UX" 
...
g_count := 0;
    ...
    union all
     select RECTYPE||''|''||
            RECCNT||''|''||
            TRAN_SELLING
     from W7131037.cust_vmp_sales_ms_CORP_FTR','|','DWH_FILES_OUT','cust_wod_vmp.txt');
