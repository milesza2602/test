-- ****** Object: Procedure W7131037.WH_PRF_CUST_530U_WL Script Date: 13/03/2019 04:41:17 PM ******
CREATE OR REPLACE PROCEDURE "W7131037"."WH_PRF_CUST_530U_WL" (p_forall_limit in integer,p_success out boolean) AS
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_CUST_530U_WL';
...
cursor c_fnd_cust_cl_inquiry is
   ...
   where  fnd_inq.last_updated_date  = g_date and
          ...
          DSC.cl_inq_sub_cat_no      = FND_inq.inq_type_no
          ;
