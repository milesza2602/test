-- ****** Object: Procedure W7131037.WH_PRF_CUST_266TO Script Date: 13/03/2019 04:41:17 PM ******
CREATE OR REPLACE PROCEDURE "W7131037"."WH_PRF_CUST_266TO" (p_forall_limit in integer,p_success out boolean) AS
...
--**************************************************************************************************
g_avg_spend          integer       := 310;  -- Implemented this threshold in July 2015
