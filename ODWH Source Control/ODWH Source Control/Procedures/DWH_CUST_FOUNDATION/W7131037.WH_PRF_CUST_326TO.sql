-- ****** Object: Procedure W7131037.WH_PRF_CUST_326TO Script Date: 13/03/2019 04:41:17 PM ******
CREATE OR REPLACE PROCEDURE "W7131037"."WH_PRF_CUST_326TO" (p_forall_limit in integer,p_success out boolean) as
...
l_description        sys_dwh_log_summary.log_description%type  := 'ROLL UP THE CUST_BASKET_ITEM to HOME48 SUBGROUP MART';
...
order by home.location_no,
   ...
   DBMS_STATS.gather_table_stats ('W7131037','cust_mart_home_and_away_sgrp',estimate_percent=>1, DEGREE => 32);
