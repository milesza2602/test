-- ****** Object: Procedure W7131037.WH_PRF_CUST_287U Script Date: 13/03/2019 04:41:17 PM ******
CREATE OR REPLACE PROCEDURE "W7131037"."WH_PRF_CUST_287U" (p_forall_limit in integer,p_success out boolean) AS
...
l_description        sys_dwh_log_summary.log_description%type  := 'CREATE LIFE STYLE SEGMENT BASE TABLE FOR C48 ';
