-- ****** Object: Procedure W7131037.WH_PRF_CUST_253U Script Date: 13/03/2019 04:41:17 PM ******
CREATE OR REPLACE PROCEDURE "W7131037"."WH_PRF_CUST_253U" (p_forall_limit in integer,p_success out boolean) AS
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_CUST_253U';
...
l_description        sys_dwh_log_summary.log_description%type  := 'CREATE temp_cust_bu_mn_c EX cust_basket_item';
...
begin
    ...
    l_text := 'LOAD OF temp_cust_bu_mn_c EX cust_basket_item STARTED AT '||
...
--**************************************************************************************************
   ...
   execute immediate 'truncate table W7131037.temp_cust_bu_mn_c';
   l_text := 'Truncate temp table  W7131037.temp_cust_bu_mn_c' ;
   dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);

   insert into temp_cust_bu_mn_c
