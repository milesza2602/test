-- ****** Object: Procedure W7131037.WH_PRF_CUST_DB1 Script Date: 13/03/2019 04:41:17 PM ******
CREATE OR REPLACE PROCEDURE "W7131037"."WH_PRF_CUST_DB1" (p_forall_limit in integer,p_success out boolean) AS
...
--**************************************************************************************************
   ...
   execute immediate 'truncate table W7131037.temp_cust_dept_mn_1';
   l_text := 'Truncate temp table  W7131037.temp_cust_dept_mn_1';
   dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);
