-- ****** Object: Procedure W7131037.WH_PRF_CUST_290BU Script Date: 13/03/2019 04:41:17 PM ******
CREATE OR REPLACE PROCEDURE "W7131037"."WH_PRF_CUST_290BU" (p_forall_limit in integer,p_success out boolean) AS
...
--    execute immediate g_stmt;
  /* g_run_date := g_this_mn_end_date + 10;
   ...
   DBMS_STATS.gather_table_stats ('W7131037','FND_CUST_DB_DEPT_INVOLVE',estimate_percent=>1, DEGREE => 32);
   ...
   full outer join
            W7131037.fnd_cust_db_dept_involve bskt
