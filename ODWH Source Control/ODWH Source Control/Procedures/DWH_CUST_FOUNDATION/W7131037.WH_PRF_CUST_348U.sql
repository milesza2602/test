-- ****** Object: Procedure W7131037.WH_PRF_CUST_348U Script Date: 13/03/2019 04:41:17 PM ******
CREATE OR REPLACE PROCEDURE "W7131037"."WH_PRF_CUST_348U" (p_forall_limit in integer,p_success out boolean) AS
...
--**************************************************************************************************
             ...
             using (
               ...
               from   cust_mart_staff_disc_detail@dwhprd csd
               join   dim_item@dwhprd di       on csd.item_no      = di.item_no
               join   dim_location@dwhprd dl   on csd.location_no  = dl.location_no
    LEFT OUTER JOIN   fnd_item_vat_rate@dwhprd  ivr  on (csd.item_no   = ivr.item_no                                      -- VAT rate change
    ...
    LEFT OUTER JOIN   fnd_pack_item_detail@dwhprd pck on csd.item_no      = pck.pack_item_no
