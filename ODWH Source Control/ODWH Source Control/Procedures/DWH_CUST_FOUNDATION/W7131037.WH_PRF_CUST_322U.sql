-- ****** Object: Procedure W7131037.WH_PRF_CUST_322U Script Date: 13/03/2019 04:41:17 PM ******
CREATE OR REPLACE PROCEDURE "W7131037"."WH_PRF_CUST_322U" (p_forall_limit in integer,p_success out boolean) as
...
--    g_stmt      := 'Alter table  W7131037.cust_mart_store_cross_shop truncate  subpartition for ('||g_yr_00||','||g_qt_00||') update global indexes';
--    l_text      := g_stmt;
--    dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);
