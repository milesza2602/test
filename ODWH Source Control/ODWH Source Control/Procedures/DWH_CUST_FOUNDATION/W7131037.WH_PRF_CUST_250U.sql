-- ****** Object: Procedure W7131037.WH_PRF_CUST_250U Script Date: 13/03/2019 04:41:17 PM ******
CREATE OR REPLACE PROCEDURE "W7131037"."WH_PRF_CUST_250U" (p_forall_limit in integer,p_success out boolean) AS

--**************************************************************************************************
--  Date:        April 2011
--  Author:      Alastair de Wet
--  Purpose:     Roll up for 3,6 & 12 months values
--  Tables:      Input  - cust_db_bu_mn
--               Output - temp_cust_bu_mn_1
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_CUST_250U';
...
l_description        sys_dwh_log_summary.log_description%type  := 'CREATE temp_cust_bu_mn_1 EX cust_db_bu_mn';
...
begin
    ...
    l_text := 'LOAD OF temp_cust_bu_mn_1 EX cust_db_bu_mn STARTED AT '||
...
--**************************************************************************************************
   ...
   execute immediate 'truncate table W7131037.temp_cust_bu_mn_1';
   l_text := 'Truncate temp table  W7131037.temp_cust_bu_mn_1';
   dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);

   insert into temp_cust_bu_mn_1
