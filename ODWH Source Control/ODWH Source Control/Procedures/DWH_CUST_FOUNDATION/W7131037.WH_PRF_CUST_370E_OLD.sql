-- ****** Object: Procedure W7131037.WH_PRF_CUST_370E_OLD Script Date: 13/03/2019 04:41:17 PM ******
CREATE OR REPLACE PROCEDURE "W7131037"."WH_PRF_CUST_370E_OLD" 
...
--  Tables:      Input  - CUST_BASKET, CUST_BASKET_ITEM, DIM_ITEM, W7131037.fnd_cust_basket_aux
...
--**************************************************************************************************
    ...
    select  /*+ Parallel(bi,4) Parallel(bk,4) Parallel(cb,4)  Parallel(di,4) Parallel(dl,4) Parallel(fb,4) Parallel(fl,4) Full(bi) Full(bk) Full(cb) Full(di) Full(dl) Full(fb) Full(fl) */
        ...
        left join W7131037.fnd_cust_basket_aux fb on bi.location_no = fb.location_no and
