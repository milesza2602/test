-- ****** Object: Procedure W7131037.WH_PRF_CUST_266TO1 Script Date: 13/03/2019 04:41:17 PM ******
CREATE OR REPLACE PROCEDURE "W7131037"."WH_PRF_CUST_266TO1" (p_forall_limit in integer,p_success out boolean) AS
...
--**************************************************************************************************
g_avg_spend          integer       := 285;  -- Implemented this threshold in July 2015
g_sub                integer       :=  0;
