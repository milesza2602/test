-- ****** Object: Procedure W7131037.WH_PRF_CUST_231U Script Date: 13/03/2019 04:41:17 PM ******
CREATE OR REPLACE PROCEDURE "W7131037"."WH_PRF_CUST_231U" (p_forall_limit in integer,p_success out boolean) AS
...
--               Output - temp_cust_subgroup_mn_2
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_CUST_231U';
...
l_description        sys_dwh_log_summary.log_description%type  := 'CREATE temp_cust_subgroup_mn_2 EX cust_db_subgroup_mn';
...
begin
    ...
    l_text := 'LOAD OF temp_cust_subgroup_mn_2 EX cust_db_subgroup_mn STARTED AT '||
...
--**************************************************************************************************
   ...
   execute immediate 'truncate table W7131037.temp_cust_subgroup_mn_2';
   l_text := 'Truncate temp table  W7131037.temp_cust_subgroup_mn_2' ;
   dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);

   insert into temp_cust_subgroup_mn_2
   ...
   where    (fin_year_no = g_yr_04 and fin_month_no = g_mn_04) or
            (fin_year_no = g_yr_05 and fin_month_no = g_mn_05) or
