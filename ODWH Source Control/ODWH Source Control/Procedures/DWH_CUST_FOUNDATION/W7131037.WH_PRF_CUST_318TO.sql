-- ****** Object: Procedure W7131037.WH_PRF_CUST_318TO Script Date: 13/03/2019 04:41:17 PM ******
CREATE OR REPLACE PROCEDURE "W7131037"."WH_PRF_CUST_318TO" (p_forall_limit in integer,p_success out boolean) as
...
g_last_mn_fin_month_no := 13;
g_last_mn_fin_year_no  := 2015;

for xyz in 1..12
loop

g_last_mn_fin_month_no := g_last_mn_fin_month_no - 1;
