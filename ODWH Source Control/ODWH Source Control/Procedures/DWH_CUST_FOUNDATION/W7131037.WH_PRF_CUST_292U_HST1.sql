-- ****** Object: Procedure W7131037.WH_PRF_CUST_292U_HST1 Script Date: 13/03/2019 04:41:17 PM ******
CREATE OR REPLACE PROCEDURE "W7131037"."WH_PRF_CUST_292U_HST1" (p_forall_limit in integer,p_success out boolean) AS
  g_year_no             NUMBER;
  g_month_no            NUMBER;
  g_prev_mn_date        DATE;
...
insert /*+ APPEND Parallel(a,8) */ into W7131037.TEMP_CUST_GRP_SALE_RANKING (fin_year_no,fin_month_no,group_no,sales_sum,customer_item_cnt,customer_cnt,diff_customer_item_cnt,ranking,last_updated_date)
    ...
    insert /*+ APPEND Parallel(a,8) */ into W7131037.TEMP_CUST_GRP_ITEM_RANKING (fin_year_no,fin_month_no,group_no,item_sum,customer_item_cnt,customer_cnt,diff_customer_item_cnt,ranking,last_updated_date)
    WITH cust AS (SELECT /*+ PARALLEL(a,8) FULL(a) */
                        g_year_no fin_year_no,
                        g_month_no fin_month_no,
                        group_no,
