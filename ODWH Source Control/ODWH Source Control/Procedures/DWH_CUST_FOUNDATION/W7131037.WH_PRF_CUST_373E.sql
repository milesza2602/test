-- ****** Object: Procedure W7131037.WH_PRF_CUST_373E Script Date: 13/03/2019 04:41:17 PM ******
CREATE OR REPLACE PROCEDURE "W7131037"."WH_PRF_CUST_373E" 
...
--  Purpose:     Create Location Extract to flat file in the performance layer
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_CUST_373E';
...
l_description        sys_dwh_log_summary.log_description%type  := 'EXTRACT E20 PERSONALISATION INTERFACE (STORES) TO FLAT FILE';
...
begin
    ...
    l_text := 'EXTRACT FOR E20 PERSONALISATION INTERFACE-STORES STARTED AT '||
...
--**************************************************************************************************
    ...
    g_count := dwh_performance.dwh_generic_file_extract(
         q'[select location_no,
           ...
           where st_store_type <> 'EN']','|','DWH_FILES_OUT','e20_cust_stores.txt');
    l_text :=  'Records extracted to E20_CUST_STORES '||g_count;
    dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);
