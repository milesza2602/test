-- ****** Object: Procedure W7131037.WH_PRF_CUST_262U Script Date: 13/03/2019 04:41:17 PM ******
CREATE OR REPLACE PROCEDURE "W7131037"."WH_PRF_CUST_262U" (p_forall_limit in integer,p_success out boolean) as
...
--execute immediate 'alter session enable parallel dml';
    ...
    g_stmt      := 'Alter table  W7131037.CUST_CSM_WK truncate  subpartition for ('||g_fin_year_no||','||g_fin_week_no||') update global indexes';
    l_text      := g_stmt;

    dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);

--if g_fin_year_no <> 2017 then
