-- ****** Object: Procedure W7131037.WH_PRF_CUST_362E Script Date: 13/03/2019 04:41:17 PM ******
CREATE OR REPLACE PROCEDURE "W7131037"."WH_PRF_CUST_362E" 
...
--  Purpose:     Create MYSTERY SHOPPER ENGEN extract to flat file in the performance layer
--               by reading a view and calling generic function to output to flat file.
--  Tables:      Input  - VS_EXT_MYSTERY_SHOPPER_ENGEN
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_CORP_362E';
...
l_description        sys_dwh_log_summary.log_description%type  := 'EXTRACT MYSTERY SHOPPER ENGEN TO FLAT FILE';
...
begin
    ...
    l_text := 'EXTRACT MYSTERY SHOPPER ENGEN DATA STARTED AT '||
...
--**************************************************************************************************
    ...
    G_COUNT := DWH_PERFORMANCE.DWH_GENERIC_FILE_EXTRACT
       ('select * from VS_EXT_MYSTERY_SHOPPER_ENGEN','|','DWH_FILES_OUT','engen_mystery_shopper.txt');
