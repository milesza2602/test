-- ****** Object: Procedure W7131037.WH_PRF_CUST_225U Script Date: 13/03/2019 04:41:17 PM ******
CREATE OR REPLACE PROCEDURE "W7131037"."WH_PRF_CUST_225U" (p_forall_limit in integer,p_success out boolean) AS
...
--for (to_date('06 Jul 2014','DD-MON-YYYY'))
    ...
    g_stmt      := 'Alter table  W7131037.CUST_DB_DEPT_MN truncate  subpartition for ('||g_yr_00||','||g_mn_00||')';
    l_text      := g_stmt;
...
--   execute immediate 'truncate table W7131037.cust_db_dept_mn'; ---For testing only---
--   l_text := 'Delete from table  W7131037.cust_db_dept_mn' ;
--   dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);
--*********************************************************************************************
