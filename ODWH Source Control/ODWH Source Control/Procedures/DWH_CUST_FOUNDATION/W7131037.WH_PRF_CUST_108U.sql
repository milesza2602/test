-- ****** Object: Procedure W7131037.WH_PRF_CUST_108U Script Date: 13/03/2019 04:41:17 PM ******
CREATE OR REPLACE PROCEDURE "W7131037"."WH_PRF_CUST_108U" (p_forall_limit in integer,p_success out boolean) AS
...
for bk_rec in c_prf_cust_basket
    ...
    if g_recs_comm mod 10000 = 0 then
