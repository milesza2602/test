-- ****** Object: Procedure W7131037.WH_PRF_CUST_291U_TO Script Date: 13/03/2019 04:41:17 PM ******
CREATE OR REPLACE PROCEDURE "W7131037"."WH_PRF_CUST_291U_TO" (p_forall_limit in integer,p_success out boolean) AS
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_CUST_291U_TO';
...
--**************************************************************************************************
   ...
   dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);
    ...
    INSERT INTO W7131037.TEMP_CUST_SGRP_SALE_RANKING (fin_year_no,fin_month_no,subgroup_no,sales_sum,customer_item_cnt,customer_cnt,diff_customer_item_cnt,ranking,last_updated_date)
    ...
    INSERT INTO W7131037.TEMP_CUST_SGRP_ITEM_RANKING (fin_year_no,fin_month_no,subgroup_no,item_sum,customer_item_cnt,customer_cnt,diff_customer_item_cnt,ranking,last_updated_date)
    WITH cust AS (SELECT /*+ PARALLEL(a,8) FULL(a) */
                        2016 fin_year_no,
                        12 fin_month_no,
                        subgroup_no,
...
-- Execute the insert
--**************************************************************************************************
    insert /*+ APPEND Parallel(a,8) */ into W7131037.cust_db_subgroup_month_involve a
    select /*+ Parallel(cma,8) Parallel(cmb,8) Parallel(cmc,8) Parallel(cmd,8) Full(cma) Full(cmb) Full(cmc) Full(cmd) */
          ...
          from W7131037.cust_db_subgroup_month cma
               left join
               W7131037.temp_cust_sgrp_item_ranking cmb on (cma.num_item_yr1_mn02 + cma.num_item_yr1_mn03 + cma.num_item_yr1_mn04+cma.num_item_yr1_mn05 + cma.num_item_yr1_mn06 +
                                                                         cma.num_item_yr1_mn07 + cma.num_item_yr1_mn08 + cma.num_item_yr1_mn09+cma.num_item_yr1_mn10 + cma.num_item_yr1_mn11 + cma.num_item_yr1_mn12 +
               ...
               left join
               W7131037.temp_cust_sgrp_sale_ranking cmc on ROUND(cma.sales_yr1_mn02 + cma.sales_yr1_mn03 + cma.sales_yr1_mn04 + cma.sales_yr1_mn05 + cma.sales_yr1_mn06 +
                                                                             cma.sales_yr1_mn07 + cma.sales_yr1_mn08 + cma.sales_yr1_mn09 + cma.sales_yr1_mn10 + cma.sales_yr1_mn11 + cma.sales_yr1_mn12 +
...
--   DBMS_STATS.gather_table_stats ('W7131037','CUST_DB_SUBGROUP_MONTH_INVOLVE',estimate_percent=>1, DEGREE => 32);
