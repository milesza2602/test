-- ****** Object: Procedure W7131037.WH_PRF_CUST_108U1 Script Date: 13/03/2019 04:41:17 PM ******
CREATE OR REPLACE PROCEDURE "W7131037"."WH_PRF_CUST_108U1" (p_forall_limit in integer,p_success out boolean) AS
...
cursor c_prf_cust_basket is
   select /*+ full(cb) parallel (cb,4) */ location_no,till_no,tran_no,tran_date,loyalty_ww_swipe_no,loyalty_ext_swipe_no,ww_online_order_no,customer_no
   from   cust_basket cb
