-- ****** Object: Procedure W7131037.WH_PRF_CUST_354E Script Date: 13/03/2019 04:41:17 PM ******
CREATE OR REPLACE PROCEDURE "W7131037"."WH_PRF_CUST_354E" 
...
--**************************************************************************************************
    ...
    g_count := dwh_performance.dwh_generic_file_extract
       ('select * from W7131037.VS_EXT_VMP_SALES_WKLY','|','DWH_FILES_OUT','cust_wod_weekly.txt');
