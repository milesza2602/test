-- ****** Object: Procedure W7131037.WH_PRF_CUST_358E_T Script Date: 13/03/2019 04:41:17 PM ******
CREATE OR REPLACE PROCEDURE "W7131037"."WH_PRF_CUST_358E_T" 
...
--  Purpose:     Create MYSTERY SHOPPER extract to flat file in the performance layer
--               by reading a view and calling generic function to output to flat file.
--  Tables:      Input  - VS_EXT_MYSTERY_SHOPPER
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_CORP_358E';
...
l_description        sys_dwh_log_summary.log_description%type  := 'EXTRACT MYSTERY SHOPPER TO FLAT FILE';
...
begin
    ...
    l_text := 'EXTRACT MYSTERY SHOPPER DATA STARTED AT '||
...
--**************************************************************************************************
    ...
    G_COUNT := DWH_PERFORMANCE.DWH_GENERIC_FILE_EXTRACT
       ('select * from VS_EXT_MYSTERY_SHOPPER_T','|','DWH_FILES_OUT','mystery_shopper_sc_20Jul.csv');
