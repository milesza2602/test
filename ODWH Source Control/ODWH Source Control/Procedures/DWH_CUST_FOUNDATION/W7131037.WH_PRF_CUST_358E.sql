-- ****** Object: Procedure W7131037.WH_PRF_CUST_358E Script Date: 13/03/2019 04:41:17 PM ******
CREATE OR REPLACE PROCEDURE "W7131037"."WH_PRF_CUST_358E" 
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_CUST_358E';
...
--**************************************************************************************************
    ...
    G_COUNT := DWH_PERFORMANCE.DWH_GENERIC_FILE_EXTRACT
       ('select * from VS_EXT_MYSTERY_SHOPPER','|','DWH_FILES_OUT','mystery_shopper_sc.txt');
