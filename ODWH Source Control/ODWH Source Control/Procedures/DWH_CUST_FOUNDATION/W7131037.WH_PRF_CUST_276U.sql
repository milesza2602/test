-- ****** Object: Procedure W7131037.WH_PRF_CUST_276U Script Date: 13/03/2019 04:41:17 PM ******
CREATE OR REPLACE PROCEDURE "W7131037"."WH_PRF_CUST_276U" 
...
-- CLEAR TABLES DOWN ---
--   g_stmt      := 'Alter table  W7131037.CUST_DB_business_unit_MONTH truncate  subpartition for ('||g_yr_00||','||g_mn_00||') update global indexes';
--   l_text      := g_stmt;
    g_stmt      := 'TRUNCATE ALL TABLES';
    dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);

    g_stmt      := 'TRUNCATE table  W7131037.CUST_DB_BUSINESS_UNIT_MONTH';
    execute immediate g_stmt;
    g_stmt      := 'TRUNCATE table  W7131037.TEMP_DB_BUSINESS_UNIT_MONTH_1';
    execute immediate g_stmt;
    g_stmt      := 'TRUNCATE table  W7131037.TEMP_DB_BUSINESS_UNIT_MONTH_2';
    execute immediate g_stmt;
    g_stmt      := 'TRUNCATE table  W7131037.TEMP_DB_BUSINESS_UNIT_MONTH_3';
    execute immediate g_stmt;
    g_stmt      := 'TRUNCATE table  W7131037.TEMP_DB_BUSINESS_UNIT_MONTH_4';
    execute immediate g_stmt;

   l_text := 'UPDATE STATS ON ALL TABLES';
   dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);

   DBMS_STATS.gather_table_stats ('W7131037','TEMP_DB_BUSINESS_UNIT_MONTH_1',estimate_percent=>1, DEGREE => 32);
   DBMS_STATS.gather_table_stats ('W7131037','TEMP_DB_BUSINESS_UNIT_MONTH_2',estimate_percent=>1, DEGREE => 32);
   DBMS_STATS.gather_table_stats ('W7131037','TEMP_DB_BUSINESS_UNIT_MONTH_3',estimate_percent=>1, DEGREE => 32);
   DBMS_STATS.gather_table_stats ('W7131037','TEMP_DB_BUSINESS_UNIT_MONTH_4',estimate_percent=>1, DEGREE => 32);
   DBMS_STATS.gather_table_stats ('W7131037','CUST_DB_BUSINESS_UNIT_MONTH',estimate_percent=>1, DEGREE => 32);
   COMMIT;
