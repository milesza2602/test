-- ****** Object: Procedure W7131037.WH_PRF_CUST_BSKT_FIX Script Date: 13/03/2019 04:41:17 PM ******
CREATE OR REPLACE PROCEDURE "W7131037"."WH_PRF_CUST_BSKT_FIX" (p_forall_limit in integer,p_success out boolean) as
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_CUST_BSKT_FIX';
...
--******************************************************************************
     ...
     set    primary_customer_identifier = LOYALTY_WW_SWIPE_NO
     where  customer_no is null and
             primary_customer_identifier = 0 and
             tran_date  between '01 SEP 2012' and '31 DEC 2013' and
             LOYALTY_WW_SWIPE_NO IS NOT NULL ;

       g_recs_updated := g_recs_updated + sql%rowcount;
       commit;

    l_text :=  'UPDATED WHERE PCI = 0 '||g_recs_updated;            --Bulk load--
