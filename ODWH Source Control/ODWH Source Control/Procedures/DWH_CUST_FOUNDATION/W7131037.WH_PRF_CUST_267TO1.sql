-- ****** Object: Procedure W7131037.WH_PRF_CUST_267TO1 Script Date: 13/03/2019 04:41:17 PM ******
CREATE OR REPLACE PROCEDURE "W7131037"."WH_PRF_CUST_267TO1" (p_forall_limit in integer,p_success out boolean) AS
...
g_avg_spend_1        integer       := 110;  -- Implemented this threshold in July 2015
g_avg_spend_2        integer       := 175;  -- Implemented this threshold in July 2015
g_avg_spend_3        integer       := 320;  -- Implemented this threshold in July 2015
g_sub                integer       :=  0;
...
--**************************************************************************************************
    ...
    l_text := 'Process completed Month:- '||g_sub;
    dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);
