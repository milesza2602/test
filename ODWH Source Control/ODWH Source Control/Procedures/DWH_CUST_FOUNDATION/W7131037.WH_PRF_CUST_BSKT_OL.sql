-- ****** Object: Procedure W7131037.WH_PRF_CUST_BSKT_OL Script Date: 13/03/2019 04:41:17 PM ******
CREATE OR REPLACE PROCEDURE "W7131037"."WH_PRF_CUST_BSKT_OL" (p_forall_limit in integer,p_success out boolean) as
...
g_recs_updated := 0;
     ...
     update /*+ FULL(cbi) parallel (cbi,4) */  CUST_BASKET cbi
