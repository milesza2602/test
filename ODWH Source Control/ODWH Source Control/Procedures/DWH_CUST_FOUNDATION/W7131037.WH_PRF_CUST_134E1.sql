-- ****** Object: Procedure W7131037.WH_PRF_CUST_134E1 Script Date: 13/03/2019 04:41:17 PM ******
CREATE OR REPLACE PROCEDURE "W7131037"."WH_PRF_CUST_134E1" 
...
--  Purpose:     Create LIGHTSTONE CUSTOMER MASTER extract to table in the performance layer
--               by reading DIM_CUSTOMER and outputting delta changes only.
--  Tables:      Input  - SQL
...
l_description        sys_dwh_log_summary.log_description%type  := 'EXTRACT LIGHTSTONE CUST MASTER TO TABLE';
...
--**************************************************************************************************
-- TRUNCATE OUTPUT TABLE AND THEN EXTRACT DELTAS TO IT
--**************************************************************************************************
   EXECUTE IMMEDIATE 'TRUNCATE TABLE W7131037.CUST_LIGHTSTONE_CUSTOMER';

   INSERT /*+ APPEND */ INTO CUST_LIGHTSTONE_CUSTOMER
        select /*+ FULL(DC) FULL(DCS) PARALLEL(4) */
