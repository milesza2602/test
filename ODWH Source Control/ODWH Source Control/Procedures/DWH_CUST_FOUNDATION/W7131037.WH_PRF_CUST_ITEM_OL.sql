-- ****** Object: Procedure W7131037.WH_PRF_CUST_ITEM_OL Script Date: 13/03/2019 04:41:17 PM ******
CREATE OR REPLACE PROCEDURE "W7131037"."WH_PRF_CUST_ITEM_OL" (p_forall_limit in integer,p_success out boolean) as
     ...
     where  customer_no is null and
             ...
             (select /*+ nl_aj */ TENDER_NO
              ...
              where LOCATION_NO = CBI.LOCATION_NO AND
                    ...
                    TENDER_NO IS NOT NULL AND ROWNUM = 1);
