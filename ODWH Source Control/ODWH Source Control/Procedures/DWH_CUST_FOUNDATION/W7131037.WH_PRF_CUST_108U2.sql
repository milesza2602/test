-- ****** Object: Procedure W7131037.WH_PRF_CUST_108U2 Script Date: 13/03/2019 04:41:17 PM ******
CREATE OR REPLACE PROCEDURE "W7131037"."WH_PRF_CUST_108U2" (p_forall_limit in integer,p_success out boolean) AS
...
begin
   ...
   if g_customer_no is not null then
       ...
       and     g_tran_date                   > nvl(last_transaction_date,'1 Jan 2000');
   end if;
