-- ****** Object: Procedure W7131037.WH_PRF_CUST_AUX_FIX Script Date: 13/03/2019 04:41:17 PM ******
CREATE OR REPLACE PROCEDURE "W7131037"."WH_PRF_CUST_AUX_FIX" (p_forall_limit in integer,p_success out boolean) as
...
g_sdate               date          := '24 DEC 2014';
g_edate               date          := '31 DEC 2014';

L_MESSAGE            SYS_DWH_ERRLOG.LOG_TEXT%TYPE;
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_CUST_AUX_FIX';
...
g_recs_updated := 0;
     ...
     update /*+ FULL(cbi) parallel (cbi,4) */  CUST_BASKET_AUX cbi
