-- ****** Object: Procedure W7131037.WH_PRF_CUST_341U1 Script Date: 13/03/2019 04:41:17 PM ******
CREATE OR REPLACE PROCEDURE "W7131037"."WH_PRF_CUST_341U1" (p_forall_limit in integer,p_success out boolean) as
...
-- ADD INVOLVE SCORES
      involve as (
select  /*+  FULL(invl) parallel (invl,12) */
