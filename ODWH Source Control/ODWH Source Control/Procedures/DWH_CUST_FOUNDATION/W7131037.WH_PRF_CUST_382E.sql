-- ****** Object: Procedure W7131037.WH_PRF_CUST_382E Script Date: 13/03/2019 04:41:17 PM ******
CREATE OR REPLACE PROCEDURE "W7131037"."WH_PRF_CUST_382E" (p_forall_limit in integer,p_success out boolean,p_run_date in date)
as
...
--    execute immediate 'TRUNCATE TABLE "W7131037"."OUT_DWH_SVOC_WEEKLY"';
--    dbms_stats.gather_table_stats ('W7131037','OUT_DWH_SVOC_WEEKLY',cascade=>true, DEGREE => 8);
--    commit;

    l_text := 'POPULATE TABLE OUT_DWH_SVOC_WEEKLY.' ;
    dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);

    insert /*+ parallel(OUT_DWH_SVOC_WEEKLY ,6) */ into W7131037.OUT_DWH_SVOC_WEEKLY
