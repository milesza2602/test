-- ****** Object: Procedure W7131037.WH_PRF_CUST_530U_ND Script Date: 13/03/2019 04:41:17 PM ******
CREATE OR REPLACE PROCEDURE "W7131037"."WH_PRF_CUST_530U_ND" (p_forall_limit in integer,p_success out boolean) AS
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_CUST_530U_ND';
...
l_text := '4 - SELECT sk1_cl_inq_sub_cat_no FROM dim_cust_cl_sub_cat WHERE cl_inq_sub_cat_no = '|| g_rec_in.inq_type_no;
    dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);
