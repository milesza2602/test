-- ****** Object: Procedure W7131037.WH_PRF_CUST_108N Script Date: 13/03/2019 04:41:17 PM ******
CREATE OR REPLACE PROCEDURE "W7131037"."WH_PRF_CUST_108N" (p_forall_limit in integer,p_success out boolean) AS
...
l_description        sys_dwh_log_summary.log_description%type  := 'UPDATE BASKET TRANSACTIONS WITH PRIMARYT CUSTOMER IDENTIFIER';
...
cursor c_prf_cust_basket is
   select location_no,till_no,tran_no,tran_date,loyalty_ww_swipe_no,loyalty_ext_swipe_no,ww_online_order_no
   from   cust_basket cb
   where  cb.last_updated_date           =  g_date-1
