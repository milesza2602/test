-- ****** Object: Procedure W7131037.WH_PRF_CUST_290U_HST2 Script Date: 13/03/2019 04:41:17 PM ******
CREATE OR REPLACE PROCEDURE "W7131037"."WH_PRF_CUST_290U_HST2" (p_forall_limit in integer,p_success out boolean) AS
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_CUST_290U_HST2';
...
insert /*+ APPEND Parallel(a,12) */ into W7131037.cust_db_dept_month_involve a
select  /*+ Parallel(cma,8) Parallel(cmb,8) Parallel(cmc,8) Parallel(cmd,8) Full(cma) Full(cmb) Full(cmc) Full(cmd) */
          ...
          from W7131037.cust_db_dept_month cma
               left join
               W7131037.temp_cust_dept_item_ranking cmb on (num_item_yr2_mn01 + num_item_yr2_mn02 + num_item_yr2_mn03 + num_item_yr2_mn04 + num_item_yr2_mn05 + num_item_yr2_mn06 +
               ...
               left join
               W7131037.temp_cust_dept_sale_ranking cmc on ROUND(sales_yr2_mn01 + sales_yr2_mn02 + sales_yr2_mn03 + sales_yr2_mn04 + sales_yr2_mn05 + sales_yr2_mn06 +
...
select  /*+ Parallel(cma,8) Parallel(cmb,8) Parallel(cmc,8) Parallel(cmd,8) Full(cma) Full(cmb) Full(cmc) Full(cmd) */
          ...
          from W7131037.cust_db_dept_month cma
               left join
               W7131037.temp_cust_dept_item_ranking cmb on (num_item_yr1_mn12 +
                                                                        num_item_yr2_mn01 + num_item_yr2_mn02 + num_item_yr2_mn03 + num_item_yr2_mn04 + num_item_yr2_mn05 + num_item_yr2_mn06 +
                                                                        ...
                                                                        cma.department_no = cmb.department_no
               left join
               W7131037.temp_cust_dept_sale_ranking cmc on ROUND(sales_yr1_mn12 +
                                                                             sales_yr2_mn01 + sales_yr2_mn02 + sales_yr2_mn03 + sales_yr2_mn04 + sales_yr2_mn05 + sales_yr2_mn06 +
...
select  /*+ Parallel(cma,8) Parallel(cmb,8) Parallel(cmc,8) Parallel(cmd,8) Full(cma) Full(cmb) Full(cmc) Full(cmd) */
          ...
          from W7131037.cust_db_dept_month cma
               left join
               W7131037.temp_cust_dept_item_ranking cmb on (num_item_yr1_mn11 + num_item_yr1_mn12 +
                                                                        num_item_yr2_mn01 + num_item_yr2_mn02 + num_item_yr2_mn03 + num_item_yr2_mn04 + num_item_yr2_mn05 + num_item_yr2_mn06 +
                                                                        ...
                                                                        cma.department_no = cmb.department_no
               left join
               W7131037.temp_cust_dept_sale_ranking cmc on ROUND(sales_yr1_mn11 + sales_yr1_mn12 +
                                                                             sales_yr2_mn01 + sales_yr2_mn02 + sales_yr2_mn03 + sales_yr2_mn04 + sales_yr2_mn05 + sales_yr2_mn06 +
...
select  /*+ Parallel(cma,8) Parallel(cmb,8) Parallel(cmc,8) Parallel(cmd,8) Full(cma) Full(cmb) Full(cmc) Full(cmd) */
          ...
          from W7131037.cust_db_dept_month cma
               left join
               W7131037.temp_cust_dept_item_ranking cmb on (num_item_yr1_mn10 + num_item_yr1_mn11 + num_item_yr1_mn12 +
                                                                        num_item_yr2_mn01 + num_item_yr2_mn02 + num_item_yr2_mn03 + num_item_yr2_mn04 + num_item_yr2_mn05 + num_item_yr2_mn06 +
                                                                        ...
                                                                        cma.department_no = cmb.department_no
               left join
               W7131037.temp_cust_dept_sale_ranking cmc on ROUND(sales_yr1_mn10 + sales_yr1_mn11 + sales_yr1_mn12 +
                                                                             sales_yr2_mn01 + sales_yr2_mn02 + sales_yr2_mn03 + sales_yr2_mn04 + sales_yr2_mn05 + sales_yr2_mn06 +
...
select  /*+ Parallel(cma,8) Parallel(cmb,8) Parallel(cmc,8) Parallel(cmd,8) Full(cma) Full(cmb) Full(cmc) Full(cmd) */
          ...
          from W7131037.cust_db_dept_month cma
               left join
               W7131037.temp_cust_dept_item_ranking cmb on (num_item_yr1_mn09 + num_item_yr1_mn10 + num_item_yr1_mn11 + num_item_yr1_mn12 +
                                                                        num_item_yr2_mn01 + num_item_yr2_mn02 + num_item_yr2_mn03 + num_item_yr2_mn04 + num_item_yr2_mn05 + num_item_yr2_mn06 +
                                                                        ...
                                                                        cma.department_no = cmb.department_no
               left join
               W7131037.temp_cust_dept_sale_ranking cmc on ROUND(sales_yr1_mn09 + sales_yr1_mn10 + sales_yr1_mn11 + sales_yr1_mn12 +
                                                                             sales_yr2_mn01 + sales_yr2_mn02 + sales_yr2_mn03 + sales_yr2_mn04 + sales_yr2_mn05 + sales_yr2_mn06 +
...
select  /*+ Parallel(cma,8) Parallel(cmb,8) Parallel(cmc,8) Parallel(cmd,8) Full(cma) Full(cmb) Full(cmc) Full(cmd) */
          ...
          from W7131037.cust_db_dept_month cma
               left join
               W7131037.temp_cust_dept_item_ranking cmb on (num_item_yr1_mn08 + num_item_yr1_mn09 + num_item_yr1_mn10 + num_item_yr1_mn11 + num_item_yr1_mn12 +
                                                                        num_item_yr2_mn01 + num_item_yr2_mn02 + num_item_yr2_mn03 + num_item_yr2_mn04 + num_item_yr2_mn05 + num_item_yr2_mn06 +
                                                                        ...
                                                                        cma.department_no = cmb.department_no
               left join
               W7131037.temp_cust_dept_sale_ranking cmc on ROUND(sales_yr1_mn08 + sales_yr1_mn09 + sales_yr1_mn10 + sales_yr1_mn11 + sales_yr1_mn12 +
                                                                             sales_yr2_mn01 + sales_yr2_mn02 + sales_yr2_mn03 + sales_yr2_mn04 + sales_yr2_mn05 + sales_yr2_mn06 +
...
select  /*+ Parallel(cma,8) Parallel(cmb,8) Parallel(cmc,8) Parallel(cmd,8) Full(cma) Full(cmb) Full(cmc) Full(cmd) */
          ...
          from W7131037.cust_db_dept_month cma
               left join
               W7131037.temp_cust_dept_item_ranking cmb on (num_item_yr1_mn07 + num_item_yr1_mn08 + num_item_yr1_mn09 + num_item_yr1_mn10 + num_item_yr1_mn11 + num_item_yr1_mn12 +
                                                                        ...
                                                                        cma.department_no = cmb.department_no
               left join
               W7131037.temp_cust_dept_sale_ranking cmc on ROUND(sales_yr1_mn07 + sales_yr1_mn08 + sales_yr1_mn09 + sales_yr1_mn10 + sales_yr1_mn11 + sales_yr1_mn12 +
...
select  /*+ Parallel(cma,8) Parallel(cmb,8) Parallel(cmc,8) Parallel(cmd,8) Full(cma) Full(cmb) Full(cmc) Full(cmd) */
          ...
          from W7131037.cust_db_dept_month cma
               left join
               W7131037.temp_cust_dept_item_ranking cmb on (num_item_yr1_mn06 +
                                                                        num_item_yr1_mn07 + num_item_yr1_mn08 + num_item_yr1_mn09 + num_item_yr1_mn10 + num_item_yr1_mn11 + num_item_yr1_mn12 +
                                                                        ...
                                                                        cma.department_no = cmb.department_no
               left join
               W7131037.temp_cust_dept_sale_ranking cmc on ROUND(sales_yr1_mn06 +
                                                                             sales_yr1_mn07 + sales_yr1_mn08 + sales_yr1_mn09 + sales_yr1_mn10 + sales_yr1_mn11 + sales_yr1_mn12 +
...
select  /*+ Parallel(cma,8) Parallel(cmb,8) Parallel(cmc,8) Parallel(cmd,8) Full(cma) Full(cmb) Full(cmc) Full(cmd) */
          ...
          from W7131037.cust_db_dept_month cma
               left join
               W7131037.temp_cust_dept_item_ranking cmb on (num_item_yr1_mn05 + num_item_yr1_mn06 +
                                                                        num_item_yr1_mn07 + num_item_yr1_mn08 + num_item_yr1_mn09 + num_item_yr1_mn10 + num_item_yr1_mn11 + num_item_yr1_mn12 +
                                                                        ...
                                                                        cma.department_no = cmb.department_no
               left join
               W7131037.temp_cust_dept_sale_ranking cmc on ROUND(sales_yr1_mn05 + sales_yr1_mn06 +
                                                                             sales_yr1_mn07 + sales_yr1_mn08 + sales_yr1_mn09 + sales_yr1_mn10 + sales_yr1_mn11 + sales_yr1_mn12 +
...
select  /*+ Parallel(cma,8) Parallel(cmb,8) Parallel(cmc,8) Parallel(cmd,8) Full(cma) Full(cmb) Full(cmc) Full(cmd) */
          ...
          from W7131037.cust_db_dept_month cma
               left join
               W7131037.temp_cust_dept_item_ranking cmb on (num_item_yr1_mn04 + num_item_yr1_mn05 + num_item_yr1_mn06 +
                                                                        num_item_yr1_mn07 + num_item_yr1_mn08 + num_item_yr1_mn09 + num_item_yr1_mn10 + num_item_yr1_mn11 + num_item_yr1_mn12 +
                                                                        ...
                                                                        cma.department_no = cmb.department_no
               left join
               W7131037.temp_cust_dept_sale_ranking cmc on ROUND(sales_yr1_mn04 + sales_yr1_mn05 + sales_yr1_mn06 +
                                                                             sales_yr1_mn07 + sales_yr1_mn08 + sales_yr1_mn09 + sales_yr1_mn10 + sales_yr1_mn11 + sales_yr1_mn12 +
...
select  /*+ Parallel(cma,8) Parallel(cmb,8) Parallel(cmc,8) Parallel(cmd,8) Full(cma) Full(cmb) Full(cmc) Full(cmd) */
          ...
          from W7131037.cust_db_dept_month cma
               left join
               W7131037.temp_cust_dept_item_ranking cmb on (num_item_yr1_mn03 + num_item_yr1_mn04 + num_item_yr1_mn05 + num_item_yr1_mn06 +
                                                                        num_item_yr1_mn07 + num_item_yr1_mn08 + num_item_yr1_mn09 + num_item_yr1_mn10 + num_item_yr1_mn11 + num_item_yr1_mn12 +
                                                                        ...
                                                                        cma.department_no = cmb.department_no
               left join
               W7131037.temp_cust_dept_sale_ranking cmc on ROUND(sales_yr1_mn03 + sales_yr1_mn04 + sales_yr1_mn05 + sales_yr1_mn06 +
                                                                             sales_yr1_mn07 + sales_yr1_mn08 + sales_yr1_mn09 + sales_yr1_mn10 + sales_yr1_mn11 + sales_yr1_mn12 +
