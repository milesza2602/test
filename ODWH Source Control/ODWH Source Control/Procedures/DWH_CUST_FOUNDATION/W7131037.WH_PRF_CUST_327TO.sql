-- ****** Object: Procedure W7131037.WH_PRF_CUST_327TO Script Date: 13/03/2019 04:41:17 PM ******
CREATE OR REPLACE PROCEDURE "W7131037"."WH_PRF_CUST_327TO" (p_forall_limit in integer,p_success out boolean) as
...
order by home.location_no,
   ...
   DBMS_STATS.gather_table_stats ('W7131037','cust_mart_home_and_away_dept',estimate_percent=>1, DEGREE => 32);
