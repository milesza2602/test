-- ****** Object: Procedure W7131037.WH_PRF_CUST_336U Script Date: 13/03/2019 04:41:17 PM ******
CREATE OR REPLACE PROCEDURE "W7131037"."WH_PRF_CUST_336U" (p_forall_limit in integer,p_success out boolean) as
...
insert  into cust_mart_store_rev_by_suburb csm
...
select  /*+ FULL(a)  FULL(ea)    parallel (8) */
         g_yr_00,
         g_qt_00,
         a.location_no,
