-- ****** Object: Procedure W7131037.WH_PRF_NRT_001U Script Date: 13/03/2019 04:41:17 PM ******
CREATE OR REPLACE PROCEDURE "W7131037"."WH_PRF_NRT_001U" (p_forall_limit in integer,p_success out boolean) as
...
select /*+ FULL(fnd)  parallel (fnd,2) */
              ...
              dw.workgroup_name,
              dj.job_name
      from    W7131037.fnd_nrt_staff_schedule fnd,
              dim_hr_employee de,
              W7131037.cust_nrt_staff_time_mng prf,
              dim_location dl,
              W7131037.dim_nrt_workgroup dw,
              W7131037.dim_nrt_job dj
...
for dupp_record in stg_dup
   loop
    ...
    if  dupp_record.location_no     = g_location_no and
        ...
        update W7131037.fnd_nrt_staff_schedule stg
        set    processed_ind = 'D'
...
--**************************************************************************************************
    ...
    update W7131037.fnd_nrt_staff_schedule
    set    processed_ind = 'Y'
    where  processed_ind = 'N';
