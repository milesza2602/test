-- ****** Object: Procedure W7131037.WH_PRF_CUST_222U Script Date: 13/03/2019 04:41:17 PM ******
CREATE OR REPLACE PROCEDURE "W7131037"."WH_PRF_CUST_222U" (p_forall_limit in integer,p_success out boolean) AS
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_CUST_222U';
...
l_description        sys_dwh_log_summary.log_description%type  := 'CREATE temp_cust_dept_mn_3 EX cust_db_dept_mn';
...
begin
    ...
    l_text := 'LOAD OF temp_cust_dept_mn_3 EX cust_db_dept_mn STARTED AT '||
