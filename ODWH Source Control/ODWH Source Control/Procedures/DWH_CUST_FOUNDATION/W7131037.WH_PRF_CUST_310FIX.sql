-- ****** Object: Procedure W7131037.WH_PRF_CUST_310FIX Script Date: 13/03/2019 04:41:17 PM ******
CREATE OR REPLACE PROCEDURE "W7131037"."WH_PRF_CUST_310FIX" (p_forall_limit in integer,p_success out boolean) as
...
cursor c_cust_basket is
        ...
        and     a.last_updated_date = '5 DEC 2015'
        and     a.tran_date         > g_date - 42
