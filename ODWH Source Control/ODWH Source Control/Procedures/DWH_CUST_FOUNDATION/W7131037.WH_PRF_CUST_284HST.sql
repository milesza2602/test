-- ****** Object: Procedure W7131037.WH_PRF_CUST_284HST Script Date: 13/03/2019 04:41:17 PM ******
CREATE OR REPLACE PROCEDURE "W7131037"."WH_PRF_CUST_284HST" (p_forall_limit in integer,p_success out boolean) AS
...
--***********************************************************************************************************
    ...
    g_stmt      := 'TRUNCATE table  W7131037.TEMP_LSS1_PCI_FD';
    execute immediate g_stmt;
    g_stmt      := 'TRUNCATE table  W7131037.TEMP_LSS1_PCI_PFC_FD';
    execute immediate g_stmt;
    g_stmt      := 'TRUNCATE table  W7131037.TEMP_LSS1_PCI_FINAL_FD';
    execute immediate g_stmt;
    ...
    DBMS_STATS.gather_table_stats ('W7131037','TEMP_LSS1_PCI_FD',estimate_percent=>1, DEGREE => 32);
...
-- CREATE A TEMP TABLE WITH PCI/PFC'S THAT NEED TO BE CALCULATED IN NEXT PROCESS
    insert  /*+ APPEND parallel(tmp,16) */ into W7131037.temp_lss1_pci_pfc_fd tmp
    ...
    DBMS_STATS.gather_table_stats ('W7131037','TEMP_LSS1_PCI_PFC_FD',estimate_percent=>1, DEGREE => 32);
...
--************************************************************************************************************************
   ...
   dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);
--************************************************************************************************************************
    INSERT  /*+ APPEND parallel(tmp,8) */ INTO W7131037.TEMP_LSS1_PCI_FINAL_FD TMP
    WITH PTHEME AS (
...
--************************************************************************************************************************
    ...
    FROM    W7131037.TEMP_LSS1_PCI_FINAL_FD FIN,
