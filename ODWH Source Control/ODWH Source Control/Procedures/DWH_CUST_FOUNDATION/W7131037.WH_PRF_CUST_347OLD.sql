-- ****** Object: Procedure W7131037.WH_PRF_CUST_347OLD Script Date: 13/03/2019 04:41:17 PM ******
CREATE OR REPLACE PROCEDURE "W7131037"."WH_PRF_CUST_347OLD" (p_forall_limit in integer,p_success out boolean) AS
...
cursor c_prf_cust_basket_item is
...
for bk_rec in c_prf_cust_basket
    loop
     ...
     for bki_rec in c_prf_cust_basket_item
         loop
             g_item_no := bki_rec.item_no;
             ...
             where  cba.item_no     =  g_item_no
             and    cba.tran_date   =  g_tran_date
             ...
             on    (cms.tran_date	  =	g_tran_date and
                    ...
                    cms.item_no     = g_item_no)
             when matched then
             update set
                    cms.tran_time                  =	bk_rec.tran_time ,
                    cms.employee_id                =  bk_rec.employee_id,
                    cms.item_tran_qty              =  bki_rec.itq,
                    cms.item_tran_selling          =  bki_rec.its,
