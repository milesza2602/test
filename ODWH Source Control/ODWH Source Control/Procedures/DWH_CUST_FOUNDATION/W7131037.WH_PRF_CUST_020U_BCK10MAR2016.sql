-- ****** Object: Procedure W7131037.WH_PRF_CUST_020U_BCK10MAR2016 Script Date: 13/03/2019 04:41:17 PM ******
CREATE OR REPLACE PROCEDURE "W7131037"."WH_PRF_CUST_020U_BCK10MAR2016" (p_forall_limit in integer,p_success out boolean) as
...
--**************************************************************************************************
  ...
  exception
      ...
      when others then
       ...
       p_success := false;
       raise;
end "WH_PRF_CUST_020U_BCK10MAR2016";
