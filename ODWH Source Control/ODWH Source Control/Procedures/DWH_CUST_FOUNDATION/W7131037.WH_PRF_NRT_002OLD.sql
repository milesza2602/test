-- ****** Object: Procedure W7131037.WH_PRF_NRT_002OLD Script Date: 13/03/2019 04:41:17 PM ******
CREATE OR REPLACE PROCEDURE "W7131037"."WH_PRF_NRT_002OLD" (p_forall_limit in integer,p_success out boolean) as
--***********************************************************************************************
--  Date:        May 2014
...
select --/*+ FULL(fnd)  parallel (fnd,2) */
              fnd.*
      from    W7131037.fnd_nrt_staff_clocking fnd,
...
--**************************************************************************************************
    ...
    select count(*)
    into   g_recs_read
    from   W7131037.fnd_nrt_staff_clocking
    ...
    update W7131037.fnd_nrt_staff_clocking
    set    processed_ind = 'Y'
    where  processed_ind = 'N';
