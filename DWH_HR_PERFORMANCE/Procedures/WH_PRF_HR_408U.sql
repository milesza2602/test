--------------------------------------------------------
--  DDL for Procedure WH_PRF_HR_408U
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_HR_PERFORMANCE"."WH_PRF_HR_408U" (p_forall_limit in integer,p_success out boolean) AS

--**************************************************************************************************
--  Date:        January 2015
--  Author:      Kgomotso
--  Purpose:     Create hr_mdl_mgmt_ctl_comp_ee fact table in the performance layer
--               with added value ex foundation layer fnd_hr_mdl_mgmt_ctl_comp_ee.
--  Tables:      Input  - fnd_hr_mdl_mgmt_ctl_comp_ee
--               Output - hr_mdl_mgmt_ctl_comp_ee
...
g_rec_out            hr_mdl_mgmt_ctl_comp_ee%rowtype;
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_HR_408U';
...
l_description        sys_dwh_log_summary.log_description%type  := 'CREATE hr_mdl_mgmt_ctl_comp_ee EX FOUNDATION';
...
type tbl_array_i is table of hr_mdl_mgmt_ctl_comp_ee%rowtype index by binary_integer;
type tbl_array_u is table of hr_mdl_mgmt_ctl_comp_ee%rowtype index by binary_integer;
...
cursor  c_fnd_mdl_mgmt_ctl_pnt_bu_ee is
  ...
  from   dwh_hr_foundation.fnd_hr_mdl_mgmt_ctl_comp_ee mgt ,
...
begin
   ...
   forall i in a_tbl_insert.first .. a_tbl_insert.last
      save exceptions
      insert into hr_mdl_mgmt_ctl_comp_ee values a_tbl_insert(i);
...
begin
   ...
   forall i in a_tbl_update.first .. a_tbl_update.last
      save exceptions
      update hr_mdl_mgmt_ctl_comp_ee
...
begin
    ...
    l_text := 'LOAD OF hr_mdl_mgmt_ctl_comp_ee EX fnd_hr_mdl_mgmt_ctl_comp_ee STARTED AT '||
