--------------------------------------------------------
--  DDL for Procedure WH_PRF_HR_322U
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_HR_PERFORMANCE"."WH_PRF_HR_322U" 
...
--               ex foundation layer fnd_hr_ap_invoice_payment.
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_HR_322U';
...
type tbl_array_i is table of hr_invoice_supplier_mth%rowtype index by binary_integer;
type tbl_array_u is table of hr_invoice_supplier_mth%rowtype index by binary_integer;
...
cursor c_fnd_hr_bee_sed is
   select dc.this_mn_end_date,
          ...
          sum(ai.amount_paid_ex_vat) amount_paid_ex_vat,
          sum(ai.discount_amount) discount_amount,
          sum(ai.discount_amount_ex_vat) discount_amount_ex_vat
   ...
   group by dc.this_mn_end_date,ds.sk1_supplier_id,dc.fin_month_code,AI.fin_month_no,AI.fin_year_no
    ;
...
begin
  ...
  g_rec_out.invoice_amount              := null;
  g_rec_out.invoice_amount_ex_vat       := null;
  g_rec_out.vat_amount                  := null;
...
begin
   ...
   forall i in a_tbl_insert.first .. a_tbl_insert.last
      save exceptions
      insert into hr_invoice_supplier_mth values a_tbl_insert(i);
   ...
   forall i in a_tbl_update.first .. a_tbl_update.last
      ...
      update hr_invoice_supplier_mth
       set
            ...
            --  sk2_supplier_id             = a_tbl_update(i).sk2_supplier_id,
...
begin
    ...
    l_text := 'LOAD OF hr_invoice_supplier_mth EX fnd_hr_ap_invoice_payment STARTED AT '||
