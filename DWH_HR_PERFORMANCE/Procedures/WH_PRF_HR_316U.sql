--------------------------------------------------------
--  DDL for Procedure WH_PRF_HR_316U
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_HR_PERFORMANCE"."WH_PRF_HR_316U" (p_forall_limit in integer,p_success out boolean) AS

--**************************************************************************************************
--  Date:        Jul 2014
--  Author:      Kgomotso Lehabe
--  Purpose:     Create hr_bee_poi_skill_dev_learn fact table in the performance layer
--
--  Tables:      Input  - fnd_hr_bee_poi_skill_dev_learn
--               Output - hr_bee_poi_skill_dev_learn
...
g_rec_out            hr_bee_poi_skill_dev_learn%rowtype;
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_HR_316U';
...
l_description        sys_dwh_log_summary.log_description%type  := 'CREATE hr_bee_poi_skill_dev_learn EX FOUNDATION';
...
type tbl_array_i is table of hr_bee_poi_skill_dev_learn%rowtype index by binary_integer;
type tbl_array_u is table of hr_bee_poi_skill_dev_learn%rowtype index by binary_integer;
...
cursor c_fnd_hr_poi_skill_dev_learn is
   select sc.*,
          dp.sk1_poi_id,
       ...
       from   dwh_hr_foundation.fnd_hr_bee_poi_skill_dev_learn sc
          join dim_hr_poi dp
...
g_rec_in                   c_fnd_hr_poi_skill_dev_learn%rowtype;
-- For input bulk collect --
type stg_array is table of c_fnd_hr_poi_skill_dev_learn%rowtype;
...
begin
   ...
   forall i in a_tbl_insert.first .. a_tbl_insert.last
      save exceptions
      insert into hr_bee_poi_skill_dev_learn values a_tbl_insert(i);
...
begin
   ...
   forall i in a_tbl_update.first .. a_tbl_update.last
      save exceptions
      update hr_bee_poi_skill_dev_learn
...
-- Check to see if item is present on table and update/insert accordingly
   select count(1)
   into   g_count
   from   hr_bee_poi_skill_dev_learn
...
begin
    ...
    l_text := 'LOAD OF hr_bee_poi_skill_dev_learn EX fnd_hr_bee_poi_skill_dev_learn STARTED AT '||
...
--**************************************************************************************************
    open c_fnd_hr_poi_skill_dev_learn;
    fetch c_fnd_hr_poi_skill_dev_learn bulk collect into a_stg_input limit g_forall_limit;
    ...
    close c_fnd_hr_poi_skill_dev_learn;
--**************************************************************************************************
