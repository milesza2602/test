--------------------------------------------------------
--  DDL for Procedure WH_FND_CUST_530U_TSTWL
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_CUST_FOUNDATION"."WH_FND_CUST_530U_TSTWL" (p_forall_limit in integer,p_success out boolean) AS
...
--               Output - WL_WL_fnd_cust_cl_inquiry
...
--                     Seems fine, but I will have to then do a datafix to WL_WL_fnd_cust_cl_inquiry to complete the change.
...
g_rec_out            WL_fnd_cust_cl_inquiry%rowtype;
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_FND_CUST_530U_TSTWL';
...
type tbl_array_i is table of DWH_CUST_FOUNDATION.WL_fnd_cust_cl_inquiry%rowtype index by binary_integer;
type tbl_array_u is table of DWH_CUST_FOUNDATION.WL_fnd_cust_cl_inquiry%rowtype index by binary_integer;
...
begin
    forall i in a_tbl_insert.first .. a_tbl_insert.last
       save exceptions
       insert into DWH_CUST_FOUNDATION.WL_fnd_cust_cl_inquiry values a_tbl_insert(i);
...
begin
    ...
    forall i in a_tbl_update.first .. a_tbl_update.last
       save exceptions
       update DWH_CUST_FOUNDATION.WL_fnd_cust_cl_inquiry
...
/*   select count(1)
   into   g_count
   from   DWH_CUST_FOUNDATION.WL_fnd_cust_cl_inquiry
...
begin
    ...
    l_text := 'LOAD OF WL_fnd_cust_cl_inquiry EX CUST LIAISON STARTED AT '||
...
--**************************************************************************************************
 ...
 execute immediate 'alter session enable parallel dml';
  ...
  execute immediate 'TRUNCATE TABLE DWH_CUST_FOUNDATION.WL_fnd_cust_cl_inquiry';
--**************************************************************************************************
