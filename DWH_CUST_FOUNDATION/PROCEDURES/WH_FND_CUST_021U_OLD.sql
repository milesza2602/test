--------------------------------------------------------
--  DDL for Procedure WH_FND_CUST_021U_OLD
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_CUST_FOUNDATION"."WH_FND_CUST_021U_OLD" (p_forall_limit in integer,p_success out boolean) AS
...
g_hospital           char(1)       := 'N';
g_hospital_text      stg_c2_customer_product_hsp.sys_process_msg%type;
g_rec_out            fnd_customer_product%rowtype;
g_rec_in             stg_c2_customer_product_cpy%rowtype;
g_found              boolean;
...
type stg_array is table of stg_c2_customer_product_cpy%rowtype;
a_stg_input      stg_array;

-- For output arrays into bulk load forall statements --
type tbl_array_i is table of fnd_customer_product%rowtype index by binary_integer;
type tbl_array_u is table of fnd_customer_product%rowtype index by binary_integer;
...
type staging_array1 is table of stg_c2_customer_product_cpy.sys_source_batch_id%type
                                                       index by binary_integer;
type staging_array2 is table of stg_c2_customer_product_cpy.sys_source_sequence_no%type
                                                       index by binary_integer;
...
begin
   ...
   insert into stg_c2_customer_product_hsp values g_rec_in;
...
begin
    forall i in a_tbl_insert.first .. a_tbl_insert.last
       save exceptions
       insert into fnd_customer_product values a_tbl_insert(i);
...
begin
   g_found := dwh_cust_valid.fnd_customer_product (g_rec_out.product_no );
...
begin
    ...
    l_text := 'LOAD OF fnd_customer_product EX CUST CENTRAL STARTED AT '||
...
--**************************************************************************************************
    open c_stg_c2_customer_product;
    fetch c_stg_c2_customer_product bulk collect into a_stg_input limit g_forall_limit;
    ...
    close c_stg_c2_customer_product;
--**************************************************************************************************
