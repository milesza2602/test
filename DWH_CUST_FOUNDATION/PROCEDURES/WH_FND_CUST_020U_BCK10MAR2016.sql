--------------------------------------------------------
--  DDL for Procedure WH_FND_CUST_020U_BCK10MAR2016
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_CUST_FOUNDATION"."WH_FND_CUST_020U_BCK10MAR2016" (p_forall_limit in integer,p_success out boolean) as
...
select /*+ FULL(cpy)  parallel (cpy,2) */
      ...
      where   cpy.customer_no       = fnd.customer_no and
             ...
             nvl(fnd.	ESTATEMENT_EMAIL_FAILURE_IND	,0) <>	cpy.	ESTATEMENT_EMAIL_FAILURE_IND
             )
...
*/
  ...
  exception
      ...
      when others then
       ...
       p_success := false;
       RAISE;
end WH_FND_CUST_020U_BCK10MAR2016;
