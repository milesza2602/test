--------------------------------------------------------
--  DDL for Procedure WH_BULK_LOAD_TEMPLATE
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_CUST_FOUNDATION"."WH_BULK_LOAD_TEMPLATE" (p_forall_limit in integer,p_success out boolean) as
...
g_location_no        stg_om_wh_plan_cpy.location_no%type;
g_item_no            stg_om_wh_plan_cpy.item_no%type;
...
begin
 --     g_rec_out.last_updated_date         := g_date;
      ...
      from   stg_om_wh_plan_cpy cpy,
       ...
       and   not exists
      (select /*+ nl_aj */  * from fnd_loc_item_om_wh_plan
   ...
   loop
     ...
     where  fnd.location_no       = upd_rec.location_no and
            fnd.item_no           = upd_rec.item_no  and
              (
            upd_rec.week_1_day_1_cases <> fnd.week_1_day_1_cases or
            upd_rec.week_1_day_2_cases <> fnd.week_1_day_2_cases or
            upd_rec.week_1_day_3_cases <> fnd.week_1_day_3_cases or
            upd_rec.week_1_day_4_cases <> fnd.week_1_day_4_cases or
            upd_rec.week_1_day_5_cases <> fnd.week_1_day_5_cases or
            upd_rec.week_1_day_6_cases <> fnd.week_1_day_6_cases or
            upd_rec.week_1_day_7_cases <> fnd.week_1_day_7_cases or
            upd_rec.week_2_day_1_cases <> fnd.week_2_day_1_cases or
            upd_rec.week_2_day_2_cases <> fnd.week_2_day_2_cases or
            upd_rec.week_2_day_3_cases <> fnd.week_2_day_3_cases or
            upd_rec.week_2_day_4_cases <> fnd.week_2_day_4_cases or
            upd_rec.week_2_day_5_cases <> fnd.week_2_day_5_cases or
            upd_rec.week_2_day_6_cases <> fnd.week_2_day_6_cases or
            upd_rec.week_2_day_7_cases <> fnd.week_2_day_7_cases or
            upd_rec.week_3_day_1_cases <> fnd.week_3_day_1_cases or
            upd_rec.week_3_day_2_cases <> fnd.week_3_day_2_cases or
            upd_rec.week_3_day_3_cases <> fnd.week_3_day_3_cases or
            upd_rec.week_3_day_4_cases <> fnd.week_3_day_4_cases or
            upd_rec.week_3_day_5_cases <> fnd.week_3_day_5_cases or
            upd_rec.week_3_day_6_cases <> fnd.week_3_day_6_cases or
            upd_rec.week_3_day_7_cases <> fnd.week_3_day_7_cases );
