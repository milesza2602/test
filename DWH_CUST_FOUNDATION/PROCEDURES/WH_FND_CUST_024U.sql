--------------------------------------------------------
--  DDL for Procedure WH_FND_CUST_024U
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_CUST_FOUNDATION"."WH_FND_CUST_024U" (p_forall_limit in integer,p_success out boolean) as
