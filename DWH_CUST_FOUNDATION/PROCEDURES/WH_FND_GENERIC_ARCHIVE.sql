...
set define off;
  ...
  CREATE OR REPLACE PROCEDURE "DWH_CUST_FOUNDATION"."WH_FND_GENERIC_ARCHIVE" (p_table_name VARCHAR2,
...
--**************************************************************************************************
    ...
    g_stmt := 'insert /*+ append */ into '||g_arc_table_name||' select * from '||g_cpy_table_name;
