--------------------------------------------------------
--  DDL for Procedure WH_PRF_CUST_400U_HIST
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_CUST_PERFORMANCE"."WH_PRF_CUST_400U_HIST" (p_forall_limit in integer,p_success out boolean,p_rundate in date) AS 
...
g_rundate            date         := nvl(p_rundate,trunc(sysdate));
