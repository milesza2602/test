--------------------------------------------------------
--  DDL for Procedure WH_PRF_CUST_324H
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_CUST_PERFORMANCE"."WH_PRF_CUST_324H" (p_forall_limit in integer,p_success out boolean) as
...
--=============================================================================================================================
    ...
    DELETE FROM cust_mart_home_and_away_bu
...
insert /*+ APPEND parallel(csm,4)*/ into cust_mart_home_and_away_bu csm
     ...
     with         home as  (
     select   /*+ FULL(bih)  parallel(bih,8) parallel(s2,8) full(di) */ 
