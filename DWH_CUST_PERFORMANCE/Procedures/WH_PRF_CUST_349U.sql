--------------------------------------------------------
--  DDL for Procedure WH_PRF_CUST_349U
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_CUST_PERFORMANCE"."WH_PRF_CUST_349U" (p_forall_limit in integer,p_success out boolean) as
...
execute immediate 'alter session enable parallel dml';
    ...
    g_stmt      := 'TRUNCATE table  DWH_CUST_PERFORMANCE.CUST_MART_VOUCHERS_CAMPAIGN';
    l_text      := g_stmt;
...
--================================================================================
    ...
    DBMS_STATS.gather_table_stats ('DWH_CUST_PERFORMANCE','CUST_MART_VOUCHERS_CAMPAIGN',estimate_percent=>1, DEGREE => 32);
COMMIT; 
