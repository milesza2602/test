--------------------------------------------------------
--  DDL for Procedure WH_PRF_CUST_358E_T
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_CUST_PERFORMANCE"."WH_PRF_CUST_358E_T" 
...
--**************************************************************************************************
    ...
    G_COUNT := DWH_PERFORMANCE.DWH_GENERIC_FILE_EXTRACT
       ('select * from VS_EXT_MYSTERY_SHOPPER_T','|','DWH_FILES_OUT','mystery_shopper_sc_11Aug.txt');
