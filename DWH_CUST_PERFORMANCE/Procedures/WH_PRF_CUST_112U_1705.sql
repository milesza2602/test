--------------------------------------------------------
--  DDL for Procedure WH_PRF_CUST_112U_1705
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_CUST_PERFORMANCE"."WH_PRF_CUST_112U_1705" (p_forall_limit in integer,p_success out boolean) as
--**************************************************************************************************
--  Date:        July 2016
...
begin
  ...
  update /*+ PARALLEL(dim,4)*/ dwh_cust_performance.dim_customer dim
     set ucount_cust_type = 'UCount Customer'
