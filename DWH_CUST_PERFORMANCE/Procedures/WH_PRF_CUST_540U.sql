--------------------------------------------------------
--  DDL for Procedure WH_PRF_CUST_540U
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_CUST_PERFORMANCE"."WH_PRF_CUST_540U" (p_forall_limit in integer,p_success out boolean) AS 
...
cursor c_cust_cl_inquiry is
   ...
   from     DWH_CUST_PERFORMANCE.CUST_CL_INQUIRY prf_inq 
...
--**************************************************************************************************
   ...
   execute immediate 'truncate table dwh_cust_performance.cust_cl_loc_item_dy_inq';
