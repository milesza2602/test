--------------------------------------------------------
--  DDL for Procedure WH_PRF_CUST_235U
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_CUST_PERFORMANCE"."WH_PRF_CUST_235U" (p_forall_limit in integer,p_success out boolean) AS
...
--   execute immediate 'truncate table dwh_cust_performance.cust_db_subgroup_mn'; ---For testing only---
--   l_text := 'Delete from table  dwh_cust_performance.cust_db_subgroup_mn' ;
--   dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);
--*********************************************************************************************
