--------------------------------------------------------
--  DDL for Procedure WH_PRF_CUST_260U
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_CUST_PERFORMANCE"."WH_PRF_CUST_260U" (p_forall_limit in integer,p_success out boolean) as
...
execute immediate 'alter session enable parallel dml';
    ...
    g_stmt      := 'Alter table  DWH_CUST_PERFORMANCE.CUST_CSM_ST_WK truncate  subpartition for ('||g_yr_00||','||g_wk_00||') update global indexes';
    l_text      := g_stmt;
