--------------------------------------------------------
--  DDL for Procedure WH_PRF_CUST_290U_TO
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_CUST_PERFORMANCE"."WH_PRF_CUST_290U_TO" (p_forall_limit in integer,p_success out boolean) AS 
...
--   DBMS_STATS.gather_table_stats ('DWH_CUST_PERFORMANCE','CUST_DB_DEPT_MONTH_INVOLVE',estimate_percent=>1, DEGREE => 32);
