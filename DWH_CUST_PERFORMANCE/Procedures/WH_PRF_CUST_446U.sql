--------------------------------------------------------
--  DDL for Procedure WH_PRF_CUST_446U
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_CUST_PERFORMANCE"."WH_PRF_CUST_446U" (p_forall_limit in integer,p_success out boolean) as
...
--**************************************************************************************************    
   ...
   if trunc(sysdate) <>  g_SAT_date then
      l_text      := 'This job only runs MONTHLY ON THE 2nd Saturday of the month and today '||to_char(sysdate,'DD/MM/YYYY')||' is not that day !';
      dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);
      p_success := true;
      return;
   end if;  
...
-------------------------------------
-- for testing ...
--g_start_date := '26 oct 2015';
--g_end_date := '24 apr 2016';
--g_fin_yr := 2016;
--g_fin_mth := 10;
------------------------------------------
...
-------------------------------------
-- for testing ...
--g_start_datep := '27 nov 2014';
--g_end_datep := '26 apr 2015';
--g_fin_yrp := 2015;
------------------------------------------
