--------------------------------------------------------
--  DDL for Procedure WH_PRF_CUST_104FIXF
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_CUST_PERFORMANCE"."WH_PRF_CUST_104FIXF" (p_forall_limit in integer,p_success out boolean) AS
...
update /*+ full(cbi) parallel (cbi,8) */ fnd_cust_basket_item cbi
     set     dept_no = null
