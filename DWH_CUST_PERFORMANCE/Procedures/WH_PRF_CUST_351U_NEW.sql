--------------------------------------------------------
--  DDL for Procedure WH_PRF_CUST_351U_NEW
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_CUST_PERFORMANCE"."WH_PRF_CUST_351U_NEW" (p_forall_limit in integer,p_success out boolean) as
...
-- 1. Removed all hints on INSERT INTO CUST_MART_VOUCHERS_WEEK except parallel hint on CUST_FV_VOUCHER
-- 2. Suggest reviewing code since it constantly rebuilds data going back to 2012 (which presumably will not change)
--    This job runtime will only get longer as time passes
-- **************************************************************************************************
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_PRF_CUST_351U_NEW';
...
execute immediate 'alter session enable parallel dml';
    ...
    l_text      := 'TRUNCATE tableS  DWH_CUST_PERFORMANCE.CUST_MART_VOUCHERS_WK, MN AND YR';
    dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);
    
    g_stmt      := 'TRUNCATE table  DWH_CUST_PERFORMANCE.CUST_MART_VOUCHERS_WEEK';
    execute immediate g_stmt;
    g_stmt      := 'TRUNCATE table  DWH_CUST_PERFORMANCE.CUST_MART_VOUCHERS_MONTH';
    execute immediate g_stmt;
    g_stmt      := 'TRUNCATE table  DWH_CUST_PERFORMANCE.CUST_MART_VOUCHERS_YEAR';
    execute immediate g_stmt;
...
--================================================================================
    ...
    DBMS_STATS.gather_table_stats ('DWH_CUST_PERFORMANCE','CUST_MART_VOUCHERS_WEEK',estimate_percent=>1, DEGREE => 32);
COMMIT; 
...
--================================================================================
    ...
    DBMS_STATS.gather_table_stats ('DWH_CUST_PERFORMANCE','CUST_MART_VOUCHERS_MONTH',estimate_percent=>1, DEGREE => 32);
COMMIT; 
...
--================================================================================
    ...
    DBMS_STATS.gather_table_stats ('DWH_CUST_PERFORMANCE','CUST_MART_VOUCHERS_YEAR',estimate_percent=>1, DEGREE => 32);
COMMIT; 
