--------------------------------------------------------
--  DDL for Procedure WH_PRF_CUST_315U
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_CUST_PERFORMANCE"."WH_PRF_CUST_315U" (p_forall_limit in integer,p_success out boolean) as
...
--**************************************************************************************************
    ...
    EXECUTE IMMEDIATE  'TRUNCATE TABLE DWH_CUST_PERFORMANCE.CUST_VMP_FTP';
