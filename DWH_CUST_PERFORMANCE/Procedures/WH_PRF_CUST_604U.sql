--------------------------------------------------------
--  DDL for Procedure WH_PRF_CUST_604U
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_CUST_PERFORMANCE"."WH_PRF_CUST_604U" (p_forall_limit in integer,p_success out boolean) AS 
...
--**************************************************************************************************
   ...
   (
    SELECT  EMAIL_SUBJECT,
            ...
            EVENT_DATE,
            LAST_UPDATED_DATE
    FROM   dwh_cust_performance.cust_svoc_campaign_fb_summ 
