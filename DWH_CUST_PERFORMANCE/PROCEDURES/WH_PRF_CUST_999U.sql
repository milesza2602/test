...
set define off;
  ...
  CREATE OR REPLACE PROCEDURE "DWH_CUST_PERFORMANCE"."WH_PRF_CUST_999U" 
...
------------------------------------  Engen
    ...
    union all
     select RECTYPE||'',''||
            RECCNT||'',''||
            TRAN_SELLING
     from dwh_cust_performance.cust_vmp_sales_ms_ENGN_FTR','|','DWH_FILES_OUT','20170510T091500-WWENGEN-49.txt');
   l_text :=  'Records extracted to 20170510T091500-WWENGEN-49 '||g_count;
