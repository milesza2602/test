--------------------------------------------------------
--  DDL for Procedure WH_PRF_CUST_251U
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_CUST_PERFORMANCE"."WH_PRF_CUST_251U" (p_forall_limit in integer,p_success out boolean) AS
...
--**************************************************************************************************
   ...
   execute immediate 'truncate table dwh_cust_performance.temp_cust_bu_mn_2';
   l_text := 'Truncate temp table  dwh_cust_performance.temp_cust_bu_mn_2' ;
   dwh_log.write_log(l_name,l_system_name,l_script_name,l_procedure_name,l_text);
