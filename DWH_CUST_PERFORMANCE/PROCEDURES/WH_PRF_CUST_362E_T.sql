--------------------------------------------------------
--  DDL for Procedure WH_PRF_CUST_362E_T
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_CUST_PERFORMANCE"."WH_PRF_CUST_362E_T" 
...
--**************************************************************************************************
    ...
    G_COUNT := DWH_PERFORMANCE.DWH_GENERIC_FILE_EXTRACT
       ('select * from VS_EXT_MYSTERY_SHOPPER_ENGEN_T','|','DWH_FILES_OUT','engen_mystery_shopper_t.txt');
