--------------------------------------------------------
--  DDL for Procedure WH_FND_HR_318U
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_HR_FOUNDATION"."WH_FND_HR_318U" (p_forall_limit in integer,p_success out boolean) AS


--**************************************************************************************************
--  Date:        Jul 2014
--  Author:      Kgomotso Lehabe
--  Purpose:     Create HR POI SKILLS DEV FACT table in the foundation layer
--
--  Tables:      Input  - stg_ps_skill_dev_spend_cpy
--               Output - fnd_hr_bee_poi_skill_dev_spend
...
g_rec_out            fnd_hr_bee_poi_skill_dev_spend%rowtype;
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_FND_HR_318U';
...
l_description        sys_dwh_log_summary.log_description%type  := 'LOAD THE HR POI SKILL DEV EX PEOPLE SOFT';
...
type tbl_array_i is table of fnd_hr_bee_poi_skill_dev_spend%rowtype index by binary_integer;
type tbl_array_u is table of fnd_hr_bee_poi_skill_dev_spend%rowtype index by binary_integer;
...
begin
    forall i in a_tbl_insert.first .. a_tbl_insert.last
       save exceptions
       insert into fnd_hr_bee_poi_skill_dev_spend values a_tbl_insert(i);
...
begin
    ...
    forall i in a_tbl_update.first .. a_tbl_update.last
       save exceptions
       update fnd_hr_bee_poi_skill_dev_spend
...
-- Check to see if item is present on table and update/insert accordingly
   select count(1)
   into   g_count
   from   fnd_hr_bee_poi_skill_dev_spend
...
begin
    ...
    l_text := 'LOAD OF fnd_hr_bee_poi_skill_dev_spend EX hr STARTED AT '||
