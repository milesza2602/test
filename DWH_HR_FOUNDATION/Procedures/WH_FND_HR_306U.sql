--------------------------------------------------------
--  DDL for Procedure WH_FND_HR_306U
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "DWH_HR_FOUNDATION"."WH_FND_HR_306U" (p_forall_limit in integer,p_success out boolean) AS

--**************************************************************************************************
--  Date:        Jan 2012
--  Author:      Alastair de Wet
--  Purpose:     Create HR SKILLS DEV LEARN FACT table in the foundation layer
--               with input ex staging table from HR.
--  Tables:      Input  - stg_ps_skill_dev_learn_cpy
--               Output - fnd_hr_bee_skill_dev_learn
--  Packages:    constants, dwh_log, dwh_valid
--
--  Maintenance:
--      Date      : Jun 2014
--     Changed by : Kgomotso Lehabe
--     Purpose    : Add more columns to fnd_hr_bee_skill_dev_learn
--                   learner_status_code
--                   absorption_ind
--                   absorption_date
--                   absorption_type
--                : Only load records that are in the Employee master because this interface combines Employees and POIs
--
--  Naming conventions
--  g_  -  Global variable
...
g_rec_out            fnd_hr_bee_skill_dev_learn%rowtype;
...
l_module_name        sys_dwh_errlog.log_procedure_name%type    := 'WH_FND_HR_306U';
...
l_description        sys_dwh_log_summary.log_description%type  := 'LOAD THE HR SKILL DEV LEARN EX PEOPLE SOFT';
...
type tbl_array_i is table of fnd_hr_bee_skill_dev_learn%rowtype index by binary_integer;
type tbl_array_u is table of fnd_hr_bee_skill_dev_learn%rowtype index by binary_integer;
...
cursor c_stg_ps_skill_dev_learn is
   select *
   from stg_ps_skill_dev_learn_cpy
...
begin
    forall i in a_tbl_insert.first .. a_tbl_insert.last
       save exceptions
       insert into fnd_hr_bee_skill_dev_learn values a_tbl_insert(i);
...
begin
    ...
    forall i in a_tbl_update.first .. a_tbl_update.last
       save exceptions
       update fnd_hr_bee_skill_dev_learn
...
-- Check to see if item is present on table and update/insert accordingly
   select count(1)
   into   g_count
   from   fnd_hr_bee_skill_dev_learn
...
begin
    ...
    l_text := 'LOAD OF fnd_hr_bee_skill_dev_learn EX hr STARTED AT '||
